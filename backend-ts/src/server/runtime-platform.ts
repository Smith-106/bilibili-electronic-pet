...
import { resolvePlatformAdapter, resolvePlatformBaseEnabled } from '../platforms/registry.js';
...
export function defaultIsPlatformEnabled(platform: PlatformName, settings: RuntimeSettings): boolean {
  return resolvePlatformEffectiveEnabled(resolvePlatformBaseEnabled(platform, settings), platform);
}
