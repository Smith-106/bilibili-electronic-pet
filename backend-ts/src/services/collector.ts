...
const mapPoller: Mapper = (p) => ({
  ...
  content: pickFirst(p, 'content', 'message', 'text', 'content.message', 'event.content', 'event.message', 'event.content.message'),
...
const mapOfficial: Mapper = (p) => ({
  comment_id: pickFirst(p, 'comment_id', 'commentId', 'data.comment_id', 'data.commentId', 'event.comment_id', 'event.commentId'),
  ...
  content: pickFirst(p, 'content', 'message', 'data.content', 'data.message', 'event.content', 'event.message', 'event.content.message'),
  parent_id: pickFirst(p, 'parent_id', 'parentId', 'data.parent_id', 'data.parentId', 'event.parent_id', 'event.parentId'),
  trace_id: pickFirst(p, 'trace_id', 'traceId', 'data.trace_id', 'data.traceId', 'event.trace_id', 'event.traceId', 'meta.trace_id', 'meta.traceId'),
});
