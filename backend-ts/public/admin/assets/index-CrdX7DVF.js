(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=s(i);fetch(i.href,a)}})();function ee(e,t,s){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof s=="string"&&s.trim()?s.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function K(){return(window.__ADMIN_API_KEY__||"").trim()}async function b(e,t={}){const s=K(),r=new Headers(t.headers||{});s&&r.set("x-api-key",s);const i=await fetch(e,{...t,headers:r}),a=await i.json().catch(()=>({}));if(!i.ok){const o=(a==null?void 0:a.detail)||(a==null?void 0:a.error);throw new Error(ee(o,i.status,i.statusText))}return a}async function N(e,t){const s=K(),r=new Headers;s&&r.set("x-api-key",s);const i=await fetch(e,{headers:r});if(!i.ok)throw new Error("download_failed");const a=await i.blob(),o=URL.createObjectURL(a),l=document.createElement("a");l.href=o,l.download=t,document.body.appendChild(l),l.click(),document.body.removeChild(l),URL.revokeObjectURL(o)}function h(e){const t=new URLSearchParams;for(const[r,i]of Object.entries(e))i!=null&&i!==""&&t.set(r,String(i));const s=t.toString();return s?`?${s}`:""}function w(){return{getOverview(){return b("/api/admin/overview")},getJobs({status:e,limit:t}={}){return b(`/api/admin/jobs${h({status:e,limit:t})}`)},getJob(e){return b(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return b(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return b(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return b("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return b("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return N(`/export/jobs.csv${h({status:e,limit:t})}`,"jobs.csv")},getComment(e){return b(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return b(`/api/admin/gateway/logs${h({limit:e,comment_id:t})}`)},publishGatewayReply(e){return b("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:s}={}){return b(`/api/admin/audit/summary${h({days:e,action:t,ok:s})}`)},getAuditLogs({limit:e,action:t,ok:s}={}){return b(`/api/audit-log${h({limit:e,action:t,ok:s})}`)},exportAuditCsv({limit:e,action:t,ok:s}={}){return N(`/export/audit-logs.csv${h({limit:e,action:t,ok:s})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return b(`/api/metrics/daily${h({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return b(`/api/admin/knowledge${h({limit:e,offset:t})}`)},createKnowledgeEntry(e){return b("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return b(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return b(`/api/admin/role-cards${h({limit:e,offset:t})}`)},createRoleCard(e){return b("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return b(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return b(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return b(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return b("/api/admin/style-profile")},setStyleProfile(e){return b("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return b("/api/admin/role-profile")},setRoleProfile(e){return b("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return b("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:s}={}){return b(`/api/admin/bilibili/videos${h({poll_enabled:e,limit:t,offset:s})}`)},addBilibiliVideo(e){return b("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return b(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return b(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return b(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return b("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return b("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return b("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return b(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return b(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function n(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function A(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function te(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const s=Date.now()-t.getTime(),r=Math.floor(s/1e3);if(r<60)return"刚刚";const i=Math.floor(r/60);if(i<60)return`${i}分钟前`;const a=Math.floor(i/60);if(a<24)return`${a}小时前`;const o=Math.floor(a/24);if(o<30)return`${o}天前`;const l=Math.floor(o/30);return l<12?`${l}个月前`:`${Math.floor(l/12)}年前`}catch{return""}}function q(e){const t=te(e),s=A(e);return t?`<span title="${n(s)}">${n(t)}</span>`:`<span title="${n(s)}">${n(s)}</span>`}function S(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const ie={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function H(e){if(!e)return"";const t=ie[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${n(t.label)}</span>`}function P(e,t="是",s="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${n(e?t:s)}</span>`}let j=null;function c(e,t="info"){const s=document.getElementById("app-toast");s&&s.remove(),j&&clearTimeout(j);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},i=document.createElement("div");i.id="app-toast",i.className="toast-notification",i.style.setProperty("--toast-color",r[t]||r.info),i.innerHTML=`
  ...
  `,document.body.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const a=()=>{i.classList.remove("show"),setTimeout(()=>i.remove(),300)};i.querySelector(".toast-close").onclick=a,j=setTimeout(a,4e3)}const T=w();async function U(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,s,r,i]=await Promise.all([T.getOverview().catch(()=>null),T.getJobs({limit:5}).catch(()=>null),T.getGatewayLogs({limit:5}).catch(()=>null),T.getAuditSummary({days:7}).catch(()=>null)]),a=t||{},o=Array.isArray(s==null?void 0:s.items)?s.items:[],l=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
      ...
      <div class="stat-grid">
        ...
        <div class="stat-card">
          ...
          <div class="stat-value">${S(l.length)}</div>
        </div>
      </div>
            ...
            <table class="data-table">
              ...
              <tbody>
                ${o.length===0?'<tr><td colspan="4" class="table-empty-cell">暂无任务</td></tr>':o.map(d=>{var p,u;return`<tr>
                    ...
                    <td class="cell-time">${n(A(d.created_at))}</td>
                  </tr>`}).join("")}
              </tbody>
            </table>
          </div>
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{c("正在刷新...","info"),U(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${n(t.message)}</div>`}}const _=w();async function se(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;const s=e.querySelector("#jobs-status"),r=e.querySelector("#jobs-limit");async function i(){var l;t.clear(),a();const o=e.querySelector("#jobs-table-wrapper");o.innerHTML='<div class="page-loading">加载中...</div>';try{const d=await _.getJobs({status:s.value,limit:r.value}),p=Array.isArray(d==null?void 0:d.items)?d.items:[];if(p.length===0){o.innerHTML='<div class="table-empty">暂无任务</div>';return}o.innerHTML=`
          ...
          <tbody>
            ${p.map(u=>{var f,$,v,x;return`
              <tr data-id="${n(u.id)}">
                ...
                <td class="cell-truncate">${n((v=u.reply_text)==null?void 0:v.substring(0,60))}</td>
                <td>${(x=u.risk_flags)!=null&&x.length?u.risk_flags.map(E=>`<span class="risk-flag">${n(E)}</span>`).join(" "):"-"}</td>
      ...
      `,(l=o.querySelector("#jobs-select-all"))==null||l.addEventListener("change",u=>{const f=u.target.checked;o.querySelectorAll(".job-checkbox").forEach($=>{$.checked=f,f?t.add($.dataset.id):t.delete($.dataset.id)}),a()}),o.querySelectorAll(".job-checkbox").forEach(u=>{u.addEventListener("change",()=>{u.checked?t.add(u.dataset.id):t.delete(u.dataset.id),a()})}),o.querySelectorAll(".job-approve").forEach(u=>{u.addEventListener("click",async()=>{u.disabled=!0,u.textContent="审批中...";try{await _.approveJob(u.dataset.id),c("审批成功","success"),i()}catch(f){c(`审批失败: ${f.message}`,"error"),u.disabled=!1,u.textContent="审批"}})}),o.querySelectorAll(".job-retry").forEach(u=>{u.addEventListener("click",async()=>{u.disabled=!0,u.textContent="重试中...";try{await _.retryJob(u.dataset.id),c("重试已提交","success"),i()}catch(f){c(`重试失败: ${f.message}`,"error"),u.disabled=!1,u.textContent="重试"}})})}catch(d){o.innerHTML=`<div class="page-error">加载失败: ${n(d.message)}</div>`}}function a(){const o=e.querySelector("#jobs-batch-bar"),l=e.querySelector("#jobs-selected-count");t.size>0?(o.style.display="flex",l.textContent=`已选 ${t.size} 项`):o.style.display="none"}e.querySelector("#jobs-filter-btn").addEventListener("click",i),e.querySelector("#jobs-refresh").addEventListener("click",i),e.querySelector("#jobs-export").addEventListener("click",async()=>{try{await _.exportJobsCsv({status:s.value,limit:r.value}),c("导出成功","success")}catch(o){c(`导出失败: ${o.message}`,"error")}}),e.querySelector("#jobs-batch-approve").addEventListener("click",async()=>{if(t.size!==0)try{await _.batchApprove([...t]),c(`批量审批 ${t.size} 项成功`,"success"),i()}catch(o){c(`批量审批失败: ${o.message}`,"error")}}),e.querySelector("#jobs-batch-retry").addEventListener("click",async()=>{if(t.size!==0)try{await _.batchRetry([...t]),c(`批量重试 ${t.size} 项成功`,"success"),i()}catch(o){c(`批量重试失败: ${o.message}`,"error")}}),await i()}const le=w();async function ae(e){e.innerHTML=`
    <div class="page-header">
      <h2>每日指标</h2>
      <div class="page-actions">
  ...
  `;async function t(){const s=e.querySelector("#metrics-days").value,r=e.querySelector("#metrics-table-wrapper");r.innerHTML='<div class="page-loading">加载中...</div>';try{const i=await le.getDailyMetrics({days:s}),a=Array.isArray(i==null?void 0:i.items)?i.items:Array.isArray(i)?i:[];if(a.length===0){r.innerHTML='<div class="table-empty">暂无指标数据</div>';return}r.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `}catch(i){r.innerHTML=`<div class="page-error">加载失败: ${n(i.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const M=w();async function re(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const s=e.querySelector("#knowledge-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await M.getKnowledgeEntries({limit:50}),i=Array.isArray(r==null?void 0:r.items)?r.items:[];if(i.length===0){s.innerHTML='<div class="table-empty">暂无知识条目</div>';return}s.innerHTML=`
      ...
      `,s.querySelectorAll(".knowledge-disable").forEach(a=>{a.addEventListener("click",async()=>{try{await M.disableKnowledgeEntry(a.dataset.id),c("已禁用","success"),t()}catch(o){c(`操作失败: ${o.message}`,"error")}})})}catch(r){s.innerHTML=`<div class="page-error">加载失败: ${n(r.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const s=e.querySelector("#knowledge-category").value.trim(),r=e.querySelector("#knowledge-title").value.trim(),i=e.querySelector("#knowledge-content").value.trim();if(!r||!i){c("标题和内容不能为空","warning");return}try{await M.createKnowledgeEntry({category:s,title:r,content:i}),c("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(a){c(`创建失败: ${a.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const k=w();let L=!1,m=null;async function de(e){L=!1,m=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `;const t=e.querySelector("#rc-select"),s=e.querySelector("#rc-editor");let r=[];function i(){L=!0}function a(){return L?confirm("当前角色卡有未保存的修改，确定要切换吗？"):!0}function o(d){m=d,e.querySelector("#rc-key").value=(d==null?void 0:d.key)||"",e.querySelector("#rc-key").disabled=!!d,e.querySelector("#rc-name").value=(d==null?void 0:d.name)||"",e.querySelector("#rc-desc").value=(d==null?void 0:d.description)||"",e.querySelector("#rc-system-prompt").value=(d==null?void 0:d.system_prompt)||"",e.querySelector("#rc-tone").value=(d==null?void 0:d.tone)||"",e.querySelector("#rc-constraints").value=typeof(d==null?void 0:d.constraints)=="string"?d.constraints:JSON.stringify((d==null?void 0:d.constraints)||"",null,2),e.querySelector("#rc-editor-title").textContent=d?`编辑: ${d.name||d.key}`:"新建角色卡",e.querySelector("#rc-activate").style.display=d&&d.enabled!==!1?"inline-flex":"none",e.querySelector("#rc-disable").style.display=d&&d.enabled!==!1?"inline-flex":"none",s.style.display="block",L=!1}s.querySelectorAll(".form-input").forEach(d=>d.addEventListener("input",i));async function l(){try{const d=await k.getRoleCards({limit:100});r=Array.isArray(d==null?void 0:d.items)?d.items:Array.isArray(d)?d:[],t.innerHTML='<option value="">-- 新建 --</option>'+r.map(p=>`<option value="${n(p.key)}">${n(p.name||p.key)}${p.enabled===!1?" (禁用)":""}</option>`).join("")}catch(d){c(`加载失败: ${d.message}`,"error")}}t.addEventListener("change",()=>{if(!a()){t.value=(m==null?void 0:m.key)||"";return}const d=t.value,p=r.find(u=>u.key===d);o(p||null)}),e.querySelector("#rc-new").addEventListener("click",()=>{a()&&(t.value="",o(null))}),e.querySelector("#rc-save").addEventListener("click",async()=>{const d={key:e.querySelector("#rc-key").value.trim(),name:e.querySelector("#rc-name").value.trim(),description:e.querySelector("#rc-desc").value.trim(),system_prompt:e.querySelector("#rc-system-prompt").value.trim(),tone:e.querySelector("#rc-tone").value.trim()},p=e.querySelector("#rc-constraints").value.trim();try{d.constraints=p?JSON.parse(p):""}catch{d.constraints=p}if(!d.key){c("Key 不能为空","warning");return}try{m!=null&&m.key?(await k.updateRoleCard(m.key,d),c("保存成功","success")):(await k.createRoleCard(d),c("创建成功","success")),L=!1,await l(),t.value=d.key}catch(u){c(`操作失败: ${u.message}`,"error")}}),e.querySelector("#rc-activate").addEventListener("click",async()=>{if(m!=null&&m.key)try{await k.activateRoleCard(m.key),c("已激活","success"),await l()}catch(d){c(`激活失败: ${d.message}`,"error")}}),e.querySelector("#rc-disable").addEventListener("click",async()=>{if(m!=null&&m.key)try{await k.disableRoleCard(m.key),c("已禁用","success"),await l()}catch(d){c(`禁用失败: ${d.message}`,"error")}}),e.querySelector("#rc-refresh").addEventListener("click",()=>{l()}),await l()}const C=w();async function oe(e){e.innerHTML=`
  ...
  `;const t=e.querySelector("#gw-reply"),s=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{s.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const i=e.querySelector("#gw-publish-btn"),a=e.querySelector("#gw-comment-id").value.trim(),o=e.querySelector("#gw-reply").value.trim(),l=e.querySelector("#gw-source").value.trim(),d=e.querySelector("#gw-force").checked;if(!a||!o){c("Comment ID 和回复内容不能为空","warning");return}i.disabled=!0,i.textContent="发布中...";try{await J.publishGatewayReply({comment_id:a,reply_text:o,source:l,force_publish:d}),c("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",s.textContent="0/0",r()}catch(p){c(`发布失败: ${p.message}`,"error")}finally{i.disabled=!1,i.textContent="发布"}});async function r(){const i=e.querySelector("#gw-table-wrapper"),a=e.querySelector("#gw-limit").value;i.innerHTML='<div class="page-loading">加载中...</div>';try{const o=await J.getGatewayLogs({limit:a}),l=Array.isArray(o==null?void 0:o.items)?o.items:[];if(l.length===0){i.innerHTML='<div class="table-empty">暂无网关日志</div>';return}i.innerHTML=ne({columns:[{key:"id",label:"ID",class:"cell-id",render:d=>{var p;return n((p=d.id)==null?void 0:p.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:d=>{var p;return n((p=d.comment_id)==null?void 0:p.substring(0,12))}},{key:"status",label:"状态",render:d=>H(d.status)},{key:"platform",label:"平台",render:d=>n(d.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:d=>{var p;return n((p=d.reply_text)==null?void 0:p.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:d=>q(d.created_at)}],rows:l})}catch(o){i.innerHTML=`<div class="page-error">加载失败: ${n(o.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",r),e.querySelector("#gw-filter-btn").addEventListener("click",r),await r()}const I=w();async function ue(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const r=await I.getAuditSummary({days:7}),i=e.querySelector("#audit-summary-cards");i.innerHTML=`
        <div class="stat-card mini">
          <div class="stat-label">总操作</div>
  ...
  `;async function t(){var a,o,l,d,p,u,f,$;const i=e.querySelector("#bili-status-cards");try{const v=await g.getBilibiliStatus(),x=Number(((a=v==null?void 0:v.videos)==null?void 0:a.poll_enabled_count)??0),E=!!((o=v==null?void 0:v.diagnostics)!=null&&o.ready),R=$e((l=v==null?void 0:v.diagnostics)==null?void 0:l.blocking_reasons),F=(d=v==null?void 0:v.credential)!=null&&d.name?n(v.credential.name):"未配置",W=Se((p=v==null?void 0:v.diagnostics)==null?void 0:p.effective_publish_mode),Z=_e((u=v==null?void 0:v.config)==null?void 0:u.poll_interval_seconds),Q=D((f=v==null?void 0:v.credential)==null?void 0:f.expires_at),X=D(($=v==null?void 0:v.credential)==null?void 0:$.last_used_at);i.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value">${n(W)}</div>
        </div>
        <div class="stat-card mini">
          <div class="stat-label">轮询间隔</div>
          <div class="stat-value">${n(Z)}</div>
        </div>
        <div class="stat-card mini">
          <div class="stat-label">凭证过期</div>
          <div class="stat-value" style="font-size:14px;">${n(Q)}</div>
        </div>
        <div class="stat-card mini">
          <div class="stat-label">最近使用</div>
          <div class="stat-value" style="font-size:14px;">${n(X)}</div>
        </div>
        ${R?`<div class="page-error" style="grid-column: 1 / -1; margin: 0;">阻塞原因: ${n(R)}</div>`:""}
      `}catch(v){i.innerHTML=`<div class="page-error">状态加载失败: ${n(y(v))}</div>`}}async function s(){const i=e.querySelector("#bili-videos-wrapper");try{const a=await g.getBilibiliVideos({limit:50}),o=Array.isArray(a==null?void 0:a.items)?a.items:Array.isArray(a)?a:[];if(o.length===0){i.innerHTML='<div class="table-empty">暂无视频</div>';return}i.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${o.map(l=>`<tr data-id="${n(l.id||l.video_id)}">
              ...
              <td>${P(l.poll_enabled)}</td>
              <td>${l.comment_count??"-"}</td>
              <td class="cell-time">${l.last_polled_at?q(l.last_polled_at):"-"}</td>
              <td>${qe(l.last_poll_status,l.last_poll_error)}</td>
              <td class="cell-actions">
      ...
      `,i.querySelectorAll(".bili-toggle-poll").forEach(l=>{l.addEventListener("click",async()=>{l.disabled=!0;try{await g.toggleBilibiliVideoPoll(l.dataset.id),c("操作成功","success"),await Promise.all([t(),s()])}catch(d){c(`失败: ${y(d)}`,"error")}finally{l.disabled=!1}})}),i.querySelectorAll(".bili-sync").forEach(l=>{l.addEventListener("click",async()=>{const d=l.textContent;l.disabled=!0,l.textContent="同步中...";try{await g.syncBilibiliVideo(l.dataset.id),c("同步完成","success"),await Promise.all([t(),s()])}catch(p){c(`同步失败: ${y(p)}`,"error")}finally{l.disabled=!1,l.textContent=d}})}),i.querySelectorAll(".bili-delete").forEach(l=>{l.addEventListener("click",async()=>{if(confirm("确定删除此视频？")){l.disabled=!0;try{await g.deleteBilibiliVideo(l.dataset.id),c("已删除","success"),await Promise.all([t(),s()])}catch(d){c(`删除失败: ${y(d)}`,"error")}finally{l.disabled=!1}}})})}catch(a){i.innerHTML=`<div class="page-error">加载失败: ${n(y(a))}</div>`}}async function r(){const i=e.querySelector("#bili-creds-wrapper");try{const a=await g.getBilibiliCredentials(),o=Array.isArray(a==null?void 0:a.items)?a.items:Array.isArray(a)?a:[];if(o.length===0){i.innerHTML='<div class="table-empty">暂无凭证</div>';return}i.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${o.map(l=>`<tr data-id="${n(l.id||l.credential_id)}">
              ...
              <td class="cell-time">${n(l.expires_at?A(l.expires_at):"-")}</td>
      ...
      `,i.querySelectorAll(".cred-activate").forEach(l=>{l.addEventListener("click",async()=>{l.disabled=!0;try{await g.activateBilibiliCredential(l.dataset.id),c("已激活","success"),await Promise.all([t(),r()])}catch(d){c(`激活失败: ${y(d)}`,"error")}finally{l.disabled=!1}})}),i.querySelectorAll(".cred-delete").forEach(l=>{l.addEventListener("click",async()=>{if(confirm("确定删除此凭证？")){l.disabled=!0;try{await g.deleteBilibiliCredential(l.dataset.id),c("已删除","success"),await Promise.all([t(),r()])}catch(d){c(`删除失败: ${y(d)}`,"error")}finally{l.disabled=!1}}})})}catch(a){i.innerHTML=`<div class="page-error">加载失败: ${n(y(a))}</div>`}}e.querySelector("#bili-video-add").addEventListener("click",async()=>{const i=e.querySelector("#bili-video-add"),a=e.querySelector("#bili-video-bvid").value.trim(),o=ge(a);if(o){c(y(o),"warning");return}i.disabled=!0,i.textContent="添加中...";try{await g.addBilibiliVideo(a),c("添加成功","success"),e.querySelector("#bili-video-bvid").value="",await Promise.all([t(),s()])}catch(l){c(`添加失败: ${y(l)}`,"error")}finally{i.disabled=!1,i.textContent="添加"}}),e.querySelector("#cred-add").addEventListener("click",async()=>{const i=e.querySelector("#cred-add"),a=we(e.querySelector("#cred-expires").value),o={name:e.querySelector("#cred-name").value.trim(),sessdata:e.querySelector("#cred-sessdata").value.trim(),bili_jct:e.querySelector("#cred-bili-jct").value.trim(),buvid3:e.querySelector("#cred-buvid3").value.trim(),buvid4:e.querySelector("#cred-buvid4").value.trim(),expires_at:a},l=he(o);if(l){c(y(l),"warning");return}i.disabled=!0,i.textContent="添加中...";try{await g.addBilibiliCredential(o),c("凭证添加成功","success"),e.querySelector("#cred-name").value="",e.querySelector("#cred-sessdata").value="",e.querySelector("#cred-bili-jct").value="",e.querySelector("#cred-buvid3").value="",e.querySelector("#cred-buvid4").value="",e.querySelector("#cred-expires").value="",await Promise.all([t(),r()])}catch(d){c(`添加失败: ${y(d)}`,"error")}finally{i.disabled=!1,i.textContent="添加凭证"}}),e.querySelector("#bili-poll-btn").addEventListener("click",async()=>{const i=e.querySelector("#bili-poll-btn");i.disabled=!0,i.textContent="轮询中...";try{await g.triggerBilibiliPoll(),c("轮询完成","success"),await Promise.all([t(),s()])}catch(a){c(`轮询失败: ${y(a)}`,"error")}finally{i.disabled=!1,i.textContent="触发轮询"}}),e.querySelector("#bili-refresh").addEventListener("click",()=>{t(),s(),r()}),await Promise.all([t(),s(),r()])}const V=w();async function Le(e){e.innerHTML=`
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),s=e.querySelector("#query-comment-result");if(!t){c("请输入 Comment ID","warning");return}s.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await V.getComment(t);s.innerHTML=`
      ...
      `}catch(r){s.innerHTML=`<div class="page-error">查询失败: ${n(r.message)}</div>`}}),e.querySelector("#query-job-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-job-id").value.trim(),s=e.querySelector("#query-job-result");if(!t){c("请输入 Job ID","warning");return}s.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await V.getJob(t);s.innerHTML=`
        <div class="detail-card">
      ...
      `;const i=s.querySelector("#query-goto-comment");i&&i.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=i.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){s.innerHTML=`<div class="page-error">查询失败: ${n(r.message)}</div>`}})}const B={dashboard:{render:U,title:"仪表盘"},jobs:{render:se,title:"任务管理"},"daily-metrics":{render:ae,title:"每日指标"},knowledge:{render:re,title:"知识库"},"role-cards":{render:de,title:"角色卡"},profiles:{render:oe,title:"风格配置"},gateway:{render:ce,title:"网关"},audit:{render:ue,title:"审计日志"},bilibili:{render:ke,title:"B站集成"},query:{render:Le,title:"查询"}};let z=null;function xe(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function G(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function Y(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Ee(e){e.preventDefault();const t=document.getElementById("login-api-key"),s=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await b("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),Y(),O("dashboard")}catch{s.textContent="API Key 无效或服务不可用",s.style.display="block",window.__ADMIN_API_KEY__=""}}}function Te(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",G()}function O(e){if(!B[e])return;z=e,document.querySelectorAll("#nav-list .nav-item").forEach(s=>{s.classList.toggle("active",s.dataset.page===e)}),document.getElementById("page-title").textContent=B[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',B[e].render(t).catch(s=>{t.innerHTML=`<div class="page-error">加载失败: ${s.message}</div>`})}function Ce(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==z&&O(t)})})}function Ae(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),s=document.getElementById("expand-left-btn");t&&s&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),s.style.display="block"}),s.addEventListener("click",()=>{e.classList.remove("collapsed"),s.style.display="none"}))}function je(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let s=0;e.addEventListener("click",()=>{s=(s+1)%t.length,t[s]?document.body.setAttribute("data-theme",t[s]):document.body.removeAttribute("data-theme")})}function Me(){Ae(),je(),Ce(),document.getElementById("login-form").addEventListener("submit",Ee),document.getElementById("logout-btn").addEventListener("click",Te),xe()?(Y(),O("dashboard")):G()}Me();
