(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function l(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=l(s);fetch(s.href,i)}})();function wt(e,t,l){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof l=="string"&&l.trim()?l.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function ct(){return(window.__ADMIN_API_KEY__||"").trim()}async function y(e,t={}){const l=ct(),r=new Headers(t.headers||{});l&&r.set("x-api-key",l);const s=await fetch(e,{...t,headers:r}),i=await s.json().catch(()=>({}));if(!s.ok){const a=(i==null?void 0:i.detail)||(i==null?void 0:i.error);throw new Error(wt(a,s.status,s.statusText))}return i}async function lt(e,t){const l=ct(),r=new Headers;l&&r.set("x-api-key",l);const s=await fetch(e,{headers:r});if(!s.ok)throw new Error("download_failed");const i=await s.blob(),a=URL.createObjectURL(i),b=document.createElement("a");b.href=a,b.download=t,document.body.appendChild(b),b.click(),document.body.removeChild(b),URL.revokeObjectURL(a)}function B(e){const t=new URLSearchParams;for(const[r,s]of Object.entries(e))s!=null&&s!==""&&t.set(r,String(s));const l=t.toString();return l?`?${l}`:""}function P(){return{getOverview(){return y("/api/admin/overview")},getJobs({status:e,limit:t}={}){return y(`/api/admin/jobs${B({status:e,limit:t})}`)},getJob(e){return y(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return y(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return y(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return y("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return y("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return lt(`/export/jobs.csv${B({status:e,limit:t})}`,"jobs.csv")},getComment(e){return y(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return y(`/api/admin/gateway/logs${B({limit:e,comment_id:t})}`)},publishGatewayReply(e){return y("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:l}={}){return y(`/api/admin/audit/summary${B({days:e,action:t,ok:l})}`)},getAuditLogs({limit:e,action:t,ok:l}={}){return y(`/api/audit-log${B({limit:e,action:t,ok:l})}`)},exportAuditCsv({limit:e,action:t,ok:l}={}){return lt(`/export/audit-logs.csv${B({limit:e,action:t,ok:l})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return y(`/api/metrics/daily${B({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return y(`/api/admin/knowledge${B({limit:e,offset:t})}`)},createKnowledgeEntry(e){return y("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return y(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return y(`/api/admin/role-cards${B({limit:e,offset:t})}`)},createRoleCard(e){return y("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return y(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return y(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return y(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return y("/api/admin/style-profile")},setStyleProfile(e){return y("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return y("/api/admin/role-profile")},setRoleProfile(e){return y("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return y("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:l}={}){return y(`/api/admin/bilibili/videos${B({poll_enabled:e,limit:t,offset:l})}`)},addBilibiliVideo(e){return y("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return y("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return y("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return y("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return y(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return y(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function d(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function M(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function Xe(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const l=Date.now()-t.getTime(),r=Math.floor(l/1e3);if(r<60)return"刚刚";const s=Math.floor(r/60);if(s<60)return`${s}分钟前`;const i=Math.floor(s/60);if(i<24)return`${i}小时前`;const a=Math.floor(i/24);if(a<30)return`${a}天前`;const b=Math.floor(a/30);return b<12?`${b}个月前`:`${Math.floor(b/12)}年前`}catch{return""}}function ye(e){const t=Xe(e),l=M(e);return t?`<span title="${d(l)}">${d(t)}</span>`:`<span title="${d(l)}">${d(l)}</span>`}function H(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const St={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function et(e){if(!e)return"";const t=St[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${d(t.label)}</span>`}function tt(e,t="是",l="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${d(e?t:l)}</span>`}let Fe=null;function v(e,t="info"){const l=document.getElementById("app-toast");l&&l.remove(),Fe&&clearTimeout(Fe);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},s=document.createElement("div");s.id="app-toast",s.className="toast-notification",s.style.setProperty("--toast-color",r[t]||r.info),s.innerHTML=`
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("show"));const i=()=>{s.classList.remove("show"),setTimeout(()=>s.remove(),300)};s.querySelector(".toast-close").onclick=i,Fe=setTimeout(i,4e3)}const Ee=P();async function ut(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,l,r,s]=await Promise.all([Ee.getOverview().catch(()=>null),Ee.getJobs({limit:5}).catch(()=>null),Ee.getGatewayLogs({limit:5}).catch(()=>null),Ee.getAuditSummary({days:7}).catch(()=>null)]),i=t||{},a=Array.isArray(l==null?void 0:l.items)?l.items:[],b=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{v("正在刷新...","info"),ut(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${d(t.message)}</div>`}}const ce=P();async function Et(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;async function t(){const l=e.querySelector("#metrics-days").value,r=e.querySelector("#metrics-table-wrapper");r.innerHTML='<div class="page-loading">加载中...</div>';try{const s=await Ct.getDailyMetrics({days:l}),i=Array.isArray(s==null?void 0:s.items)?s.items:Array.isArray(s)?s:[];if(i.length===0){r.innerHTML='<div class="table-empty">暂无指标数据</div>';return}r.innerHTML=`
      ...
      `}catch(s){r.innerHTML=`<div class="page-error">加载失败: ${d(s.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const ze=P();async function Tt(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const l=e.querySelector("#knowledge-table-wrapper");l.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await ze.getKnowledgeEntries({limit:50}),s=Array.isArray(r==null?void 0:r.items)?r.items:[];if(s.length===0){l.innerHTML='<div class="table-empty">暂无知识条目</div>';return}l.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${s.map(i=>{var a,b;return`<tr>
              ...
              <td class="cell-time">${ye(i.created_at)}</td>
              <td class="cell-actions">
      ...
      `,l.querySelectorAll(".knowledge-disable").forEach(i=>{i.addEventListener("click",async()=>{try{await ze.disableKnowledgeEntry(i.dataset.id),v("已禁用","success"),t()}catch(a){v(`操作失败: ${a.message}`,"error")}})})}catch(r){l.innerHTML=`<div class="page-error">加载失败: ${d(r.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const l=e.querySelector("#knowledge-category").value.trim(),r=e.querySelector("#knowledge-title").value.trim(),s=e.querySelector("#knowledge-content").value.trim();if(!r||!s){v("标题和内容不能为空","warning");return}try{await ze.createKnowledgeEntry({category:l,title:r,content:s}),v("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(i){v(`创建失败: ${i.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const fe=P();let he=!1,S=null;async function kt(e){he=!1,S=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `;const t=e.querySelector("#gw-reply"),l=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{l.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const s=e.querySelector("#gw-publish-btn"),i=e.querySelector("#gw-comment-id").value.trim(),a=e.querySelector("#gw-reply").value.trim(),b=e.querySelector("#gw-source").value.trim(),o=e.querySelector("#gw-force").checked;if(!i||!a){v("Comment ID 和回复内容不能为空","warning");return}s.disabled=!0,s.textContent="发布中...";try{await rt.publishGatewayReply({comment_id:i,reply_text:a,source:b,force_publish:o}),v("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",l.textContent="0/0",r()}catch(p){v(`发布失败: ${p.message}`,"error")}finally{s.disabled=!1,s.textContent="发布"}});async function r(){const s=e.querySelector("#gw-table-wrapper"),i=e.querySelector("#gw-limit").value;s.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await rt.getGatewayLogs({limit:i}),b=Array.isArray(a==null?void 0:a.items)?a.items:[];if(b.length===0){s.innerHTML='<div class="table-empty">暂无网关日志</div>';return}s.innerHTML=Bt({columns:[{key:"id",label:"ID",class:"cell-id",render:o=>{var p;return d((p=o.id)==null?void 0:p.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:o=>{var p;return d((p=o.comment_id)==null?void 0:p.substring(0,12))}},{key:"status",label:"状态",render:o=>et(o.status)},{key:"platform",label:"平台",render:o=>d(o.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:o=>{var p;return d((p=o.reply_text)==null?void 0:p.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:o=>ye(o.created_at)}],rows:b})}catch(a){s.innerHTML=`<div class="page-error">加载失败: ${d(a.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",r),e.querySelector("#gw-filter-btn").addEventListener("click",r),await r()}const Ge=P();async function Pt(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const r=await Ge.getAuditSummary({days:7}),s=e.querySelector("#audit-summary-cards");s.innerHTML=`
      ...
      `}catch(b){r.innerHTML=`<div class="page-error">加载失败: ${d(b.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),l()}),e.querySelector("#audit-filter-btn").addEventListener("click",l),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await Ge.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(r){v(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),l()])}const L=P(),At=/^BV[a-zA-Z0-9]{10}$/,Nt={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},It={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},jt={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},Ht={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},ge={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},ue=50,Rt=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return Nt[t]||t}function Dt(e){return e?At.test(e)?null:"invalid_bvid_format":"bvid_required"}function Ot(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Ut(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Vt(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(l=>It[l]||l).join("；")}function Wt(e){const t=String(e??"").trim().toLowerCase();return jt[t]||t||"-"}function Ye(e,t,l){return e?t:l}function Jt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Kt(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"";if(t<60){const s=60/t;return`约每分钟 ${s.toFixed(s>=10?0:1).replace(/\.0$/,"")} 轮`}if(t<3600){const s=3600/t;return`约每小时 ${s.toFixed(s>=10?0:1).replace(/\.0$/,"")} 轮`}const l=t/3600;return`约每 ${l.toFixed(l>=10?0:1).replace(/\.0$/,"")} 小时 1 轮`}function Ft(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function zt(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"";const l=t/60;if(l>=1)return`约每秒 ${l.toFixed(l>=10?0:1).replace(/\.0$/,"")} 次`;const r=60/t;return`约每 ${r.toFixed(r>=10?0:1).replace(/\.0$/,"")} 秒 1 次`}function st(e,t,l="覆盖率"){const r=Number(t??0);if(!Number.isFinite(r)||r<=0)return"暂无视频";const s=Number(e??0),a=((Number.isFinite(s)?Math.min(r,Math.max(0,s)):0)/r*100).toFixed(1).replace(/\.0$/,"");return`${l} ${a}%`}function Gt(e,t){const l=Number(e??0);if(!Number.isFinite(l)||l<=0)return"暂无视频";const r=Number(t??0),s=Number.isFinite(r)?Math.min(l,Math.max(0,r)):0,i=Math.max(0,l-s);return`轮询中 ${s}，停用 ${i}`}function Yt(e,t,l){const r=String(e??"").trim().toLowerCase();if(!r)return"-";const s=Ht[r]||{label:r,cls:"badge-muted"},i=r==="error"&&t?ge[String(t).trim().toLowerCase()]||String(t):"",a=i?` title="${d(i)}"`:"",b=typeof l=="number"&&Number.isFinite(l)?`评论游标: ${l}`:"",o=[i,b].filter(Boolean).map(p=>`<div class="form-hint" style="margin-top:4px;">${d(p)}</div>`).join("");return`<span class="status-badge ${s.cls}"${a}>${d(s.label)}</span>${o}`}function Zt(e){if(e==="true")return!0;if(e==="false")return!1}function Qt(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function A(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Xt(e){return e.filter(t=>!A(t)).length}function ei(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function ti(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!A(t)).length}function ii(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&A(t)).length}function li(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!A(t)).length}function ri(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function si(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ni(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function ai(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function oi(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function di(e){return e.filter(t=>{const l=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return l==="ok"||l==="no_new"}).length}function ci(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function ui(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function pi(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function bi(e){return e.filter(t=>A(t)&&!(t!=null&&t.last_polled_at)).length}function vi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function fi(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function hi(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function yi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function gi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&Number((t==null?void 0:t.comment_count)??0)<=0).length}function mi(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function $i(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function xi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function _i(e){return e.filter(t=>A(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function wi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(A(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function Si(e){return e.reduce((t,l)=>{const r=Number((l==null?void 0:l.comment_count)??0);return t+(Number.isFinite(r)&&r>0?r:0)},0)}function Ei(e){const l=A(e)?`aid: ${e.aid}`:ge.no_aid;return`${d((e==null?void 0:e.bvid)||"-")}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function pe(e,t){if(!t)return"";const l=Xe(t),r=M(t);return l?`${e}: ${l}（${r}）`:`${e}: ${r}`}function Ci(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&t.push(pe("创建",e.created_at)),`${d((e==null?void 0:e.title)||"-")}${t.map(l=>`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`).join("")}`}function qi(e){const t=A(e),l=t?"":" disabled",r=t?"":` title="${d(ge.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${d(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${l}${r}>同步</button>`}function Ti(e){const t=A(e)?"可同步":ge.no_aid;return`${tt(e==null?void 0:e.poll_enabled)}<div class="form-hint" style="margin-top:4px;">${d(t)}</div>`}function ki(e){const t=Number((e==null?void 0:e.comment_count)??0),l=Number.isFinite(t)&&t>0?t:0;let r="尚未轮询";return l>0?r="已有评论":e!=null&&e.last_polled_at&&(r="已轮询无评论"),`${d(l)}<div class="form-hint" style="margin-top:4px;">${d(r)}</div>`}function Li(e,t,l,r=0,s=ue,i=[]){const a=l==="true"?"轮询中":l==="false"?"已停用":"全部",b=Math.floor(r/s)+1,o=Math.max(1,Math.ceil(e/s)),p=ei(i),u=Math.max(0,i.length-p),g=ti(i),m=ii(i),w=li(i),h=ri(i),f=si(i),C=ni(i),E=ai(i),R=Xt(i),D=Math.max(0,i.length-R),W=oi(i),O=di(i),U=ci(i),c=ui(i),T=pi(i),N=bi(i),$=Math.max(0,i.length-T),J=fi(i),Q=Math.max(0,i.length-J),K=hi(i),F=Math.max(0,i.length-K),k=yi(i),I=Math.max(0,i.length-k),j=gi(i),z=mi(i),X=$i(i),ee=xi(i),te=Math.max(0,i.length-z),ie=vi(i),G=_i(i),le=Math.max(0,i.length-G),re=wi(i),se=Si(i),ne=R>0?`，当前页缺少 aid ${R} 条`:"",be=l===""&&p>0?`，当前页轮询开启 ${p} 条`:"",ae=l===""&&u>0?`，当前页轮询停用 ${u} 条`:"",Y=l===""&&g>0?`，轮询开启但缺少 aid ${g} 条`:"",oe=l===""&&m>0?`，轮询停用但可同步 ${m} 条`:"",Z=l===""&&w>0?`，轮询停用且缺少 aid ${w} 条`:"",qe=l===""&&h>0?`，轮询停用且从未轮询 ${h} 条`:"",Te=l===""&&f>0?`，轮询停用且已有轮询记录 ${f} 条`:"",ke=l===""&&C>0?`，轮询开启但尚未轮询 ${C} 条`:"",de=l===""&&E>0?`，轮询开启且已有轮询记录 ${E} 条`:"",ve=D>0?`，可同步 ${D} 条`:"",Le=O>0?`，正常轮询 ${O} 条`:"",Be=U>0?`，成功轮询 ${U} 条`:"",Me=c>0?`，无新增 ${c} 条`:"",Pe=W>0?`，轮询失败 ${W} 条`:"",me=$>0?`，已有轮询记录 ${$} 条`:"",Ae=T>0?`，尚未轮询 ${T} 条`:"",$e=N>0?`，可同步但尚未轮询 ${N} 条`:"",Ne=J>0?`，已识别 UP 主 ${J} 条`:"",xe=Q>0?`，缺少 UP 主 ${Q} 条`:"",Ie=K>0?`，已抓取标题 ${K} 条`:"",je=F>0?`，缺少标题 ${F} 条`:"",He=G>0?`，信息完整 ${G} 条`:"",Re=le>0?`，信息不完整 ${le} 条`:"",De=re>0?`，已轮询但信息不完整 ${re} 条`:"",_e=k>0?`，已有评论视频 ${k} 条`:"",Oe=I>0?`，无评论视频 ${I} 条`:"",we=j>0?`，已轮询但无评论 ${j} 条`:"",Ue=z>0?`，已有评论游标 ${z} 条`:"",Se=X>0?`，有评论但无游标 ${X} 条`:"",Ve=ee>0?`，无评论但有游标 ${ee} 条`:"",We=te>0?`，无评论游标 ${te} 条`:"",Je=ie>0?`，已轮询但无游标 ${ie} 条`:"",Ke=se>0?`，关联评论 ${se} 条`:"";return`筛选: ${a}，共 ${e} 条，当前展示 ${t} 条，第 ${b}/${o} 页${be}${ae}${ne}${Y}${oe}${Z}${qe}${Te}${ke}${de}${ve}${Le}${Be}${Me}${Pe}${me}${Ae}${$e}${Ne}${xe}${Ie}${je}${He}${Re}${De}${_e}${Oe}${we}${Ue}${Se}${Ve}${We}${Je}${Ke}`}function nt(e,t={}){const l=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),s=Number((e==null?void 0:e.events_injected)??r),i=t.subject||(l===1?"视频":"轮询");return r>0||s>0?`${i}完成，处理 ${l} 个视频，新增 ${r} 条评论，注入 ${s} 个事件。`:l>0?`${i}完成，处理 ${l} 个视频，暂无新增评论。`:`${i}完成，暂无可处理视频。`}function Ze(e,t=Date.now()){const l=new Date(e);if(Number.isNaN(l.getTime()))return"";const r=l.getTime()-t,s=Math.abs(r),i=60*1e3,a=60*i,b=24*a;let o,p;return s<a?(o=Math.max(1,Math.round(s/i)),p="分钟"):s<b?(o=Math.max(1,Math.round(s/a)),p="小时"):(o=Math.max(1,Math.round(s/b)),p="天"),r<=0?`${o}${p}前`:`${o}${p}后`}function x(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const l=new Date(e);if(Number.isNaN(l.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const r=l.getTime()-t;if(r<=0){const i=Ze(e,t);return{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:i?`${i}过期，${M(e)}`:M(e)}}if(r<=Rt){const i=Ze(e,t);return{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:i?`${i}到期，${M(e)}`:M(e)}}const s=Ze(e,t);return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:s?`${s}到期，${M(e)}`:M(e)}}function Bi(e){const t=x(e),l=t.detail||(t.hasExpiry?"":"未设置过期时间"),r=l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:"";return`<span class="status-badge ${t.cls}">${d(t.label)}</span>${r}`}function at(e,t="-"){const l=[];return e!=null&&e.updated_at&&l.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&l.push(pe("创建",e.created_at)),`${d((e==null?void 0:e.name)||t)}${l.map(r=>`<div class="form-hint" style="margin-top:4px;">${d(r)}</div>`).join("")}`}function Mi(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function pt(e){if(!e)return{label:"未配置",detail:""};if(e!=null&&e.last_used_at)return{label:Xe(e.last_used_at)||"已使用",detail:M(e.last_used_at)};const t=[];return e!=null&&e.updated_at&&t.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&t.push(pe("创建",e.created_at)),{label:"从未使用",detail:t.join("，")}}function Pi(e){const t=pt(e),l=t.detail?`<div class="form-hint" style="margin-top:4px;">${d(t.detail)}</div>`:"";return`${d(t.label)}${l}`}function _(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function Ai(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function Ni(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function Ii(e){var o,p,u,g,m,w;const t=!!((p=(o=e==null?void 0:e.checks)==null?void 0:o.auth)!=null&&p.ready),l=!!((g=(u=e==null?void 0:e.checks)==null?void 0:u.worker_or_publish)!=null&&g.ready),r=!!((m=e==null?void 0:e.signals)!=null&&m.polling_worker_enabled),s=!!((w=e==null?void 0:e.signals)!=null&&w.native_publish_enabled),i=Array.isArray(e==null?void 0:e.blocking_reasons)?e.blocking_reasons.filter(Boolean):[],a=i.length>0?`，阻塞 ${i.length} 项`:"";return r||s?`${t?"鉴权已就绪":"鉴权未就绪"}，${l?"执行链路可用":"执行链路阻塞"}${a}`:i.length>0?`当前无需鉴权，但诊断仍受阻${a}`:"轮询与发布链路均未启用"}function ji(e){var s,i,a;const t=!!((s=e==null?void 0:e.signals)!=null&&s.publish_mode_config_ready),l=!!((i=e==null?void 0:e.signals)!=null&&i.native_publish_enabled),r=!!((a=e==null?void 0:e.signals)!=null&&a.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",l?"原生发布启用":"原生发布停用",r?"轮询链路启用":"轮询链路停用"].join("，")}function Hi(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",l=_(e)?"字段完整":`缺少 ${Ai(e).join(" / ")}`;return`${d(t)}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function bt(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function Ri(e,t="",l="",r=e.length){const s=e.length,i=vt(e,t,l),a=e.filter(n=>n.is_active||n.active),b=e.filter(n=>!(n.is_active||n.active)),o=a.length,p=b.length,u=e.filter(n=>_(n)).length,g=e.filter(n=>(n.is_active||n.active)&&_(n)).length,m=Math.max(0,u-g),w=Math.max(0,o-g),h=Math.max(0,p-m),f=a.filter(n=>n.last_used_at).length,C=Math.max(0,o-f),E=b.filter(n=>n.last_used_at).length,R=Math.max(0,p-E),D=e.filter(n=>_(n)&&n.last_used_at).length,W=Math.max(0,u-D),O=Math.max(0,s-u),U=e.filter(n=>!_(n)&&n.last_used_at).length,c=Math.max(0,O-U),T=e.filter(n=>!n.last_used_at).length,N=Math.max(0,s-T),$=Date.now(),J=e.filter(n=>_(n)&&x(n.expires_at,$).hasExpiry&&!x(n.expires_at,$).expired).length,Q=e.filter(n=>_(n)&&x(n.expires_at,$).expired).length,K=e.filter(n=>_(n)&&x(n.expires_at,$).expiringSoon).length,F=e.filter(n=>_(n)&&!x(n.expires_at,$).hasExpiry).length,k=e.map(n=>x(n.expires_at,$)),I=a.map(n=>x(n.expires_at,$)),j=b.map(n=>x(n.expires_at,$)),z=k.filter(n=>n.hasExpiry).length,X=k.filter(n=>n.hasExpiry&&!n.expired).length,ee=k.filter(n=>n.expired).length,te=k.filter(n=>n.expiringSoon).length,ie=I.filter(n=>n.hasExpiry&&!n.expired).length,G=I.filter(n=>n.expired).length,le=I.filter(n=>n.expiringSoon).length,re=I.filter(n=>!n.hasExpiry).length,se=j.filter(n=>n.hasExpiry&&!n.expired).length,ne=j.filter(n=>n.expired).length,be=j.filter(n=>n.expiringSoon).length,ae=j.filter(n=>!n.hasExpiry).length,Y=e.filter(n=>!_(n)&&x(n.expires_at,$).hasExpiry&&!x(n.expires_at,$).expired).length,oe=e.filter(n=>!_(n)&&x(n.expires_at,$).expired).length,Z=e.filter(n=>!_(n)&&x(n.expires_at,$).expiringSoon).length,qe=e.filter(n=>!_(n)&&!x(n.expires_at,$).hasExpiry).length,Te=k.filter(n=>!n.hasExpiry).length,ke=bt(t,l),de=i.filter(n=>_(n)).length,ve=Math.max(0,i.length-de),Le=i.filter(n=>{if(!_(n))return!1;const V=x(n.expires_at,$);return V.hasExpiry&&!V.expired}).length,Be=i.filter(n=>_(n)?x(n.expires_at,$).expired:!1).length,Me=i.filter(n=>_(n)?x(n.expires_at,$).expiringSoon:!1).length,Pe=i.filter(n=>_(n)?!x(n.expires_at,$).hasExpiry:!1).length,me=i.filter(n=>_(n)&&(n.is_active||n.active)).length,Ae=Math.max(0,de-me),$e=i.filter(n=>_(n)&&n.last_used_at).length,Ne=Math.max(0,de-$e),xe=i.filter(n=>!_(n)&&n.last_used_at).length,Ie=Math.max(0,ve-xe),je=i.filter(n=>{if(_(n))return!1;const V=x(n.expires_at,$);return V.hasExpiry&&!V.expired}).length,He=i.filter(n=>_(n)?!1:x(n.expires_at,$).expired).length,Re=i.filter(n=>_(n)?!1:x(n.expires_at,$).expiringSoon).length,De=i.filter(n=>_(n)?!1:!x(n.expires_at,$).hasExpiry).length,_e=i.filter(n=>!_(n)&&(n.is_active||n.active)).length,Oe=Math.max(0,ve-_e),we=i.filter(n=>n.is_active||n.active).length,Ue=Math.max(0,i.length-we),Se=i.filter(n=>n.last_used_at).length,Ve=Math.max(0,i.length-Se),We=i.filter(n=>{const V=x(n.expires_at,$);return V.hasExpiry&&!V.expired}).length,Je=i.filter(n=>x(n.expires_at,$).expired).length,Ke=i.filter(n=>x(n.expires_at,$).expiringSoon).length,gt=i.filter(n=>!x(n.expires_at,$).hasExpiry).length,mt=t?"":`，激活 ${we} 个，未激活 ${Ue} 个`,$t=t?"":`，完整且激活 ${me} 个，完整但未激活 ${Ae} 个`,xt=t?"":`，缺字段且激活 ${_e} 个，缺字段且未激活 ${Oe} 个`,_t=t||l?`，筛选结果完整 ${de} 个${$t}，完整且有效 ${Le} 个，完整且已过期 ${Be} 个，完整且即将过期 ${Me} 个，完整且未设置过期 ${Pe} 个，完整且已使用 ${$e} 个，完整但未使用 ${Ne} 个，缺字段 ${ve} 个${xt}，缺字段但已使用 ${xe} 个，缺字段且从未使用 ${Ie} 个，缺字段但有效 ${je} 个，缺字段且已过期 ${He} 个，缺字段且即将过期 ${Re} 个，缺字段且未设置过期 ${De} 个${mt}，已使用 ${Se} 个，从未使用 ${Ve} 个，有效 ${We} 个，已过期 ${Je} 个，即将过期 ${Ke} 个，未设置过期 ${gt} 个`:"";return`共 ${s} 个凭证，激活中 ${o} 个，未激活 ${p} 个，激活且完整 ${g} 个，未激活但完整 ${m} 个，激活但缺字段 ${w} 个，未激活且缺字段 ${h} 个，激活且已使用 ${f} 个，激活但从未使用 ${C} 个，未激活且已使用 ${E} 个，未激活但从未使用 ${R} 个，激活且有效 ${ie} 个，未激活且有效 ${se} 个，激活已过期 ${G} 个，未激活已过期 ${ne} 个，激活即将过期 ${le} 个，未激活即将过期 ${be} 个，激活未设置过期 ${re} 个，未激活未设置过期 ${ae} 个，字段完整 ${u} 个，完整且有效 ${J} 个，完整且已过期 ${Q} 个，完整即将过期 ${K} 个，完整未设置过期 ${F} 个，完整且已使用 ${D} 个，完整但未使用 ${W} 个，字段缺失 ${O} 个，缺字段但已使用 ${U} 个，缺字段且未使用 ${c} 个，缺字段但有效 ${Y} 个，缺字段且已过期 ${oe} 个，缺字段即将过期 ${Z} 个，缺字段未设置过期 ${qe} 个，已使用 ${N} 个，从未使用 ${T} 个，设置过期时间 ${z} 个，有效 ${X} 个，已过期 ${ee} 个，即将过期 ${te} 个，未设置 ${Te} 个；筛选: ${ke}，当前展示 ${r} 个${_t}`}function vt(e,t="",l=""){const r=Date.now();return e.filter(s=>{const i=s.is_active||s.active;if(t==="active"&&!i||t==="inactive"&&i)return!1;const a=x(s.expires_at,r);return!(l==="expired"&&!a.expired||l==="expiring"&&!a.expiringSoon||l==="valid"&&(!a.hasExpiry||a.expired)||l==="unset"&&a.hasExpiry)})}function Di(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${bt(e,t)}）`:"暂无凭证"}function ot(e,t,l){const r=e.querySelector(l);t.forEach(s=>{const i=e.querySelector(s);i==null||i.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),r.disabled||r.click())})})}async function Oi(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function l(){var a,b,o,p,u,g,m,w,h,f,C,E,R,D,W,O,U;const i=e.querySelector("#bili-status-cards");i.innerHTML='<div class="page-loading">加载中...</div>';try{const c=await L.getBilibiliStatus(),T=Number((c==null?void 0:c.video_count)??0),N=Number(((a=c==null?void 0:c.videos)==null?void 0:a.poll_enabled_count)??0),$=Math.max(0,T-N),J=Gt(T,N),Q=st(N,T),K=st($,T,"占比"),F=!!((b=c==null?void 0:c.diagnostics)!=null&&b.ready),k=Vt((o=c==null?void 0:c.diagnostics)==null?void 0:o.blocking_reasons),I=at(c==null?void 0:c.credential,"未配置"),j=!!(((u=(p=c==null?void 0:c.diagnostics)==null?void 0:p.signals)==null?void 0:u.credential_present)??((m=(g=c==null?void 0:c.diagnostics)==null?void 0:g.release_gates)==null?void 0:m.credential_present)),z=!!(((h=(w=c==null?void 0:c.diagnostics)==null?void 0:w.signals)==null?void 0:h.credential_complete)??((C=(f=c==null?void 0:c.diagnostics)==null?void 0:f.release_gates)==null?void 0:C.credential_complete)),X=Ni(j,z),ee=Ii(c==null?void 0:c.diagnostics),te=Wt((E=c==null?void 0:c.diagnostics)==null?void 0:E.effective_publish_mode),ie=ji(c==null?void 0:c.diagnostics),G=Ye(c==null?void 0:c.enabled,"B 站集成已启用","B 站集成已停用"),le=Ye(c==null?void 0:c.polling_enabled,"评论轮询已启用","评论轮询已停用"),re=Ye(c==null?void 0:c.publish_enabled,"发布链路已启用","发布链路已停用"),se=Jt((R=c==null?void 0:c.config)==null?void 0:R.poll_interval_seconds),ne=Kt((D=c==null?void 0:c.config)==null?void 0:D.poll_interval_seconds),be=Ft((W=c==null?void 0:c.config)==null?void 0:W.rate_limit_per_minute),ae=zt((O=c==null?void 0:c.config)==null?void 0:O.rate_limit_per_minute),Y=x((U=c==null?void 0:c.credential)==null?void 0:U.expires_at),oe=Y.detail||(c!=null&&c.credential?"未设置过期时间":"当前无活跃凭证"),Z=pt(c==null?void 0:c.credential);i.innerHTML=`
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${Mi(Y)}">${d(Y.label)}</div>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${w.map(f=>`<tr data-id="${d(f.id||f.video_id)}">
              ...
              <td>${Ti(f)}</td>
              <td>${ki(f)}</td>
              <td class="cell-time">${f.last_polled_at?ye(f.last_polled_at):"-"}</td>
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),l=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}l.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await dt.getComment(t);l.innerHTML=`
      ...
      `;const s=l.querySelector("#query-goto-comment");s&&s.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=s.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){l.innerHTML=`<div class="page-error">查询失败: ${d(r.message)}</div>`}})}const Qe={dashboard:{render:ut,title:"仪表盘"},jobs:{render:Et,title:"任务管理"},"daily-metrics":{render:qt,title:"每日指标"},knowledge:{render:Tt,title:"知识库"},"role-cards":{render:kt,title:"角色卡"},profiles:{render:Lt,title:"风格配置"},gateway:{render:Mt,title:"网关"},audit:{render:Pt,title:"审计日志"},bilibili:{render:Oi,title:"B站集成"},query:{render:Ui,title:"查询"}};let ft=null;function Vi(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function ht(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function yt(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Wi(e){e.preventDefault();const t=document.getElementById("login-api-key"),l=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await y("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),yt(),it("dashboard")}catch{l.textContent="API Key 无效或服务不可用",l.style.display="block",window.__ADMIN_API_KEY__=""}}}function Ji(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",ht()}function it(e){if(!Qe[e])return;ft=e,document.querySelectorAll("#nav-list .nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===e)}),document.getElementById("page-title").textContent=Qe[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',Qe[e].render(t).catch(l=>{t.innerHTML=`<div class="page-error">加载失败: ${l.message}</div>`})}function Ki(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==ft&&it(t)})})}function Fi(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),l=document.getElementById("expand-left-btn");t&&l&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),l.style.display="block"}),l.addEventListener("click",()=>{e.classList.remove("collapsed"),l.style.display="none"}))}function zi(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let l=0;e.addEventListener("click",()=>{l=(l+1)%t.length,t[l]?document.body.setAttribute("data-theme",t[l]):document.body.removeAttribute("data-theme")})}function Gi(){Fi(),zi(),Ki(),document.getElementById("login-form").addEventListener("submit",Wi),document.getElementById("logout-btn").addEventListener("click",Ji),Vi()?(yt(),it("dashboard")):ht()}Gi();
