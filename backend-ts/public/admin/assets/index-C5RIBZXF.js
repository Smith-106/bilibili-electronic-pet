(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function l(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=l(s);fetch(s.href,i)}})();function _t(e,t,l){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof l=="string"&&l.trim()?l.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function ot(){return(window.__ADMIN_API_KEY__||"").trim()}async function h(e,t={}){const l=ot(),r=new Headers(t.headers||{});l&&r.set("x-api-key",l);const s=await fetch(e,{...t,headers:r}),i=await s.json().catch(()=>({}));if(!s.ok){const a=(i==null?void 0:i.detail)||(i==null?void 0:i.error);throw new Error(_t(a,s.status,s.statusText))}return i}async function tt(e,t){const l=ot(),r=new Headers;l&&r.set("x-api-key",l);const s=await fetch(e,{headers:r});if(!s.ok)throw new Error("download_failed");const i=await s.blob(),a=URL.createObjectURL(i),b=document.createElement("a");b.href=a,b.download=t,document.body.appendChild(b),b.click(),document.body.removeChild(b),URL.revokeObjectURL(a)}function B(e){const t=new URLSearchParams;for(const[r,s]of Object.entries(e))s!=null&&s!==""&&t.set(r,String(s));const l=t.toString();return l?`?${l}`:""}function A(){return{getOverview(){return h("/api/admin/overview")},getJobs({status:e,limit:t}={}){return h(`/api/admin/jobs${B({status:e,limit:t})}`)},getJob(e){return h(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return h(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return h(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return h("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return h("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return tt(`/export/jobs.csv${B({status:e,limit:t})}`,"jobs.csv")},getComment(e){return h(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return h(`/api/admin/gateway/logs${B({limit:e,comment_id:t})}`)},publishGatewayReply(e){return h("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:l}={}){return h(`/api/admin/audit/summary${B({days:e,action:t,ok:l})}`)},getAuditLogs({limit:e,action:t,ok:l}={}){return h(`/api/audit-log${B({limit:e,action:t,ok:l})}`)},exportAuditCsv({limit:e,action:t,ok:l}={}){return tt(`/export/audit-logs.csv${B({limit:e,action:t,ok:l})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return h(`/api/metrics/daily${B({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return h(`/api/admin/knowledge${B({limit:e,offset:t})}`)},createKnowledgeEntry(e){return h("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return h(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return h(`/api/admin/role-cards${B({limit:e,offset:t})}`)},createRoleCard(e){return h("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return h(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return h(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return h(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return h("/api/admin/style-profile")},setStyleProfile(e){return h("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return h("/api/admin/role-profile")},setRoleProfile(e){return h("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return h("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:l}={}){return h(`/api/admin/bilibili/videos${B({poll_enabled:e,limit:t,offset:l})}`)},addBilibiliVideo(e){return h("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return h("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return h("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return h("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return h(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return h(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function d(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function P(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function Ze(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const l=Date.now()-t.getTime(),r=Math.floor(l/1e3);if(r<60)return"刚刚";const s=Math.floor(r/60);if(s<60)return`${s}分钟前`;const i=Math.floor(s/60);if(i<24)return`${i}小时前`;const a=Math.floor(i/24);if(a<30)return`${a}天前`;const b=Math.floor(a/30);return b<12?`${b}个月前`:`${Math.floor(b/12)}年前`}catch{return""}}function ue(e){const t=Ze(e),l=P(e);return t?`<span title="${d(l)}">${d(t)}</span>`:`<span title="${d(l)}">${d(l)}</span>`}function j(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const wt={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function Qe(e){if(!e)return"";const t=wt[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${d(t.label)}</span>`}function Xe(e,t="是",l="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${d(e?t:l)}</span>`}let Je=null;function v(e,t="info"){const l=document.getElementById("app-toast");l&&l.remove(),Je&&clearTimeout(Je);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},s=document.createElement("div");s.id="app-toast",s.className="toast-notification",s.style.setProperty("--toast-color",r[t]||r.info),s.innerHTML=`
  ...
  `;async function t(){try{const r=await Fe.getAuditSummary({days:7}),s=e.querySelector("#audit-summary-cards");s.innerHTML=`
      ...
      `}catch(b){r.innerHTML=`<div class="page-error">加载失败: ${d(b.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),l()}),e.querySelector("#audit-filter-btn").addEventListener("click",l),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await Fe.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(r){v(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),l()])}const L=A(),Pt=/^BV[a-zA-Z0-9]{10}$/,At={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},Nt={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},It={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},jt={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},ge={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},ce=50,Ht=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return At[t]||t}function Rt(e){return e?Pt.test(e)?null:"invalid_bvid_format":"bvid_required"}function Ot(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Dt(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Ut(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(l=>Nt[l]||l).join("；")}function Vt(e){const t=String(e??"").trim().toLowerCase();return It[t]||t||"-"}function ze(e,t,l){return e?t:l}function Wt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Jt(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"";if(t<60){const s=60/t;return`约每分钟 ${s.toFixed(s>=10?0:1).replace(/\.0$/,"")} 轮`}if(t<3600){const s=3600/t;return`约每小时 ${s.toFixed(s>=10?0:1).replace(/\.0$/,"")} 轮`}const l=t/3600;return`约每 ${l.toFixed(l>=10?0:1).replace(/\.0$/,"")} 小时 1 轮`}function Kt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function Ft(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"";const l=t/60;if(l>=1)return`约每秒 ${l.toFixed(l>=10?0:1).replace(/\.0$/,"")} 次`;const r=60/t;return`约每 ${r.toFixed(r>=10?0:1).replace(/\.0$/,"")} 秒 1 次`}function lt(e,t,l="覆盖率"){const r=Number(t??0);if(!Number.isFinite(r)||r<=0)return"暂无视频";const s=Number(e??0),a=((Number.isFinite(s)?Math.min(r,Math.max(0,s)):0)/r*100).toFixed(1).replace(/\.0$/,"");return`${l} ${a}%`}function zt(e,t){const l=Number(e??0);if(!Number.isFinite(l)||l<=0)return"暂无视频";const r=Number(t??0),s=Number.isFinite(r)?Math.min(l,Math.max(0,r)):0,i=Math.max(0,l-s);return`轮询中 ${s}，停用 ${i}`}function Gt(e,t,l){const r=String(e??"").trim().toLowerCase();if(!r)return"-";const s=jt[r]||{label:r,cls:"badge-muted"},i=r==="error"&&t?ge[String(t).trim().toLowerCase()]||String(t):"",a=i?` title="${d(i)}"`:"",b=typeof l=="number"&&Number.isFinite(l)?`评论游标: ${l}`:"",o=[i,b].filter(Boolean).map(p=>`<div class="form-hint" style="margin-top:4px;">${d(p)}</div>`).join("");return`<span class="status-badge ${s.cls}"${a}>${d(s.label)}</span>${o}`}function Yt(e){if(e==="true")return!0;if(e==="false")return!1}function Zt(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function H(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Qt(e){return e.filter(t=>!H(t)).length}function Xt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function ei(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!H(t)).length}function ti(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&H(t)).length}function ii(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function li(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ri(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function si(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ni(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function ai(e){return e.filter(t=>{const l=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return l==="ok"||l==="no_new"}).length}function oi(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function di(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function ci(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function ui(e){return e.filter(t=>H(t)&&!(t!=null&&t.last_polled_at)).length}function pi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function bi(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function vi(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function fi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function yi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&Number((t==null?void 0:t.comment_count)??0)<=0).length}function hi(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function gi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function mi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function $i(e){return e.filter(t=>H(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function xi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(H(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function _i(e){return e.reduce((t,l)=>{const r=Number((l==null?void 0:l.comment_count)??0);return t+(Number.isFinite(r)&&r>0?r:0)},0)}function wi(e){const l=H(e)?`aid: ${e.aid}`:ge.no_aid;return`${d((e==null?void 0:e.bvid)||"-")}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function pe(e,t){if(!t)return"";const l=Ze(t),r=P(t);return l?`${e}: ${l}（${r}）`:`${e}: ${r}`}function Si(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&t.push(pe("创建",e.created_at)),`${d((e==null?void 0:e.title)||"-")}${t.map(l=>`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`).join("")}`}function Ei(e){const t=H(e),l=t?"":" disabled",r=t?"":` title="${d(ge.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${d(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${l}${r}>同步</button>`}function Ci(e){const t=H(e)?"可同步":ge.no_aid;return`${Xe(e==null?void 0:e.poll_enabled)}<div class="form-hint" style="margin-top:4px;">${d(t)}</div>`}function qi(e,t,l,r=0,s=ce,i=[]){const a=l==="true"?"轮询中":l==="false"?"已停用":"全部",b=Math.floor(r/s)+1,o=Math.max(1,Math.ceil(e/s)),p=Xt(i),u=Math.max(0,i.length-p),g=ei(i),m=ti(i),w=ii(i),y=li(i),f=ri(i),C=si(i),E=Qt(i),W=Math.max(0,i.length-E),R=ni(i),J=ai(i),O=oi(i),D=di(i),c=ci(i),k=ui(i),N=Math.max(0,i.length-c),$=bi(i),Y=Math.max(0,i.length-$),K=vi(i),Z=Math.max(0,i.length-K),U=fi(i),T=Math.max(0,i.length-U),I=yi(i),M=hi(i),Q=gi(i),X=mi(i),ee=Math.max(0,i.length-M),te=pi(i),F=$i(i),ie=Math.max(0,i.length-F),le=xi(i),re=_i(i),be=E>0?`，当前页缺少 aid ${E} 条`:"",se=l===""&&p>0?`，当前页轮询开启 ${p} 条`:"",ve=l===""&&u>0?`，当前页轮询停用 ${u} 条`:"",ne=l===""&&g>0?`，轮询开启但缺少 aid ${g} 条`:"",z=l===""&&m>0?`，轮询停用但可同步 ${m} 条`:"",ae=l===""&&w>0?`，轮询停用且从未轮询 ${w} 条`:"",G=l===""&&y>0?`，轮询停用且已有轮询记录 ${y} 条`:"",qe=l===""&&f>0?`，轮询开启但尚未轮询 ${f} 条`:"",ke=l===""&&C>0?`，轮询开启且已有轮询记录 ${C} 条`:"",Te=W>0?`，可同步 ${W} 条`:"",oe=J>0?`，正常轮询 ${J} 条`:"",fe=O>0?`，成功轮询 ${O} 条`:"",Le=D>0?`，无新增 ${D} 条`:"",Me=R>0?`，轮询失败 ${R} 条`:"",Be=N>0?`，已有轮询记录 ${N} 条`:"",Pe=c>0?`，尚未轮询 ${c} 条`:"",me=k>0?`，可同步但尚未轮询 ${k} 条`:"",Ae=$>0?`，已识别 UP 主 ${$} 条`:"",$e=Y>0?`，缺少 UP 主 ${Y} 条`:"",Ne=K>0?`，已抓取标题 ${K} 条`:"",xe=Z>0?`，缺少标题 ${Z} 条`:"",Ie=F>0?`，信息完整 ${F} 条`:"",je=ie>0?`，信息不完整 ${ie} 条`:"",He=le>0?`，已轮询但信息不完整 ${le} 条`:"",Re=U>0?`，已有评论视频 ${U} 条`:"",Oe=T>0?`，无评论视频 ${T} 条`:"",_e=I>0?`，已轮询但无评论 ${I} 条`:"",De=M>0?`，已有评论游标 ${M} 条`:"",we=Q>0?`，有评论但无游标 ${Q} 条`:"",Ue=X>0?`，无评论但有游标 ${X} 条`:"",Se=ee>0?`，无评论游标 ${ee} 条`:"",Ve=te>0?`，已轮询但无游标 ${te} 条`:"",We=re>0?`，关联评论 ${re} 条`:"";return`筛选: ${a}，共 ${e} 条，当前展示 ${t} 条，第 ${b}/${o} 页${se}${ve}${be}${ne}${z}${ae}${G}${qe}${ke}${Te}${oe}${fe}${Le}${Me}${Be}${Pe}${me}${Ae}${$e}${Ne}${xe}${Ie}${je}${He}${Re}${Oe}${_e}${De}${we}${Ue}${Se}${Ve}${We}`}function rt(e,t={}){const l=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),s=Number((e==null?void 0:e.events_injected)??r),i=t.subject||(l===1?"视频":"轮询");return r>0||s>0?`${i}完成，处理 ${l} 个视频，新增 ${r} 条评论，注入 ${s} 个事件。`:l>0?`${i}完成，处理 ${l} 个视频，暂无新增评论。`:`${i}完成，暂无可处理视频。`}function Ge(e,t=Date.now()){const l=new Date(e);if(Number.isNaN(l.getTime()))return"";const r=l.getTime()-t,s=Math.abs(r),i=60*1e3,a=60*i,b=24*a;let o,p;return s<a?(o=Math.max(1,Math.round(s/i)),p="分钟"):s<b?(o=Math.max(1,Math.round(s/a)),p="小时"):(o=Math.max(1,Math.round(s/b)),p="天"),r<=0?`${o}${p}前`:`${o}${p}后`}function x(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const l=new Date(e);if(Number.isNaN(l.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const r=l.getTime()-t;if(r<=0){const i=Ge(e,t);return{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:i?`${i}过期，${P(e)}`:P(e)}}if(r<=Ht){const i=Ge(e,t);return{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:i?`${i}到期，${P(e)}`:P(e)}}const s=Ge(e,t);return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:s?`${s}到期，${P(e)}`:P(e)}}function ki(e){const t=x(e),l=t.detail||(t.hasExpiry?"":"未设置过期时间"),r=l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:"";return`<span class="status-badge ${t.cls}">${d(t.label)}</span>${r}`}function st(e,t="-"){const l=[];return e!=null&&e.updated_at&&l.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&l.push(pe("创建",e.created_at)),`${d((e==null?void 0:e.name)||t)}${l.map(r=>`<div class="form-hint" style="margin-top:4px;">${d(r)}</div>`).join("")}`}function Ti(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function Li(e){if(!e)return{label:"未配置",detail:""};if(e!=null&&e.last_used_at)return{label:Ze(e.last_used_at)||"已使用",detail:P(e.last_used_at)};const t=[];return e!=null&&e.updated_at&&t.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&t.push(pe("创建",e.created_at)),{label:"从未使用",detail:t.join("，")}}function _(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function Mi(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function Bi(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function Pi(e){var o,p,u,g,m,w;const t=!!((p=(o=e==null?void 0:e.checks)==null?void 0:o.auth)!=null&&p.ready),l=!!((g=(u=e==null?void 0:e.checks)==null?void 0:u.worker_or_publish)!=null&&g.ready),r=!!((m=e==null?void 0:e.signals)!=null&&m.polling_worker_enabled),s=!!((w=e==null?void 0:e.signals)!=null&&w.native_publish_enabled),i=Array.isArray(e==null?void 0:e.blocking_reasons)?e.blocking_reasons.filter(Boolean):[],a=i.length>0?`，阻塞 ${i.length} 项`:"";return r||s?`${t?"鉴权已就绪":"鉴权未就绪"}，${l?"执行链路可用":"执行链路阻塞"}${a}`:i.length>0?`当前无需鉴权，但诊断仍受阻${a}`:"轮询与发布链路均未启用"}function Ai(e){var s,i,a;const t=!!((s=e==null?void 0:e.signals)!=null&&s.publish_mode_config_ready),l=!!((i=e==null?void 0:e.signals)!=null&&i.native_publish_enabled),r=!!((a=e==null?void 0:e.signals)!=null&&a.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",l?"原生发布启用":"原生发布停用",r?"轮询链路启用":"轮询链路停用"].join("，")}function Ni(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",l=_(e)?"字段完整":`缺少 ${Mi(e).join(" / ")}`;return`${d(t)}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function ct(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function Ii(e,t="",l="",r=e.length){const s=e.length,i=ut(e,t,l),a=e.filter(n=>n.is_active||n.active),b=e.filter(n=>!(n.is_active||n.active)),o=a.length,p=b.length,u=e.filter(n=>_(n)).length,g=e.filter(n=>(n.is_active||n.active)&&_(n)).length,m=Math.max(0,u-g),w=Math.max(0,o-g),y=Math.max(0,p-m),f=a.filter(n=>n.last_used_at).length,C=Math.max(0,o-f),E=b.filter(n=>n.last_used_at).length,W=Math.max(0,p-E),R=e.filter(n=>_(n)&&n.last_used_at).length,J=Math.max(0,u-R),O=Math.max(0,s-u),D=e.filter(n=>!_(n)&&n.last_used_at).length,c=Math.max(0,O-D),k=e.filter(n=>!n.last_used_at).length,N=Math.max(0,s-k),$=Date.now(),Y=e.filter(n=>_(n)&&x(n.expires_at,$).hasExpiry&&!x(n.expires_at,$).expired).length,K=e.filter(n=>_(n)&&x(n.expires_at,$).expired).length,Z=e.filter(n=>_(n)&&x(n.expires_at,$).expiringSoon).length,U=e.filter(n=>_(n)&&!x(n.expires_at,$).hasExpiry).length,T=e.map(n=>x(n.expires_at,$)),I=a.map(n=>x(n.expires_at,$)),M=b.map(n=>x(n.expires_at,$)),Q=T.filter(n=>n.hasExpiry).length,X=T.filter(n=>n.hasExpiry&&!n.expired).length,ee=T.filter(n=>n.expired).length,te=T.filter(n=>n.expiringSoon).length,F=I.filter(n=>n.hasExpiry&&!n.expired).length,ie=I.filter(n=>n.expired).length,le=I.filter(n=>n.expiringSoon).length,re=I.filter(n=>!n.hasExpiry).length,be=M.filter(n=>n.hasExpiry&&!n.expired).length,se=M.filter(n=>n.expired).length,ve=M.filter(n=>n.expiringSoon).length,ne=M.filter(n=>!n.hasExpiry).length,z=e.filter(n=>!_(n)&&x(n.expires_at,$).hasExpiry&&!x(n.expires_at,$).expired).length,ae=e.filter(n=>!_(n)&&x(n.expires_at,$).expired).length,G=e.filter(n=>!_(n)&&x(n.expires_at,$).expiringSoon).length,qe=e.filter(n=>!_(n)&&!x(n.expires_at,$).hasExpiry).length,ke=T.filter(n=>!n.hasExpiry).length,Te=ct(t,l),oe=i.filter(n=>_(n)).length,fe=Math.max(0,i.length-oe),Le=i.filter(n=>{if(!_(n))return!1;const V=x(n.expires_at,$);return V.hasExpiry&&!V.expired}).length,Me=i.filter(n=>_(n)?x(n.expires_at,$).expired:!1).length,Be=i.filter(n=>_(n)?x(n.expires_at,$).expiringSoon:!1).length,Pe=i.filter(n=>_(n)?!x(n.expires_at,$).hasExpiry:!1).length,me=i.filter(n=>_(n)&&(n.is_active||n.active)).length,Ae=Math.max(0,oe-me),$e=i.filter(n=>_(n)&&n.last_used_at).length,Ne=Math.max(0,oe-$e),xe=i.filter(n=>!_(n)&&n.last_used_at).length,Ie=Math.max(0,fe-xe),je=i.filter(n=>{if(_(n))return!1;const V=x(n.expires_at,$);return V.hasExpiry&&!V.expired}).length,He=i.filter(n=>_(n)?!1:x(n.expires_at,$).expired).length,Re=i.filter(n=>_(n)?!1:x(n.expires_at,$).expiringSoon).length,Oe=i.filter(n=>_(n)?!1:!x(n.expires_at,$).hasExpiry).length,_e=i.filter(n=>!_(n)&&(n.is_active||n.active)).length,De=Math.max(0,fe-_e),we=i.filter(n=>n.is_active||n.active).length,Ue=Math.max(0,i.length-we),Se=i.filter(n=>n.last_used_at).length,Ve=Math.max(0,i.length-Se),We=i.filter(n=>{const V=x(n.expires_at,$);return V.hasExpiry&&!V.expired}).length,ft=i.filter(n=>x(n.expires_at,$).expired).length,yt=i.filter(n=>x(n.expires_at,$).expiringSoon).length,ht=i.filter(n=>!x(n.expires_at,$).hasExpiry).length,gt=t?"":`，激活 ${we} 个，未激活 ${Ue} 个`,mt=t?"":`，完整且激活 ${me} 个，完整但未激活 ${Ae} 个`,$t=t?"":`，缺字段且激活 ${_e} 个，缺字段且未激活 ${De} 个`,xt=t||l?`，筛选结果完整 ${oe} 个${mt}，完整且有效 ${Le} 个，完整且已过期 ${Me} 个，完整且即将过期 ${Be} 个，完整且未设置过期 ${Pe} 个，完整且已使用 ${$e} 个，完整但未使用 ${Ne} 个，缺字段 ${fe} 个${$t}，缺字段但已使用 ${xe} 个，缺字段且从未使用 ${Ie} 个，缺字段但有效 ${je} 个，缺字段且已过期 ${He} 个，缺字段且即将过期 ${Re} 个，缺字段且未设置过期 ${Oe} 个${gt}，已使用 ${Se} 个，从未使用 ${Ve} 个，有效 ${We} 个，已过期 ${ft} 个，即将过期 ${yt} 个，未设置过期 ${ht} 个`:"";return`共 ${s} 个凭证，激活中 ${o} 个，未激活 ${p} 个，激活且完整 ${g} 个，未激活但完整 ${m} 个，激活但缺字段 ${w} 个，未激活且缺字段 ${y} 个，激活且已使用 ${f} 个，激活但从未使用 ${C} 个，未激活且已使用 ${E} 个，未激活但从未使用 ${W} 个，激活且有效 ${F} 个，未激活且有效 ${be} 个，激活已过期 ${ie} 个，未激活已过期 ${se} 个，激活即将过期 ${le} 个，未激活即将过期 ${ve} 个，激活未设置过期 ${re} 个，未激活未设置过期 ${ne} 个，字段完整 ${u} 个，完整且有效 ${Y} 个，完整且已过期 ${K} 个，完整即将过期 ${Z} 个，完整未设置过期 ${U} 个，完整且已使用 ${R} 个，完整但未使用 ${J} 个，字段缺失 ${O} 个，缺字段但已使用 ${D} 个，缺字段且未使用 ${c} 个，缺字段但有效 ${z} 个，缺字段且已过期 ${ae} 个，缺字段即将过期 ${G} 个，缺字段未设置过期 ${qe} 个，已使用 ${N} 个，从未使用 ${k} 个，设置过期时间 ${Q} 个，有效 ${X} 个，已过期 ${ee} 个，即将过期 ${te} 个，未设置 ${ke} 个；筛选: ${Te}，当前展示 ${r} 个${xt}`}function ut(e,t="",l=""){const r=Date.now();return e.filter(s=>{const i=s.is_active||s.active;if(t==="active"&&!i||t==="inactive"&&i)return!1;const a=x(s.expires_at,r);return!(l==="expired"&&!a.expired||l==="expiring"&&!a.expiringSoon||l==="valid"&&(!a.hasExpiry||a.expired)||l==="unset"&&a.hasExpiry)})}function ji(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${ct(e,t)}）`:"暂无凭证"}function nt(e,t,l){const r=e.querySelector(l);t.forEach(s=>{const i=e.querySelector(s);i==null||i.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),r.disabled||r.click())})})}async function Hi(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function l(){var a,b,o,p,u,g,m,w,y,f,C,E,W,R,J,O,D;const i=e.querySelector("#bili-status-cards");i.innerHTML='<div class="page-loading">加载中...</div>';try{const c=await L.getBilibiliStatus(),k=Number((c==null?void 0:c.video_count)??0),N=Number(((a=c==null?void 0:c.videos)==null?void 0:a.poll_enabled_count)??0),$=Math.max(0,k-N),Y=zt(k,N),K=lt(N,k),Z=lt($,k,"占比"),U=!!((b=c==null?void 0:c.diagnostics)!=null&&b.ready),T=Ut((o=c==null?void 0:c.diagnostics)==null?void 0:o.blocking_reasons),I=st(c==null?void 0:c.credential,"未配置"),M=!!(((u=(p=c==null?void 0:c.diagnostics)==null?void 0:p.signals)==null?void 0:u.credential_present)??((m=(g=c==null?void 0:c.diagnostics)==null?void 0:g.release_gates)==null?void 0:m.credential_present)),Q=!!(((y=(w=c==null?void 0:c.diagnostics)==null?void 0:w.signals)==null?void 0:y.credential_complete)??((C=(f=c==null?void 0:c.diagnostics)==null?void 0:f.release_gates)==null?void 0:C.credential_complete)),X=Bi(M,Q),ee=Pi(c==null?void 0:c.diagnostics),te=Vt((E=c==null?void 0:c.diagnostics)==null?void 0:E.effective_publish_mode),F=Ai(c==null?void 0:c.diagnostics),ie=ze(c==null?void 0:c.enabled,"B 站集成已启用","B 站集成已停用"),le=ze(c==null?void 0:c.polling_enabled,"评论轮询已启用","评论轮询已停用"),re=ze(c==null?void 0:c.publish_enabled,"发布链路已启用","发布链路已停用"),be=Wt((W=c==null?void 0:c.config)==null?void 0:W.poll_interval_seconds),se=Jt((R=c==null?void 0:c.config)==null?void 0:R.poll_interval_seconds),ve=Kt((J=c==null?void 0:c.config)==null?void 0:J.rate_limit_per_minute),ne=Ft((O=c==null?void 0:c.config)==null?void 0:O.rate_limit_per_minute),z=x((D=c==null?void 0:c.credential)==null?void 0:D.expires_at),ae=z.detail||(c!=null&&c.credential?"未设置过期时间":"当前无活跃凭证"),G=Li(c==null?void 0:c.credential);i.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${Ti(z)}">${d(z.label)}</div>
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),l=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}l.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await at.getComment(t);l.innerHTML=`
      ...
      `;const s=l.querySelector("#query-goto-comment");s&&s.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=s.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){l.innerHTML=`<div class="page-error">查询失败: ${d(r.message)}</div>`}})}const Ye={dashboard:{render:dt,title:"仪表盘"},jobs:{render:St,title:"任务管理"},"daily-metrics":{render:Ct,title:"每日指标"},knowledge:{render:qt,title:"知识库"},"role-cards":{render:kt,title:"角色卡"},profiles:{render:Tt,title:"风格配置"},gateway:{render:Mt,title:"网关"},audit:{render:Bt,title:"审计日志"},bilibili:{render:Hi,title:"B站集成"},query:{render:Ri,title:"查询"}};let pt=null;function Oi(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function bt(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function vt(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Di(e){e.preventDefault();const t=document.getElementById("login-api-key"),l=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await h("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),vt(),et("dashboard")}catch{l.textContent="API Key 无效或服务不可用",l.style.display="block",window.__ADMIN_API_KEY__=""}}}function Ui(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",bt()}function et(e){if(!Ye[e])return;pt=e,document.querySelectorAll("#nav-list .nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===e)}),document.getElementById("page-title").textContent=Ye[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',Ye[e].render(t).catch(l=>{t.innerHTML=`<div class="page-error">加载失败: ${l.message}</div>`})}function Vi(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==pt&&et(t)})})}function Wi(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),l=document.getElementById("expand-left-btn");t&&l&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),l.style.display="block"}),l.addEventListener("click",()=>{e.classList.remove("collapsed"),l.style.display="none"}))}function Ji(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let l=0;e.addEventListener("click",()=>{l=(l+1)%t.length,t[l]?document.body.setAttribute("data-theme",t[l]):document.body.removeAttribute("data-theme")})}function Ki(){Wi(),Ji(),Vi(),document.getElementById("login-form").addEventListener("submit",Di),document.getElementById("logout-btn").addEventListener("click",Ui),Oi()?(vt(),et("dashboard")):bt()}Ki();
