(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function i(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(s){if(s.ep)return;s.ep=!0;const l=i(s);fetch(s.href,l)}})();function qt(e,t,i){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof i=="string"&&i.trim()?i.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function bt(){return(window.__ADMIN_API_KEY__||"").trim()}async function h(e,t={}){const i=bt(),r=new Headers(t.headers||{});i&&r.set("x-api-key",i);const s=await fetch(e,{...t,headers:r}),l=await s.json().catch(()=>({}));if(!s.ok){const a=(l==null?void 0:l.detail)||(l==null?void 0:l.error);throw new Error(qt(a,s.status,s.statusText))}return l}async function st(e,t){const i=bt(),r=new Headers;i&&r.set("x-api-key",i);const s=await fetch(e,{headers:r});if(!s.ok)throw new Error("download_failed");const l=await s.blob(),a=URL.createObjectURL(l),p=document.createElement("a");p.href=a,p.download=t,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(a)}function M(e){const t=new URLSearchParams;for(const[r,s]of Object.entries(e))s!=null&&s!==""&&t.set(r,String(s));const i=t.toString();return i?`?${i}`:""}function A(){return{getOverview(){return h("/api/admin/overview")},getJobs({status:e,limit:t}={}){return h(`/api/admin/jobs${M({status:e,limit:t})}`)},getJob(e){return h(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return h(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return h(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return h("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return h("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return st(`/export/jobs.csv${M({status:e,limit:t})}`,"jobs.csv")},getComment(e){return h(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return h(`/api/admin/gateway/logs${M({limit:e,comment_id:t})}`)},publishGatewayReply(e){return h("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:i}={}){return h(`/api/admin/audit/summary${M({days:e,action:t,ok:i})}`)},getAuditLogs({limit:e,action:t,ok:i}={}){return h(`/api/audit-log${M({limit:e,action:t,ok:i})}`)},exportAuditCsv({limit:e,action:t,ok:i}={}){return st(`/export/audit-logs.csv${M({limit:e,action:t,ok:i})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return h(`/api/metrics/daily${M({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return h(`/api/admin/knowledge${M({limit:e,offset:t})}`)},createKnowledgeEntry(e){return h("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return h(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return h(`/api/admin/role-cards${M({limit:e,offset:t})}`)},createRoleCard(e){return h("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return h(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return h(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return h(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return h("/api/admin/style-profile")},setStyleProfile(e){return h("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return h("/api/admin/role-profile")},setRoleProfile(e){return h("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return h("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:i}={}){return h(`/api/admin/bilibili/videos${M({poll_enabled:e,limit:t,offset:i})}`)},addBilibiliVideo(e){return h("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return h("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return h("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return h("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return h(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return h(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function d(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function P(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function Xe(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const i=Date.now()-t.getTime(),r=Math.floor(i/1e3);if(r<60)return"刚刚";const s=Math.floor(r/60);if(s<60)return`${s}分钟前`;const l=Math.floor(s/60);if(l<24)return`${l}小时前`;const a=Math.floor(l/24);if(a<30)return`${a}天前`;const p=Math.floor(a/30);return p<12?`${p}个月前`:`${Math.floor(p/12)}年前`}catch{return""}}function ye(e){const t=Xe(e),i=P(e);return t?`<span title="${d(i)}">${d(t)}</span>`:`<span title="${d(i)}">${d(i)}</span>`}function H(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const Bt={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function et(e){if(!e)return"";const t=Bt[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${d(t.label)}</span>`}function tt(e,t="是",i="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${d(e?t:i)}</span>`}let Ke=null;function f(e,t="info"){const i=document.getElementById("app-toast");i&&i.remove(),Ke&&clearTimeout(Ke);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},s=document.createElement("div");s.id="app-toast",s.className="toast-notification",s.style.setProperty("--toast-color",r[t]||r.info),s.innerHTML=`
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("show"));const l=()=>{s.classList.remove("show"),setTimeout(()=>s.remove(),300)};s.querySelector(".toast-close").onclick=l,Ke=setTimeout(l,4e3)}const Ee=A();async function ft(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,i,r,s]=await Promise.all([Ee.getOverview().catch(()=>null),Ee.getJobs({limit:5}).catch(()=>null),Ee.getGatewayLogs({limit:5}).catch(()=>null),Ee.getAuditSummary({days:7}).catch(()=>null)]),l=t||{},a=Array.isArray(i==null?void 0:i.items)?i.items:[],p=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{f("正在刷新...","info"),ft(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${d(t.message)}</div>`}}const ce=A();async function Tt(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;async function t(){const i=e.querySelector("#metrics-days").value,r=e.querySelector("#metrics-table-wrapper");r.innerHTML='<div class="page-loading">加载中...</div>';try{const s=await kt.getDailyMetrics({days:i}),l=Array.isArray(s==null?void 0:s.items)?s.items:Array.isArray(s)?s:[];if(l.length===0){r.innerHTML='<div class="table-empty">暂无指标数据</div>';return}r.innerHTML=`
      ...
      `}catch(s){r.innerHTML=`<div class="page-error">加载失败: ${d(s.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const ze=A();async function Mt(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const i=e.querySelector("#knowledge-table-wrapper");i.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await ze.getKnowledgeEntries({limit:50}),s=Array.isArray(r==null?void 0:r.items)?r.items:[];if(s.length===0){i.innerHTML='<div class="table-empty">暂无知识条目</div>';return}i.innerHTML=`
      ...
      `,i.querySelectorAll(".knowledge-disable").forEach(l=>{l.addEventListener("click",async()=>{try{await ze.disableKnowledgeEntry(l.dataset.id),f("已禁用","success"),t()}catch(a){f(`操作失败: ${a.message}`,"error")}})})}catch(r){i.innerHTML=`<div class="page-error">加载失败: ${d(r.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const i=e.querySelector("#knowledge-category").value.trim(),r=e.querySelector("#knowledge-title").value.trim(),s=e.querySelector("#knowledge-content").value.trim();if(!r||!s){f("标题和内容不能为空","warning");return}try{await ze.createKnowledgeEntry({category:i,title:r,content:s}),f("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(l){f(`创建失败: ${l.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const ge=A();let he=!1,S=null;async function Pt(e){he=!1,S=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `}const nt=A();async function It(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
  ...
  `;const t=e.querySelector("#gw-reply"),i=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{i.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const s=e.querySelector("#gw-publish-btn"),l=e.querySelector("#gw-comment-id").value.trim(),a=e.querySelector("#gw-reply").value.trim(),p=e.querySelector("#gw-source").value.trim(),o=e.querySelector("#gw-force").checked;if(!l||!a){f("Comment ID 和回复内容不能为空","warning");return}s.disabled=!0,s.textContent="发布中...";try{await nt.publishGatewayReply({comment_id:l,reply_text:a,source:p,force_publish:o}),f("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",i.textContent="0/0",r()}catch(b){f(`发布失败: ${b.message}`,"error")}finally{s.disabled=!1,s.textContent="发布"}});async function r(){const s=e.querySelector("#gw-table-wrapper"),l=e.querySelector("#gw-limit").value;s.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await nt.getGatewayLogs({limit:l}),p=Array.isArray(a==null?void 0:a.items)?a.items:[];if(p.length===0){s.innerHTML='<div class="table-empty">暂无网关日志</div>';return}s.innerHTML=Nt({columns:[{key:"id",label:"ID",class:"cell-id",render:o=>{var b;return d((b=o.id)==null?void 0:b.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:o=>{var b;return d((b=o.comment_id)==null?void 0:b.substring(0,12))}},{key:"status",label:"状态",render:o=>et(o.status)},{key:"platform",label:"平台",render:o=>d(o.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:o=>{var b;return d((b=o.reply_text)==null?void 0:b.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:o=>ye(o.created_at)}],rows:p})}catch(a){s.innerHTML=`<div class="page-error">加载失败: ${d(a.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",r),e.querySelector("#gw-filter-btn").addEventListener("click",r),await r()}const Ge=A();async function jt(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const r=await Ge.getAuditSummary({days:7}),s=e.querySelector("#audit-summary-cards");s.innerHTML=`
      ...
      `}catch(p){r.innerHTML=`<div class="page-error">加载失败: ${d(p.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),i()}),e.querySelector("#audit-filter-btn").addEventListener("click",i),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await Ge.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),f("导出成功","success")}catch(r){f(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),i()])}const L=A(),Ht=/^BV[a-zA-Z0-9]{10}$/,Dt={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},Rt={"auth:no active credential":"缺少可用的激活凭证，请先添加并激活。","config:bilibili_enabled is false":"B 站集成总开关已关闭，请先启用配置。","dependency:diagnostics_unavailable":"诊断信息暂时不可用，请稍后刷新重试。"},Ot={manual_queue:"人工队列发布",simulated:"模拟发布流程",webhook:"Webhook 推送",real_publish:"真实发布流程",native_bilibili:"原生 B 站发布"},at={ok:{label:"轮询成功",cls:"badge-success"},no_new:{label:"无新增评论",cls:"badge-muted"},error:{label:"轮询失败",cls:"badge-danger"}},be={no_aid:"缺少视频 aid，暂时无法轮询评论。",retry_exhausted:"评论抓取重试耗尽。"},ue=50,Vt=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return Dt[t]||t}function Ut(e){return e?Ht.test(e)?null:"invalid_bvid_format":"bvid_required"}function Wt(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Jt(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Ft(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(i=>Rt[i]||`未识别阻塞原因: ${i}`).join("；")}function Kt(e){const t=String(e??"").trim().toLowerCase();return t?Ot[t]||`未识别发布模式: ${t}`:"未设置发布模式"}function Ye(e,t,i){return e?t:i}function zt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"未设置轮询间隔":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Gt(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"未设置轮询间隔，请检查轮询配置";if(t<60){const s=60/t;return`约每分钟 ${s.toFixed(s>=10?0:1).replace(/\.0$/,"")} 轮`}if(t<3600){const s=3600/t;return`约每小时 ${s.toFixed(s>=10?0:1).replace(/\.0$/,"")} 轮`}const i=t/3600;return`约每 ${i.toFixed(i>=10?0:1).replace(/\.0$/,"")} 小时 1 轮`}function Yt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"未设置速率限制":`${t} 次/分钟`}function Zt(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"未设置速率限制，请检查抓取配置";const i=t/60;if(i>=1)return`约每秒 ${i.toFixed(i>=10?0:1).replace(/\.0$/,"")} 次`;const r=60/t;return`约每 ${r.toFixed(r>=10?0:1).replace(/\.0$/,"")} 秒 1 次`}function ot(e,t,i="覆盖率"){const r=Number(t??0);if(!Number.isFinite(r)||r<=0)return`暂无视频，无法计算${i}，请先添加监控对象`;const s=Number(e??0),l=Number.isFinite(s)?Math.min(r,Math.max(0,s)):0,a=(l/r*100).toFixed(1).replace(/\.0$/,"");return`${i} ${a}%（${l}/${r}）`}function Qt(e,t){const i=Number(e??0);if(!Number.isFinite(i)||i<=0)return"暂无视频，请先添加 BVID 监控对象";const r=Number(t??0),s=Number.isFinite(r)?Math.min(i,Math.max(0,r)):0,l=Math.max(0,i-s);return`共 ${i} 个视频，轮询中 ${s}，停用 ${l}`}function Xt(e,t,i){const r=String(e??"").trim().toLowerCase();if(!r)return"-";const s=at[r]||{label:"未识别轮询状态",cls:"badge-muted"},l=r==="error"&&t?be[String(t).trim().toLowerCase()]||String(t):"",a=l?` title="${d(l)}"`:"",p=typeof i=="number"&&Number.isFinite(i)?`评论游标: ${i}`:"",b=[r==="ok"?p?"轮询完成，评论游标已推进":"轮询完成":r==="no_new"?p?"本次未发现新评论，评论游标已保留":"本次未发现新评论":at[r]?"":`原始状态值: ${r}`,l,p].filter(Boolean).map(u=>`<div class="form-hint" style="margin-top:4px;">${d(u)}</div>`).join("");return`<span class="status-badge ${s.cls}"${a}>${d(s.label)}</span>${b}`}function ei(e){if(String((e==null?void 0:e.last_poll_status)??"").trim().toLowerCase())return Xt(e==null?void 0:e.last_poll_status,e==null?void 0:e.last_poll_error,e==null?void 0:e.last_rpid);if(!(e!=null&&e.last_polled_at))return`<span class="status-badge badge-muted">未轮询</span><div class="form-hint" style="margin-top:4px;">${d(it(e))}</div>`;const i=typeof(e==null?void 0:e.last_rpid)=="number"&&Number.isFinite(e.last_rpid)?"已轮询但未记录结果，评论游标已保留":"已轮询但未记录结果";return`<span class="status-badge badge-muted">未记录结果</span><div class="form-hint" style="margin-top:4px;">${d(i)}</div>`}function ti(e){if(e==="true")return!0;if(e==="false")return!1}function ii(e){return e==="true"?"当前筛选暂无轮询中视频，可切换筛选查看停用项":e==="false"?"当前筛选暂无已停用视频，可切换筛选查看轮询中项":"暂无监控视频，请先添加 BVID 作为监控对象"}function k(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function it(e){return k(e)?e!=null&&e.poll_enabled?"等待首次自动轮询，可稍后刷新查看":"轮询未启用，可手动同步评论":be.no_aid}function li(e){return e.filter(t=>!k(t)).length}function ri(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function si(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!k(t)).length}function ni(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&k(t)).length}function ai(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!k(t)).length}function oi(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function di(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ci(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function ui(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function pi(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function bi(e){return e.filter(t=>{const i=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return i==="ok"||i==="no_new"}).length}function fi(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function vi(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function gi(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function hi(e){return e.filter(t=>k(t)&&!(t!=null&&t.last_polled_at)).length}function yi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function mi(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function $i(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function xi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function _i(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&Number((t==null?void 0:t.comment_count)??0)<=0).length}function wi(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function Si(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function Ei(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function Ci(e){return e.filter(t=>k(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function qi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(k(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function Bi(e){return e.reduce((t,i)=>{const r=Number((i==null?void 0:i.comment_count)??0);return t+(Number.isFinite(r)&&r>0?r:0)},0)}function Ti(e){const t=k(e),i=String((e==null?void 0:e.bvid)??"").trim(),r=String((e==null?void 0:e.id)??(e==null?void 0:e.video_id)??"").trim(),s=[t?`aid: ${e.aid}`:be.no_aid];return i||s.push(r?`记录 ID: ${r}`:"未同步 BVID"),`${d(i||"未同步 BVID")}${s.filter(Boolean).map(l=>`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`).join("")}`}function pe(e,t){if(!t)return"";const i=Xe(t),r=P(t);return i?`${e}: ${i}（${r}）`:`${e}: ${r}`}function ki(e){const t=[];return k(e)||t.push("aid"),String((e==null?void 0:e.title)??"").trim()||t.push("标题"),typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)||t.push("UP主 MID"),t}function Li(e){const t=[],i=String((e==null?void 0:e.title)??"").trim(),r=ki(e);return r.length>0&&t.push(`缺少 ${r.join(" / ")}`),typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&t.push(pe("创建",e.created_at)),`${d(i||"未同步标题")}${t.map(s=>`<div class="form-hint" style="margin-top:4px;">${d(s)}</div>`).join("")}`}function Mi(e){const t=k(e),i=t?"":" disabled",r=t?"":` title="${d(be.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${d(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${i}${r}>同步</button>`}function Pi(e){const t=k(e);let i=be.no_aid;return t&&(i=e!=null&&e.poll_enabled?"自动轮询中，等待计划任务执行":"轮询停用，可手动同步评论"),`${tt(e==null?void 0:e.poll_enabled)}<div class="form-hint" style="margin-top:4px;">${d(i)}</div>`}function Ai(e){const t=Number((e==null?void 0:e.comment_count)??0),i=Number.isFinite(t)&&t>0?t:0,r=typeof(e==null?void 0:e.last_rpid)=="number"&&Number.isFinite(e.last_rpid);let s=it(e);return i>0?s=r?"已有评论，游标已记录":"已有评论，缺少游标":e!=null&&e.last_polled_at&&(s=r?"已轮询无评论，保留游标":"已轮询无评论，未记录游标"),`${d(i)}<div class="form-hint" style="margin-top:4px;">${d(s)}</div>`}function Ni(e){if(e!=null&&e.last_polled_at){const t=typeof(e==null?void 0:e.last_rpid)=="number"&&Number.isFinite(e.last_rpid)?`评论游标: ${e.last_rpid}`:"未记录评论游标，可在下次轮询后补齐";return`${ye(e.last_polled_at)}<div class="form-hint" style="margin-top:4px;">${d(t)}</div>`}return`从未轮询<div class="form-hint" style="margin-top:4px;">${d(it(e))}</div>`}function Ii(e,t,i,r=0,s=ue,l=[]){const a=i==="true"?"轮询中":i==="false"?"已停用":"全部状态",p=Math.floor(r/s)+1,o=Math.max(1,Math.ceil(e/s)),b=ri(l),u=Math.max(0,l.length-b),y=si(l),m=ni(l),w=ai(l),g=oi(l),v=di(l),C=ci(l),E=ui(l),D=li(l),R=Math.max(0,l.length-D),W=pi(l),O=bi(l),V=fi(l),c=vi(l),B=gi(l),N=hi(l),$=Math.max(0,l.length-B),J=mi(l),Q=Math.max(0,l.length-J),F=$i(l),K=Math.max(0,l.length-F),T=xi(l),I=Math.max(0,l.length-T),j=_i(l),z=wi(l),X=Si(l),ee=Ei(l),te=Math.max(0,l.length-z),ie=yi(l),G=Ci(l),le=Math.max(0,l.length-G),re=qi(l),se=Bi(l),ne=D>0?`，当前页缺少 aid ${D} 条`:"",fe=i===""&&b>0?`，当前页轮询开启 ${b} 条`:"",ae=i===""&&u>0?`，当前页轮询停用 ${u} 条`:"",Y=i===""&&y>0?`，轮询开启但缺少 aid ${y} 条`:"",oe=i===""&&m>0?`，轮询停用但可手动同步 ${m} 条`:"",Z=i===""&&w>0?`，轮询停用且缺少 aid ${w} 条`:"",qe=i===""&&g>0?`，轮询停用且从未轮询 ${g} 条`:"",Be=i===""&&v>0?`，轮询停用且已有轮询记录 ${v} 条`:"",Te=i===""&&C>0?`，轮询开启但尚未轮询 ${C} 条`:"",de=i===""&&E>0?`，轮询开启且已有轮询记录 ${E} 条`:"",ve=R>0?`，可手动同步 ${R} 条`:"",ke=O>0?`，正常轮询 ${O} 条`:"",Le=V>0?`，成功轮询 ${V} 条`:"",Me=c>0?`，无新增评论 ${c} 条`:"",Pe=W>0?`，轮询失败 ${W} 条`:"",me=$>0?`，已有轮询记录 ${$} 条`:"",Ae=B>0?`，尚未轮询 ${B} 条`:"",$e=N>0?`，可手动同步但尚未轮询 ${N} 条`:"",Ne=J>0?`，已识别 UP 主 ${J} 条`:"",xe=Q>0?`，缺少 UP 主 ${Q} 条`:"",Ie=F>0?`，已抓取标题 ${F} 条`:"",je=K>0?`，缺少标题 ${K} 条`:"",He=G>0?`，信息完整 ${G} 条`:"",De=le>0?`，信息不完整 ${le} 条`:"",Re=re>0?`，已轮询但信息不完整 ${re} 条`:"",_e=T>0?`，已有评论视频 ${T} 条`:"",Oe=I>0?`，无评论视频 ${I} 条`:"",we=j>0?`，已轮询但无评论 ${j} 条`:"",Ve=z>0?`，已有评论游标 ${z} 条`:"",Se=X>0?`，有评论但无游标 ${X} 条`:"",Ue=ee>0?`，无评论但有游标 ${ee} 条`:"",We=te>0?`，无评论游标 ${te} 条`:"",Je=ie>0?`，已轮询但无游标 ${ie} 条`:"",Fe=se>0?`，关联评论 ${se} 条`:"";return`筛选条件: ${a}，共 ${e} 条，当前展示 ${t} 条，第 ${p}/${o} 页${fe}${ae}${ne}${Y}${oe}${Z}${qe}${Be}${Te}${de}${ve}${ke}${Le}${Me}${Pe}${me}${Ae}${$e}${Ne}${xe}${Ie}${je}${He}${De}${Re}${_e}${Oe}${we}${Ve}${Se}${Ue}${We}${Je}${Fe}`}function dt(e,t={}){const i=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),s=Number((e==null?void 0:e.events_injected)??r),l=t.subject||(i===1?"视频":"轮询");return r>0||s>0?`${l}完成，处理 ${i} 个视频，新增 ${r} 条评论，已注入 ${s} 个事件。`:i>0?`${l}完成，处理 ${i} 个视频，暂无新增评论，已保留当前评论状态。`:`${l}完成，暂无可处理视频，请先确认监控对象已同步。`}function Ze(e,t=Date.now()){const i=new Date(e);if(Number.isNaN(i.getTime()))return"";const r=i.getTime()-t,s=Math.abs(r),l=60*1e3,a=60*l,p=24*a;let o,b;return s<a?(o=Math.max(1,Math.round(s/l)),b="分钟"):s<p?(o=Math.max(1,Math.round(s/a)),b="小时"):(o=Math.max(1,Math.round(s/p)),b="天"),r<=0?`${o}${b}前`:`${o}${b}后`}function x(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置过期时间",cls:"badge-muted",detail:""};const i=new Date(e);if(Number.isNaN(i.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"过期时间异常",cls:"badge-danger",detail:String(e)};const r=i.getTime()-t;if(r<=0){const l=Ze(e,t);return{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:l?`${l}过期，${P(e)}`:P(e)}}if(r<=Vt){const l=Ze(e,t);return{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:l?`${l}到期，${P(e)}`:P(e)}}const s=Ze(e,t);return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效期内",cls:"badge-success",detail:s?`${s}到期，${P(e)}`:P(e)}}function vt(e,t=!0){if(!t)return"当前无活跃凭证，无法评估过期状态";const i=e.hasExpiry?e.label==="过期时间异常"?"请检查过期时间格式后重试":e.expired?"建议尽快更新":e.expiringSoon?"建议提前轮换":"当前仍可使用":"需手动确认有效性并定期轮换";return[e.detail||(e.hasExpiry?"":"未设置过期时间"),i].filter(Boolean).join("，")}function ji(e){const t=x(e),i=vt(t),r=i?`<div class="form-hint" style="margin-top:4px;">${d(i)}</div>`:"";return`<span class="status-badge ${t.cls}">${d(t.label)}</span>${r}`}function ct(e,t="未命名凭证"){const i=[],r=String((e==null?void 0:e.name)??"").trim();return!r&&e&&i.push("未填写凭证名称，当前展示默认标签"),e!=null&&e.updated_at&&i.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&i.push(pe("创建",e.created_at)),`${d(r||t)}${i.map(s=>`<div class="form-hint" style="margin-top:4px;">${d(s)}</div>`).join("")}`}function Hi(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function gt(e){if(!e)return{label:"未配置凭证",detail:"请先添加并激活凭证用于鉴权"};const t=!!(e!=null&&e.is_active||e!=null&&e.active),i=_(e),r=i?"":lt(e).join(" / "),s=i?"":`缺少 ${r}`;if(e!=null&&e.last_used_at)return{label:Xe(e.last_used_at)||"已使用",detail:`${P(e.last_used_at)}，${t?"当前生效":"当前未激活，历史使用记录保留"}${i?"，字段完整":`，${s}`}`};const l=[];return t?l.push(i?"当前生效，等待首次使用":`当前生效，但${s}`):l.push(i?"待手动激活，激活后可用于鉴权":`待补齐 ${r} 后激活`),e!=null&&e.updated_at&&l.push(pe("更新",e.updated_at)),e!=null&&e.created_at&&l.push(pe("创建",e.created_at)),{label:"从未使用",detail:l.join("，")}}function Di(e){const t=gt(e),i=t.detail?`<div class="form-hint" style="margin-top:4px;">${d(t.detail)}</div>`:"";return`${d(t.label)}${i}`}function Ri(e){const t=!!(e!=null&&e.is_active||e!=null&&e.active),i=_(e),r=i?"":lt(e).join(" / "),s=i?"":`缺少 ${r}`,l=t?i?"当前生效，字段完整，可用于鉴权":`当前生效，但${s}`:i?"待手动激活，字段完整，激活后即可切换使用":`待补齐 ${r} 后激活`;return`${tt(t)}<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`}function _(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function lt(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function Oi(e,t){return e?t?"活跃凭证字段完整，可用于鉴权":"活跃凭证已激活，但缺少关键字段，请检查凭证配置":"当前无活跃凭证，请先添加并激活"}function Vi(e){var o,b,u,y,m,w;const t=!!((b=(o=e==null?void 0:e.checks)==null?void 0:o.auth)!=null&&b.ready),i=!!((y=(u=e==null?void 0:e.checks)==null?void 0:u.worker_or_publish)!=null&&y.ready),r=!!((m=e==null?void 0:e.signals)!=null&&m.polling_worker_enabled),s=!!((w=e==null?void 0:e.signals)!=null&&w.native_publish_enabled),l=Array.isArray(e==null?void 0:e.blocking_reasons)?e.blocking_reasons.filter(Boolean):[],a=l.length>0?`，阻塞 ${l.length} 项，详见下方阻塞原因`:"";return r||s?t&&i?`鉴权已就绪，执行链路可用${a}`:t?`鉴权已就绪，但执行链路阻塞${a}`:i?`执行链路可用，但鉴权未就绪${a}`:`鉴权未就绪，执行链路阻塞${a}`:l.length>0?`当前无需鉴权，但诊断校验仍受阻${a}`:"轮询与发布链路均未启用，可按需开启"}function Ui(e){var s,l,a;const t=!!((s=e==null?void 0:e.signals)!=null&&s.publish_mode_config_ready),i=!!((l=e==null?void 0:e.signals)!=null&&l.native_publish_enabled),r=!!((a=e==null?void 0:e.signals)!=null&&a.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失，请检查发布配置",i?"原生发布启用，可直接进入 B 站发布链路":"原生发布停用，当前不会直接走 B 站发布",r?"轮询链路启用，可配合自动处理评论侧流程":"轮询链路停用，评论侧仅支持手动同步"].join("，")}function Wi(e,t=4){const i=String(e??"").trim();return i?i.endsWith("...")||i.length<=t?i:`...${i.slice(-t)}`:""}function Ji(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${Wi(e.buvid3)}`:""].filter(Boolean).join(" / ")||"未配置指纹",i=[_(e)?"字段完整，可用于鉴权":`缺少 ${lt(e).join(" / ")}`,e!=null&&e.buvid3?"仅展示指纹摘要":"未记录 buvid3 指纹摘要"].filter(Boolean).join("，");return`${d(t)}${i?`<div class="form-hint" style="margin-top:4px;">${d(i)}</div>`:""}`}function ht(e="",t=""){return`激活筛选: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期筛选: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效期内":t==="unset"?"未设置过期时间":"全部"}`}function Fi(e,t="",i="",r=e.length){const s=e.length,l=yt(e,t,i),a=e.filter(n=>n.is_active||n.active),p=e.filter(n=>!(n.is_active||n.active)),o=a.length,b=p.length,u=e.filter(n=>_(n)).length,y=e.filter(n=>(n.is_active||n.active)&&_(n)).length,m=Math.max(0,u-y),w=Math.max(0,o-y),g=Math.max(0,b-m),v=a.filter(n=>n.last_used_at).length,C=Math.max(0,o-v),E=p.filter(n=>n.last_used_at).length,D=Math.max(0,b-E),R=e.filter(n=>_(n)&&n.last_used_at).length,W=Math.max(0,u-R),O=Math.max(0,s-u),V=e.filter(n=>!_(n)&&n.last_used_at).length,c=Math.max(0,O-V),B=e.filter(n=>!n.last_used_at).length,N=Math.max(0,s-B),$=Date.now(),J=e.filter(n=>_(n)&&x(n.expires_at,$).hasExpiry&&!x(n.expires_at,$).expired).length,Q=e.filter(n=>_(n)&&x(n.expires_at,$).expired).length,F=e.filter(n=>_(n)&&x(n.expires_at,$).expiringSoon).length,K=e.filter(n=>_(n)&&!x(n.expires_at,$).hasExpiry).length,T=e.map(n=>x(n.expires_at,$)),I=a.map(n=>x(n.expires_at,$)),j=p.map(n=>x(n.expires_at,$)),z=T.filter(n=>n.hasExpiry).length,X=T.filter(n=>n.hasExpiry&&!n.expired).length,ee=T.filter(n=>n.expired).length,te=T.filter(n=>n.expiringSoon).length,ie=I.filter(n=>n.hasExpiry&&!n.expired).length,G=I.filter(n=>n.expired).length,le=I.filter(n=>n.expiringSoon).length,re=I.filter(n=>!n.hasExpiry).length,se=j.filter(n=>n.hasExpiry&&!n.expired).length,ne=j.filter(n=>n.expired).length,fe=j.filter(n=>n.expiringSoon).length,ae=j.filter(n=>!n.hasExpiry).length,Y=e.filter(n=>!_(n)&&x(n.expires_at,$).hasExpiry&&!x(n.expires_at,$).expired).length,oe=e.filter(n=>!_(n)&&x(n.expires_at,$).expired).length,Z=e.filter(n=>!_(n)&&x(n.expires_at,$).expiringSoon).length,qe=e.filter(n=>!_(n)&&!x(n.expires_at,$).hasExpiry).length,Be=T.filter(n=>!n.hasExpiry).length,Te=ht(t,i),de=l.filter(n=>_(n)).length,ve=Math.max(0,l.length-de),ke=l.filter(n=>{if(!_(n))return!1;const U=x(n.expires_at,$);return U.hasExpiry&&!U.expired}).length,Le=l.filter(n=>_(n)?x(n.expires_at,$).expired:!1).length,Me=l.filter(n=>_(n)?x(n.expires_at,$).expiringSoon:!1).length,Pe=l.filter(n=>_(n)?!x(n.expires_at,$).hasExpiry:!1).length,me=l.filter(n=>_(n)&&(n.is_active||n.active)).length,Ae=Math.max(0,de-me),$e=l.filter(n=>_(n)&&n.last_used_at).length,Ne=Math.max(0,de-$e),xe=l.filter(n=>!_(n)&&n.last_used_at).length,Ie=Math.max(0,ve-xe),je=l.filter(n=>{if(_(n))return!1;const U=x(n.expires_at,$);return U.hasExpiry&&!U.expired}).length,He=l.filter(n=>_(n)?!1:x(n.expires_at,$).expired).length,De=l.filter(n=>_(n)?!1:x(n.expires_at,$).expiringSoon).length,Re=l.filter(n=>_(n)?!1:!x(n.expires_at,$).hasExpiry).length,_e=l.filter(n=>!_(n)&&(n.is_active||n.active)).length,Oe=Math.max(0,ve-_e),we=l.filter(n=>n.is_active||n.active).length,Ve=Math.max(0,l.length-we),Se=l.filter(n=>n.last_used_at).length,Ue=Math.max(0,l.length-Se),We=l.filter(n=>{const U=x(n.expires_at,$);return U.hasExpiry&&!U.expired}).length,Je=l.filter(n=>x(n.expires_at,$).expired).length,Fe=l.filter(n=>x(n.expires_at,$).expiringSoon).length,_t=l.filter(n=>!x(n.expires_at,$).hasExpiry).length,wt=t?"":`，激活 ${we} 个，未激活 ${Ve} 个`,St=t?"":`，完整且激活 ${me} 个，完整但未激活 ${Ae} 个`,Et=t?"":`，缺字段且激活 ${_e} 个，缺字段且未激活 ${Oe} 个`,Ct=t||i?`，筛选结果完整 ${de} 个${St}，完整且有效 ${ke} 个，完整且已过期 ${Le} 个，完整且即将过期 ${Me} 个，完整且未设置过期 ${Pe} 个，完整且已使用 ${$e} 个，完整但未使用 ${Ne} 个，缺字段 ${ve} 个${Et}，缺字段但已使用 ${xe} 个，缺字段且从未使用 ${Ie} 个，缺字段但有效 ${je} 个，缺字段且已过期 ${He} 个，缺字段且即将过期 ${De} 个，缺字段且未设置过期 ${Re} 个${wt}，已使用 ${Se} 个，从未使用 ${Ue} 个，有效 ${We} 个，已过期 ${Je} 个，即将过期 ${Fe} 个，未设置过期 ${_t} 个`:"";return`共 ${s} 个凭证，激活中 ${o} 个，未激活 ${b} 个，激活且完整 ${y} 个，未激活但完整 ${m} 个，激活但缺字段 ${w} 个，未激活且缺字段 ${g} 个，激活且已使用 ${v} 个，激活但从未使用 ${C} 个，未激活且已使用 ${E} 个，未激活但从未使用 ${D} 个，激活且有效 ${ie} 个，未激活且有效 ${se} 个，激活已过期 ${G} 个，未激活已过期 ${ne} 个，激活即将过期 ${le} 个，未激活即将过期 ${fe} 个，激活未设置过期 ${re} 个，未激活未设置过期 ${ae} 个，字段完整 ${u} 个，完整且有效 ${J} 个，完整且已过期 ${Q} 个，完整即将过期 ${F} 个，完整未设置过期 ${K} 个，完整且已使用 ${R} 个，完整但未使用 ${W} 个，字段缺失 ${O} 个，缺字段但已使用 ${V} 个，缺字段且未使用 ${c} 个，缺字段但有效 ${Y} 个，缺字段且已过期 ${oe} 个，缺字段即将过期 ${Z} 个，缺字段未设置过期 ${qe} 个，已使用 ${N} 个，从未使用 ${B} 个，设置过期时间 ${z} 个，有效 ${X} 个，已过期 ${ee} 个，即将过期 ${te} 个，未设置 ${Be} 个；筛选条件: ${Te}，当前展示 ${r} 个${Ct}`}function yt(e,t="",i=""){const r=Date.now();return e.filter(s=>{const l=s.is_active||s.active;if(t==="active"&&!l||t==="inactive"&&l)return!1;const a=x(s.expires_at,r);return!(i==="expired"&&!a.expired||i==="expiring"&&!a.expiringSoon||i==="valid"&&(!a.hasExpiry||a.expired)||i==="unset"&&a.hasExpiry)})}function Ki(e="",t=""){return e||t?`当前筛选暂无匹配凭证（${ht(e,t)}），可调整筛选条件后重试`:"暂无凭证，请先添加并激活可用凭证用于鉴权"}function ut(e,t,i){const r=e.querySelector(i);t.forEach(s=>{const l=e.querySelector(s);l==null||l.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),r.disabled||r.click())})})}async function zi(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function i(){var a,p,o,b,u,y,m,w,g,v,C,E,D,R,W,O,V;const l=e.querySelector("#bili-status-cards");l.innerHTML='<div class="page-loading">加载中...</div>';try{const c=await L.getBilibiliStatus(),B=Number((c==null?void 0:c.video_count)??0),N=Number(((a=c==null?void 0:c.videos)==null?void 0:a.poll_enabled_count)??0),$=Math.max(0,B-N),J=Qt(B,N),Q=ot(N,B),F=ot($,B,"停用占比"),K=!!((p=c==null?void 0:c.diagnostics)!=null&&p.ready),T=Ft((o=c==null?void 0:c.diagnostics)==null?void 0:o.blocking_reasons),I=ct(c==null?void 0:c.credential,"未配置活跃凭证"),j=!!(((u=(b=c==null?void 0:c.diagnostics)==null?void 0:b.signals)==null?void 0:u.credential_present)??((m=(y=c==null?void 0:c.diagnostics)==null?void 0:y.release_gates)==null?void 0:m.credential_present)),z=!!(((g=(w=c==null?void 0:c.diagnostics)==null?void 0:w.signals)==null?void 0:g.credential_complete)??((C=(v=c==null?void 0:c.diagnostics)==null?void 0:v.release_gates)==null?void 0:C.credential_complete)),X=Oi(j,z),ee=Vi(c==null?void 0:c.diagnostics),te=Kt((E=c==null?void 0:c.diagnostics)==null?void 0:E.effective_publish_mode),ie=Ui(c==null?void 0:c.diagnostics),G=Ye(c==null?void 0:c.enabled,"B 站集成已启用，可管理凭证与视频","B 站集成已停用，当前不会触发轮询或发布"),le=Ye(c==null?void 0:c.polling_enabled,"评论轮询已启用，会按配置自动抓取评论","评论轮询已停用，仅支持手动同步"),re=Ye(c==null?void 0:c.publish_enabled,"发布链路已启用，满足条件后可进入发布流程","发布链路已停用，不会进入自动发布流程"),se=zt((D=c==null?void 0:c.config)==null?void 0:D.poll_interval_seconds),ne=Gt((R=c==null?void 0:c.config)==null?void 0:R.poll_interval_seconds),fe=Yt((W=c==null?void 0:c.config)==null?void 0:W.rate_limit_per_minute),ae=Zt((O=c==null?void 0:c.config)==null?void 0:O.rate_limit_per_minute),Y=x((V=c==null?void 0:c.credential)==null?void 0:V.expires_at),oe=vt(Y,!!(c!=null&&c.credential)),Z=gt(c==null?void 0:c.credential);l.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${Hi(Y)}">${d(Y.label)}</div>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${w.map(v=>`<tr data-id="${d(v.id||v.video_id)}">
              <td class="cell-id">${Ti(v)}</td>
              <td class="cell-truncate">${Li(v)}</td>
              <td>${Pi(v)}</td>
              <td>${Ai(v)}</td>
              <td class="cell-time">${Ni(v)}</td>
              <td>${ei(v)}</td>
              <td class="cell-actions">
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),i=e.querySelector("#query-comment-result");if(!t){f("请输入 Comment ID","warning");return}i.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await pt.getComment(t);i.innerHTML=`
      ...
      `;const s=i.querySelector("#query-goto-comment");s&&s.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=s.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){i.innerHTML=`<div class="page-error">查询失败: ${d(r.message)}</div>`}})}const Qe={dashboard:{render:ft,title:"仪表盘"},jobs:{render:Tt,title:"任务管理"},"daily-metrics":{render:Lt,title:"每日指标"},knowledge:{render:Mt,title:"知识库"},"role-cards":{render:Pt,title:"角色卡"},profiles:{render:At,title:"风格配置"},gateway:{render:It,title:"网关"},audit:{render:jt,title:"审计日志"},bilibili:{render:zi,title:"B站集成"},query:{render:Gi,title:"查询"}};let mt=null;function Yi(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function $t(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function xt(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Zi(e){e.preventDefault();const t=document.getElementById("login-api-key"),i=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await h("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),xt(),rt("dashboard")}catch{i.textContent="API Key 无效或服务不可用",i.style.display="block",window.__ADMIN_API_KEY__=""}}}function Qi(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",$t()}function rt(e){if(!Qe[e])return;mt=e,document.querySelectorAll("#nav-list .nav-item").forEach(i=>{i.classList.toggle("active",i.dataset.page===e)}),document.getElementById("page-title").textContent=Qe[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',Qe[e].render(t).catch(i=>{t.innerHTML=`<div class="page-error">加载失败: ${i.message}</div>`})}function Xi(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==mt&&rt(t)})})}function el(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),i=document.getElementById("expand-left-btn");t&&i&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),i.style.display="block"}),i.addEventListener("click",()=>{e.classList.remove("collapsed"),i.style.display="none"}))}function tl(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let i=0;e.addEventListener("click",()=>{i=(i+1)%t.length,t[i]?document.body.setAttribute("data-theme",t[i]):document.body.removeAttribute("data-theme")})}function il(){el(),tl(),Xi(),document.getElementById("login-form").addEventListener("submit",Zi),document.getElementById("logout-btn").addEventListener("click",Qi),Yi()?(xt(),rt("dashboard")):$t()}il();
