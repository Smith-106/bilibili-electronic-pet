(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const r of l)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(l){const r={};return l.integrity&&(r.integrity=l.integrity),l.referrerPolicy&&(r.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?r.credentials="include":l.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(l){if(l.ep)return;l.ep=!0;const r=i(l);fetch(l.href,r)}})();function ae(e,t,i){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof i=="string"&&i.trim()?i.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function W(){return(window.__ADMIN_API_KEY__||"").trim()}async function y(e,t={}){const i=W(),s=new Headers(t.headers||{});i&&s.set("x-api-key",i);const l=await fetch(e,{...t,headers:s}),r=await l.json().catch(()=>({}));if(!l.ok){const a=(r==null?void 0:r.detail)||(r==null?void 0:r.error);throw new Error(ae(a,l.status,l.statusText))}return r}async function U(e,t){const i=W(),s=new Headers;i&&s.set("x-api-key",i);const l=await fetch(e,{headers:s});if(!l.ok)throw new Error("download_failed");const r=await l.blob(),a=URL.createObjectURL(r),u=document.createElement("a");u.href=a,u.download=t,document.body.appendChild(u),u.click(),document.body.removeChild(u),URL.revokeObjectURL(a)}function w(e){const t=new URLSearchParams;for(const[s,l]of Object.entries(e))l!=null&&l!==""&&t.set(s,String(l));const i=t.toString();return i?`?${i}`:""}function S(){return{getOverview(){return y("/api/admin/overview")},getJobs({status:e,limit:t}={}){return y(`/api/admin/jobs${w({status:e,limit:t})}`)},getJob(e){return y(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return y(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return y(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return y("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return y("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return U(`/export/jobs.csv${w({status:e,limit:t})}`,"jobs.csv")},getComment(e){return y(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return y(`/api/admin/gateway/logs${w({limit:e,comment_id:t})}`)},publishGatewayReply(e){return y("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:i}={}){return y(`/api/admin/audit/summary${w({days:e,action:t,ok:i})}`)},getAuditLogs({limit:e,action:t,ok:i}={}){return y(`/api/audit-log${w({limit:e,action:t,ok:i})}`)},exportAuditCsv({limit:e,action:t,ok:i}={}){return U(`/export/audit-logs.csv${w({limit:e,action:t,ok:i})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return y(`/api/metrics/daily${w({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return y(`/api/admin/knowledge${w({limit:e,offset:t})}`)},createKnowledgeEntry(e){return y("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return y(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return y(`/api/admin/role-cards${w({limit:e,offset:t})}`)},createRoleCard(e){return y("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return y(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return y(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return y(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return y("/api/admin/style-profile")},setStyleProfile(e){return y("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return y("/api/admin/role-profile")},setRoleProfile(e){return y("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return y("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:i}={}){return y(`/api/admin/bilibili/videos${w({poll_enabled:e,limit:t,offset:i})}`)},addBilibiliVideo(e){return y("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return y("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return y("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return y("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return y(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return y(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function n(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function E(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function de(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const i=Date.now()-t.getTime(),s=Math.floor(i/1e3);if(s<60)return"刚刚";const l=Math.floor(s/60);if(l<60)return`${l}分钟前`;const r=Math.floor(l/60);if(r<24)return`${r}小时前`;const a=Math.floor(r/24);if(a<30)return`${a}天前`;const u=Math.floor(a/30);return u<12?`${u}个月前`:`${Math.floor(u/12)}年前`}catch{return""}}function C(e){const t=de(e),i=E(e);return t?`<span title="${n(i)}">${n(t)}</span>`:`<span title="${n(i)}">${n(i)}</span>`}function _(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const ne={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function D(e){if(!e)return"";const t=ne[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${n(t.label)}</span>`}function R(e,t="是",i="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${n(e?t:i)}</span>`}let P=null;function b(e,t="info"){const i=document.getElementById("app-toast");i&&i.remove(),P&&clearTimeout(P);const s={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},l=document.createElement("div");l.id="app-toast",l.className="toast-notification",l.style.setProperty("--toast-color",s[t]||s.info),l.innerHTML=`
  ...
  `,document.body.appendChild(l),requestAnimationFrame(()=>l.classList.add("show"));const r=()=>{l.classList.remove("show"),setTimeout(()=>l.remove(),300)};l.querySelector(".toast-close").onclick=r,P=setTimeout(r,4e3)}const B=S();async function Z(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,i,s,l]=await Promise.all([B.getOverview().catch(()=>null),B.getJobs({limit:5}).catch(()=>null),B.getGatewayLogs({limit:5}).catch(()=>null),B.getAuditSummary({days:7}).catch(()=>null)]),r=t||{},a=Array.isArray(i==null?void 0:i.items)?i.items:[],u=Array.isArray(s==null?void 0:s.items)?s.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{b("正在刷新...","info"),Z(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${n(t.message)}</div>`}}const k=S();async function oe(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;async function t(){const i=e.querySelector("#metrics-days").value,s=e.querySelector("#metrics-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';try{const l=await ce.getDailyMetrics({days:i}),r=Array.isArray(l==null?void 0:l.items)?l.items:Array.isArray(l)?l:[];if(r.length===0){s.innerHTML='<div class="table-empty">暂无指标数据</div>';return}s.innerHTML=`
      ...
      `}catch(l){s.innerHTML=`<div class="page-error">加载失败: ${n(l.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const H=S();async function ve(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const i=e.querySelector("#knowledge-table-wrapper");i.innerHTML='<div class="page-loading">加载中...</div>';try{const s=await H.getKnowledgeEntries({limit:50}),l=Array.isArray(s==null?void 0:s.items)?s.items:[];if(l.length===0){i.innerHTML='<div class="table-empty">暂无知识条目</div>';return}i.innerHTML=`
        <table class="data-table">
          <thead><tr>
          ...
          <tbody>
            ${l.map(r=>{var a,u;return`<tr>
              ...
              <td>${R(r.enabled!==!1)}</td>
              <td class="cell-time">${C(r.created_at)}</td>
              <td class="cell-actions">
      ...
      `,i.querySelectorAll(".knowledge-disable").forEach(r=>{r.addEventListener("click",async()=>{try{await H.disableKnowledgeEntry(r.dataset.id),b("已禁用","success"),t()}catch(a){b(`操作失败: ${a.message}`,"error")}})})}catch(s){i.innerHTML=`<div class="page-error">加载失败: ${n(s.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const i=e.querySelector("#knowledge-category").value.trim(),s=e.querySelector("#knowledge-title").value.trim(),l=e.querySelector("#knowledge-content").value.trim();if(!s||!l){b("标题和内容不能为空","warning");return}try{await H.createKnowledgeEntry({category:i,title:s,content:l}),b("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(r){b(`创建失败: ${r.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const T=S();let A=!1,f=null;async function be(e){A=!1,f=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `}const z=S();async function ye(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
  ...
  `;const t=e.querySelector("#gw-reply"),i=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{i.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const l=e.querySelector("#gw-publish-btn"),r=e.querySelector("#gw-comment-id").value.trim(),a=e.querySelector("#gw-reply").value.trim(),u=e.querySelector("#gw-source").value.trim(),d=e.querySelector("#gw-force").checked;if(!r||!a){b("Comment ID 和回复内容不能为空","warning");return}l.disabled=!0,l.textContent="发布中...";try{await z.publishGatewayReply({comment_id:r,reply_text:a,source:u,force_publish:d}),b("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",i.textContent="0/0",s()}catch(v){b(`发布失败: ${v.message}`,"error")}finally{l.disabled=!1,l.textContent="发布"}});async function s(){const l=e.querySelector("#gw-table-wrapper"),r=e.querySelector("#gw-limit").value;l.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await z.getGatewayLogs({limit:r}),u=Array.isArray(a==null?void 0:a.items)?a.items:[];if(u.length===0){l.innerHTML='<div class="table-empty">暂无网关日志</div>';return}l.innerHTML=me({columns:[{key:"id",label:"ID",class:"cell-id",render:d=>{var v;return n((v=d.id)==null?void 0:v.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:d=>{var v;return n((v=d.comment_id)==null?void 0:v.substring(0,12))}},{key:"status",label:"状态",render:d=>D(d.status)},{key:"platform",label:"平台",render:d=>n(d.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:d=>{var v;return n((v=d.reply_text)==null?void 0:v.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:d=>C(d.created_at)}],rows:u})}catch(a){l.innerHTML=`<div class="page-error">加载失败: ${n(a.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",s),e.querySelector("#gw-filter-btn").addEventListener("click",s),await s()}const O=S();async function fe(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const s=await O.getAuditSummary({days:7}),l=e.querySelector("#audit-summary-cards");l.innerHTML=`
        <div class="stat-card mini">
          <div class="stat-label">总操作</div>
      ...
      `}catch{e.querySelector("#audit-summary-cards").innerHTML='<div class="page-error">摘要加载失败</div>'}}async function i(){const s=e.querySelector("#audit-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';const l=e.querySelector("#audit-action").value.trim(),r=e.querySelector("#audit-ok").value,a=e.querySelector("#audit-limit").value;try{const u=await O.getAuditLogs({action:l,ok:r,limit:a}),d=Array.isArray(u==null?void 0:u.items)?u.items:[];if(d.length===0){s.innerHTML='<div class="table-empty">暂无审计日志</div>';return}s.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `}catch(u){s.innerHTML=`<div class="page-error">加载失败: ${n(u.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),i()}),e.querySelector("#audit-filter-btn").addEventListener("click",i),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await O.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),b("导出成功","success")}catch(s){b(`导出失败: ${s.message}`,"error")}}),await Promise.all([t(),i()])}const $=S(),ge=/^BV[a-zA-Z0-9]{10}$/,he={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},$e={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},we={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},Se={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},F={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},L=50,qe=7*24*60*60*1e3;function h(e){const t=e instanceof Error?e.message:String(e??"request_failed");return he[t]||t}function _e(e){return e?ge.test(e)?null:"invalid_bvid_format":"bvid_required"}function xe(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function ke(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Le(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(i=>$e[i]||i).join("；")}function Ee(e){const t=String(e??"").trim().toLowerCase();return we[t]||t||"-"}function Ce(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Te(e,t){const i=String(e??"").trim().toLowerCase();if(!i)return"-";const s=Se[i]||{label:i,cls:"badge-muted"},l=i==="error"&&t?F[String(t).trim().toLowerCase()]||String(t):"",r=l?` title="${n(l)}"`:"";return`<span class="status-badge ${s.cls}"${r}>${n(s.label)}</span>${l?`<div class="form-hint" style="margin-top:4px;">${n(l)}</div>`:""}`}function Ae(e){return e?E(e):"-"}function Me(e){if(e==="true")return!0;if(e==="false")return!1}function Be(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function je(e){return e.filter(t=>!(typeof(t==null?void 0:t.aid)=="number"&&Number.isFinite(t.aid))).length}function Ie(e){const i=typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)?`aid: ${e.aid}`:F.no_aid;return`${n((e==null?void 0:e.bvid)||"-")}${i?`<div class="form-hint" style="margin-top:4px;">${n(i)}</div>`:""}`}function Pe(e,t,i,s=0,l=L,r=[]){const a=i==="true"?"轮询中":i==="false"?"已停用":"全部",u=Math.floor(s/l)+1,d=Math.max(1,Math.ceil(e/l)),v=je(r),c=v>0?`，当前页缺少 aid ${v} 条`:"";return`筛选: ${a}，共 ${e} 条，当前展示 ${t} 条，第 ${u}/${d} 页${c}`}function V(e,t={}){const i=Number((e==null?void 0:e.videos)??0),s=Number((e==null?void 0:e.comments)??0),l=Number((e==null?void 0:e.events_injected)??s),r=t.subject||(i===1?"视频":"轮询");return s>0||l>0?`${r}完成，处理 ${i} 个视频，新增 ${s} 条评论，注入 ${l} 个事件。`:i>0?`${r}完成，处理 ${i} 个视频，暂无新增评论。`:`${r}完成，暂无可处理视频。`}function I(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const i=new Date(e);if(Number.isNaN(i.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const s=i.getTime()-t;return s<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:E(e)}:s<=qe?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:E(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:E(e)}}function He(e){const t=I(e),i=t.detail?`<div class="form-hint" style="margin-top:4px;">${n(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${n(t.label)}</span>${i}`}function Oe(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function Q(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function Ne(e,t="",i="",s=e.length){const l=e.length,r=e.filter(m=>m.is_active||m.active).length,a=Date.now(),u=e.map(m=>I(m.expires_at,a)),d=u.filter(m=>m.hasExpiry).length,v=u.filter(m=>m.expired).length,c=Q(t,i);return`共 ${l} 个凭证，激活中 ${r} 个，设置过期时间 ${d} 个，已过期 ${v} 个；筛选: ${c}，当前展示 ${s} 个`}function Re(e,t="",i=""){const s=Date.now();return e.filter(l=>{const r=l.is_active||l.active;if(t==="active"&&!r||t==="inactive"&&r)return!1;const a=I(l.expires_at,s);return!(i==="expired"&&!a.expired||i==="expiring"&&!a.expiringSoon||i==="valid"&&(!a.hasExpiry||a.expired)||i==="unset"&&a.hasExpiry)})}function De(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${Q(e,t)}）`:"暂无凭证"}function G(e,t,i){const s=e.querySelector(i);t.forEach(l=>{const r=e.querySelector(l);r==null||r.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),s.disabled||s.click())})})}async function Je(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function i(){var a,u,d,v,c,m,p,g;const r=e.querySelector("#bili-status-cards");try{const o=await $.getBilibiliStatus(),q=Number(((a=o==null?void 0:o.videos)==null?void 0:a.poll_enabled_count)??0),x=!!((u=o==null?void 0:o.diagnostics)!=null&&u.ready),K=Le((d=o==null?void 0:o.diagnostics)==null?void 0:d.blocking_reasons),ie=(v=o==null?void 0:o.credential)!=null&&v.name?n(o.credential.name):"未配置",se=Ee((c=o==null?void 0:o.diagnostics)==null?void 0:c.effective_publish_mode),le=Ce((m=o==null?void 0:o.config)==null?void 0:m.poll_interval_seconds),M=I((p=o==null?void 0:o.credential)==null?void 0:p.expires_at),re=Ae((g=o==null?void 0:o.credential)==null?void 0:g.last_used_at);r.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${Oe(M)}">${n(M.label)}</div>
          ${M.detail?`<div class="form-hint" style="margin-top:6px;">${n(M.detail)}</div>`:""}
        </div>
        <div class="stat-card mini">
      ...
      `}catch(o){r.innerHTML=`<div class="page-error">状态加载失败: ${n(h(o))}</div>`}}async function s(){const r=e.querySelector("#bili-videos-wrapper"),a=e.querySelector("#bili-video-summary"),u=e.querySelector("#bili-video-filter-btn"),d=e.querySelector("#bili-video-prev"),v=e.querySelector("#bili-video-next"),c=e.querySelector("#bili-video-poll-filter").value;a.textContent="加载中...",u.disabled=!0,d.disabled=!0,v.disabled=!0;try{const m=await $.getBilibiliVideos({limit:L,offset:t,poll_enabled:Me(c)}),p=Array.isArray(m==null?void 0:m.items)?m.items:Array.isArray(m)?m:[],g=Number((m==null?void 0:m.total)??p.length);if(p.length===0&&g>0&&t>0){t=Math.max(0,t-L),await s();return}if(a.textContent=Pe(g,p.length,c,t,L,p),d.disabled=t<=0,v.disabled=t+p.length>=g,p.length===0){r.innerHTML=`<div class="table-empty">${n(Be(c))}</div>`;return}r.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${p.map(o=>`<tr data-id="${n(o.id||o.video_id)}">
              ...
              <td>${R(o.poll_enabled)}</td>
              <td>${o.comment_count??"-"}</td>
              <td class="cell-time">${o.last_polled_at?C(o.last_polled_at):"-"}</td>
              <td>${Te(o.last_poll_status,o.last_poll_error)}</td>
              <td class="cell-actions">
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),i=e.querySelector("#query-comment-result");if(!t){b("请输入 Comment ID","warning");return}i.innerHTML='<div class="page-loading">查询中...</div>';try{const s=await Y.getComment(t);i.innerHTML=`
      ...
      `;const l=i.querySelector("#query-goto-comment");l&&l.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=l.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(s){i.innerHTML=`<div class="page-error">查询失败: ${n(s.message)}</div>`}})}const N={dashboard:{render:Z,title:"仪表盘"},jobs:{render:oe,title:"任务管理"},"daily-metrics":{render:ue,title:"每日指标"},knowledge:{render:ve,title:"知识库"},"role-cards":{render:be,title:"角色卡"},profiles:{render:pe,title:"风格配置"},gateway:{render:ye,title:"网关"},audit:{render:fe,title:"审计日志"},bilibili:{render:Je,title:"B站集成"},query:{render:Ke,title:"查询"}};let X=null;function Ue(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function ee(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function te(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function ze(e){e.preventDefault();const t=document.getElementById("login-api-key"),i=document.getElementById("login-error"),s=t.value.trim();if(s){window.__ADMIN_API_KEY__=s;try{await y("/api/admin/overview"),sessionStorage.setItem("admin_api_key",s),te(),J("dashboard")}catch{i.textContent="API Key 无效或服务不可用",i.style.display="block",window.__ADMIN_API_KEY__=""}}}function Ve(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",ee()}function J(e){if(!N[e])return;X=e,document.querySelectorAll("#nav-list .nav-item").forEach(i=>{i.classList.toggle("active",i.dataset.page===e)}),document.getElementById("page-title").textContent=N[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',N[e].render(t).catch(i=>{t.innerHTML=`<div class="page-error">加载失败: ${i.message}</div>`})}function Ge(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==X&&J(t)})})}function Ye(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),i=document.getElementById("expand-left-btn");t&&i&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),i.style.display="block"}),i.addEventListener("click",()=>{e.classList.remove("collapsed"),i.style.display="none"}))}function We(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let i=0;e.addEventListener("click",()=>{i=(i+1)%t.length,t[i]?document.body.setAttribute("data-theme",t[i]):document.body.removeAttribute("data-theme")})}function Ze(){Ye(),We(),Ge(),document.getElementById("login-form").addEventListener("submit",ze),document.getElementById("logout-btn").addEventListener("click",Ve),Ue()?(te(),J("dashboard")):ee()}Ze();
