(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function l(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=l(s);fetch(s.href,i)}})();function ot(e,t,l){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof l=="string"&&l.trim()?l.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function Ze(){return(window.__ADMIN_API_KEY__||"").trim()}async function g(e,t={}){const l=Ze(),r=new Headers(t.headers||{});l&&r.set("x-api-key",l);const s=await fetch(e,{...t,headers:r}),i=await s.json().catch(()=>({}));if(!s.ok){const n=(i==null?void 0:i.detail)||(i==null?void 0:i.error);throw new Error(ot(n,s.status,s.statusText))}return i}async function Je(e,t){const l=Ze(),r=new Headers;l&&r.set("x-api-key",l);const s=await fetch(e,{headers:r});if(!s.ok)throw new Error("download_failed");const i=await s.blob(),n=URL.createObjectURL(i),p=document.createElement("a");p.href=n,p.download=t,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(n)}function T(e){const t=new URLSearchParams;for(const[r,s]of Object.entries(e))s!=null&&s!==""&&t.set(r,String(s));const l=t.toString();return l?`?${l}`:""}function M(){return{getOverview(){return g("/api/admin/overview")},getJobs({status:e,limit:t}={}){return g(`/api/admin/jobs${T({status:e,limit:t})}`)},getJob(e){return g(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return g(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return g(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return g("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return g("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return Je(`/export/jobs.csv${T({status:e,limit:t})}`,"jobs.csv")},getComment(e){return g(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return g(`/api/admin/gateway/logs${T({limit:e,comment_id:t})}`)},publishGatewayReply(e){return g("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:l}={}){return g(`/api/admin/audit/summary${T({days:e,action:t,ok:l})}`)},getAuditLogs({limit:e,action:t,ok:l}={}){return g(`/api/audit-log${T({limit:e,action:t,ok:l})}`)},exportAuditCsv({limit:e,action:t,ok:l}={}){return Je(`/export/audit-logs.csv${T({limit:e,action:t,ok:l})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return g(`/api/metrics/daily${T({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return g(`/api/admin/knowledge${T({limit:e,offset:t})}`)},createKnowledgeEntry(e){return g("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return g(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return g(`/api/admin/role-cards${T({limit:e,offset:t})}`)},createRoleCard(e){return g("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return g(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return g("/api/admin/style-profile")},setStyleProfile(e){return g("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return g("/api/admin/role-profile")},setRoleProfile(e){return g("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return g("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:l}={}){return g(`/api/admin/bilibili/videos${T({poll_enabled:e,limit:t,offset:l})}`)},addBilibiliVideo(e){return g("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return g("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return g("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return g("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function d(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function B(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function dt(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const l=Date.now()-t.getTime(),r=Math.floor(l/1e3);if(r<60)return"刚刚";const s=Math.floor(r/60);if(s<60)return`${s}分钟前`;const i=Math.floor(s/60);if(i<24)return`${i}小时前`;const n=Math.floor(i/24);if(n<30)return`${n}天前`;const p=Math.floor(n/30);return p<12?`${p}个月前`:`${Math.floor(p/12)}年前`}catch{return""}}function te(e){const t=dt(e),l=B(e);return t?`<span title="${d(l)}">${d(t)}</span>`:`<span title="${d(l)}">${d(l)}</span>`}function H(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const ct={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function Ve(e){if(!e)return"";const t=ct[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${d(t.label)}</span>`}function Ue(e,t="是",l="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${d(e?t:l)}</span>`}let He=null;function v(e,t="info"){const l=document.getElementById("app-toast");l&&l.remove(),He&&clearTimeout(He);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},s=document.createElement("div");s.id="app-toast",s.className="toast-notification",s.style.setProperty("--toast-color",r[t]||r.info),s.innerHTML=`
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("show"));const i=()=>{s.classList.remove("show"),setTimeout(()=>s.remove(),300)};s.querySelector(".toast-close").onclick=i,He=setTimeout(i,4e3)}const ce=M();async function Qe(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,l,r,s]=await Promise.all([ce.getOverview().catch(()=>null),ce.getJobs({limit:5}).catch(()=>null),ce.getGatewayLogs({limit:5}).catch(()=>null),ce.getAuditSummary({days:7}).catch(()=>null)]),i=t||{},n=Array.isArray(l==null?void 0:l.items)?l.items:[],p=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{v("正在刷新...","info"),Qe(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${d(t.message)}</div>`}}const X=M();async function ut(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;async function t(){const l=e.querySelector("#metrics-days").value,r=e.querySelector("#metrics-table-wrapper");r.innerHTML='<div class="page-loading">加载中...</div>';try{const s=await pt.getDailyMetrics({days:l}),i=Array.isArray(s==null?void 0:s.items)?s.items:Array.isArray(s)?s:[];if(i.length===0){r.innerHTML='<div class="table-empty">暂无指标数据</div>';return}r.innerHTML=`
      ...
      `}catch(s){r.innerHTML=`<div class="page-error">加载失败: ${d(s.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const Oe=M();async function vt(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const l=e.querySelector("#knowledge-table-wrapper");l.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await Oe.getKnowledgeEntries({limit:50}),s=Array.isArray(r==null?void 0:r.items)?r.items:[];if(s.length===0){l.innerHTML='<div class="table-empty">暂无知识条目</div>';return}l.innerHTML=`
      ...
      `,l.querySelectorAll(".knowledge-disable").forEach(i=>{i.addEventListener("click",async()=>{try{await Oe.disableKnowledgeEntry(i.dataset.id),v("已禁用","success"),t()}catch(n){v(`操作失败: ${n.message}`,"error")}})})}catch(r){l.innerHTML=`<div class="page-error">加载失败: ${d(r.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const l=e.querySelector("#knowledge-category").value.trim(),r=e.querySelector("#knowledge-title").value.trim(),s=e.querySelector("#knowledge-content").value.trim();if(!r||!s){v("标题和内容不能为空","warning");return}try{await Oe.createKnowledgeEntry({category:l,title:r,content:s}),v("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(i){v(`创建失败: ${i.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const se=M();let ae=!1,S=null;async function ft(e){ae=!1,S=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `}const Ke=M();async function ht(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
  ...
  `;const t=e.querySelector("#gw-reply"),l=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{l.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const s=e.querySelector("#gw-publish-btn"),i=e.querySelector("#gw-comment-id").value.trim(),n=e.querySelector("#gw-reply").value.trim(),p=e.querySelector("#gw-source").value.trim(),o=e.querySelector("#gw-force").checked;if(!i||!n){v("Comment ID 和回复内容不能为空","warning");return}s.disabled=!0,s.textContent="发布中...";try{await Ke.publishGatewayReply({comment_id:i,reply_text:n,source:p,force_publish:o}),v("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",l.textContent="0/0",r()}catch(b){v(`发布失败: ${b.message}`,"error")}finally{s.disabled=!1,s.textContent="发布"}});async function r(){const s=e.querySelector("#gw-table-wrapper"),i=e.querySelector("#gw-limit").value;s.innerHTML='<div class="page-loading">加载中...</div>';try{const n=await Ke.getGatewayLogs({limit:i}),p=Array.isArray(n==null?void 0:n.items)?n.items:[];if(p.length===0){s.innerHTML='<div class="table-empty">暂无网关日志</div>';return}s.innerHTML=gt({columns:[{key:"id",label:"ID",class:"cell-id",render:o=>{var b;return d((b=o.id)==null?void 0:b.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:o=>{var b;return d((b=o.comment_id)==null?void 0:b.substring(0,12))}},{key:"status",label:"状态",render:o=>Ve(o.status)},{key:"platform",label:"平台",render:o=>d(o.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:o=>{var b;return d((b=o.reply_text)==null?void 0:b.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:o=>te(o.created_at)}],rows:p})}catch(n){s.innerHTML=`<div class="page-error">加载失败: ${d(n.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",r),e.querySelector("#gw-filter-btn").addEventListener("click",r),await r()}const Re=M();async function mt(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const r=await Re.getAuditSummary({days:7}),s=e.querySelector("#audit-summary-cards");s.innerHTML=`
      ...
      `}catch(p){r.innerHTML=`<div class="page-error">加载失败: ${d(p.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),l()}),e.querySelector("#audit-filter-btn").addEventListener("click",l),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await Re.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(r){v(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),l()])}const k=M(),$t=/^BV[a-zA-Z0-9]{10}$/,xt={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},_t={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},wt={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},St={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},pe={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},ee=50,Et=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return xt[t]||t}function Ct(e){return e?$t.test(e)?null:"invalid_bvid_format":"bvid_required"}function qt(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function kt(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Lt(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(l=>_t[l]||l).join("；")}function Tt(e){const t=String(e??"").trim().toLowerCase();return wt[t]||t||"-"}function Bt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Mt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function Pt(e,t){const l=Number(t??0);if(!Number.isFinite(l)||l<=0)return"暂无视频";const r=Number(e??0);return`覆盖率 ${((Number.isFinite(r)?Math.min(l,Math.max(0,r)):0)/l*100).toFixed(1).replace(/\.0$/,"")}%`}function At(e,t,l){const r=String(e??"").trim().toLowerCase();if(!r)return"-";const s=St[r]||{label:r,cls:"badge-muted"},i=r==="error"&&t?pe[String(t).trim().toLowerCase()]||String(t):"",n=i?` title="${d(i)}"`:"",p=typeof l=="number"&&Number.isFinite(l)?`评论游标: ${l}`:"",o=[i,p].filter(Boolean).map(b=>`<div class="form-hint" style="margin-top:4px;">${d(b)}</div>`).join("");return`<span class="status-badge ${s.cls}"${n}>${d(s.label)}</span>${o}`}function jt(e){return e?B(e):"-"}function It(e){if(e==="true")return!0;if(e==="false")return!1}function Nt(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function V(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Ht(e){return e.filter(t=>!V(t)).length}function Ot(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function Rt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!V(t)).length}function Dt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&V(t)).length}function Ut(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function Vt(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function Wt(e){return e.filter(t=>{const l=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return l==="ok"||l==="no_new"}).length}function Jt(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function Kt(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function zt(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function Ft(e){return e.filter(t=>V(t)&&!(t!=null&&t.last_polled_at)).length}function Gt(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function Yt(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function Zt(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function Qt(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function Xt(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&Number((t==null?void 0:t.comment_count)??0)<=0).length}function ei(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function ti(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function ii(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function li(e){return e.filter(t=>V(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function ri(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(V(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function si(e){return e.reduce((t,l)=>{const r=Number((l==null?void 0:l.comment_count)??0);return t+(Number.isFinite(r)&&r>0?r:0)},0)}function ai(e){const l=V(e)?`aid: ${e.aid}`:pe.no_aid;return`${d((e==null?void 0:e.bvid)||"-")}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function ni(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(`更新: ${B(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${B(e.created_at)}`),`${d((e==null?void 0:e.title)||"-")}${t.map(l=>`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`).join("")}`}function oi(e){const t=V(e),l=t?"":" disabled",r=t?"":` title="${d(pe.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${d(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${l}${r}>同步</button>`}function di(e,t,l,r=0,s=ee,i=[]){const n=l==="true"?"轮询中":l==="false"?"已停用":"全部",p=Math.floor(r/s)+1,o=Math.max(1,Math.ceil(e/s)),b=Ot(i),c=Math.max(0,i.length-b),h=Rt(i),m=Dt(i),_=Ut(i),y=Ht(i),f=Math.max(0,i.length-y),C=Vt(i),E=Wt(i),W=Jt(i),O=Kt(i),R=zt(i),D=Ft(i),u=Math.max(0,i.length-R),P=Yt(i),A=Math.max(0,i.length-P),J=Zt(i),$=Math.max(0,i.length-J),U=Qt(i),K=Math.max(0,i.length-U),G=Xt(i),z=ei(i),L=ti(i),j=ii(i),I=Math.max(0,i.length-z),Y=Gt(i),F=li(i),Z=Math.max(0,i.length-F),Q=ri(i),N=si(i),ie=y>0?`，当前页缺少 aid ${y} 条`:"",be=l===""&&b>0?`，当前页轮询开启 ${b} 条`:"",ve=l===""&&c>0?`，当前页轮询停用 ${c} 条`:"",fe=l===""&&h>0?`，轮询开启但缺少 aid ${h} 条`:"",ye=l===""&&m>0?`，轮询停用但可同步 ${m} 条`:"",ge=l===""&&_>0?`，轮询开启但尚未轮询 ${_} 条`:"",he=f>0?`，可同步 ${f} 条`:"",me=E>0?`，正常轮询 ${E} 条`:"",$e=W>0?`，成功轮询 ${W} 条`:"",xe=O>0?`，无新增 ${O} 条`:"",_e=C>0?`，轮询失败 ${C} 条`:"",we=u>0?`，已有轮询记录 ${u} 条`:"",Se=R>0?`，尚未轮询 ${R} 条`:"",le=D>0?`，可同步但尚未轮询 ${D} 条`:"",Ee=P>0?`，已识别 UP 主 ${P} 条`:"",Ce=A>0?`，缺少 UP 主 ${A} 条`:"",qe=J>0?`，已抓取标题 ${J} 条`:"",ke=$>0?`，缺少标题 ${$} 条`:"",ne=F>0?`，信息完整 ${F} 条`:"",Le=Z>0?`，信息不完整 ${Z} 条`:"",Te=Q>0?`，已轮询但信息不完整 ${Q} 条`:"",Be=U>0?`，已有评论视频 ${U} 条`:"",Me=K>0?`，无评论视频 ${K} 条`:"",Pe=G>0?`，已轮询但无评论 ${G} 条`:"",oe=z>0?`，已有评论游标 ${z} 条`:"",Ae=L>0?`，有评论但无游标 ${L} 条`:"",de=j>0?`，无评论但有游标 ${j} 条`:"",je=I>0?`，无评论游标 ${I} 条`:"",Ie=Y>0?`，已轮询但无游标 ${Y} 条`:"",Ne=N>0?`，关联评论 ${N} 条`:"";return`筛选: ${n}，共 ${e} 条，当前展示 ${t} 条，第 ${p}/${o} 页${be}${ve}${ie}${fe}${ye}${ge}${he}${me}${$e}${xe}${_e}${we}${Se}${le}${Ee}${Ce}${qe}${ke}${ne}${Le}${Te}${Be}${Me}${Pe}${oe}${Ae}${de}${je}${Ie}${Ne}`}function ze(e,t={}){const l=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),s=Number((e==null?void 0:e.events_injected)??r),i=t.subject||(l===1?"视频":"轮询");return r>0||s>0?`${i}完成，处理 ${l} 个视频，新增 ${r} 条评论，注入 ${s} 个事件。`:l>0?`${i}完成，处理 ${l} 个视频，暂无新增评论。`:`${i}完成，暂无可处理视频。`}function x(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const l=new Date(e);if(Number.isNaN(l.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const r=l.getTime()-t;return r<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:B(e)}:r<=Et?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:B(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:B(e)}}function ci(e){const t=x(e),l=t.detail?`<div class="form-hint" style="margin-top:4px;">${d(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${d(t.label)}</span>${l}`}function Fe(e,t="-"){const l=[];return e!=null&&e.updated_at&&l.push(`更新: ${B(e.updated_at)}`),e!=null&&e.created_at&&l.push(`创建: ${B(e.created_at)}`),`${d((e==null?void 0:e.name)||t)}${l.map(r=>`<div class="form-hint" style="margin-top:4px;">${d(r)}</div>`).join("")}`}function ui(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function w(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function pi(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function bi(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function vi(e){var n,p,o,b,c,h;const t=!!((p=(n=e==null?void 0:e.checks)==null?void 0:n.auth)!=null&&p.ready),l=!!((b=(o=e==null?void 0:e.checks)==null?void 0:o.worker_or_publish)!=null&&b.ready),r=!!((c=e==null?void 0:e.signals)!=null&&c.polling_worker_enabled),s=!!((h=e==null?void 0:e.signals)!=null&&h.native_publish_enabled);return r||s?`${t?"鉴权已就绪":"鉴权未就绪"}，${l?"执行链路可用":"执行链路阻塞"}`:"当前无需鉴权"}function fi(e){var s,i,n;const t=!!((s=e==null?void 0:e.signals)!=null&&s.publish_mode_config_ready),l=!!((i=e==null?void 0:e.signals)!=null&&i.native_publish_enabled),r=!!((n=e==null?void 0:e.signals)!=null&&n.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",l?"原生发布启用":"原生发布停用",r?"轮询链路启用":"轮询链路停用"].join("，")}function yi(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",l=w(e)?"字段完整":`缺少 ${pi(e).join(" / ")}`;return`${d(t)}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function Xe(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function gi(e,t="",l="",r=e.length){const s=e.length,i=et(e,t,l),n=e.filter(a=>a.is_active||a.active),p=e.filter(a=>!(a.is_active||a.active)),o=n.length,b=p.length,c=e.filter(a=>w(a)).length,h=e.filter(a=>(a.is_active||a.active)&&w(a)).length,m=Math.max(0,c-h),_=Math.max(0,o-h),y=Math.max(0,b-m),f=n.filter(a=>a.last_used_at).length,C=Math.max(0,o-f),E=p.filter(a=>a.last_used_at).length,W=Math.max(0,b-E),O=e.filter(a=>w(a)&&a.last_used_at).length,R=Math.max(0,c-O),D=Math.max(0,s-c),u=e.filter(a=>!w(a)&&a.last_used_at).length,P=Math.max(0,D-u),A=e.filter(a=>!a.last_used_at).length,J=Math.max(0,s-A),$=Date.now(),U=e.filter(a=>w(a)&&x(a.expires_at,$).hasExpiry&&!x(a.expires_at,$).expired).length,K=e.filter(a=>w(a)&&x(a.expires_at,$).expired).length,G=e.filter(a=>w(a)&&x(a.expires_at,$).expiringSoon).length,z=e.filter(a=>w(a)&&!x(a.expires_at,$).hasExpiry).length,L=e.map(a=>x(a.expires_at,$)),j=n.map(a=>x(a.expires_at,$)),I=p.map(a=>x(a.expires_at,$)),Y=L.filter(a=>a.hasExpiry).length,F=L.filter(a=>a.hasExpiry&&!a.expired).length,Z=L.filter(a=>a.expired).length,Q=L.filter(a=>a.expiringSoon).length,N=j.filter(a=>a.hasExpiry&&!a.expired).length,ie=j.filter(a=>a.expired).length,be=j.filter(a=>a.expiringSoon).length,ve=j.filter(a=>!a.hasExpiry).length,fe=I.filter(a=>a.hasExpiry&&!a.expired).length,ye=I.filter(a=>a.expired).length,ge=I.filter(a=>a.expiringSoon).length,he=I.filter(a=>!a.hasExpiry).length,me=e.filter(a=>!w(a)&&x(a.expires_at,$).hasExpiry&&!x(a.expires_at,$).expired).length,$e=e.filter(a=>!w(a)&&x(a.expires_at,$).expired).length,xe=e.filter(a=>!w(a)&&x(a.expires_at,$).expiringSoon).length,_e=e.filter(a=>!w(a)&&!x(a.expires_at,$).hasExpiry).length,we=L.filter(a=>!a.hasExpiry).length,Se=Xe(t,l),le=i.filter(a=>w(a)).length,Ee=Math.max(0,i.length-le),Ce=i.filter(a=>{if(!w(a))return!1;const re=x(a.expires_at,$);return re.hasExpiry&&!re.expired}).length,qe=i.filter(a=>w(a)?x(a.expires_at,$).expired:!1).length,ke=i.filter(a=>w(a)?x(a.expires_at,$).expiringSoon:!1).length,ne=i.filter(a=>w(a)&&a.last_used_at).length,Le=Math.max(0,le-ne),Te=i.filter(a=>!w(a)&&a.last_used_at).length,Be=i.filter(a=>w(a)?!1:x(a.expires_at,$).expired).length,Me=i.filter(a=>w(a)?!1:x(a.expires_at,$).expiringSoon).length,Pe=i.filter(a=>w(a)?!1:!x(a.expires_at,$).hasExpiry).length,oe=i.filter(a=>a.is_active||a.active).length,Ae=Math.max(0,i.length-oe),de=i.filter(a=>a.last_used_at).length,je=Math.max(0,i.length-de),Ie=i.filter(a=>{const re=x(a.expires_at,$);return re.hasExpiry&&!re.expired}).length,Ne=i.filter(a=>x(a.expires_at,$).expired).length,rt=i.filter(a=>x(a.expires_at,$).expiringSoon).length,st=i.filter(a=>!x(a.expires_at,$).hasExpiry).length,at=t?"":`，激活 ${oe} 个，未激活 ${Ae} 个`,nt=t||l?`，筛选结果完整 ${le} 个，完整且有效 ${Ce} 个，完整且已过期 ${qe} 个，完整且即将过期 ${ke} 个，完整且已使用 ${ne} 个，完整但未使用 ${Le} 个，缺字段 ${Ee} 个，缺字段但已使用 ${Te} 个，缺字段且已过期 ${Be} 个，缺字段且即将过期 ${Me} 个，缺字段且未设置过期 ${Pe} 个${at}，已使用 ${de} 个，从未使用 ${je} 个，有效 ${Ie} 个，已过期 ${Ne} 个，即将过期 ${rt} 个，未设置过期 ${st} 个`:"";return`共 ${s} 个凭证，激活中 ${o} 个，未激活 ${b} 个，激活且完整 ${h} 个，未激活但完整 ${m} 个，激活但缺字段 ${_} 个，未激活且缺字段 ${y} 个，激活且已使用 ${f} 个，激活但从未使用 ${C} 个，未激活且已使用 ${E} 个，未激活但从未使用 ${W} 个，激活且有效 ${N} 个，未激活且有效 ${fe} 个，激活已过期 ${ie} 个，未激活已过期 ${ye} 个，激活即将过期 ${be} 个，未激活即将过期 ${ge} 个，激活未设置过期 ${ve} 个，未激活未设置过期 ${he} 个，字段完整 ${c} 个，完整且有效 ${U} 个，完整且已过期 ${K} 个，完整即将过期 ${G} 个，完整未设置过期 ${z} 个，完整且已使用 ${O} 个，完整但未使用 ${R} 个，字段缺失 ${D} 个，缺字段但已使用 ${u} 个，缺字段且未使用 ${P} 个，缺字段但有效 ${me} 个，缺字段且已过期 ${$e} 个，缺字段即将过期 ${xe} 个，缺字段未设置过期 ${_e} 个，已使用 ${J} 个，从未使用 ${A} 个，设置过期时间 ${Y} 个，有效 ${F} 个，已过期 ${Z} 个，即将过期 ${Q} 个，未设置 ${we} 个；筛选: ${Se}，当前展示 ${r} 个${nt}`}function et(e,t="",l=""){const r=Date.now();return e.filter(s=>{const i=s.is_active||s.active;if(t==="active"&&!i||t==="inactive"&&i)return!1;const n=x(s.expires_at,r);return!(l==="expired"&&!n.expired||l==="expiring"&&!n.expiringSoon||l==="valid"&&(!n.hasExpiry||n.expired)||l==="unset"&&n.hasExpiry)})}function hi(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${Xe(e,t)}）`:"暂无凭证"}function Ge(e,t,l){const r=e.querySelector(l);t.forEach(s=>{const i=e.querySelector(s);i==null||i.addEventListener("keydown",n=>{n.key==="Enter"&&(n.preventDefault(),r.disabled||r.click())})})}async function mi(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function l(){var n,p,o,b,c,h,m,_,y,f,C,E,W,O,R,D;const i=e.querySelector("#bili-status-cards");i.innerHTML='<div class="page-loading">加载中...</div>';try{const u=await k.getBilibiliStatus(),P=Number((u==null?void 0:u.video_count)??0),A=Number(((n=u==null?void 0:u.videos)==null?void 0:n.poll_enabled_count)??0),J=Math.max(0,P-A),$=Pt(A,P),U=!!((p=u==null?void 0:u.diagnostics)!=null&&p.ready),K=Lt((o=u==null?void 0:u.diagnostics)==null?void 0:o.blocking_reasons),G=Fe(u==null?void 0:u.credential,"未配置"),z=!!(((c=(b=u==null?void 0:u.diagnostics)==null?void 0:b.signals)==null?void 0:c.credential_present)??((m=(h=u==null?void 0:u.diagnostics)==null?void 0:h.release_gates)==null?void 0:m.credential_present)),L=!!(((y=(_=u==null?void 0:u.diagnostics)==null?void 0:_.signals)==null?void 0:y.credential_complete)??((C=(f=u==null?void 0:u.diagnostics)==null?void 0:f.release_gates)==null?void 0:C.credential_complete)),j=bi(z,L),I=vi(u==null?void 0:u.diagnostics),Y=Tt((E=u==null?void 0:u.diagnostics)==null?void 0:E.effective_publish_mode),F=fi(u==null?void 0:u.diagnostics),Z=Bt((W=u==null?void 0:u.config)==null?void 0:W.poll_interval_seconds),Q=Mt((O=u==null?void 0:u.config)==null?void 0:O.rate_limit_per_minute),N=x((R=u==null?void 0:u.credential)==null?void 0:R.expires_at),ie=jt((D=u==null?void 0:u.credential)==null?void 0:D.last_used_at);i.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${ui(N)}">${d(N.label)}</div>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${_.map(f=>`<tr data-id="${d(f.id||f.video_id)}">
              <td class="cell-id">${ai(f)}</td>
              <td class="cell-truncate">${ni(f)}</td>
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),l=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}l.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await Ye.getComment(t);l.innerHTML=`
      ...
      `;const s=l.querySelector("#query-goto-comment");s&&s.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=s.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){l.innerHTML=`<div class="page-error">查询失败: ${d(r.message)}</div>`}})}const De={dashboard:{render:Qe,title:"仪表盘"},jobs:{render:ut,title:"任务管理"},"daily-metrics":{render:bt,title:"每日指标"},knowledge:{render:vt,title:"知识库"},"role-cards":{render:ft,title:"角色卡"},profiles:{render:yt,title:"风格配置"},gateway:{render:ht,title:"网关"},audit:{render:mt,title:"审计日志"},bilibili:{render:mi,title:"B站集成"},query:{render:$i,title:"查询"}};let tt=null;function xi(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function it(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function lt(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function _i(e){e.preventDefault();const t=document.getElementById("login-api-key"),l=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await g("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),lt(),We("dashboard")}catch{l.textContent="API Key 无效或服务不可用",l.style.display="block",window.__ADMIN_API_KEY__=""}}}function wi(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",it()}function We(e){if(!De[e])return;tt=e,document.querySelectorAll("#nav-list .nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===e)}),document.getElementById("page-title").textContent=De[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',De[e].render(t).catch(l=>{t.innerHTML=`<div class="page-error">加载失败: ${l.message}</div>`})}function Si(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==tt&&We(t)})})}function Ei(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),l=document.getElementById("expand-left-btn");t&&l&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),l.style.display="block"}),l.addEventListener("click",()=>{e.classList.remove("collapsed"),l.style.display="none"}))}function Ci(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let l=0;e.addEventListener("click",()=>{l=(l+1)%t.length,t[l]?document.body.setAttribute("data-theme",t[l]):document.body.removeAttribute("data-theme")})}function qi(){Ei(),Ci(),Si(),document.getElementById("login-form").addEventListener("submit",_i),document.getElementById("logout-btn").addEventListener("click",wi),xi()?(lt(),We("dashboard")):it()}qi();
