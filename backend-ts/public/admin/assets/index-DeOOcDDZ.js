(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function i(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(s){if(s.ep)return;s.ep=!0;const l=i(s);fetch(s.href,l)}})();function $t(e,t,i){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof i=="string"&&i.trim()?i.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function st(){return(window.__ADMIN_API_KEY__||"").trim()}async function g(e,t={}){const i=st(),r=new Headers(t.headers||{});i&&r.set("x-api-key",i);const s=await fetch(e,{...t,headers:r}),l=await s.json().catch(()=>({}));if(!s.ok){const n=(l==null?void 0:l.detail)||(l==null?void 0:l.error);throw new Error($t(n,s.status,s.statusText))}return l}async function Qe(e,t){const i=st(),r=new Headers;i&&r.set("x-api-key",i);const s=await fetch(e,{headers:r});if(!s.ok)throw new Error("download_failed");const l=await s.blob(),n=URL.createObjectURL(l),p=document.createElement("a");p.href=n,p.download=t,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(n)}function P(e){const t=new URLSearchParams;for(const[r,s]of Object.entries(e))s!=null&&s!==""&&t.set(r,String(s));const i=t.toString();return i?`?${i}`:""}function A(){return{getOverview(){return g("/api/admin/overview")},getJobs({status:e,limit:t}={}){return g(`/api/admin/jobs${P({status:e,limit:t})}`)},getJob(e){return g(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return g(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return g(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return g("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return g("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return Qe(`/export/jobs.csv${P({status:e,limit:t})}`,"jobs.csv")},getComment(e){return g(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return g(`/api/admin/gateway/logs${P({limit:e,comment_id:t})}`)},publishGatewayReply(e){return g("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:i}={}){return g(`/api/admin/audit/summary${P({days:e,action:t,ok:i})}`)},getAuditLogs({limit:e,action:t,ok:i}={}){return g(`/api/audit-log${P({limit:e,action:t,ok:i})}`)},exportAuditCsv({limit:e,action:t,ok:i}={}){return Qe(`/export/audit-logs.csv${P({limit:e,action:t,ok:i})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return g(`/api/metrics/daily${P({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return g(`/api/admin/knowledge${P({limit:e,offset:t})}`)},createKnowledgeEntry(e){return g("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return g(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return g(`/api/admin/role-cards${P({limit:e,offset:t})}`)},createRoleCard(e){return g("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return g(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return g("/api/admin/style-profile")},setStyleProfile(e){return g("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return g("/api/admin/role-profile")},setRoleProfile(e){return g("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return g("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:i}={}){return g(`/api/admin/bilibili/videos${P({poll_enabled:e,limit:t,offset:i})}`)},addBilibiliVideo(e){return g("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return g("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return g("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return g("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function d(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function L(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function at(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const i=Date.now()-t.getTime(),r=Math.floor(i/1e3);if(r<60)return"刚刚";const s=Math.floor(r/60);if(s<60)return`${s}分钟前`;const l=Math.floor(s/60);if(l<24)return`${l}小时前`;const n=Math.floor(l/24);if(n<30)return`${n}天前`;const p=Math.floor(n/30);return p<12?`${p}个月前`:`${Math.floor(p/12)}年前`}catch{return""}}function ue(e){const t=at(e),i=L(e);return t?`<span title="${d(i)}">${d(t)}</span>`:`<span title="${d(i)}">${d(i)}</span>`}function j(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const xt={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function Ye(e){if(!e)return"";const t=xt[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${d(t.label)}</span>`}function Ge(e,t="是",i="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${d(e?t:i)}</span>`}let We=null;function v(e,t="info"){const i=document.getElementById("app-toast");i&&i.remove(),We&&clearTimeout(We);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},s=document.createElement("div");s.id="app-toast",s.className="toast-notification",s.style.setProperty("--toast-color",r[t]||r.info),s.innerHTML=`
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("show"));const l=()=>{s.classList.remove("show"),setTimeout(()=>s.remove(),300)};s.querySelector(".toast-close").onclick=l,We=setTimeout(l,4e3)}const we=A();async function nt(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,i,r,s]=await Promise.all([we.getOverview().catch(()=>null),we.getJobs({limit:5}).catch(()=>null),we.getGatewayLogs({limit:5}).catch(()=>null),we.getAuditSummary({days:7}).catch(()=>null)]),l=t||{},n=Array.isArray(i==null?void 0:i.items)?i.items:[],p=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{v("正在刷新...","info"),nt(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${d(t.message)}</div>`}}const de=A();async function _t(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;const i=e.querySelector("#jobs-status"),r=e.querySelector("#jobs-limit");async function s(){var p;t.clear(),l();const n=e.querySelector("#jobs-table-wrapper");n.innerHTML='<div class="page-loading">加载中...</div>';try{const o=await de.getJobs({status:i.value,limit:r.value}),b=Array.isArray(o==null?void 0:o.items)?o.items:[];if(b.length===0){n.innerHTML='<div class="table-empty">暂无任务</div>';return}n.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `,(p=n.querySelector("#jobs-select-all"))==null||p.addEventListener("change",u=>{const h=u.target.checked;n.querySelectorAll(".job-checkbox").forEach($=>{$.checked=h,h?t.add($.dataset.id):t.delete($.dataset.id)}),l()}),n.querySelectorAll(".job-checkbox").forEach(u=>{u.addEventListener("change",()=>{u.checked?t.add(u.dataset.id):t.delete(u.dataset.id),l()})}),n.querySelectorAll(".job-approve").forEach(u=>{u.addEventListener("click",async()=>{u.disabled=!0,u.textContent="审批中...";try{await de.approveJob(u.dataset.id),v("审批成功","success"),s()}catch(h){v(`审批失败: ${h.message}`,"error"),u.disabled=!1,u.textContent="审批"}})}),n.querySelectorAll(".job-retry").forEach(u=>{u.addEventListener("click",async()=>{u.disabled=!0,u.textContent="重试中...";try{await de.retryJob(u.dataset.id),v("重试已提交","success"),s()}catch(h){v(`重试失败: ${h.message}`,"error"),u.disabled=!1,u.textContent="重试"}})})}catch(o){n.innerHTML=`<div class="page-error">加载失败: ${d(o.message)}</div>`}}function l(){const n=e.querySelector("#jobs-batch-bar"),p=e.querySelector("#jobs-selected-count");t.size>0?(n.style.display="flex",p.textContent=`已选 ${t.size} 项`):n.style.display="none"}e.querySelector("#jobs-filter-btn").addEventListener("click",s),e.querySelector("#jobs-refresh").addEventListener("click",s),e.querySelector("#jobs-export").addEventListener("click",async()=>{try{await de.exportJobsCsv({status:i.value,limit:r.value}),v("导出成功","success")}catch(n){v(`导出失败: ${n.message}`,"error")}}),e.querySelector("#jobs-batch-approve").addEventListener("click",async()=>{if(t.size!==0)try{await de.batchApprove([...t]),v(`批量审批 ${t.size} 项成功`,"success"),s()}catch(n){v(`批量审批失败: ${n.message}`,"error")}}),e.querySelector("#jobs-batch-retry").addEventListener("click",async()=>{if(t.size!==0)try{await de.batchRetry([...t]),v(`批量重试 ${t.size} 项成功`,"success"),s()}catch(n){v(`批量重试失败: ${n.message}`,"error")}}),await s()}const wt=A();async function St(e){e.innerHTML=`
    <div class="page-header">
      <h2>每日指标</h2>
      <div class="page-actions">
  ...
  `;async function t(){const i=e.querySelector("#knowledge-table-wrapper");i.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await Je.getKnowledgeEntries({limit:50}),s=Array.isArray(r==null?void 0:r.items)?r.items:[];if(s.length===0){i.innerHTML='<div class="table-empty">暂无知识条目</div>';return}i.innerHTML=`
        <table class="data-table">
          <thead><tr>
            <th>ID</th><th>分类</th><th>标题</th><th>内容</th><th>启用</th><th>时间</th><th>操作</th>
          </tr></thead>
          <tbody>
            ${s.map(l=>{var n,p;return`<tr>
              <td class="cell-id">${d((n=l.id)==null?void 0:n.toString().substring(0,8))}</td>
              <td>${d(l.category)}</td>
              <td>${d(l.title)}</td>
              <td class="cell-truncate">${d((p=l.content)==null?void 0:p.substring(0,80))}</td>
              <td>${Ge(l.enabled!==!1)}</td>
              <td class="cell-time">${ue(l.created_at)}</td>
              <td class="cell-actions">
      ...
      `,i.querySelectorAll(".knowledge-disable").forEach(l=>{l.addEventListener("click",async()=>{try{await Je.disableKnowledgeEntry(l.dataset.id),v("已禁用","success"),t()}catch(n){v(`操作失败: ${n.message}`,"error")}})})}catch(r){i.innerHTML=`<div class="page-error">加载失败: ${d(r.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const i=e.querySelector("#knowledge-category").value.trim(),r=e.querySelector("#knowledge-title").value.trim(),s=e.querySelector("#knowledge-content").value.trim();if(!r||!s){v("标题和内容不能为空","warning");return}try{await Je.createKnowledgeEntry({category:i,title:r,content:s}),v("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(l){v(`创建失败: ${l.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const fe=A();let ye=!1,S=null;async function Ct(e){ye=!1,S=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const[i,r]=await Promise.all([Se.getStyleProfile().catch(()=>null),Se.getRoleProfile().catch(()=>null)]);i!=null&&i.style&&(e.querySelector("#profile-style").value=i.style,e.querySelector("#profile-style-current").textContent=`当前: ${i.style}`),r!=null&&r.role&&(e.querySelector("#profile-role").value=r.role,e.querySelector("#profile-role-current").textContent=`当前: ${r.role}`)}catch(i){v(`加载配置失败: ${i.message}`,"error")}}e.querySelector("#profile-style-apply").addEventListener("click",async()=>{const i=e.querySelector("#profile-style").value;try{await Se.setStyleProfile(i),e.querySelector("#profile-style-current").textContent=`当前: ${i}`,v("风格已更新","success")}catch(r){v(`更新失败: ${r.message}`,"error")}}),e.querySelector("#profile-role-apply").addEventListener("click",async()=>{const i=e.querySelector("#profile-role").value;try{await Se.setRoleProfile(i),e.querySelector("#profile-role-current").textContent=`当前: ${i}`,v("角色配置已更新","success")}catch(r){v(`更新失败: ${r.message}`,"error")}}),await t()}function Lt({columns:e,rows:t,empty:i="暂无数据"}){if(!t||t.length===0)return`<div class="table-empty">${d(i)}</div>`;const r=e.map(l=>`<th class="${l.class||""}">${d(l.label)}</th>`).join(""),s=t.map(l=>`<tr>${e.map(n=>`<td class="${n.class||""}">${n.render?n.render(l):d(l[n.key])}</td>`).join("")}</tr>`).join("");return`
    <div class="table-wrapper">
      <table class="data-table">
        <thead><tr>${r}</tr></thead>
        <tbody>${s}</tbody>
  ...
  `;const t=e.querySelector("#gw-reply"),i=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{i.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const s=e.querySelector("#gw-publish-btn"),l=e.querySelector("#gw-comment-id").value.trim(),n=e.querySelector("#gw-reply").value.trim(),p=e.querySelector("#gw-source").value.trim(),o=e.querySelector("#gw-force").checked;if(!l||!n){v("Comment ID 和回复内容不能为空","warning");return}s.disabled=!0,s.textContent="发布中...";try{await Xe.publishGatewayReply({comment_id:l,reply_text:n,source:p,force_publish:o}),v("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",i.textContent="0/0",r()}catch(b){v(`发布失败: ${b.message}`,"error")}finally{s.disabled=!1,s.textContent="发布"}});async function r(){const s=e.querySelector("#gw-table-wrapper"),l=e.querySelector("#gw-limit").value;s.innerHTML='<div class="page-loading">加载中...</div>';try{const n=await Xe.getGatewayLogs({limit:l}),p=Array.isArray(n==null?void 0:n.items)?n.items:[];if(p.length===0){s.innerHTML='<div class="table-empty">暂无网关日志</div>';return}s.innerHTML=Lt({columns:[{key:"id",label:"ID",class:"cell-id",render:o=>{var b;return d((b=o.id)==null?void 0:b.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:o=>{var b;return d((b=o.comment_id)==null?void 0:b.substring(0,12))}},{key:"status",label:"状态",render:o=>Ye(o.status)},{key:"platform",label:"平台",render:o=>d(o.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:o=>{var b;return d((b=o.reply_text)==null?void 0:b.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:o=>ue(o.created_at)}],rows:p})}catch(n){s.innerHTML=`<div class="page-error">加载失败: ${d(n.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",r),e.querySelector("#gw-filter-btn").addEventListener("click",r),await r()}const Ke=A();async function Tt(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const r=await Ke.getAuditSummary({days:7}),s=e.querySelector("#audit-summary-cards");s.innerHTML=`
      ...
      `}catch(p){r.innerHTML=`<div class="page-error">加载失败: ${d(p.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),i()}),e.querySelector("#audit-filter-btn").addEventListener("click",i),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await Ke.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(r){v(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),i()])}const B=A(),Bt=/^BV[a-zA-Z0-9]{10}$/,Mt={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},Pt={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},At={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},Nt={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},Ee={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},ce=50,It=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return Mt[t]||t}function jt(e){return e?Bt.test(e)?null:"invalid_bvid_format":"bvid_required"}function Ht(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Rt(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Ot(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(i=>Pt[i]||i).join("；")}function Dt(e){const t=String(e??"").trim().toLowerCase();return At[t]||t||"-"}function Fe(e,t,i){return e?t:i}function Ut(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Vt(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"";if(t<60){const s=60/t;return`约每分钟 ${s.toFixed(s>=10?0:1).replace(/\.0$/,"")} 轮`}if(t<3600){const s=3600/t;return`约每小时 ${s.toFixed(s>=10?0:1).replace(/\.0$/,"")} 轮`}const i=t/3600;return`约每 ${i.toFixed(i>=10?0:1).replace(/\.0$/,"")} 小时 1 轮`}function Wt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function Jt(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"";const i=t/60;if(i>=1)return`约每秒 ${i.toFixed(i>=10?0:1).replace(/\.0$/,"")} 次`;const r=60/t;return`约每 ${r.toFixed(r>=10?0:1).replace(/\.0$/,"")} 秒 1 次`}function et(e,t,i="覆盖率"){const r=Number(t??0);if(!Number.isFinite(r)||r<=0)return"暂无视频";const s=Number(e??0),n=((Number.isFinite(s)?Math.min(r,Math.max(0,s)):0)/r*100).toFixed(1).replace(/\.0$/,"");return`${i} ${n}%`}function Kt(e,t){const i=Number(e??0);if(!Number.isFinite(i)||i<=0)return"暂无视频";const r=Number(t??0),s=Number.isFinite(r)?Math.min(i,Math.max(0,r)):0,l=Math.max(0,i-s);return`轮询中 ${s}，停用 ${l}`}function Ft(e,t,i){const r=String(e??"").trim().toLowerCase();if(!r)return"-";const s=Nt[r]||{label:r,cls:"badge-muted"},l=r==="error"&&t?Ee[String(t).trim().toLowerCase()]||String(t):"",n=l?` title="${d(l)}"`:"",p=typeof i=="number"&&Number.isFinite(i)?`评论游标: ${i}`:"",o=[l,p].filter(Boolean).map(b=>`<div class="form-hint" style="margin-top:4px;">${d(b)}</div>`).join("");return`<span class="status-badge ${s.cls}"${n}>${d(s.label)}</span>${o}`}function zt(e){if(e==="true")return!0;if(e==="false")return!1}function Gt(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function V(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Yt(e){return e.filter(t=>!V(t)).length}function Zt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function Qt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!V(t)).length}function Xt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&V(t)).length}function ei(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function ti(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ii(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function li(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ri(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function si(e){return e.filter(t=>{const i=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return i==="ok"||i==="no_new"}).length}function ai(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function ni(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function oi(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function di(e){return e.filter(t=>V(t)&&!(t!=null&&t.last_polled_at)).length}function ci(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function ui(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function pi(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function bi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function vi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&Number((t==null?void 0:t.comment_count)??0)<=0).length}function fi(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function yi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function gi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function hi(e){return e.filter(t=>V(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function mi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(V(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function $i(e){return e.reduce((t,i)=>{const r=Number((i==null?void 0:i.comment_count)??0);return t+(Number.isFinite(r)&&r>0?r:0)},0)}function xi(e){const i=V(e)?`aid: ${e.aid}`:Ee.no_aid;return`${d((e==null?void 0:e.bvid)||"-")}${i?`<div class="form-hint" style="margin-top:4px;">${d(i)}</div>`:""}`}function _i(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(`更新: ${L(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${L(e.created_at)}`),`${d((e==null?void 0:e.title)||"-")}${t.map(i=>`<div class="form-hint" style="margin-top:4px;">${d(i)}</div>`).join("")}`}function wi(e){const t=V(e),i=t?"":" disabled",r=t?"":` title="${d(Ee.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${d(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${i}${r}>同步</button>`}function Si(e,t,i,r=0,s=ce,l=[]){const n=i==="true"?"轮询中":i==="false"?"已停用":"全部",p=Math.floor(r/s)+1,o=Math.max(1,Math.ceil(e/s)),b=Zt(l),u=Math.max(0,l.length-b),h=Qt(l),$=Xt(l),w=ei(l),y=ti(l),f=ii(l),C=li(l),E=Yt(l),W=Math.max(0,l.length-E),H=ri(l),J=si(l),R=ai(l),O=ni(l),c=oi(l),k=di(l),N=Math.max(0,l.length-c),m=ui(l),Y=Math.max(0,l.length-m),K=pi(l),Z=Math.max(0,l.length-K),D=bi(l),T=Math.max(0,l.length-D),I=vi(l),M=fi(l),Q=yi(l),X=gi(l),ee=Math.max(0,l.length-M),te=ci(l),F=hi(l),ie=Math.max(0,l.length-F),le=mi(l),re=$i(l),pe=E>0?`，当前页缺少 aid ${E} 条`:"",se=i===""&&b>0?`，当前页轮询开启 ${b} 条`:"",be=i===""&&u>0?`，当前页轮询停用 ${u} 条`:"",ae=i===""&&h>0?`，轮询开启但缺少 aid ${h} 条`:"",z=i===""&&$>0?`，轮询停用但可同步 ${$} 条`:"",ne=i===""&&w>0?`，轮询停用且从未轮询 ${w} 条`:"",G=i===""&&y>0?`，轮询停用且已有轮询记录 ${y} 条`:"",Ce=i===""&&f>0?`，轮询开启但尚未轮询 ${f} 条`:"",qe=i===""&&C>0?`，轮询开启且已有轮询记录 ${C} 条`:"",Le=W>0?`，可同步 ${W} 条`:"",oe=J>0?`，正常轮询 ${J} 条`:"",ve=R>0?`，成功轮询 ${R} 条`:"",ke=O>0?`，无新增 ${O} 条`:"",Te=H>0?`，轮询失败 ${H} 条`:"",Be=N>0?`，已有轮询记录 ${N} 条`:"",Me=c>0?`，尚未轮询 ${c} 条`:"",ge=k>0?`，可同步但尚未轮询 ${k} 条`:"",Pe=m>0?`，已识别 UP 主 ${m} 条`:"",he=Y>0?`，缺少 UP 主 ${Y} 条`:"",Ae=K>0?`，已抓取标题 ${K} 条`:"",me=Z>0?`，缺少标题 ${Z} 条`:"",Ne=F>0?`，信息完整 ${F} 条`:"",Ie=ie>0?`，信息不完整 ${ie} 条`:"",je=le>0?`，已轮询但信息不完整 ${le} 条`:"",He=D>0?`，已有评论视频 ${D} 条`:"",Re=T>0?`，无评论视频 ${T} 条`:"",$e=I>0?`，已轮询但无评论 ${I} 条`:"",Oe=M>0?`，已有评论游标 ${M} 条`:"",xe=Q>0?`，有评论但无游标 ${Q} 条`:"",De=X>0?`，无评论但有游标 ${X} 条`:"",_e=ee>0?`，无评论游标 ${ee} 条`:"",Ue=te>0?`，已轮询但无游标 ${te} 条`:"",Ve=re>0?`，关联评论 ${re} 条`:"";return`筛选: ${n}，共 ${e} 条，当前展示 ${t} 条，第 ${p}/${o} 页${se}${be}${pe}${ae}${z}${ne}${G}${Ce}${qe}${Le}${oe}${ve}${ke}${Te}${Be}${Me}${ge}${Pe}${he}${Ae}${me}${Ne}${Ie}${je}${He}${Re}${$e}${Oe}${xe}${De}${_e}${Ue}${Ve}`}function tt(e,t={}){const i=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),s=Number((e==null?void 0:e.events_injected)??r),l=t.subject||(i===1?"视频":"轮询");return r>0||s>0?`${l}完成，处理 ${i} 个视频，新增 ${r} 条评论，注入 ${s} 个事件。`:i>0?`${l}完成，处理 ${i} 个视频，暂无新增评论。`:`${l}完成，暂无可处理视频。`}function x(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const i=new Date(e);if(Number.isNaN(i.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const r=i.getTime()-t;return r<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:L(e)}:r<=It?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:L(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:L(e)}}function Ei(e){const t=x(e),i=t.detail||(t.hasExpiry?"":"未设置过期时间"),r=i?`<div class="form-hint" style="margin-top:4px;">${d(i)}</div>`:"";return`<span class="status-badge ${t.cls}">${d(t.label)}</span>${r}`}function it(e,t="-"){const i=[];return e!=null&&e.updated_at&&i.push(`更新: ${L(e.updated_at)}`),e!=null&&e.created_at&&i.push(`创建: ${L(e.created_at)}`),`${d((e==null?void 0:e.name)||t)}${i.map(r=>`<div class="form-hint" style="margin-top:4px;">${d(r)}</div>`).join("")}`}function Ci(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function qi(e){if(!e)return{label:"未配置",detail:""};if(e!=null&&e.last_used_at)return{label:at(e.last_used_at)||"已使用",detail:L(e.last_used_at)};const t=[];return e!=null&&e.updated_at&&t.push(`更新: ${L(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${L(e.created_at)}`),{label:"从未使用",detail:t.join("，")}}function _(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function Li(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function ki(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function Ti(e){var n,p,o,b,u,h;const t=!!((p=(n=e==null?void 0:e.checks)==null?void 0:n.auth)!=null&&p.ready),i=!!((b=(o=e==null?void 0:e.checks)==null?void 0:o.worker_or_publish)!=null&&b.ready),r=!!((u=e==null?void 0:e.signals)!=null&&u.polling_worker_enabled),s=!!((h=e==null?void 0:e.signals)!=null&&h.native_publish_enabled);return r||s?`${t?"鉴权已就绪":"鉴权未就绪"}，${i?"执行链路可用":"执行链路阻塞"}`:"当前无需鉴权"}function Bi(e){var s,l,n;const t=!!((s=e==null?void 0:e.signals)!=null&&s.publish_mode_config_ready),i=!!((l=e==null?void 0:e.signals)!=null&&l.native_publish_enabled),r=!!((n=e==null?void 0:e.signals)!=null&&n.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",i?"原生发布启用":"原生发布停用",r?"轮询链路启用":"轮询链路停用"].join("，")}function Mi(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",i=_(e)?"字段完整":`缺少 ${Li(e).join(" / ")}`;return`${d(t)}${i?`<div class="form-hint" style="margin-top:4px;">${d(i)}</div>`:""}`}function ot(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function Pi(e,t="",i="",r=e.length){const s=e.length,l=dt(e,t,i),n=e.filter(a=>a.is_active||a.active),p=e.filter(a=>!(a.is_active||a.active)),o=n.length,b=p.length,u=e.filter(a=>_(a)).length,h=e.filter(a=>(a.is_active||a.active)&&_(a)).length,$=Math.max(0,u-h),w=Math.max(0,o-h),y=Math.max(0,b-$),f=n.filter(a=>a.last_used_at).length,C=Math.max(0,o-f),E=p.filter(a=>a.last_used_at).length,W=Math.max(0,b-E),H=e.filter(a=>_(a)&&a.last_used_at).length,J=Math.max(0,u-H),R=Math.max(0,s-u),O=e.filter(a=>!_(a)&&a.last_used_at).length,c=Math.max(0,R-O),k=e.filter(a=>!a.last_used_at).length,N=Math.max(0,s-k),m=Date.now(),Y=e.filter(a=>_(a)&&x(a.expires_at,m).hasExpiry&&!x(a.expires_at,m).expired).length,K=e.filter(a=>_(a)&&x(a.expires_at,m).expired).length,Z=e.filter(a=>_(a)&&x(a.expires_at,m).expiringSoon).length,D=e.filter(a=>_(a)&&!x(a.expires_at,m).hasExpiry).length,T=e.map(a=>x(a.expires_at,m)),I=n.map(a=>x(a.expires_at,m)),M=p.map(a=>x(a.expires_at,m)),Q=T.filter(a=>a.hasExpiry).length,X=T.filter(a=>a.hasExpiry&&!a.expired).length,ee=T.filter(a=>a.expired).length,te=T.filter(a=>a.expiringSoon).length,F=I.filter(a=>a.hasExpiry&&!a.expired).length,ie=I.filter(a=>a.expired).length,le=I.filter(a=>a.expiringSoon).length,re=I.filter(a=>!a.hasExpiry).length,pe=M.filter(a=>a.hasExpiry&&!a.expired).length,se=M.filter(a=>a.expired).length,be=M.filter(a=>a.expiringSoon).length,ae=M.filter(a=>!a.hasExpiry).length,z=e.filter(a=>!_(a)&&x(a.expires_at,m).hasExpiry&&!x(a.expires_at,m).expired).length,ne=e.filter(a=>!_(a)&&x(a.expires_at,m).expired).length,G=e.filter(a=>!_(a)&&x(a.expires_at,m).expiringSoon).length,Ce=e.filter(a=>!_(a)&&!x(a.expires_at,m).hasExpiry).length,qe=T.filter(a=>!a.hasExpiry).length,Le=ot(t,i),oe=l.filter(a=>_(a)).length,ve=Math.max(0,l.length-oe),ke=l.filter(a=>{if(!_(a))return!1;const U=x(a.expires_at,m);return U.hasExpiry&&!U.expired}).length,Te=l.filter(a=>_(a)?x(a.expires_at,m).expired:!1).length,Be=l.filter(a=>_(a)?x(a.expires_at,m).expiringSoon:!1).length,Me=l.filter(a=>_(a)?!x(a.expires_at,m).hasExpiry:!1).length,ge=l.filter(a=>_(a)&&(a.is_active||a.active)).length,Pe=Math.max(0,oe-ge),he=l.filter(a=>_(a)&&a.last_used_at).length,Ae=Math.max(0,oe-he),me=l.filter(a=>!_(a)&&a.last_used_at).length,Ne=Math.max(0,ve-me),Ie=l.filter(a=>{if(_(a))return!1;const U=x(a.expires_at,m);return U.hasExpiry&&!U.expired}).length,je=l.filter(a=>_(a)?!1:x(a.expires_at,m).expired).length,He=l.filter(a=>_(a)?!1:x(a.expires_at,m).expiringSoon).length,Re=l.filter(a=>_(a)?!1:!x(a.expires_at,m).hasExpiry).length,$e=l.filter(a=>!_(a)&&(a.is_active||a.active)).length,Oe=Math.max(0,ve-$e),xe=l.filter(a=>a.is_active||a.active).length,De=Math.max(0,l.length-xe),_e=l.filter(a=>a.last_used_at).length,Ue=Math.max(0,l.length-_e),Ve=l.filter(a=>{const U=x(a.expires_at,m);return U.hasExpiry&&!U.expired}).length,bt=l.filter(a=>x(a.expires_at,m).expired).length,vt=l.filter(a=>x(a.expires_at,m).expiringSoon).length,ft=l.filter(a=>!x(a.expires_at,m).hasExpiry).length,yt=t?"":`，激活 ${xe} 个，未激活 ${De} 个`,gt=t?"":`，完整且激活 ${ge} 个，完整但未激活 ${Pe} 个`,ht=t?"":`，缺字段且激活 ${$e} 个，缺字段且未激活 ${Oe} 个`,mt=t||i?`，筛选结果完整 ${oe} 个${gt}，完整且有效 ${ke} 个，完整且已过期 ${Te} 个，完整且即将过期 ${Be} 个，完整且未设置过期 ${Me} 个，完整且已使用 ${he} 个，完整但未使用 ${Ae} 个，缺字段 ${ve} 个${ht}，缺字段但已使用 ${me} 个，缺字段且从未使用 ${Ne} 个，缺字段但有效 ${Ie} 个，缺字段且已过期 ${je} 个，缺字段且即将过期 ${He} 个，缺字段且未设置过期 ${Re} 个${yt}，已使用 ${_e} 个，从未使用 ${Ue} 个，有效 ${Ve} 个，已过期 ${bt} 个，即将过期 ${vt} 个，未设置过期 ${ft} 个`:"";return`共 ${s} 个凭证，激活中 ${o} 个，未激活 ${b} 个，激活且完整 ${h} 个，未激活但完整 ${$} 个，激活但缺字段 ${w} 个，未激活且缺字段 ${y} 个，激活且已使用 ${f} 个，激活但从未使用 ${C} 个，未激活且已使用 ${E} 个，未激活但从未使用 ${W} 个，激活且有效 ${F} 个，未激活且有效 ${pe} 个，激活已过期 ${ie} 个，未激活已过期 ${se} 个，激活即将过期 ${le} 个，未激活即将过期 ${be} 个，激活未设置过期 ${re} 个，未激活未设置过期 ${ae} 个，字段完整 ${u} 个，完整且有效 ${Y} 个，完整且已过期 ${K} 个，完整即将过期 ${Z} 个，完整未设置过期 ${D} 个，完整且已使用 ${H} 个，完整但未使用 ${J} 个，字段缺失 ${R} 个，缺字段但已使用 ${O} 个，缺字段且未使用 ${c} 个，缺字段但有效 ${z} 个，缺字段且已过期 ${ne} 个，缺字段即将过期 ${G} 个，缺字段未设置过期 ${Ce} 个，已使用 ${N} 个，从未使用 ${k} 个，设置过期时间 ${Q} 个，有效 ${X} 个，已过期 ${ee} 个，即将过期 ${te} 个，未设置 ${qe} 个；筛选: ${Le}，当前展示 ${r} 个${mt}`}function dt(e,t="",i=""){const r=Date.now();return e.filter(s=>{const l=s.is_active||s.active;if(t==="active"&&!l||t==="inactive"&&l)return!1;const n=x(s.expires_at,r);return!(i==="expired"&&!n.expired||i==="expiring"&&!n.expiringSoon||i==="valid"&&(!n.hasExpiry||n.expired)||i==="unset"&&n.hasExpiry)})}function Ai(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${ot(e,t)}）`:"暂无凭证"}function lt(e,t,i){const r=e.querySelector(i);t.forEach(s=>{const l=e.querySelector(s);l==null||l.addEventListener("keydown",n=>{n.key==="Enter"&&(n.preventDefault(),r.disabled||r.click())})})}async function Ni(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function i(){var n,p,o,b,u,h,$,w,y,f,C,E,W,H,J,R,O;const l=e.querySelector("#bili-status-cards");l.innerHTML='<div class="page-loading">加载中...</div>';try{const c=await B.getBilibiliStatus(),k=Number((c==null?void 0:c.video_count)??0),N=Number(((n=c==null?void 0:c.videos)==null?void 0:n.poll_enabled_count)??0),m=Math.max(0,k-N),Y=Kt(k,N),K=et(N,k),Z=et(m,k,"占比"),D=!!((p=c==null?void 0:c.diagnostics)!=null&&p.ready),T=Ot((o=c==null?void 0:c.diagnostics)==null?void 0:o.blocking_reasons),I=it(c==null?void 0:c.credential,"未配置"),M=!!(((u=(b=c==null?void 0:c.diagnostics)==null?void 0:b.signals)==null?void 0:u.credential_present)??(($=(h=c==null?void 0:c.diagnostics)==null?void 0:h.release_gates)==null?void 0:$.credential_present)),Q=!!(((y=(w=c==null?void 0:c.diagnostics)==null?void 0:w.signals)==null?void 0:y.credential_complete)??((C=(f=c==null?void 0:c.diagnostics)==null?void 0:f.release_gates)==null?void 0:C.credential_complete)),X=ki(M,Q),ee=Ti(c==null?void 0:c.diagnostics),te=Dt((E=c==null?void 0:c.diagnostics)==null?void 0:E.effective_publish_mode),F=Bi(c==null?void 0:c.diagnostics),ie=Fe(c==null?void 0:c.enabled,"B 站集成已启用","B 站集成已停用"),le=Fe(c==null?void 0:c.polling_enabled,"评论轮询已启用","评论轮询已停用"),re=Fe(c==null?void 0:c.publish_enabled,"发布链路已启用","发布链路已停用"),pe=Ut((W=c==null?void 0:c.config)==null?void 0:W.poll_interval_seconds),se=Vt((H=c==null?void 0:c.config)==null?void 0:H.poll_interval_seconds),be=Wt((J=c==null?void 0:c.config)==null?void 0:J.rate_limit_per_minute),ae=Jt((R=c==null?void 0:c.config)==null?void 0:R.rate_limit_per_minute),z=x((O=c==null?void 0:c.credential)==null?void 0:O.expires_at),ne=z.detail||(c!=null&&c.credential?"未设置过期时间":"当前无活跃凭证"),G=qi(c==null?void 0:c.credential);l.innerHTML=`
      ...
      `}catch(c){l.innerHTML=`<div class="page-error">状态加载失败: ${d(q(c))}</div>`}}async function r(){const l=e.querySelector("#bili-videos-wrapper"),n=e.querySelector("#bili-video-summary"),p=e.querySelector("#bili-video-filter-btn"),o=e.querySelector("#bili-video-poll-filter"),b=e.querySelector("#bili-video-prev"),u=e.querySelector("#bili-video-next"),h=o.value;n.textContent="加载中...",l.innerHTML='<div class="page-loading">加载中...</div>',o.disabled=!0,p.disabled=!0,b.disabled=!0,u.disabled=!0;try{const $=await B.getBilibiliVideos({limit:ce,offset:t,poll_enabled:zt(h)}),w=Array.isArray($==null?void 0:$.items)?$.items:Array.isArray($)?$:[],y=Number(($==null?void 0:$.total)??w.length);if(w.length===0&&y>0&&t>0){t=Math.max(0,t-ce),await r();return}if(n.textContent=Si(y,w.length,h,t,ce,w),b.disabled=t<=0,u.disabled=t+w.length>=y,w.length===0){l.innerHTML=`<div class="table-empty">${d(Gt(h))}</div>`;return}l.innerHTML=`
        <table class="data-table">
      ...
      `,l.querySelectorAll(".bili-toggle-poll").forEach(f=>{f.addEventListener("click",async()=>{f.disabled=!0;try{await B.toggleBilibiliVideoPoll(f.dataset.id),v("操作成功","success"),await Promise.all([i(),r()])}catch(C){v(`失败: ${q(C)}`,"error")}finally{f.disabled=!1}})}),l.querySelectorAll(".bili-sync").forEach(f=>{f.addEventListener("click",async()=>{if(f.dataset.hasAid==="false"){v(Ee.no_aid,"warning");return}const C=f.textContent;f.disabled=!0,f.textContent="同步中...";try{const E=await B.syncBilibiliVideo(f.dataset.id);v(tt(E==null?void 0:E.result,{subject:"同步"}),"success"),await Promise.all([i(),r()])}catch(E){v(`同步失败: ${q(E)}`,"error")}finally{f.disabled=!1,f.textContent=C}})}),l.querySelectorAll(".bili-delete").forEach(f=>{f.addEventListener("click",async()=>{if(confirm("确定删除此视频？")){f.disabled=!0;try{await B.deleteBilibiliVideo(f.dataset.id),v("已删除","success"),await Promise.all([i(),r()])}catch(C){v(`删除失败: ${q(C)}`,"error")}finally{f.disabled=!1}}})})}catch($){n.textContent="视频加载失败",l.innerHTML=`<div class="page-error">加载失败: ${d(q($))}</div>`}finally{o.disabled=!1,p.disabled=!1}}async function s(){const l=e.querySelector("#bili-creds-wrapper"),n=e.querySelector("#bili-cred-summary"),p=e.querySelector("#bili-cred-active-filter"),o=e.querySelector("#bili-cred-expiry-filter"),b=p.value,u=o.value;n.textContent="加载中...",l.innerHTML='<div class="page-loading">加载中...</div>',p.disabled=!0,o.disabled=!0;try{const h=await B.getBilibiliCredentials(),$=Array.isArray(h==null?void 0:h.items)?h.items:Array.isArray(h)?h:[],w=dt($,b,u);if(n.textContent=Pi($,b,u,w.length),w.length===0){l.innerHTML=`<div class="table-empty">${d(Ai(b,u))}</div>`;return}l.innerHTML=`
        <table class="data-table">
      ...
      `,l.querySelectorAll(".cred-activate").forEach(y=>{y.addEventListener("click",async()=>{y.disabled=!0;try{await B.activateBilibiliCredential(y.dataset.id),v("已激活","success"),await Promise.all([i(),s()])}catch(f){v(`激活失败: ${q(f)}`,"error")}finally{y.disabled=!1}})}),l.querySelectorAll(".cred-delete").forEach(y=>{y.addEventListener("click",async()=>{if(confirm("确定删除此凭证？")){y.disabled=!0;try{await B.deleteBilibiliCredential(y.dataset.id),v("已删除","success"),await Promise.all([i(),s()])}catch(f){v(`删除失败: ${q(f)}`,"error")}finally{y.disabled=!1}}})})}catch(h){n.textContent="凭证加载失败",l.innerHTML=`<div class="page-error">加载失败: ${d(q(h))}</div>`}finally{p.disabled=!1,o.disabled=!1}}e.querySelector("#bili-video-add").addEventListener("click",async()=>{const l=e.querySelector("#bili-video-add"),n=e.querySelector("#bili-video-bvid").value.trim(),p=jt(n);if(p){v(q(p),"warning");return}l.disabled=!0,l.textContent="添加中...";try{await B.addBilibiliVideo(n),v("添加成功","success"),e.querySelector("#bili-video-bvid").value="",await Promise.all([i(),r()])}catch(o){v(`添加失败: ${q(o)}`,"error")}finally{l.disabled=!1,l.textContent="添加"}}),e.querySelector("#cred-add").addEventListener("click",async()=>{var b;const l=e.querySelector("#cred-add"),n=Rt(e.querySelector("#cred-expires").value),p={name:e.querySelector("#cred-name").value.trim(),sessdata:e.querySelector("#cred-sessdata").value.trim(),bili_jct:e.querySelector("#cred-bili-jct").value.trim(),buvid3:e.querySelector("#cred-buvid3").value.trim(),buvid4:e.querySelector("#cred-buvid4").value.trim(),expires_at:n},o=Ht(p);if(o){v(q(o),"warning");return}l.disabled=!0,l.textContent="添加中...";try{const u=await B.addBilibiliCredential(p);v((b=u==null?void 0:u.item)!=null&&b.is_active?"凭证添加成功，已自动激活":"凭证添加成功","success"),e.querySelector("#cred-name").value="",e.querySelector("#cred-sessdata").value="",e.querySelector("#cred-bili-jct").value="",e.querySelector("#cred-buvid3").value="",e.querySelector("#cred-buvid4").value="",e.querySelector("#cred-expires").value="",await Promise.all([i(),s()])}catch(u){v(`添加失败: ${q(u)}`,"error")}finally{l.disabled=!1,l.textContent="添加凭证"}}),e.querySelector("#bili-poll-btn").addEventListener("click",async()=>{const l=e.querySelector("#bili-poll-btn");l.disabled=!0,l.textContent="轮询中...";try{const n=await B.triggerBilibiliPoll();v(tt(n==null?void 0:n.result),"success"),await Promise.all([i(),r()])}catch(n){v(`轮询失败: ${q(n)}`,"error")}finally{l.disabled=!1,l.textContent="触发轮询"}}),e.querySelector("#bili-refresh").addEventListener("click",async()=>{const l=e.querySelector("#bili-refresh");l.disabled=!0,l.textContent="刷新中...";try{await Promise.all([i(),r(),s()])}finally{l.disabled=!1,l.innerHTML='<svg width="14" height="14"><use href="#icon-refresh"></use></svg> 刷新'}}),e.querySelector("#bili-video-filter-btn").addEventListener("click",()=>{t=0,r()}),e.querySelector("#bili-video-poll-filter").addEventListener("change",()=>{t=0,r()}),e.querySelector("#bili-video-prev").addEventListener("click",()=>{t<=0||(t=Math.max(0,t-ce),r())}),e.querySelector("#bili-video-next").addEventListener("click",()=>{t+=ce,r()}),e.querySelector("#bili-cred-active-filter").addEventListener("change",s),e.querySelector("#bili-cred-expiry-filter").addEventListener("change",s),lt(e,["#bili-video-bvid"],"#bili-video-add"),lt(e,["#cred-name","#cred-sessdata","#cred-bili-jct","#cred-buvid3","#cred-buvid4","#cred-expires"],"#cred-add"),await Promise.all([i(),r(),s()])}const rt=A();async function Ii(e){e.innerHTML=`
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),i=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}i.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await rt.getComment(t);i.innerHTML=`
      ...
      `;const s=i.querySelector("#query-goto-comment");s&&s.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=s.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){i.innerHTML=`<div class="page-error">查询失败: ${d(r.message)}</div>`}})}const ze={dashboard:{render:nt,title:"仪表盘"},jobs:{render:_t,title:"任务管理"},"daily-metrics":{render:St,title:"每日指标"},knowledge:{render:Et,title:"知识库"},"role-cards":{render:Ct,title:"角色卡"},profiles:{render:qt,title:"风格配置"},gateway:{render:kt,title:"网关"},audit:{render:Tt,title:"审计日志"},bilibili:{render:Ni,title:"B站集成"},query:{render:Ii,title:"查询"}};let ct=null;function ji(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function ut(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function pt(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Hi(e){e.preventDefault();const t=document.getElementById("login-api-key"),i=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await g("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),pt(),Ze("dashboard")}catch{i.textContent="API Key 无效或服务不可用",i.style.display="block",window.__ADMIN_API_KEY__=""}}}function Ri(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",ut()}function Ze(e){if(!ze[e])return;ct=e,document.querySelectorAll("#nav-list .nav-item").forEach(i=>{i.classList.toggle("active",i.dataset.page===e)}),document.getElementById("page-title").textContent=ze[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',ze[e].render(t).catch(i=>{t.innerHTML=`<div class="page-error">加载失败: ${i.message}</div>`})}function Oi(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==ct&&Ze(t)})})}function Di(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),i=document.getElementById("expand-left-btn");t&&i&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),i.style.display="block"}),i.addEventListener("click",()=>{e.classList.remove("collapsed"),i.style.display="none"}))}function Ui(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let i=0;e.addEventListener("click",()=>{i=(i+1)%t.length,t[i]?document.body.setAttribute("data-theme",t[i]):document.body.removeAttribute("data-theme")})}function Vi(){Di(),Ui(),Oi(),document.getElementById("login-form").addEventListener("submit",Hi),document.getElementById("logout-btn").addEventListener("click",Ri),ji()?(pt(),Ze("dashboard")):ut()}Vi();
