(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(r){if(r.ep)return;r.ep=!0;const l=i(r);fetch(r.href,l)}})();function Ce(e,t,i){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof i=="string"&&i.trim()?i.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function $e(){return(window.__ADMIN_API_KEY__||"").trim()}async function m(e,t={}){const i=$e(),s=new Headers(t.headers||{});i&&s.set("x-api-key",i);const r=await fetch(e,{...t,headers:s}),l=await r.json().catch(()=>({}));if(!r.ok){const a=(l==null?void 0:l.detail)||(l==null?void 0:l.error);throw new Error(Ce(a,r.status,r.statusText))}return l}async function ve(e,t){const i=$e(),s=new Headers;i&&s.set("x-api-key",i);const r=await fetch(e,{headers:s});if(!r.ok)throw new Error("download_failed");const l=await r.blob(),a=URL.createObjectURL(l),u=document.createElement("a");u.href=a,u.download=t,document.body.appendChild(u),u.click(),document.body.removeChild(u),URL.revokeObjectURL(a)}function k(e){const t=new URLSearchParams;for(const[s,r]of Object.entries(e))r!=null&&r!==""&&t.set(s,String(r));const i=t.toString();return i?`?${i}`:""}function C(){return{getOverview(){return m("/api/admin/overview")},getJobs({status:e,limit:t}={}){return m(`/api/admin/jobs${k({status:e,limit:t})}`)},getJob(e){return m(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return m(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return m(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return m("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return m("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return ve(`/export/jobs.csv${k({status:e,limit:t})}`,"jobs.csv")},getComment(e){return m(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return m(`/api/admin/gateway/logs${k({limit:e,comment_id:t})}`)},publishGatewayReply(e){return m("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:i}={}){return m(`/api/admin/audit/summary${k({days:e,action:t,ok:i})}`)},getAuditLogs({limit:e,action:t,ok:i}={}){return m(`/api/audit-log${k({limit:e,action:t,ok:i})}`)},exportAuditCsv({limit:e,action:t,ok:i}={}){return ve(`/export/audit-logs.csv${k({limit:e,action:t,ok:i})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return m(`/api/metrics/daily${k({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return m(`/api/admin/knowledge${k({limit:e,offset:t})}`)},createKnowledgeEntry(e){return m("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return m(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return m(`/api/admin/role-cards${k({limit:e,offset:t})}`)},createRoleCard(e){return m("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return m(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return m(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return m(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return m("/api/admin/style-profile")},setStyleProfile(e){return m("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return m("/api/admin/role-profile")},setRoleProfile(e){return m("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return m("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:i}={}){return m(`/api/admin/bilibili/videos${k({poll_enabled:e,limit:t,offset:i})}`)},addBilibiliVideo(e){return m("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return m("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return m("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return m("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return m(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return m(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function o(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function L(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function Te(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const i=Date.now()-t.getTime(),s=Math.floor(i/1e3);if(s<60)return"刚刚";const r=Math.floor(s/60);if(r<60)return`${r}分钟前`;const l=Math.floor(r/60);if(l<24)return`${l}小时前`;const a=Math.floor(l/24);if(a<30)return`${a}天前`;const u=Math.floor(a/30);return u<12?`${u}个月前`:`${Math.floor(u/12)}年前`}catch{return""}}function V(e){const t=Te(e),i=L(e);return t?`<span title="${o(i)}">${o(t)}</span>`:`<span title="${o(i)}">${o(i)}</span>`}function M(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const Be={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function be(e){if(!e)return"";const t=Be[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${o(t.label)}</span>`}function ue(e,t="是",i="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${o(e?t:i)}</span>`}let ne=null;function p(e,t="info"){const i=document.getElementById("app-toast");i&&i.remove(),ne&&clearTimeout(ne);const s={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},r=document.createElement("div");r.id="app-toast",r.className="toast-notification",r.style.setProperty("--toast-color",s[t]||s.info),r.innerHTML=`
  ...
  `,document.body.appendChild(r),requestAnimationFrame(()=>r.classList.add("show"));const l=()=>{r.classList.remove("show"),setTimeout(()=>r.remove(),300)};r.querySelector(".toast-close").onclick=l,ne=setTimeout(l,4e3)}const F=C();async function we(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,i,s,r]=await Promise.all([F.getOverview().catch(()=>null),F.getJobs({limit:5}).catch(()=>null),F.getGatewayLogs({limit:5}).catch(()=>null),F.getAuditSummary({days:7}).catch(()=>null)]),l=t||{},a=Array.isArray(i==null?void 0:i.items)?i.items:[],u=Array.isArray(s==null?void 0:s.items)?s.items:[];e.innerHTML=`
      ...
      <div class="stat-grid">
        <div class="stat-card">
          ...
          <div class="stat-value">${M(l.total_comments)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">任务总数</div>
          <div class="stat-value">${M(l.total_jobs)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">已发布</div>
          <div class="stat-value">${M(l.total_published)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">人工队列</div>
          <div class="stat-value">${M(l.pending_review)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">失败数</div>
          <div class="stat-value">${M(l.total_failed)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">网关事件</div>
          <div class="stat-value">${M(u.length)}</div>
        </div>
      </div>
            ...
            <table class="data-table">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="4" class="table-empty-cell">暂无任务</td></tr>':a.map(n=>{var b,d;return`<tr>
                    ...
                    <td class="cell-time">${o(L(n.created_at))}</td>
                  </tr>`}).join("")}
              </tbody>
            </table>
          </div>
        ...
        <div class="section-card">
          ...
          <div class="audit-summary-grid">
            <div class="stat-card mini">
              ...
              <div class="stat-value">${M(r==null?void 0:r.total)}</div>
            </div>
            <div class="stat-card mini">
              <div class="stat-label">成功</div>
              <div class="stat-value" style="color:var(--success-color)">${M(r==null?void 0:r.ok_count)}</div>
            </div>
            <div class="stat-card mini">
              <div class="stat-label">失败</div>
              <div class="stat-value" style="color:var(--danger-color)">${M(r==null?void 0:r.failed_count)}</div>
            </div>
          </div>
        </div>
      </div>
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{p("正在刷新...","info"),we(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${o(t.message)}</div>`}}const R=C();async function Me(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;const i=e.querySelector("#jobs-status"),s=e.querySelector("#jobs-limit");async function r(){var u;t.clear(),l();const a=e.querySelector("#jobs-table-wrapper");a.innerHTML='<div class="page-loading">加载中...</div>';try{const n=await R.getJobs({status:i.value,limit:s.value}),b=Array.isArray(n==null?void 0:n.items)?n.items:[];if(b.length===0){a.innerHTML='<div class="table-empty">暂无任务</div>';return}a.innerHTML=`
        <table class="data-table">
          <thead><tr>
          ...
          <tbody>
            ${b.map(d=>{var g,h,$,f;return`
              <tr data-id="${o(d.id)}">
                ...
                <td class="cell-time">${V(d.created_at)}</td>
      ...
      `,(u=a.querySelector("#jobs-select-all"))==null||u.addEventListener("change",d=>{const g=d.target.checked;a.querySelectorAll(".job-checkbox").forEach(h=>{h.checked=g,g?t.add(h.dataset.id):t.delete(h.dataset.id)}),l()}),a.querySelectorAll(".job-checkbox").forEach(d=>{d.addEventListener("change",()=>{d.checked?t.add(d.dataset.id):t.delete(d.dataset.id),l()})}),a.querySelectorAll(".job-approve").forEach(d=>{d.addEventListener("click",async()=>{d.disabled=!0,d.textContent="审批中...";try{await R.approveJob(d.dataset.id),p("审批成功","success"),r()}catch(g){p(`审批失败: ${g.message}`,"error"),d.disabled=!1,d.textContent="审批"}})}),a.querySelectorAll(".job-retry").forEach(d=>{d.addEventListener("click",async()=>{d.disabled=!0,d.textContent="重试中...";try{await R.retryJob(d.dataset.id),p("重试已提交","success"),r()}catch(g){p(`重试失败: ${g.message}`,"error"),d.disabled=!1,d.textContent="重试"}})})}catch(n){a.innerHTML=`<div class="page-error">加载失败: ${o(n.message)}</div>`}}function l(){const a=e.querySelector("#jobs-batch-bar"),u=e.querySelector("#jobs-selected-count");t.size>0?(a.style.display="flex",u.textContent=`已选 ${t.size} 项`):a.style.display="none"}e.querySelector("#jobs-filter-btn").addEventListener("click",r),e.querySelector("#jobs-refresh").addEventListener("click",r),e.querySelector("#jobs-export").addEventListener("click",async()=>{try{await R.exportJobsCsv({status:i.value,limit:s.value}),p("导出成功","success")}catch(a){p(`导出失败: ${a.message}`,"error")}}),e.querySelector("#jobs-batch-approve").addEventListener("click",async()=>{if(t.size!==0)try{await R.batchApprove([...t]),p(`批量审批 ${t.size} 项成功`,"success"),r()}catch(a){p(`批量审批失败: ${a.message}`,"error")}}),e.querySelector("#jobs-batch-retry").addEventListener("click",async()=>{if(t.size!==0)try{await R.batchRetry([...t]),p(`批量重试 ${t.size} 项成功`,"success"),r()}catch(a){p(`批量重试失败: ${a.message}`,"error")}}),await r()}const Ae=C();async function Pe(e){e.innerHTML=`
    <div class="page-header">
      <h2>每日指标</h2>
      <div class="page-actions">
  ...
  `;async function t(){const i=e.querySelector("#metrics-days").value,s=e.querySelector("#metrics-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await Ae.getDailyMetrics({days:i}),l=Array.isArray(r==null?void 0:r.items)?r.items:Array.isArray(r)?r:[];if(l.length===0){s.innerHTML='<div class="table-empty">暂无指标数据</div>';return}s.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `}catch(r){s.innerHTML=`<div class="page-error">加载失败: ${o(r.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const oe=C();async function je(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const i=e.querySelector("#knowledge-table-wrapper");i.innerHTML='<div class="page-loading">加载中...</div>';try{const s=await oe.getKnowledgeEntries({limit:50}),r=Array.isArray(s==null?void 0:s.items)?s.items:[];if(r.length===0){i.innerHTML='<div class="table-empty">暂无知识条目</div>';return}i.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${r.map(l=>{var a,u;return`<tr>
              ...
              <td class="cell-time">${V(l.created_at)}</td>
              <td class="cell-actions">
      ...
      `,i.querySelectorAll(".knowledge-disable").forEach(l=>{l.addEventListener("click",async()=>{try{await oe.disableKnowledgeEntry(l.dataset.id),p("已禁用","success"),t()}catch(a){p(`操作失败: ${a.message}`,"error")}})})}catch(s){i.innerHTML=`<div class="page-error">加载失败: ${o(s.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const i=e.querySelector("#knowledge-category").value.trim(),s=e.querySelector("#knowledge-title").value.trim(),r=e.querySelector("#knowledge-content").value.trim();if(!s||!r){p("标题和内容不能为空","warning");return}try{await oe.createKnowledgeEntry({category:i,title:s,content:r}),p("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(l){p(`创建失败: ${l.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const K=C();let z=!1,w=null;async function Ie(e){z=!1,w=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `;const t=e.querySelector("#rc-select"),i=e.querySelector("#rc-editor");let s=[];function r(){z=!0}function l(){return z?confirm("当前角色卡有未保存的修改，确定要切换吗？"):!0}function a(n){w=n,e.querySelector("#rc-key").value=(n==null?void 0:n.key)||"",e.querySelector("#rc-key").disabled=!!n,e.querySelector("#rc-name").value=(n==null?void 0:n.name)||"",e.querySelector("#rc-desc").value=(n==null?void 0:n.description)||"",e.querySelector("#rc-system-prompt").value=(n==null?void 0:n.system_prompt)||"",e.querySelector("#rc-tone").value=(n==null?void 0:n.tone)||"",e.querySelector("#rc-constraints").value=typeof(n==null?void 0:n.constraints)=="string"?n.constraints:JSON.stringify((n==null?void 0:n.constraints)||"",null,2),e.querySelector("#rc-editor-title").textContent=n?`编辑: ${n.name||n.key}`:"新建角色卡",e.querySelector("#rc-activate").style.display=n&&n.enabled!==!1?"inline-flex":"none",e.querySelector("#rc-disable").style.display=n&&n.enabled!==!1?"inline-flex":"none",i.style.display="block",z=!1}i.querySelectorAll(".form-input").forEach(n=>n.addEventListener("input",r));async function u(){try{const n=await K.getRoleCards({limit:100});s=Array.isArray(n==null?void 0:n.items)?n.items:Array.isArray(n)?n:[],t.innerHTML='<option value="">-- 新建 --</option>'+s.map(b=>`<option value="${o(b.key)}">${o(b.name||b.key)}${b.enabled===!1?" (禁用)":""}</option>`).join("")}catch(n){p(`加载失败: ${n.message}`,"error")}}t.addEventListener("change",()=>{if(!l()){t.value=(w==null?void 0:w.key)||"";return}const n=t.value,b=s.find(d=>d.key===n);a(b||null)}),e.querySelector("#rc-new").addEventListener("click",()=>{l()&&(t.value="",a(null))}),e.querySelector("#rc-save").addEventListener("click",async()=>{const n={key:e.querySelector("#rc-key").value.trim(),name:e.querySelector("#rc-name").value.trim(),description:e.querySelector("#rc-desc").value.trim(),system_prompt:e.querySelector("#rc-system-prompt").value.trim(),tone:e.querySelector("#rc-tone").value.trim()},b=e.querySelector("#rc-constraints").value.trim();try{n.constraints=b?JSON.parse(b):""}catch{n.constraints=b}if(!n.key){p("Key 不能为空","warning");return}try{w!=null&&w.key?(await K.updateRoleCard(w.key,n),p("保存成功","success")):(await K.createRoleCard(n),p("创建成功","success")),z=!1,await u(),t.value=n.key}catch(d){p(`操作失败: ${d.message}`,"error")}}),e.querySelector("#rc-activate").addEventListener("click",async()=>{if(w!=null&&w.key)try{await K.activateRoleCard(w.key),p("已激活","success"),await u()}catch(n){p(`激活失败: ${n.message}`,"error")}}),e.querySelector("#rc-disable").addEventListener("click",async()=>{if(w!=null&&w.key)try{await K.disableRoleCard(w.key),p("已禁用","success"),await u()}catch(n){p(`禁用失败: ${n.message}`,"error")}}),e.querySelector("#rc-refresh").addEventListener("click",()=>{u()}),await u()}const G=C();async function Ne(e){e.innerHTML=`
  ...
  `;async function t(){try{const[i,s]=await Promise.all([G.getStyleProfile().catch(()=>null),G.getRoleProfile().catch(()=>null)]);i!=null&&i.style&&(e.querySelector("#profile-style").value=i.style,e.querySelector("#profile-style-current").textContent=`当前: ${i.style}`),s!=null&&s.role&&(e.querySelector("#profile-role").value=s.role,e.querySelector("#profile-role-current").textContent=`当前: ${s.role}`)}catch(i){p(`加载配置失败: ${i.message}`,"error")}}e.querySelector("#profile-style-apply").addEventListener("click",async()=>{const i=e.querySelector("#profile-style").value;try{await G.setStyleProfile(i),e.querySelector("#profile-style-current").textContent=`当前: ${i}`,p("风格已更新","success")}catch(s){p(`更新失败: ${s.message}`,"error")}}),e.querySelector("#profile-role-apply").addEventListener("click",async()=>{const i=e.querySelector("#profile-role").value;try{await G.setRoleProfile(i),e.querySelector("#profile-role-current").textContent=`当前: ${i}`,p("角色配置已更新","success")}catch(s){p(`更新失败: ${s.message}`,"error")}}),await t()}function He({columns:e,rows:t,empty:i="暂无数据"}){if(!t||t.length===0)return`<div class="table-empty">${o(i)}</div>`;const s=e.map(l=>`<th class="${l.class||""}">${o(l.label)}</th>`).join(""),r=t.map(l=>`<tr>${e.map(a=>`<td class="${a.class||""}">${a.render?a.render(l):o(l[a.key])}</td>`).join("")}</tr>`).join("");return`
    <div class="table-wrapper">
      <table class="data-table">
        <thead><tr>${s}</tr></thead>
        <tbody>${r}</tbody>
  ...
  `}const fe=C();async function Oe(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${n.map(b=>{var d;return`<tr>
              ...
              <td class="cell-time">${V(b.created_at)}</td>
            </tr>`}).join("")}
          </tbody>
        </table>
      `}catch(u){s.innerHTML=`<div class="page-error">加载失败: ${o(u.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),i()}),e.querySelector("#audit-filter-btn").addEventListener("click",i),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await de.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),p("导出成功","success")}catch(s){p(`导出失败: ${s.message}`,"error")}}),await Promise.all([t(),i()])}const E=C(),De=/^BV[a-zA-Z0-9]{10}$/,Ve={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},Je={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},Ue={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},Ke={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},Z={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},D=50,ze=7*24*60*60*1e3;function x(e){const t=e instanceof Error?e.message:String(e??"request_failed");return Ve[t]||t}function We(e){return e?De.test(e)?null:"invalid_bvid_format":"bvid_required"}function Fe(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Ge(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Ye(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(i=>Je[i]||i).join("；")}function Ze(e){const t=String(e??"").trim().toLowerCase();return Ue[t]||t||"-"}function Qe(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Xe(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function et(e,t){const i=Number(t??0);if(!Number.isFinite(i)||i<=0)return"暂无视频";const s=Number(e??0);return`覆盖率 ${((Number.isFinite(s)?Math.min(i,Math.max(0,s)):0)/i*100).toFixed(1).replace(/\.0$/,"")}%`}function tt(e,t,i){const s=String(e??"").trim().toLowerCase();if(!s)return"-";const r=Ke[s]||{label:s,cls:"badge-muted"},l=s==="error"&&t?Z[String(t).trim().toLowerCase()]||String(t):"",a=l?` title="${o(l)}"`:"",u=typeof i=="number"&&Number.isFinite(i)?`评论游标: ${i}`:"",n=[l,u].filter(Boolean).map(b=>`<div class="form-hint" style="margin-top:4px;">${o(b)}</div>`).join("");return`<span class="status-badge ${r.cls}"${a}>${o(r.label)}</span>${n}`}function it(e){return e?L(e):"-"}function lt(e){if(e==="true")return!0;if(e==="false")return!1}function st(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function Q(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function rt(e){return e.filter(t=>!Q(t)).length}function at(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function nt(e){return e.filter(t=>{const i=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return i==="ok"||i==="no_new"}).length}function ot(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function dt(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function ct(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function ut(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function bt(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function pt(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function vt(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function ft(e){return e.filter(t=>Q(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function yt(e){return e.reduce((t,i)=>{const s=Number((i==null?void 0:i.comment_count)??0);return t+(Number.isFinite(s)&&s>0?s:0)},0)}function mt(e){const i=Q(e)?`aid: ${e.aid}`:Z.no_aid;return`${o((e==null?void 0:e.bvid)||"-")}${i?`<div class="form-hint" style="margin-top:4px;">${o(i)}</div>`:""}`}function gt(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(`更新: ${L(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${L(e.created_at)}`),`${o((e==null?void 0:e.title)||"-")}${t.map(i=>`<div class="form-hint" style="margin-top:4px;">${o(i)}</div>`).join("")}`}function ht(e){const t=Q(e),i=t?"":" disabled",s=t?"":` title="${o(Z.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${o(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${i}${s}>同步</button>`}function $t(e,t,i,s=0,r=D,l=[]){const a=i==="true"?"轮询中":i==="false"?"已停用":"全部",u=Math.floor(s/r)+1,n=Math.max(1,Math.ceil(e/r)),b=rt(l),d=Math.max(0,l.length-b),g=at(l),h=nt(l),$=ot(l),f=dt(l),v=ct(l),_=Math.max(0,l.length-v),S=ut(l),A=Math.max(0,l.length-S),q=bt(l),T=Math.max(0,l.length-q),j=pt(l),c=vt(l),B=ft(l),P=Math.max(0,l.length-B),I=yt(l),J=b>0?`，当前页缺少 aid ${b} 条`:"",N=d>0?`，可同步 ${d} 条`:"",H=h>0?`，正常轮询 ${h} 条`:"",U=$>0?`，成功轮询 ${$} 条`:"",y=f>0?`，无新增 ${f} 条`:"",X=g>0?`，轮询失败 ${g} 条`:"",ee=_>0?`，已有轮询记录 ${_} 条`:"",te=v>0?`，尚未轮询 ${v} 条`:"",ie=S>0?`，已识别 UP 主 ${S} 条`:"",le=A>0?`，缺少 UP 主 ${A} 条`:"",se=q>0?`，已抓取标题 ${q} 条`:"",re=T>0?`，缺少标题 ${T} 条`:"",O=B>0?`，信息完整 ${B} 条`:"",ae=P>0?`，信息不完整 ${P} 条`:"",Ee=j>0?`，已有评论视频 ${j} 条`:"",ke=c>0?`，已有评论游标 ${c} 条`:"",Le=I>0?`，关联评论 ${I} 条`:"";return`筛选: ${a}，共 ${e} 条，当前展示 ${t} 条，第 ${u}/${n} 页${J}${N}${H}${U}${y}${X}${ee}${te}${ie}${le}${se}${re}${O}${ae}${Ee}${ke}${Le}`}function ye(e,t={}){const i=Number((e==null?void 0:e.videos)??0),s=Number((e==null?void 0:e.comments)??0),r=Number((e==null?void 0:e.events_injected)??s),l=t.subject||(i===1?"视频":"轮询");return s>0||r>0?`${l}完成，处理 ${i} 个视频，新增 ${s} 条评论，注入 ${r} 个事件。`:i>0?`${l}完成，处理 ${i} 个视频，暂无新增评论。`:`${l}完成，暂无可处理视频。`}function W(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const i=new Date(e);if(Number.isNaN(i.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const s=i.getTime()-t;return s<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:L(e)}:s<=ze?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:L(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:L(e)}}function wt(e){const t=W(e),i=t.detail?`<div class="form-hint" style="margin-top:4px;">${o(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${o(t.label)}</span>${i}`}function me(e,t="-"){const i=[];return e!=null&&e.updated_at&&i.push(`更新: ${L(e.updated_at)}`),e!=null&&e.created_at&&i.push(`创建: ${L(e.created_at)}`),`${o((e==null?void 0:e.name)||t)}${i.map(s=>`<div class="form-hint" style="margin-top:4px;">${o(s)}</div>`).join("")}`}function _t(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function Y(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function St(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function xt(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function qt(e){var a,u,n,b,d,g;const t=!!((u=(a=e==null?void 0:e.checks)==null?void 0:a.auth)!=null&&u.ready),i=!!((b=(n=e==null?void 0:e.checks)==null?void 0:n.worker_or_publish)!=null&&b.ready),s=!!((d=e==null?void 0:e.signals)!=null&&d.polling_worker_enabled),r=!!((g=e==null?void 0:e.signals)!=null&&g.native_publish_enabled);return s||r?`${t?"鉴权已就绪":"鉴权未就绪"}，${i?"执行链路可用":"执行链路阻塞"}`:"当前无需鉴权"}function Et(e){var r,l,a;const t=!!((r=e==null?void 0:e.signals)!=null&&r.publish_mode_config_ready),i=!!((l=e==null?void 0:e.signals)!=null&&l.native_publish_enabled),s=!!((a=e==null?void 0:e.signals)!=null&&a.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",i?"原生发布启用":"原生发布停用",s?"轮询链路启用":"轮询链路停用"].join("，")}function kt(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",i=Y(e)?"字段完整":`缺少 ${St(e).join(" / ")}`;return`${o(t)}${i?`<div class="form-hint" style="margin-top:4px;">${o(i)}</div>`:""}`}function _e(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function Lt(e,t="",i="",s=e.length){const r=e.length,l=e.filter(y=>y.is_active||y.active),a=l.length,u=Math.max(0,r-a),n=e.filter(y=>Y(y)).length,b=e.filter(y=>(y.is_active||y.active)&&Y(y)).length,d=Math.max(0,n-b),g=Math.max(0,a-b),h=Math.max(0,u-d),$=e.filter(y=>Y(y)&&y.last_used_at).length,f=Math.max(0,n-$),v=Math.max(0,r-n),_=e.filter(y=>!y.last_used_at).length,S=Math.max(0,r-_),A=Date.now(),q=e.map(y=>W(y.expires_at,A)),T=l.map(y=>W(y.expires_at,A)),j=q.filter(y=>y.hasExpiry).length,c=q.filter(y=>y.hasExpiry&&!y.expired).length,B=q.filter(y=>y.expired).length,P=q.filter(y=>y.expiringSoon).length,I=T.filter(y=>y.hasExpiry&&!y.expired).length,J=T.filter(y=>y.expired).length,N=T.filter(y=>y.expiringSoon).length,H=q.filter(y=>!y.hasExpiry).length,U=_e(t,i);return`共 ${r} 个凭证，激活中 ${a} 个，未激活 ${u} 个，激活且完整 ${b} 个，未激活但完整 ${d} 个，激活但缺字段 ${g} 个，未激活且缺字段 ${h} 个，激活且有效 ${I} 个，激活已过期 ${J} 个，激活即将过期 ${N} 个，字段完整 ${n} 个，完整且已使用 ${$} 个，完整但未使用 ${f} 个，字段缺失 ${v} 个，已使用 ${S} 个，从未使用 ${_} 个，设置过期时间 ${j} 个，有效 ${c} 个，已过期 ${B} 个，即将过期 ${P} 个，未设置 ${H} 个；筛选: ${U}，当前展示 ${s} 个`}function Ct(e,t="",i=""){const s=Date.now();return e.filter(r=>{const l=r.is_active||r.active;if(t==="active"&&!l||t==="inactive"&&l)return!1;const a=W(r.expires_at,s);return!(i==="expired"&&!a.expired||i==="expiring"&&!a.expiringSoon||i==="valid"&&(!a.hasExpiry||a.expired)||i==="unset"&&a.hasExpiry)})}function Tt(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${_e(e,t)}）`:"暂无凭证"}function ge(e,t,i){const s=e.querySelector(i);t.forEach(r=>{const l=e.querySelector(r);l==null||l.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),s.disabled||s.click())})})}async function Bt(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function i(){var a,u,n,b,d,g,h,$,f,v,_,S,A,q,T,j;const l=e.querySelector("#bili-status-cards");l.innerHTML='<div class="page-loading">加载中...</div>';try{const c=await E.getBilibiliStatus(),B=Number((c==null?void 0:c.video_count)??0),P=Number(((a=c==null?void 0:c.videos)==null?void 0:a.poll_enabled_count)??0),I=Math.max(0,B-P),J=et(P,B),N=!!((u=c==null?void 0:c.diagnostics)!=null&&u.ready),H=Ye((n=c==null?void 0:c.diagnostics)==null?void 0:n.blocking_reasons),U=me(c==null?void 0:c.credential,"未配置"),y=!!(((d=(b=c==null?void 0:c.diagnostics)==null?void 0:b.signals)==null?void 0:d.credential_present)??((h=(g=c==null?void 0:c.diagnostics)==null?void 0:g.release_gates)==null?void 0:h.credential_present)),X=!!(((f=($=c==null?void 0:c.diagnostics)==null?void 0:$.signals)==null?void 0:f.credential_complete)??((_=(v=c==null?void 0:c.diagnostics)==null?void 0:v.release_gates)==null?void 0:_.credential_complete)),ee=xt(y,X),te=qt(c==null?void 0:c.diagnostics),ie=Ze((S=c==null?void 0:c.diagnostics)==null?void 0:S.effective_publish_mode),le=Et(c==null?void 0:c.diagnostics),se=Qe((A=c==null?void 0:c.config)==null?void 0:A.poll_interval_seconds),re=Xe((q=c==null?void 0:c.config)==null?void 0:q.rate_limit_per_minute),O=W((T=c==null?void 0:c.credential)==null?void 0:T.expires_at),ae=it((j=c==null?void 0:c.credential)==null?void 0:j.last_used_at);l.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="color:${N?"var(--success-color)":"var(--danger-color)"}">${N?"就绪":"阻塞"}</div>
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${_t(O)}">${o(O.label)}</div>
          ${O.detail?`<div class="form-hint" style="margin-top:6px;">${o(O.detail)}</div>`:""}
        </div>
        <div class="stat-card mini">
          <div class="stat-label">最近使用</div>
          <div class="stat-value" style="font-size:14px;">${o(ae)}</div>
        </div>
        ${H?`<div class="page-error" style="grid-column: 1 / -1; margin: 0;">阻塞原因: ${o(H)}</div>`:""}
      `}catch(c){l.innerHTML=`<div class="page-error">状态加载失败: ${o(x(c))}</div>`}}async function s(){const l=e.querySelector("#bili-videos-wrapper"),a=e.querySelector("#bili-video-summary"),u=e.querySelector("#bili-video-filter-btn"),n=e.querySelector("#bili-video-poll-filter"),b=e.querySelector("#bili-video-prev"),d=e.querySelector("#bili-video-next"),g=n.value;a.textContent="加载中...",l.innerHTML='<div class="page-loading">加载中...</div>',n.disabled=!0,u.disabled=!0,b.disabled=!0,d.disabled=!0;try{const h=await E.getBilibiliVideos({limit:D,offset:t,poll_enabled:lt(g)}),$=Array.isArray(h==null?void 0:h.items)?h.items:Array.isArray(h)?h:[],f=Number((h==null?void 0:h.total)??$.length);if($.length===0&&f>0&&t>0){t=Math.max(0,t-D),await s();return}if(a.textContent=$t(f,$.length,g,t,D,$),b.disabled=t<=0,d.disabled=t+$.length>=f,$.length===0){l.innerHTML=`<div class="table-empty">${o(st(g))}</div>`;return}l.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${$.map(v=>`<tr data-id="${o(v.id||v.video_id)}">
              <td class="cell-id">${mt(v)}</td>
              <td class="cell-truncate">${gt(v)}</td>
              <td>${ue(v.poll_enabled)}</td>
              <td>${v.comment_count??"-"}</td>
              <td class="cell-time">${v.last_polled_at?V(v.last_polled_at):"-"}</td>
              <td>${tt(v.last_poll_status,v.last_poll_error,v.last_rpid)}</td>
              <td class="cell-actions">
      ...
      `,l.querySelectorAll(".bili-toggle-poll").forEach(v=>{v.addEventListener("click",async()=>{v.disabled=!0;try{await E.toggleBilibiliVideoPoll(v.dataset.id),p("操作成功","success"),await Promise.all([i(),s()])}catch(_){p(`失败: ${x(_)}`,"error")}finally{v.disabled=!1}})}),l.querySelectorAll(".bili-sync").forEach(v=>{v.addEventListener("click",async()=>{if(v.dataset.hasAid==="false"){p(Z.no_aid,"warning");return}const _=v.textContent;v.disabled=!0,v.textContent="同步中...";try{const S=await E.syncBilibiliVideo(v.dataset.id);p(ye(S==null?void 0:S.result,{subject:"同步"}),"success"),await Promise.all([i(),s()])}catch(S){p(`同步失败: ${x(S)}`,"error")}finally{v.disabled=!1,v.textContent=_}})}),l.querySelectorAll(".bili-delete").forEach(v=>{v.addEventListener("click",async()=>{if(confirm("确定删除此视频？")){v.disabled=!0;try{await E.deleteBilibiliVideo(v.dataset.id),p("已删除","success"),await Promise.all([i(),s()])}catch(_){p(`删除失败: ${x(_)}`,"error")}finally{v.disabled=!1}}})})}catch(h){a.textContent="视频加载失败",l.innerHTML=`<div class="page-error">加载失败: ${o(x(h))}</div>`}finally{n.disabled=!1,u.disabled=!1}}async function r(){const l=e.querySelector("#bili-creds-wrapper"),a=e.querySelector("#bili-cred-summary"),u=e.querySelector("#bili-cred-active-filter"),n=e.querySelector("#bili-cred-expiry-filter"),b=u.value,d=n.value;a.textContent="加载中...",l.innerHTML='<div class="page-loading">加载中...</div>',u.disabled=!0,n.disabled=!0;try{const g=await E.getBilibiliCredentials(),h=Array.isArray(g==null?void 0:g.items)?g.items:Array.isArray(g)?g:[],$=Ct(h,b,d);if(a.textContent=Lt(h,b,d,$.length),$.length===0){l.innerHTML=`<div class="table-empty">${o(Tt(b,d))}</div>`;return}l.innerHTML=`
        <table class="data-table">
          <thead><tr><th>名称</th><th>凭证摘要</th><th>激活</th><th>过期状态</th><th>最近使用</th><th>操作</th></tr></thead>
          <tbody>
            ${$.map(f=>`<tr data-id="${o(f.id||f.credential_id)}">
              <td>${me(f)}</td>
              <td class="cell-id">${kt(f)}</td>
              <td>${ue(f.is_active||f.active)}</td>
              <td>${wt(f.expires_at)}</td>
              <td class="cell-time">${f.last_used_at?V(f.last_used_at):"-"}</td>
              <td class="cell-actions">
      ...
      `,l.querySelectorAll(".cred-activate").forEach(f=>{f.addEventListener("click",async()=>{f.disabled=!0;try{await E.activateBilibiliCredential(f.dataset.id),p("已激活","success"),await Promise.all([i(),r()])}catch(v){p(`激活失败: ${x(v)}`,"error")}finally{f.disabled=!1}})}),l.querySelectorAll(".cred-delete").forEach(f=>{f.addEventListener("click",async()=>{if(confirm("确定删除此凭证？")){f.disabled=!0;try{await E.deleteBilibiliCredential(f.dataset.id),p("已删除","success"),await Promise.all([i(),r()])}catch(v){p(`删除失败: ${x(v)}`,"error")}finally{f.disabled=!1}}})})}catch(g){a.textContent="凭证加载失败",l.innerHTML=`<div class="page-error">加载失败: ${o(x(g))}</div>`}finally{u.disabled=!1,n.disabled=!1}}e.querySelector("#bili-video-add").addEventListener("click",async()=>{const l=e.querySelector("#bili-video-add"),a=e.querySelector("#bili-video-bvid").value.trim(),u=We(a);if(u){p(x(u),"warning");return}l.disabled=!0,l.textContent="添加中...";try{await E.addBilibiliVideo(a),p("添加成功","success"),e.querySelector("#bili-video-bvid").value="",await Promise.all([i(),s()])}catch(n){p(`添加失败: ${x(n)}`,"error")}finally{l.disabled=!1,l.textContent="添加"}}),e.querySelector("#cred-add").addEventListener("click",async()=>{var b;const l=e.querySelector("#cred-add"),a=Ge(e.querySelector("#cred-expires").value),u={name:e.querySelector("#cred-name").value.trim(),sessdata:e.querySelector("#cred-sessdata").value.trim(),bili_jct:e.querySelector("#cred-bili-jct").value.trim(),buvid3:e.querySelector("#cred-buvid3").value.trim(),buvid4:e.querySelector("#cred-buvid4").value.trim(),expires_at:a},n=Fe(u);if(n){p(x(n),"warning");return}l.disabled=!0,l.textContent="添加中...";try{const d=await E.addBilibiliCredential(u);p((b=d==null?void 0:d.item)!=null&&b.is_active?"凭证添加成功，已自动激活":"凭证添加成功","success"),e.querySelector("#cred-name").value="",e.querySelector("#cred-sessdata").value="",e.querySelector("#cred-bili-jct").value="",e.querySelector("#cred-buvid3").value="",e.querySelector("#cred-buvid4").value="",e.querySelector("#cred-expires").value="",await Promise.all([i(),r()])}catch(d){p(`添加失败: ${x(d)}`,"error")}finally{l.disabled=!1,l.textContent="添加凭证"}}),e.querySelector("#bili-poll-btn").addEventListener("click",async()=>{const l=e.querySelector("#bili-poll-btn");l.disabled=!0,l.textContent="轮询中...";try{const a=await E.triggerBilibiliPoll();p(ye(a==null?void 0:a.result),"success"),await Promise.all([i(),s()])}catch(a){p(`轮询失败: ${x(a)}`,"error")}finally{l.disabled=!1,l.textContent="触发轮询"}}),e.querySelector("#bili-refresh").addEventListener("click",async()=>{const l=e.querySelector("#bili-refresh");l.disabled=!0,l.textContent="刷新中...";try{await Promise.all([i(),s(),r()])}finally{l.disabled=!1,l.innerHTML='<svg width="14" height="14"><use href="#icon-refresh"></use></svg> 刷新'}}),e.querySelector("#bili-video-filter-btn").addEventListener("click",()=>{t=0,s()}),e.querySelector("#bili-video-poll-filter").addEventListener("change",()=>{t=0,s()}),e.querySelector("#bili-video-prev").addEventListener("click",()=>{t<=0||(t=Math.max(0,t-D),s())}),e.querySelector("#bili-video-next").addEventListener("click",()=>{t+=D,s()}),e.querySelector("#bili-cred-active-filter").addEventListener("change",r),e.querySelector("#bili-cred-expiry-filter").addEventListener("change",r),ge(e,["#bili-video-bvid"],"#bili-video-add"),ge(e,["#cred-name","#cred-sessdata","#cred-bili-jct","#cred-buvid3","#cred-buvid4","#cred-expires"],"#cred-add"),await Promise.all([i(),s(),r()])}const he=C();async function Mt(e){e.innerHTML=`
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),i=e.querySelector("#query-comment-result");if(!t){p("请输入 Comment ID","warning");return}i.innerHTML='<div class="page-loading">查询中...</div>';try{const s=await he.getComment(t);i.innerHTML=`
      ...
      `;const r=i.querySelector("#query-goto-comment");r&&r.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=r.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(s){i.innerHTML=`<div class="page-error">查询失败: ${o(s.message)}</div>`}})}const ce={dashboard:{render:we,title:"仪表盘"},jobs:{render:Me,title:"任务管理"},"daily-metrics":{render:Pe,title:"每日指标"},knowledge:{render:je,title:"知识库"},"role-cards":{render:Ie,title:"角色卡"},profiles:{render:Ne,title:"风格配置"},gateway:{render:Oe,title:"网关"},audit:{render:Re,title:"审计日志"},bilibili:{render:Bt,title:"B站集成"},query:{render:Mt,title:"查询"}};let Se=null;function At(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function xe(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function qe(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Pt(e){e.preventDefault();const t=document.getElementById("login-api-key"),i=document.getElementById("login-error"),s=t.value.trim();if(s){window.__ADMIN_API_KEY__=s;try{await m("/api/admin/overview"),sessionStorage.setItem("admin_api_key",s),qe(),pe("dashboard")}catch{i.textContent="API Key 无效或服务不可用",i.style.display="block",window.__ADMIN_API_KEY__=""}}}function jt(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",xe()}function pe(e){if(!ce[e])return;Se=e,document.querySelectorAll("#nav-list .nav-item").forEach(i=>{i.classList.toggle("active",i.dataset.page===e)}),document.getElementById("page-title").textContent=ce[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',ce[e].render(t).catch(i=>{t.innerHTML=`<div class="page-error">加载失败: ${i.message}</div>`})}function It(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==Se&&pe(t)})})}function Nt(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),i=document.getElementById("expand-left-btn");t&&i&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),i.style.display="block"}),i.addEventListener("click",()=>{e.classList.remove("collapsed"),i.style.display="none"}))}function Ht(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let i=0;e.addEventListener("click",()=>{i=(i+1)%t.length,t[i]?document.body.setAttribute("data-theme",t[i]):document.body.removeAttribute("data-theme")})}function Ot(){Nt(),Ht(),It(),document.getElementById("login-form").addEventListener("submit",Pt),document.getElementById("logout-btn").addEventListener("click",jt),At()?(qe(),pe("dashboard")):xe()}Ot();
