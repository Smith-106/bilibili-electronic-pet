(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const r of l)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(l){const r={};return l.integrity&&(r.integrity=l.integrity),l.referrerPolicy&&(r.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?r.credentials="include":l.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(l){if(l.ep)return;l.ep=!0;const r=i(l);fetch(l.href,r)}})();function ae(e,t,i){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof i=="string"&&i.trim()?i.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function W(){return(window.__ADMIN_API_KEY__||"").trim()}async function y(e,t={}){const i=W(),s=new Headers(t.headers||{});i&&s.set("x-api-key",i);const l=await fetch(e,{...t,headers:s}),r=await l.json().catch(()=>({}));if(!l.ok){const a=(r==null?void 0:r.detail)||(r==null?void 0:r.error);throw new Error(ae(a,l.status,l.statusText))}return r}async function K(e,t){const i=W(),s=new Headers;i&&s.set("x-api-key",i);const l=await fetch(e,{headers:s});if(!l.ok)throw new Error("download_failed");const r=await l.blob(),a=URL.createObjectURL(r),u=document.createElement("a");u.href=a,u.download=t,document.body.appendChild(u),u.click(),document.body.removeChild(u),URL.revokeObjectURL(a)}function w(e){const t=new URLSearchParams;for(const[s,l]of Object.entries(e))l!=null&&l!==""&&t.set(s,String(l));const i=t.toString();return i?`?${i}`:""}function S(){return{getOverview(){return y("/api/admin/overview")},getJobs({status:e,limit:t}={}){return y(`/api/admin/jobs${w({status:e,limit:t})}`)},getJob(e){return y(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return y(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return y(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return y("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return y("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return K(`/export/jobs.csv${w({status:e,limit:t})}`,"jobs.csv")},getComment(e){return y(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return y(`/api/admin/gateway/logs${w({limit:e,comment_id:t})}`)},publishGatewayReply(e){return y("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:i}={}){return y(`/api/admin/audit/summary${w({days:e,action:t,ok:i})}`)},getAuditLogs({limit:e,action:t,ok:i}={}){return y(`/api/audit-log${w({limit:e,action:t,ok:i})}`)},exportAuditCsv({limit:e,action:t,ok:i}={}){return K(`/export/audit-logs.csv${w({limit:e,action:t,ok:i})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return y(`/api/metrics/daily${w({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return y(`/api/admin/knowledge${w({limit:e,offset:t})}`)},createKnowledgeEntry(e){return y("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return y(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return y(`/api/admin/role-cards${w({limit:e,offset:t})}`)},createRoleCard(e){return y("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return y(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return y(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return y(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return y("/api/admin/style-profile")},setStyleProfile(e){return y("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return y("/api/admin/role-profile")},setRoleProfile(e){return y("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return y("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:i}={}){return y(`/api/admin/bilibili/videos${w({poll_enabled:e,limit:t,offset:i})}`)},addBilibiliVideo(e){return y("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return y("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return y("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return y("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return y(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return y(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function o(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function E(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function de(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const i=Date.now()-t.getTime(),s=Math.floor(i/1e3);if(s<60)return"刚刚";const l=Math.floor(s/60);if(l<60)return`${l}分钟前`;const r=Math.floor(l/60);if(r<24)return`${r}小时前`;const a=Math.floor(r/24);if(a<30)return`${a}天前`;const u=Math.floor(a/30);return u<12?`${u}个月前`:`${Math.floor(u/12)}年前`}catch{return""}}function T(e){const t=de(e),i=E(e);return t?`<span title="${o(i)}">${o(t)}</span>`:`<span title="${o(i)}">${o(i)}</span>`}function _(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const oe={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function N(e){if(!e)return"";const t=oe[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${o(t.label)}</span>`}function O(e,t="是",i="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${o(e?t:i)}</span>`}let B=null;function v(e,t="info"){const i=document.getElementById("app-toast");i&&i.remove(),B&&clearTimeout(B);const s={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},l=document.createElement("div");l.id="app-toast",l.className="toast-notification",l.style.setProperty("--toast-color",s[t]||s.info),l.innerHTML=`
  ...
  `,document.body.appendChild(l),requestAnimationFrame(()=>l.classList.add("show"));const r=()=>{l.classList.remove("show"),setTimeout(()=>l.remove(),300)};l.querySelector(".toast-close").onclick=r,B=setTimeout(r,4e3)}const M=S();async function Z(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,i,s,l]=await Promise.all([M.getOverview().catch(()=>null),M.getJobs({limit:5}).catch(()=>null),M.getGatewayLogs({limit:5}).catch(()=>null),M.getAuditSummary({days:7}).catch(()=>null)]),r=t||{},a=Array.isArray(i==null?void 0:i.items)?i.items:[],u=Array.isArray(s==null?void 0:s.items)?s.items:[];e.innerHTML=`
      ...
      <div class="stat-grid">
        <div class="stat-card">
          ...
          <div class="stat-value">${_(r.total_comments)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">任务总数</div>
          <div class="stat-value">${_(r.total_jobs)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">已发布</div>
          <div class="stat-value">${_(r.total_published)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">人工队列</div>
          <div class="stat-value">${_(r.pending_review)}</div>
        </div>
        <div class="stat-card">
          <div class="stat-label">失败数</div>
          <div class="stat-value">${_(r.total_failed)}</div>
        </div>
        <div class="stat-card">
            ...
            <table class="data-table">
              ...
              <tbody>
                ${a.length===0?'<tr><td colspan="4" class="table-empty-cell">暂无任务</td></tr>':a.map(d=>{var b,c;return`<tr>
                    <td class="cell-id">${o((b=d.id)==null?void 0:b.substring(0,8))}</td>
                    <td>${N(d.status)}</td>
                    <td class="cell-truncate">${o((c=d.comment_text)==null?void 0:c.substring(0,60))}</td>
                    <td class="cell-time">${o(E(d.created_at))}</td>
                  </tr>`}).join("")}
              </tbody>
            </table>
          </div>
        ...
        <div class="section-card">
          ...
          <div class="audit-summary-grid">
            <div class="stat-card mini">
              ...
              <div class="stat-value">${_(l==null?void 0:l.total)}</div>
            </div>
            <div class="stat-card mini">
              <div class="stat-label">成功</div>
              <div class="stat-value" style="color:var(--success-color)">${_(l==null?void 0:l.ok_count)}</div>
            </div>
            <div class="stat-card mini">
              <div class="stat-label">失败</div>
              <div class="stat-value" style="color:var(--danger-color)">${_(l==null?void 0:l.failed_count)}</div>
            </div>
          </div>
        </div>
      </div>
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{v("正在刷新...","info"),Z(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${o(t.message)}</div>`}}const k=S();async function ne(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;const i=e.querySelector("#jobs-status"),s=e.querySelector("#jobs-limit");async function l(){var u;t.clear(),r();const a=e.querySelector("#jobs-table-wrapper");a.innerHTML='<div class="page-loading">加载中...</div>';try{const d=await k.getJobs({status:i.value,limit:s.value}),b=Array.isArray(d==null?void 0:d.items)?d.items:[];if(b.length===0){a.innerHTML='<div class="table-empty">暂无任务</div>';return}a.innerHTML=`
          ...
          <tbody>
            ${b.map(c=>{var m,p,g,n;return`
              <tr data-id="${o(c.id)}">
                ...
                <td>${N(c.status)}</td>
                <td class="cell-truncate" title="${o(c.comment_text)}">${o((p=c.comment_text)==null?void 0:p.substring(0,80))}</td>
      ...
      `,(u=a.querySelector("#jobs-select-all"))==null||u.addEventListener("change",c=>{const m=c.target.checked;a.querySelectorAll(".job-checkbox").forEach(p=>{p.checked=m,m?t.add(p.dataset.id):t.delete(p.dataset.id)}),r()}),a.querySelectorAll(".job-checkbox").forEach(c=>{c.addEventListener("change",()=>{c.checked?t.add(c.dataset.id):t.delete(c.dataset.id),r()})}),a.querySelectorAll(".job-approve").forEach(c=>{c.addEventListener("click",async()=>{c.disabled=!0,c.textContent="审批中...";try{await k.approveJob(c.dataset.id),v("审批成功","success"),l()}catch(m){v(`审批失败: ${m.message}`,"error"),c.disabled=!1,c.textContent="审批"}})}),a.querySelectorAll(".job-retry").forEach(c=>{c.addEventListener("click",async()=>{c.disabled=!0,c.textContent="重试中...";try{await k.retryJob(c.dataset.id),v("重试已提交","success"),l()}catch(m){v(`重试失败: ${m.message}`,"error"),c.disabled=!1,c.textContent="重试"}})})}catch(d){a.innerHTML=`<div class="page-error">加载失败: ${o(d.message)}</div>`}}function r(){const a=e.querySelector("#jobs-batch-bar"),u=e.querySelector("#jobs-selected-count");t.size>0?(a.style.display="flex",u.textContent=`已选 ${t.size} 项`):a.style.display="none"}e.querySelector("#jobs-filter-btn").addEventListener("click",l),e.querySelector("#jobs-refresh").addEventListener("click",l),e.querySelector("#jobs-export").addEventListener("click",async()=>{try{await k.exportJobsCsv({status:i.value,limit:s.value}),v("导出成功","success")}catch(a){v(`导出失败: ${a.message}`,"error")}}),e.querySelector("#jobs-batch-approve").addEventListener("click",async()=>{if(t.size!==0)try{await k.batchApprove([...t]),v(`批量审批 ${t.size} 项成功`,"success"),l()}catch(a){v(`批量审批失败: ${a.message}`,"error")}}),e.querySelector("#jobs-batch-retry").addEventListener("click",async()=>{if(t.size!==0)try{await k.batchRetry([...t]),v(`批量重试 ${t.size} 项成功`,"success"),l()}catch(a){v(`批量重试失败: ${a.message}`,"error")}}),await l()}const ce=S();async function ue(e){e.innerHTML=`
    <div class="page-header">
      <h2>每日指标</h2>
      <div class="page-actions">
  ...
  `;async function t(){const i=e.querySelector("#metrics-days").value,s=e.querySelector("#metrics-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';try{const l=await ce.getDailyMetrics({days:i}),r=Array.isArray(l==null?void 0:l.items)?l.items:Array.isArray(l)?l:[];if(r.length===0){s.innerHTML='<div class="table-empty">暂无指标数据</div>';return}s.innerHTML=`
      ...
      `}catch(l){s.innerHTML=`<div class="page-error">加载失败: ${o(l.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const I=S();async function ve(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const i=e.querySelector("#knowledge-table-wrapper");i.innerHTML='<div class="page-loading">加载中...</div>';try{const s=await I.getKnowledgeEntries({limit:50}),l=Array.isArray(s==null?void 0:s.items)?s.items:[];if(l.length===0){i.innerHTML='<div class="table-empty">暂无知识条目</div>';return}i.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${l.map(r=>{var a,u;return`<tr>
              ...
              <td>${o(r.category)}</td>
              <td>${o(r.title)}</td>
              <td class="cell-truncate">${o((u=r.content)==null?void 0:u.substring(0,80))}</td>
              <td>${O(r.enabled!==!1)}</td>
      ...
      `,i.querySelectorAll(".knowledge-disable").forEach(r=>{r.addEventListener("click",async()=>{try{await I.disableKnowledgeEntry(r.dataset.id),v("已禁用","success"),t()}catch(a){v(`操作失败: ${a.message}`,"error")}})})}catch(s){i.innerHTML=`<div class="page-error">加载失败: ${o(s.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const i=e.querySelector("#knowledge-category").value.trim(),s=e.querySelector("#knowledge-title").value.trim(),l=e.querySelector("#knowledge-content").value.trim();if(!s||!l){v("标题和内容不能为空","warning");return}try{await I.createKnowledgeEntry({category:i,title:s,content:l}),v("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(r){v(`创建失败: ${r.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const C=S();let A=!1,f=null;async function be(e){A=!1,f=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `}const U=S();async function ye(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
  ...
  `;const t=e.querySelector("#gw-reply"),i=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{i.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const l=e.querySelector("#gw-publish-btn"),r=e.querySelector("#gw-comment-id").value.trim(),a=e.querySelector("#gw-reply").value.trim(),u=e.querySelector("#gw-source").value.trim(),d=e.querySelector("#gw-force").checked;if(!r||!a){v("Comment ID 和回复内容不能为空","warning");return}l.disabled=!0,l.textContent="发布中...";try{await U.publishGatewayReply({comment_id:r,reply_text:a,source:u,force_publish:d}),v("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",i.textContent="0/0",s()}catch(b){v(`发布失败: ${b.message}`,"error")}finally{l.disabled=!1,l.textContent="发布"}});async function s(){const l=e.querySelector("#gw-table-wrapper"),r=e.querySelector("#gw-limit").value;l.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await U.getGatewayLogs({limit:r}),u=Array.isArray(a==null?void 0:a.items)?a.items:[];if(u.length===0){l.innerHTML='<div class="table-empty">暂无网关日志</div>';return}l.innerHTML=me({columns:[{key:"id",label:"ID",class:"cell-id",render:d=>{var b;return o((b=d.id)==null?void 0:b.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:d=>{var b;return o((b=d.comment_id)==null?void 0:b.substring(0,12))}},{key:"status",label:"状态",render:d=>N(d.status)},{key:"platform",label:"平台",render:d=>o(d.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:d=>{var b;return o((b=d.reply_text)==null?void 0:b.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:d=>T(d.created_at)}],rows:u})}catch(a){l.innerHTML=`<div class="page-error">加载失败: ${o(a.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",s),e.querySelector("#gw-filter-btn").addEventListener("click",s),await s()}const P=S();async function fe(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const s=await P.getAuditSummary({days:7}),l=e.querySelector("#audit-summary-cards");l.innerHTML=`
      ...
      `}catch(u){s.innerHTML=`<div class="page-error">加载失败: ${o(u.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),i()}),e.querySelector("#audit-filter-btn").addEventListener("click",i),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await P.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(s){v(`导出失败: ${s.message}`,"error")}}),await Promise.all([t(),i()])}const $=S(),ge=/^BV[a-zA-Z0-9]{10}$/,he={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},$e={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},we={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},Se={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},qe={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},L=50,_e=7*24*60*60*1e3;function h(e){const t=e instanceof Error?e.message:String(e??"request_failed");return he[t]||t}function xe(e){return e?ge.test(e)?null:"invalid_bvid_format":"bvid_required"}function ke(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Le(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Ee(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(i=>$e[i]||i).join("；")}function Te(e){const t=String(e??"").trim().toLowerCase();return we[t]||t||"-"}function Ce(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Ae(e,t){const i=String(e??"").trim().toLowerCase();if(!i)return"-";const s=Se[i]||{label:i,cls:"badge-muted"},l=i==="error"&&t?qe[String(t).trim().toLowerCase()]||String(t):"",r=l?` title="${o(l)}"`:"";return`<span class="status-badge ${s.cls}"${r}>${o(s.label)}</span>${l?`<div class="form-hint" style="margin-top:4px;">${o(l)}</div>`:""}`}function z(e){return e?E(e):"-"}function Me(e){if(e==="true")return!0;if(e==="false")return!1}function je(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function Be(e,t,i,s=0,l=L){const r=i==="true"?"轮询中":i==="false"?"已停用":"全部",a=Math.floor(s/l)+1,u=Math.max(1,Math.ceil(e/l));return`筛选: ${r}，共 ${e} 条，当前展示 ${t} 条，第 ${a}/${u} 页`}function V(e,t={}){const i=Number((e==null?void 0:e.videos)??0),s=Number((e==null?void 0:e.comments)??0),l=Number((e==null?void 0:e.events_injected)??s),r=t.subject||(i===1?"视频":"轮询");return s>0||l>0?`${r}完成，处理 ${i} 个视频，新增 ${s} 条评论，注入 ${l} 个事件。`:i>0?`${r}完成，处理 ${i} 个视频，暂无新增评论。`:`${r}完成，暂无可处理视频。`}function R(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const i=new Date(e);if(Number.isNaN(i.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const s=i.getTime()-t;return s<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:E(e)}:s<=_e?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:E(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:E(e)}}function Ie(e){const t=R(e),i=t.detail?`<div class="form-hint" style="margin-top:4px;">${o(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${o(t.label)}</span>${i}`}function Q(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function Pe(e,t="",i="",s=e.length){const l=e.length,r=e.filter(m=>m.is_active||m.active).length,a=Date.now(),u=e.map(m=>R(m.expires_at,a)),d=u.filter(m=>m.hasExpiry).length,b=u.filter(m=>m.expired).length,c=Q(t,i);return`共 ${l} 个凭证，激活中 ${r} 个，设置过期时间 ${d} 个，已过期 ${b} 个；筛选: ${c}，当前展示 ${s} 个`}function He(e,t="",i=""){const s=Date.now();return e.filter(l=>{const r=l.is_active||l.active;if(t==="active"&&!r||t==="inactive"&&r)return!1;const a=R(l.expires_at,s);return!(i==="expired"&&!a.expired||i==="expiring"&&!a.expiringSoon||i==="valid"&&(!a.hasExpiry||a.expired)||i==="unset"&&a.hasExpiry)})}function Oe(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${Q(e,t)}）`:"暂无凭证"}function G(e,t,i){const s=e.querySelector(i);t.forEach(l=>{const r=e.querySelector(l);r==null||r.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),s.disabled||s.click())})})}async function Ne(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function i(){var a,u,d,b,c,m,p,g;const r=e.querySelector("#bili-status-cards");try{const n=await $.getBilibiliStatus(),q=Number(((a=n==null?void 0:n.videos)==null?void 0:a.poll_enabled_count)??0),x=!!((u=n==null?void 0:n.diagnostics)!=null&&u.ready),J=Ee((d=n==null?void 0:n.diagnostics)==null?void 0:d.blocking_reasons),te=(b=n==null?void 0:n.credential)!=null&&b.name?o(n.credential.name):"未配置",ie=Te((c=n==null?void 0:n.diagnostics)==null?void 0:c.effective_publish_mode),se=Ce((m=n==null?void 0:n.config)==null?void 0:m.poll_interval_seconds),le=z((p=n==null?void 0:n.credential)==null?void 0:p.expires_at),re=z((g=n==null?void 0:n.credential)==null?void 0:g.last_used_at);r.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px;">${o(re)}</div>
        </div>
        ${J?`<div class="page-error" style="grid-column: 1 / -1; margin: 0;">阻塞原因: ${o(J)}</div>`:""}
      `}catch(n){r.innerHTML=`<div class="page-error">状态加载失败: ${o(h(n))}</div>`}}async function s(){const r=e.querySelector("#bili-videos-wrapper"),a=e.querySelector("#bili-video-summary"),u=e.querySelector("#bili-video-filter-btn"),d=e.querySelector("#bili-video-prev"),b=e.querySelector("#bili-video-next"),c=e.querySelector("#bili-video-poll-filter").value;a.textContent="加载中...",u.disabled=!0,d.disabled=!0,b.disabled=!0;try{const m=await $.getBilibiliVideos({limit:L,offset:t,poll_enabled:Me(c)}),p=Array.isArray(m==null?void 0:m.items)?m.items:Array.isArray(m)?m:[],g=Number((m==null?void 0:m.total)??p.length);if(p.length===0&&g>0&&t>0){t=Math.max(0,t-L),await s();return}if(a.textContent=Be(g,p.length,c,t,L),d.disabled=t<=0,b.disabled=t+p.length>=g,p.length===0){r.innerHTML=`<div class="table-empty">${o(je(c))}</div>`;return}r.innerHTML=`
        <table class="data-table">
          <thead><tr><th>BVID</th><th>标题</th><th>轮询</th><th>评论数</th><th>最后轮询</th><th>轮询结果</th><th>操作</th></tr></thead>
          <tbody>
            ${p.map(n=>`<tr data-id="${o(n.id||n.video_id)}">
              ...
              <td>${Ae(n.last_poll_status,n.last_poll_error)}</td>
              <td class="cell-actions">
      ...
      `,r.querySelectorAll(".bili-toggle-poll").forEach(n=>{n.addEventListener("click",async()=>{n.disabled=!0;try{await $.toggleBilibiliVideoPoll(n.dataset.id),v("操作成功","success"),await Promise.all([i(),s()])}catch(q){v(`失败: ${h(q)}`,"error")}finally{n.disabled=!1}})}),r.querySelectorAll(".bili-sync").forEach(n=>{n.addEventListener("click",async()=>{const q=n.textContent;n.disabled=!0,n.textContent="同步中...";try{const x=await $.syncBilibiliVideo(n.dataset.id);v(V(x==null?void 0:x.result,{subject:"同步"}),"success"),await Promise.all([i(),s()])}catch(x){v(`同步失败: ${h(x)}`,"error")}finally{n.disabled=!1,n.textContent=q}})}),r.querySelectorAll(".bili-delete").forEach(n=>{n.addEventListener("click",async()=>{if(confirm("确定删除此视频？")){n.disabled=!0;try{await $.deleteBilibiliVideo(n.dataset.id),v("已删除","success"),await Promise.all([i(),s()])}catch(q){v(`删除失败: ${h(q)}`,"error")}finally{n.disabled=!1}}})})}catch(m){a.textContent="视频加载失败",r.innerHTML=`<div class="page-error">加载失败: ${o(h(m))}</div>`}finally{u.disabled=!1}}async function l(){const r=e.querySelector("#bili-creds-wrapper"),a=e.querySelector("#bili-cred-summary"),u=e.querySelector("#bili-cred-active-filter").value,d=e.querySelector("#bili-cred-expiry-filter").value;try{const b=await $.getBilibiliCredentials(),c=Array.isArray(b==null?void 0:b.items)?b.items:Array.isArray(b)?b:[],m=He(c,u,d);if(a.textContent=Pe(c,u,d,m.length),m.length===0){r.innerHTML=`<div class="table-empty">${o(Oe(u,d))}</div>`;return}r.innerHTML=`
        <table class="data-table">
          <thead><tr><th>名称</th><th>凭证摘要</th><th>激活</th><th>过期状态</th><th>最近使用</th><th>操作</th></tr></thead>
          <tbody>
            ${m.map(p=>`<tr data-id="${o(p.id||p.credential_id)}">
              <td>${o(p.name||"-")}</td>
              <td class="cell-id">${o([p.has_sessdata?"SESSDATA":"",p.has_bili_jct?"bili_jct":"",p.buvid3?`buvid3:${p.buvid3}`:""].filter(Boolean).join(" / ")||"-")}</td>
              <td>${O(p.is_active||p.active)}</td>
              <td>${Ie(p.expires_at)}</td>
              <td class="cell-time">${p.last_used_at?T(p.last_used_at):"-"}</td>
              <td class="cell-actions">
                ${p.is_active||p.active?"":`<button class="btn btn-sm cred-activate" data-id="${o(p.id||p.credential_id)}">激活</button>`}
                <button class="btn btn-sm btn-danger cred-delete" data-id="${o(p.id||p.credential_id)}">删除</button>
              </td>
            </tr>`).join("")}
          </tbody>
        </table>
      `,r.querySelectorAll(".cred-activate").forEach(p=>{p.addEventListener("click",async()=>{p.disabled=!0;try{await $.activateBilibiliCredential(p.dataset.id),v("已激活","success"),await Promise.all([i(),l()])}catch(g){v(`激活失败: ${h(g)}`,"error")}finally{p.disabled=!1}})}),r.querySelectorAll(".cred-delete").forEach(p=>{p.addEventListener("click",async()=>{if(confirm("确定删除此凭证？")){p.disabled=!0;try{await $.deleteBilibiliCredential(p.dataset.id),v("已删除","success"),await Promise.all([i(),l()])}catch(g){v(`删除失败: ${h(g)}`,"error")}finally{p.disabled=!1}}})})}catch(b){a.textContent="凭证加载失败",r.innerHTML=`<div class="page-error">加载失败: ${o(h(b))}</div>`}}e.querySelector("#bili-video-add").addEventListener("click",async()=>{const r=e.querySelector("#bili-video-add"),a=e.querySelector("#bili-video-bvid").value.trim(),u=xe(a);if(u){v(h(u),"warning");return}r.disabled=!0,r.textContent="添加中...";try{await $.addBilibiliVideo(a),v("添加成功","success"),e.querySelector("#bili-video-bvid").value="",await Promise.all([i(),s()])}catch(d){v(`添加失败: ${h(d)}`,"error")}finally{r.disabled=!1,r.textContent="添加"}}),e.querySelector("#cred-add").addEventListener("click",async()=>{var b;const r=e.querySelector("#cred-add"),a=Le(e.querySelector("#cred-expires").value),u={name:e.querySelector("#cred-name").value.trim(),sessdata:e.querySelector("#cred-sessdata").value.trim(),bili_jct:e.querySelector("#cred-bili-jct").value.trim(),buvid3:e.querySelector("#cred-buvid3").value.trim(),buvid4:e.querySelector("#cred-buvid4").value.trim(),expires_at:a},d=ke(u);if(d){v(h(d),"warning");return}r.disabled=!0,r.textContent="添加中...";try{const c=await $.addBilibiliCredential(u);v((b=c==null?void 0:c.item)!=null&&b.is_active?"凭证添加成功，已自动激活":"凭证添加成功","success"),e.querySelector("#cred-name").value="",e.querySelector("#cred-sessdata").value="",e.querySelector("#cred-bili-jct").value="",e.querySelector("#cred-buvid3").value="",e.querySelector("#cred-buvid4").value="",e.querySelector("#cred-expires").value="",await Promise.all([i(),l()])}catch(c){v(`添加失败: ${h(c)}`,"error")}finally{r.disabled=!1,r.textContent="添加凭证"}}),e.querySelector("#bili-poll-btn").addEventListener("click",async()=>{const r=e.querySelector("#bili-poll-btn");r.disabled=!0,r.textContent="轮询中...";try{const a=await $.triggerBilibiliPoll();v(V(a==null?void 0:a.result),"success"),await Promise.all([i(),s()])}catch(a){v(`轮询失败: ${h(a)}`,"error")}finally{r.disabled=!1,r.textContent="触发轮询"}}),e.querySelector("#bili-refresh").addEventListener("click",()=>{i(),s(),l()}),e.querySelector("#bili-video-filter-btn").addEventListener("click",()=>{t=0,s()}),e.querySelector("#bili-video-poll-filter").addEventListener("change",()=>{t=0,s()}),e.querySelector("#bili-video-prev").addEventListener("click",()=>{t<=0||(t=Math.max(0,t-L),s())}),e.querySelector("#bili-video-next").addEventListener("click",()=>{t+=L,s()}),e.querySelector("#bili-cred-active-filter").addEventListener("change",l),e.querySelector("#bili-cred-expiry-filter").addEventListener("change",l),G(e,["#bili-video-bvid"],"#bili-video-add"),G(e,["#cred-name","#cred-sessdata","#cred-bili-jct","#cred-buvid3","#cred-buvid4","#cred-expires"],"#cred-add"),await Promise.all([i(),s(),l()])}const Y=S();async function Re(e){e.innerHTML=`
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),i=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}i.innerHTML='<div class="page-loading">查询中...</div>';try{const s=await Y.getComment(t);i.innerHTML=`
      ...
      `;const l=i.querySelector("#query-goto-comment");l&&l.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=l.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(s){i.innerHTML=`<div class="page-error">查询失败: ${o(s.message)}</div>`}})}const H={dashboard:{render:Z,title:"仪表盘"},jobs:{render:ne,title:"任务管理"},"daily-metrics":{render:ue,title:"每日指标"},knowledge:{render:ve,title:"知识库"},"role-cards":{render:be,title:"角色卡"},profiles:{render:pe,title:"风格配置"},gateway:{render:ye,title:"网关"},audit:{render:fe,title:"审计日志"},bilibili:{render:Ne,title:"B站集成"},query:{render:Re,title:"查询"}};let X=null;function De(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function F(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function ee(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Je(e){e.preventDefault();const t=document.getElementById("login-api-key"),i=document.getElementById("login-error"),s=t.value.trim();if(s){window.__ADMIN_API_KEY__=s;try{await y("/api/admin/overview"),sessionStorage.setItem("admin_api_key",s),ee(),D("dashboard")}catch{i.textContent="API Key 无效或服务不可用",i.style.display="block",window.__ADMIN_API_KEY__=""}}}function Ke(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",F()}function D(e){if(!H[e])return;X=e,document.querySelectorAll("#nav-list .nav-item").forEach(i=>{i.classList.toggle("active",i.dataset.page===e)}),document.getElementById("page-title").textContent=H[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',H[e].render(t).catch(i=>{t.innerHTML=`<div class="page-error">加载失败: ${i.message}</div>`})}function Ue(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==X&&D(t)})})}function ze(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),i=document.getElementById("expand-left-btn");t&&i&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),i.style.display="block"}),i.addEventListener("click",()=>{e.classList.remove("collapsed"),i.style.display="none"}))}function Ve(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let i=0;e.addEventListener("click",()=>{i=(i+1)%t.length,t[i]?document.body.setAttribute("data-theme",t[i]):document.body.removeAttribute("data-theme")})}function Ge(){ze(),Ve(),Ue(),document.getElementById("login-form").addEventListener("submit",Je),document.getElementById("logout-btn").addEventListener("click",Ke),De()?(ee(),D("dashboard")):F()}Ge();
