(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function l(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(a){if(a.ep)return;a.ep=!0;const i=l(a);fetch(a.href,i)}})();function ht(e,t,l){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof l=="string"&&l.trim()?l.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function rt(){return(window.__ADMIN_API_KEY__||"").trim()}async function g(e,t={}){const l=rt(),r=new Headers(t.headers||{});l&&r.set("x-api-key",l);const a=await fetch(e,{...t,headers:r}),i=await a.json().catch(()=>({}));if(!a.ok){const n=(i==null?void 0:i.detail)||(i==null?void 0:i.error);throw new Error(ht(n,a.status,a.statusText))}return i}async function Ze(e,t){const l=rt(),r=new Headers;l&&r.set("x-api-key",l);const a=await fetch(e,{headers:r});if(!a.ok)throw new Error("download_failed");const i=await a.blob(),n=URL.createObjectURL(i),p=document.createElement("a");p.href=n,p.download=t,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(n)}function A(e){const t=new URLSearchParams;for(const[r,a]of Object.entries(e))a!=null&&a!==""&&t.set(r,String(a));const l=t.toString();return l?`?${l}`:""}function I(){return{getOverview(){return g("/api/admin/overview")},getJobs({status:e,limit:t}={}){return g(`/api/admin/jobs${A({status:e,limit:t})}`)},getJob(e){return g(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return g(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return g(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return g("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return g("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return Ze(`/export/jobs.csv${A({status:e,limit:t})}`,"jobs.csv")},getComment(e){return g(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return g(`/api/admin/gateway/logs${A({limit:e,comment_id:t})}`)},publishGatewayReply(e){return g("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:l}={}){return g(`/api/admin/audit/summary${A({days:e,action:t,ok:l})}`)},getAuditLogs({limit:e,action:t,ok:l}={}){return g(`/api/audit-log${A({limit:e,action:t,ok:l})}`)},exportAuditCsv({limit:e,action:t,ok:l}={}){return Ze(`/export/audit-logs.csv${A({limit:e,action:t,ok:l})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return g(`/api/metrics/daily${A({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return g(`/api/admin/knowledge${A({limit:e,offset:t})}`)},createKnowledgeEntry(e){return g("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return g(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return g(`/api/admin/role-cards${A({limit:e,offset:t})}`)},createRoleCard(e){return g("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return g(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return g("/api/admin/style-profile")},setStyleProfile(e){return g("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return g("/api/admin/role-profile")},setRoleProfile(e){return g("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return g("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:l}={}){return g(`/api/admin/bilibili/videos${A({poll_enabled:e,limit:t,offset:l})}`)},addBilibiliVideo(e){return g("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return g("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return g("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return g("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function d(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function k(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function mt(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const l=Date.now()-t.getTime(),r=Math.floor(l/1e3);if(r<60)return"刚刚";const a=Math.floor(r/60);if(a<60)return`${a}分钟前`;const i=Math.floor(a/60);if(i<24)return`${i}小时前`;const n=Math.floor(i/24);if(n<30)return`${n}天前`;const p=Math.floor(n/30);return p<12?`${p}个月前`:`${Math.floor(p/12)}年前`}catch{return""}}function re(e){const t=mt(e),l=k(e);return t?`<span title="${d(l)}">${d(t)}</span>`:`<span title="${d(l)}">${d(l)}</span>`}function H(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const $t={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function Ge(e){if(!e)return"";const t=$t[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${d(t.label)}</span>`}function Fe(e,t="是",l="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${d(e?t:l)}</span>`}let We=null;function v(e,t="info"){const l=document.getElementById("app-toast");l&&l.remove(),We&&clearTimeout(We);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},a=document.createElement("div");a.id="app-toast",a.className="toast-notification",a.style.setProperty("--toast-color",r[t]||r.info),a.innerHTML=`
  ...
  `,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));const i=()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300)};a.querySelector(".toast-close").onclick=i,We=setTimeout(i,4e3)}const ye=I();async function st(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,l,r,a]=await Promise.all([ye.getOverview().catch(()=>null),ye.getJobs({limit:5}).catch(()=>null),ye.getGatewayLogs({limit:5}).catch(()=>null),ye.getAuditSummary({days:7}).catch(()=>null)]),i=t||{},n=Array.isArray(l==null?void 0:l.items)?l.items:[],p=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{v("正在刷新...","info"),st(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${d(t.message)}</div>`}}const ie=I();async function xt(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;async function t(){const l=e.querySelector("#metrics-days").value,r=e.querySelector("#metrics-table-wrapper");r.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await _t.getDailyMetrics({days:l}),i=Array.isArray(a==null?void 0:a.items)?a.items:Array.isArray(a)?a:[];if(i.length===0){r.innerHTML='<div class="table-empty">暂无指标数据</div>';return}r.innerHTML=`
      ...
      `}catch(a){r.innerHTML=`<div class="page-error">加载失败: ${d(a.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const Je=I();async function St(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `}const Qe=I();async function kt(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
  ...
  `;async function t(){try{const r=await Ke.getAuditSummary({days:7}),a=e.querySelector("#audit-summary-cards");a.innerHTML=`
      ...
      `}catch(p){r.innerHTML=`<div class="page-error">加载失败: ${d(p.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),l()}),e.querySelector("#audit-filter-btn").addEventListener("click",l),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await Ke.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(r){v(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),l()])}const L=I(),Tt=/^BV[a-zA-Z0-9]{10}$/,Bt={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},Mt={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},Pt={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},At={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},he={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},le=50,It=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return Bt[t]||t}function jt(e){return e?Tt.test(e)?null:"invalid_bvid_format":"bvid_required"}function Nt(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Ht(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Ot(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(l=>Mt[l]||l).join("；")}function Rt(e){const t=String(e??"").trim().toLowerCase();return Pt[t]||t||"-"}function Dt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Ut(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function Xe(e,t,l="覆盖率"){const r=Number(t??0);if(!Number.isFinite(r)||r<=0)return"暂无视频";const a=Number(e??0),n=((Number.isFinite(a)?Math.min(r,Math.max(0,a)):0)/r*100).toFixed(1).replace(/\.0$/,"");return`${l} ${n}%`}function Vt(e,t,l){const r=String(e??"").trim().toLowerCase();if(!r)return"-";const a=At[r]||{label:r,cls:"badge-muted"},i=r==="error"&&t?he[String(t).trim().toLowerCase()]||String(t):"",n=i?` title="${d(i)}"`:"",p=typeof l=="number"&&Number.isFinite(l)?`评论游标: ${l}`:"",o=[i,p].filter(Boolean).map(b=>`<div class="form-hint" style="margin-top:4px;">${d(b)}</div>`).join("");return`<span class="status-badge ${a.cls}"${n}>${d(a.label)}</span>${o}`}function Wt(e){if(e==="true")return!0;if(e==="false")return!1}function Jt(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function W(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Kt(e){return e.filter(t=>!W(t)).length}function zt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function Ft(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!W(t)).length}function Gt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&W(t)).length}function Yt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function Zt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function Qt(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function Xt(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ei(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function ti(e){return e.filter(t=>{const l=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return l==="ok"||l==="no_new"}).length}function ii(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function li(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function ri(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function si(e){return e.filter(t=>W(t)&&!(t!=null&&t.last_polled_at)).length}function ai(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function ni(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function oi(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function di(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function ci(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&Number((t==null?void 0:t.comment_count)??0)<=0).length}function ui(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function pi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function bi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function vi(e){return e.filter(t=>W(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function fi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(W(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function yi(e){return e.reduce((t,l)=>{const r=Number((l==null?void 0:l.comment_count)??0);return t+(Number.isFinite(r)&&r>0?r:0)},0)}function gi(e){const l=W(e)?`aid: ${e.aid}`:he.no_aid;return`${d((e==null?void 0:e.bvid)||"-")}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function hi(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(`更新: ${k(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${k(e.created_at)}`),`${d((e==null?void 0:e.title)||"-")}${t.map(l=>`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`).join("")}`}function mi(e){const t=W(e),l=t?"":" disabled",r=t?"":` title="${d(he.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${d(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${l}${r}>同步</button>`}function $i(e,t,l,r=0,a=le,i=[]){const n=l==="true"?"轮询中":l==="false"?"已停用":"全部",p=Math.floor(r/a)+1,o=Math.max(1,Math.ceil(e/a)),b=zt(i),c=Math.max(0,i.length-b),h=Ft(i),$=Gt(i),w=Yt(i),y=Zt(i),f=Qt(i),C=Xt(i),E=Kt(i),J=Math.max(0,i.length-E),O=ei(i),K=ti(i),u=ii(i),T=li(i),j=ri(i),R=si(i),G=Math.max(0,i.length-j),m=ni(i),z=Math.max(0,i.length-m),D=oi(i),Y=Math.max(0,i.length-D),F=di(i),B=Math.max(0,i.length-F),N=ci(i),M=ui(i),Z=pi(i),Q=bi(i),X=Math.max(0,i.length-M),ee=ai(i),P=vi(i),U=Math.max(0,i.length-P),oe=fi(i),de=yi(i),me=E>0?`，当前页缺少 aid ${E} 条`:"",$e=l===""&&b>0?`，当前页轮询开启 ${b} 条`:"",xe=l===""&&c>0?`，当前页轮询停用 ${c} 条`:"",_e=l===""&&h>0?`，轮询开启但缺少 aid ${h} 条`:"",we=l===""&&$>0?`，轮询停用但可同步 ${$} 条`:"",Se=l===""&&w>0?`，轮询停用且从未轮询 ${w} 条`:"",Ee=l===""&&y>0?`，轮询停用且已有轮询记录 ${y} 条`:"",Ce=l===""&&f>0?`，轮询开启但尚未轮询 ${f} 条`:"",qe=l===""&&C>0?`，轮询开启且已有轮询记录 ${C} 条`:"",ke=J>0?`，可同步 ${J} 条`:"",te=K>0?`，正常轮询 ${K} 条`:"",se=u>0?`，成功轮询 ${u} 条`:"",Le=T>0?`，无新增 ${T} 条`:"",Te=O>0?`，轮询失败 ${O} 条`:"",Be=G>0?`，已有轮询记录 ${G} 条`:"",Me=j>0?`，尚未轮询 ${j} 条`:"",ce=R>0?`，可同步但尚未轮询 ${R} 条`:"",Pe=m>0?`，已识别 UP 主 ${m} 条`:"",ue=z>0?`，缺少 UP 主 ${z} 条`:"",Ae=D>0?`，已抓取标题 ${D} 条`:"",pe=Y>0?`，缺少标题 ${Y} 条`:"",Ie=P>0?`，信息完整 ${P} 条`:"",je=U>0?`，信息不完整 ${U} 条`:"",Ne=oe>0?`，已轮询但信息不完整 ${oe} 条`:"",He=F>0?`，已有评论视频 ${F} 条`:"",Oe=B>0?`，无评论视频 ${B} 条`:"",be=N>0?`，已轮询但无评论 ${N} 条`:"",Re=M>0?`，已有评论游标 ${M} 条`:"",ve=Z>0?`，有评论但无游标 ${Z} 条`:"",De=Q>0?`，无评论但有游标 ${Q} 条`:"",fe=X>0?`，无评论游标 ${X} 条`:"",Ue=ee>0?`，已轮询但无游标 ${ee} 条`:"",Ve=de>0?`，关联评论 ${de} 条`:"";return`筛选: ${n}，共 ${e} 条，当前展示 ${t} 条，第 ${p}/${o} 页${$e}${xe}${me}${_e}${we}${Se}${Ee}${Ce}${qe}${ke}${te}${se}${Le}${Te}${Be}${Me}${ce}${Pe}${ue}${Ae}${pe}${Ie}${je}${Ne}${He}${Oe}${be}${Re}${ve}${De}${fe}${Ue}${Ve}`}function et(e,t={}){const l=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),a=Number((e==null?void 0:e.events_injected)??r),i=t.subject||(l===1?"视频":"轮询");return r>0||a>0?`${i}完成，处理 ${l} 个视频，新增 ${r} 条评论，注入 ${a} 个事件。`:l>0?`${i}完成，处理 ${l} 个视频，暂无新增评论。`:`${i}完成，暂无可处理视频。`}function x(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const l=new Date(e);if(Number.isNaN(l.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const r=l.getTime()-t;return r<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:k(e)}:r<=It?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:k(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:k(e)}}function xi(e){const t=x(e),l=t.detail?`<div class="form-hint" style="margin-top:4px;">${d(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${d(t.label)}</span>${l}`}function tt(e,t="-"){const l=[];return e!=null&&e.updated_at&&l.push(`更新: ${k(e.updated_at)}`),e!=null&&e.created_at&&l.push(`创建: ${k(e.created_at)}`),`${d((e==null?void 0:e.name)||t)}${l.map(r=>`<div class="form-hint" style="margin-top:4px;">${d(r)}</div>`).join("")}`}function _i(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function wi(e){if(!e)return{label:"未配置",detail:""};if(e!=null&&e.last_used_at)return{label:k(e.last_used_at),detail:""};const t=[];return e!=null&&e.updated_at&&t.push(`更新: ${k(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${k(e.created_at)}`),{label:"从未使用",detail:t.join("，")}}function _(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function Si(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function Ei(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function Ci(e){var n,p,o,b,c,h;const t=!!((p=(n=e==null?void 0:e.checks)==null?void 0:n.auth)!=null&&p.ready),l=!!((b=(o=e==null?void 0:e.checks)==null?void 0:o.worker_or_publish)!=null&&b.ready),r=!!((c=e==null?void 0:e.signals)!=null&&c.polling_worker_enabled),a=!!((h=e==null?void 0:e.signals)!=null&&h.native_publish_enabled);return r||a?`${t?"鉴权已就绪":"鉴权未就绪"}，${l?"执行链路可用":"执行链路阻塞"}`:"当前无需鉴权"}function qi(e){var a,i,n;const t=!!((a=e==null?void 0:e.signals)!=null&&a.publish_mode_config_ready),l=!!((i=e==null?void 0:e.signals)!=null&&i.native_publish_enabled),r=!!((n=e==null?void 0:e.signals)!=null&&n.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",l?"原生发布启用":"原生发布停用",r?"轮询链路启用":"轮询链路停用"].join("，")}function ki(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",l=_(e)?"字段完整":`缺少 ${Si(e).join(" / ")}`;return`${d(t)}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function at(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function Li(e,t="",l="",r=e.length){const a=e.length,i=nt(e,t,l),n=e.filter(s=>s.is_active||s.active),p=e.filter(s=>!(s.is_active||s.active)),o=n.length,b=p.length,c=e.filter(s=>_(s)).length,h=e.filter(s=>(s.is_active||s.active)&&_(s)).length,$=Math.max(0,c-h),w=Math.max(0,o-h),y=Math.max(0,b-$),f=n.filter(s=>s.last_used_at).length,C=Math.max(0,o-f),E=p.filter(s=>s.last_used_at).length,J=Math.max(0,b-E),O=e.filter(s=>_(s)&&s.last_used_at).length,K=Math.max(0,c-O),u=Math.max(0,a-c),T=e.filter(s=>!_(s)&&s.last_used_at).length,j=Math.max(0,u-T),R=e.filter(s=>!s.last_used_at).length,G=Math.max(0,a-R),m=Date.now(),z=e.filter(s=>_(s)&&x(s.expires_at,m).hasExpiry&&!x(s.expires_at,m).expired).length,D=e.filter(s=>_(s)&&x(s.expires_at,m).expired).length,Y=e.filter(s=>_(s)&&x(s.expires_at,m).expiringSoon).length,F=e.filter(s=>_(s)&&!x(s.expires_at,m).hasExpiry).length,B=e.map(s=>x(s.expires_at,m)),N=n.map(s=>x(s.expires_at,m)),M=p.map(s=>x(s.expires_at,m)),Z=B.filter(s=>s.hasExpiry).length,Q=B.filter(s=>s.hasExpiry&&!s.expired).length,X=B.filter(s=>s.expired).length,ee=B.filter(s=>s.expiringSoon).length,P=N.filter(s=>s.hasExpiry&&!s.expired).length,U=N.filter(s=>s.expired).length,oe=N.filter(s=>s.expiringSoon).length,de=N.filter(s=>!s.hasExpiry).length,me=M.filter(s=>s.hasExpiry&&!s.expired).length,$e=M.filter(s=>s.expired).length,xe=M.filter(s=>s.expiringSoon).length,_e=M.filter(s=>!s.hasExpiry).length,we=e.filter(s=>!_(s)&&x(s.expires_at,m).hasExpiry&&!x(s.expires_at,m).expired).length,Se=e.filter(s=>!_(s)&&x(s.expires_at,m).expired).length,Ee=e.filter(s=>!_(s)&&x(s.expires_at,m).expiringSoon).length,Ce=e.filter(s=>!_(s)&&!x(s.expires_at,m).hasExpiry).length,qe=B.filter(s=>!s.hasExpiry).length,ke=at(t,l),te=i.filter(s=>_(s)).length,se=Math.max(0,i.length-te),Le=i.filter(s=>{if(!_(s))return!1;const V=x(s.expires_at,m);return V.hasExpiry&&!V.expired}).length,Te=i.filter(s=>_(s)?x(s.expires_at,m).expired:!1).length,Be=i.filter(s=>_(s)?x(s.expires_at,m).expiringSoon:!1).length,Me=i.filter(s=>_(s)?!x(s.expires_at,m).hasExpiry:!1).length,ce=i.filter(s=>_(s)&&(s.is_active||s.active)).length,Pe=Math.max(0,te-ce),ue=i.filter(s=>_(s)&&s.last_used_at).length,Ae=Math.max(0,te-ue),pe=i.filter(s=>!_(s)&&s.last_used_at).length,Ie=Math.max(0,se-pe),je=i.filter(s=>{if(_(s))return!1;const V=x(s.expires_at,m);return V.hasExpiry&&!V.expired}).length,Ne=i.filter(s=>_(s)?!1:x(s.expires_at,m).expired).length,He=i.filter(s=>_(s)?!1:x(s.expires_at,m).expiringSoon).length,Oe=i.filter(s=>_(s)?!1:!x(s.expires_at,m).hasExpiry).length,be=i.filter(s=>!_(s)&&(s.is_active||s.active)).length,Re=Math.max(0,se-be),ve=i.filter(s=>s.is_active||s.active).length,De=Math.max(0,i.length-ve),fe=i.filter(s=>s.last_used_at).length,Ue=Math.max(0,i.length-fe),Ve=i.filter(s=>{const V=x(s.expires_at,m);return V.hasExpiry&&!V.expired}).length,ut=i.filter(s=>x(s.expires_at,m).expired).length,pt=i.filter(s=>x(s.expires_at,m).expiringSoon).length,bt=i.filter(s=>!x(s.expires_at,m).hasExpiry).length,vt=t?"":`，激活 ${ve} 个，未激活 ${De} 个`,ft=t?"":`，完整且激活 ${ce} 个，完整但未激活 ${Pe} 个`,yt=t?"":`，缺字段且激活 ${be} 个，缺字段且未激活 ${Re} 个`,gt=t||l?`，筛选结果完整 ${te} 个${ft}，完整且有效 ${Le} 个，完整且已过期 ${Te} 个，完整且即将过期 ${Be} 个，完整且未设置过期 ${Me} 个，完整且已使用 ${ue} 个，完整但未使用 ${Ae} 个，缺字段 ${se} 个${yt}，缺字段但已使用 ${pe} 个，缺字段且从未使用 ${Ie} 个，缺字段但有效 ${je} 个，缺字段且已过期 ${Ne} 个，缺字段且即将过期 ${He} 个，缺字段且未设置过期 ${Oe} 个${vt}，已使用 ${fe} 个，从未使用 ${Ue} 个，有效 ${Ve} 个，已过期 ${ut} 个，即将过期 ${pt} 个，未设置过期 ${bt} 个`:"";return`共 ${a} 个凭证，激活中 ${o} 个，未激活 ${b} 个，激活且完整 ${h} 个，未激活但完整 ${$} 个，激活但缺字段 ${w} 个，未激活且缺字段 ${y} 个，激活且已使用 ${f} 个，激活但从未使用 ${C} 个，未激活且已使用 ${E} 个，未激活但从未使用 ${J} 个，激活且有效 ${P} 个，未激活且有效 ${me} 个，激活已过期 ${U} 个，未激活已过期 ${$e} 个，激活即将过期 ${oe} 个，未激活即将过期 ${xe} 个，激活未设置过期 ${de} 个，未激活未设置过期 ${_e} 个，字段完整 ${c} 个，完整且有效 ${z} 个，完整且已过期 ${D} 个，完整即将过期 ${Y} 个，完整未设置过期 ${F} 个，完整且已使用 ${O} 个，完整但未使用 ${K} 个，字段缺失 ${u} 个，缺字段但已使用 ${T} 个，缺字段且未使用 ${j} 个，缺字段但有效 ${we} 个，缺字段且已过期 ${Se} 个，缺字段即将过期 ${Ee} 个，缺字段未设置过期 ${Ce} 个，已使用 ${G} 个，从未使用 ${R} 个，设置过期时间 ${Z} 个，有效 ${Q} 个，已过期 ${X} 个，即将过期 ${ee} 个，未设置 ${qe} 个；筛选: ${ke}，当前展示 ${r} 个${gt}`}function nt(e,t="",l=""){const r=Date.now();return e.filter(a=>{const i=a.is_active||a.active;if(t==="active"&&!i||t==="inactive"&&i)return!1;const n=x(a.expires_at,r);return!(l==="expired"&&!n.expired||l==="expiring"&&!n.expiringSoon||l==="valid"&&(!n.hasExpiry||n.expired)||l==="unset"&&n.hasExpiry)})}function Ti(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${at(e,t)}）`:"暂无凭证"}function it(e,t,l){const r=e.querySelector(l);t.forEach(a=>{const i=e.querySelector(a);i==null||i.addEventListener("keydown",n=>{n.key==="Enter"&&(n.preventDefault(),r.disabled||r.click())})})}async function Bi(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function l(){var n,p,o,b,c,h,$,w,y,f,C,E,J,O,K;const i=e.querySelector("#bili-status-cards");i.innerHTML='<div class="page-loading">加载中...</div>';try{const u=await L.getBilibiliStatus(),T=Number((u==null?void 0:u.video_count)??0),j=Number(((n=u==null?void 0:u.videos)==null?void 0:n.poll_enabled_count)??0),R=Math.max(0,T-j),G=Xe(j,T),m=Xe(R,T,"占比"),z=!!((p=u==null?void 0:u.diagnostics)!=null&&p.ready),D=Ot((o=u==null?void 0:u.diagnostics)==null?void 0:o.blocking_reasons),Y=tt(u==null?void 0:u.credential,"未配置"),F=!!(((c=(b=u==null?void 0:u.diagnostics)==null?void 0:b.signals)==null?void 0:c.credential_present)??(($=(h=u==null?void 0:u.diagnostics)==null?void 0:h.release_gates)==null?void 0:$.credential_present)),B=!!(((y=(w=u==null?void 0:u.diagnostics)==null?void 0:w.signals)==null?void 0:y.credential_complete)??((C=(f=u==null?void 0:u.diagnostics)==null?void 0:f.release_gates)==null?void 0:C.credential_complete)),N=Ei(F,B),M=Ci(u==null?void 0:u.diagnostics),Z=Rt((E=u==null?void 0:u.diagnostics)==null?void 0:E.effective_publish_mode),Q=qi(u==null?void 0:u.diagnostics),X=Dt((J=u==null?void 0:u.config)==null?void 0:J.poll_interval_seconds),ee=Ut((O=u==null?void 0:u.config)==null?void 0:O.rate_limit_per_minute),P=x((K=u==null?void 0:u.credential)==null?void 0:K.expires_at),U=wi(u==null?void 0:u.credential);i.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${_i(P)}">${d(P.label)}</div>
          ${P.detail?`<div class="form-hint" style="margin-top:6px;">${d(P.detail)}</div>`:""}
        </div>
        <div class="stat-card mini">
