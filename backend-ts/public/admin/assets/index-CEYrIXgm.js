(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function l(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(a){if(a.ep)return;a.ep=!0;const i=l(a);fetch(a.href,i)}})();function yt(e,t,l){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof l=="string"&&l.trim()?l.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function lt(){return(window.__ADMIN_API_KEY__||"").trim()}async function g(e,t={}){const l=lt(),r=new Headers(t.headers||{});l&&r.set("x-api-key",l);const a=await fetch(e,{...t,headers:r}),i=await a.json().catch(()=>({}));if(!a.ok){const n=(i==null?void 0:i.detail)||(i==null?void 0:i.error);throw new Error(yt(n,a.status,a.statusText))}return i}async function Ze(e,t){const l=lt(),r=new Headers;l&&r.set("x-api-key",l);const a=await fetch(e,{headers:r});if(!a.ok)throw new Error("download_failed");const i=await a.blob(),n=URL.createObjectURL(i),p=document.createElement("a");p.href=n,p.download=t,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(n)}function M(e){const t=new URLSearchParams;for(const[r,a]of Object.entries(e))a!=null&&a!==""&&t.set(r,String(a));const l=t.toString();return l?`?${l}`:""}function A(){return{getOverview(){return g("/api/admin/overview")},getJobs({status:e,limit:t}={}){return g(`/api/admin/jobs${M({status:e,limit:t})}`)},getJob(e){return g(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return g(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return g(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return g("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return g("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return Ze(`/export/jobs.csv${M({status:e,limit:t})}`,"jobs.csv")},getComment(e){return g(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return g(`/api/admin/gateway/logs${M({limit:e,comment_id:t})}`)},publishGatewayReply(e){return g("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:l}={}){return g(`/api/admin/audit/summary${M({days:e,action:t,ok:l})}`)},getAuditLogs({limit:e,action:t,ok:l}={}){return g(`/api/audit-log${M({limit:e,action:t,ok:l})}`)},exportAuditCsv({limit:e,action:t,ok:l}={}){return Ze(`/export/audit-logs.csv${M({limit:e,action:t,ok:l})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return g(`/api/metrics/daily${M({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return g(`/api/admin/knowledge${M({limit:e,offset:t})}`)},createKnowledgeEntry(e){return g("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return g(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return g(`/api/admin/role-cards${M({limit:e,offset:t})}`)},createRoleCard(e){return g("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return g(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return g("/api/admin/style-profile")},setStyleProfile(e){return g("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return g("/api/admin/role-profile")},setRoleProfile(e){return g("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return g("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:l}={}){return g(`/api/admin/bilibili/videos${M({poll_enabled:e,limit:t,offset:l})}`)},addBilibiliVideo(e){return g("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return g("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return g("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return g("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function d(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function P(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function gt(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const l=Date.now()-t.getTime(),r=Math.floor(l/1e3);if(r<60)return"刚刚";const a=Math.floor(r/60);if(a<60)return`${a}分钟前`;const i=Math.floor(a/60);if(i<24)return`${i}小时前`;const n=Math.floor(i/24);if(n<30)return`${n}天前`;const p=Math.floor(n/30);return p<12?`${p}个月前`:`${Math.floor(p/12)}年前`}catch{return""}}function le(e){const t=gt(e),l=P(e);return t?`<span title="${d(l)}">${d(t)}</span>`:`<span title="${d(l)}">${d(l)}</span>`}function H(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const ht={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function Ge(e){if(!e)return"";const t=ht[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${d(t.label)}</span>`}function Fe(e,t="是",l="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${d(e?t:l)}</span>`}let We=null;function v(e,t="info"){const l=document.getElementById("app-toast");l&&l.remove(),We&&clearTimeout(We);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},a=document.createElement("div");a.id="app-toast",a.className="toast-notification",a.style.setProperty("--toast-color",r[t]||r.info),a.innerHTML=`
  ...
  `,document.body.appendChild(a),requestAnimationFrame(()=>a.classList.add("show"));const i=()=>{a.classList.remove("show"),setTimeout(()=>a.remove(),300)};a.querySelector(".toast-close").onclick=i,We=setTimeout(i,4e3)}const ye=A();async function rt(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,l,r,a]=await Promise.all([ye.getOverview().catch(()=>null),ye.getJobs({limit:5}).catch(()=>null),ye.getGatewayLogs({limit:5}).catch(()=>null),ye.getAuditSummary({days:7}).catch(()=>null)]),i=t||{},n=Array.isArray(l==null?void 0:l.items)?l.items:[],p=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{v("正在刷新...","info"),rt(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${d(t.message)}</div>`}}const te=A();async function mt(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;async function t(){const l=e.querySelector("#metrics-days").value,r=e.querySelector("#metrics-table-wrapper");r.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await $t.getDailyMetrics({days:l}),i=Array.isArray(a==null?void 0:a.items)?a.items:Array.isArray(a)?a:[];if(i.length===0){r.innerHTML='<div class="table-empty">暂无指标数据</div>';return}r.innerHTML=`
      ...
      `}catch(a){r.innerHTML=`<div class="page-error">加载失败: ${d(a.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const Je=A();async function _t(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `}const Qe=A();async function Ct(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
  ...
  `;const t=e.querySelector("#gw-reply"),l=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{l.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const a=e.querySelector("#gw-publish-btn"),i=e.querySelector("#gw-comment-id").value.trim(),n=e.querySelector("#gw-reply").value.trim(),p=e.querySelector("#gw-source").value.trim(),o=e.querySelector("#gw-force").checked;if(!i||!n){v("Comment ID 和回复内容不能为空","warning");return}a.disabled=!0,a.textContent="发布中...";try{await Qe.publishGatewayReply({comment_id:i,reply_text:n,source:p,force_publish:o}),v("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",l.textContent="0/0",r()}catch(b){v(`发布失败: ${b.message}`,"error")}finally{a.disabled=!1,a.textContent="发布"}});async function r(){const a=e.querySelector("#gw-table-wrapper"),i=e.querySelector("#gw-limit").value;a.innerHTML='<div class="page-loading">加载中...</div>';try{const n=await Qe.getGatewayLogs({limit:i}),p=Array.isArray(n==null?void 0:n.items)?n.items:[];if(p.length===0){a.innerHTML='<div class="table-empty">暂无网关日志</div>';return}a.innerHTML=Et({columns:[{key:"id",label:"ID",class:"cell-id",render:o=>{var b;return d((b=o.id)==null?void 0:b.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:o=>{var b;return d((b=o.comment_id)==null?void 0:b.substring(0,12))}},{key:"status",label:"状态",render:o=>Ge(o.status)},{key:"platform",label:"平台",render:o=>d(o.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:o=>{var b;return d((b=o.reply_text)==null?void 0:b.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:o=>le(o.created_at)}],rows:p})}catch(n){a.innerHTML=`<div class="page-error">加载失败: ${d(n.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",r),e.querySelector("#gw-filter-btn").addEventListener("click",r),await r()}const Ke=A();async function qt(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const r=await Ke.getAuditSummary({days:7}),a=e.querySelector("#audit-summary-cards");a.innerHTML=`
      ...
      `}catch(p){r.innerHTML=`<div class="page-error">加载失败: ${d(p.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),l()}),e.querySelector("#audit-filter-btn").addEventListener("click",l),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await Ke.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(r){v(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),l()])}const k=A(),kt=/^BV[a-zA-Z0-9]{10}$/,Lt={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},Tt={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},Bt={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},Mt={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},he={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},ie=50,Pt=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return Lt[t]||t}function At(e){return e?kt.test(e)?null:"invalid_bvid_format":"bvid_required"}function It(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Nt(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function jt(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(l=>Tt[l]||l).join("；")}function Ht(e){const t=String(e??"").trim().toLowerCase();return Bt[t]||t||"-"}function Ot(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Rt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function Dt(e,t){const l=Number(t??0);if(!Number.isFinite(l)||l<=0)return"暂无视频";const r=Number(e??0);return`覆盖率 ${((Number.isFinite(r)?Math.min(l,Math.max(0,r)):0)/l*100).toFixed(1).replace(/\.0$/,"")}%`}function Ut(e,t,l){const r=String(e??"").trim().toLowerCase();if(!r)return"-";const a=Mt[r]||{label:r,cls:"badge-muted"},i=r==="error"&&t?he[String(t).trim().toLowerCase()]||String(t):"",n=i?` title="${d(i)}"`:"",p=typeof l=="number"&&Number.isFinite(l)?`评论游标: ${l}`:"",o=[i,p].filter(Boolean).map(b=>`<div class="form-hint" style="margin-top:4px;">${d(b)}</div>`).join("");return`<span class="status-badge ${a.cls}"${n}>${d(a.label)}</span>${o}`}function Vt(e){return e?P(e):"-"}function Wt(e){if(e==="true")return!0;if(e==="false")return!1}function Jt(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function U(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Kt(e){return e.filter(t=>!U(t)).length}function zt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function Ft(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!U(t)).length}function Gt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&U(t)).length}function Yt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function Zt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function Qt(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function Xt(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ei(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function ti(e){return e.filter(t=>{const l=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return l==="ok"||l==="no_new"}).length}function ii(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function li(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function ri(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function si(e){return e.filter(t=>U(t)&&!(t!=null&&t.last_polled_at)).length}function ai(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function ni(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function oi(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function di(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function ci(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&Number((t==null?void 0:t.comment_count)??0)<=0).length}function ui(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function pi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function bi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function vi(e){return e.filter(t=>U(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function fi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(U(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function yi(e){return e.reduce((t,l)=>{const r=Number((l==null?void 0:l.comment_count)??0);return t+(Number.isFinite(r)&&r>0?r:0)},0)}function gi(e){const l=U(e)?`aid: ${e.aid}`:he.no_aid;return`${d((e==null?void 0:e.bvid)||"-")}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function hi(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(`更新: ${P(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${P(e.created_at)}`),`${d((e==null?void 0:e.title)||"-")}${t.map(l=>`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`).join("")}`}function mi(e){const t=U(e),l=t?"":" disabled",r=t?"":` title="${d(he.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${d(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${l}${r}>同步</button>`}function $i(e,t,l,r=0,a=ie,i=[]){const n=l==="true"?"轮询中":l==="false"?"已停用":"全部",p=Math.floor(r/a)+1,o=Math.max(1,Math.ceil(e/a)),b=zt(i),c=Math.max(0,i.length-b),h=Ft(i),m=Gt(i),w=Yt(i),y=Zt(i),f=Qt(i),C=Xt(i),E=Kt(i),V=Math.max(0,i.length-E),O=ei(i),W=ti(i),R=ii(i),u=li(i),I=ri(i),N=si(i),z=Math.max(0,i.length-I),$=ni(i),J=Math.max(0,i.length-$),D=oi(i),F=Math.max(0,i.length-D),K=di(i),L=Math.max(0,i.length-K),j=ci(i),T=ui(i),G=pi(i),Y=bi(i),Z=Math.max(0,i.length-T),Q=ai(i),B=vi(i),X=Math.max(0,i.length-B),oe=fi(i),de=yi(i),me=E>0?`，当前页缺少 aid ${E} 条`:"",$e=l===""&&b>0?`，当前页轮询开启 ${b} 条`:"",xe=l===""&&c>0?`，当前页轮询停用 ${c} 条`:"",_e=l===""&&h>0?`，轮询开启但缺少 aid ${h} 条`:"",we=l===""&&m>0?`，轮询停用但可同步 ${m} 条`:"",Se=l===""&&w>0?`，轮询停用且从未轮询 ${w} 条`:"",Ee=l===""&&y>0?`，轮询停用且已有轮询记录 ${y} 条`:"",Ce=l===""&&f>0?`，轮询开启但尚未轮询 ${f} 条`:"",qe=l===""&&C>0?`，轮询开启且已有轮询记录 ${C} 条`:"",ke=V>0?`，可同步 ${V} 条`:"",ee=W>0?`，正常轮询 ${W} 条`:"",re=R>0?`，成功轮询 ${R} 条`:"",Le=u>0?`，无新增 ${u} 条`:"",Te=O>0?`，轮询失败 ${O} 条`:"",Be=z>0?`，已有轮询记录 ${z} 条`:"",Me=I>0?`，尚未轮询 ${I} 条`:"",ce=N>0?`，可同步但尚未轮询 ${N} 条`:"",Pe=$>0?`，已识别 UP 主 ${$} 条`:"",ue=J>0?`，缺少 UP 主 ${J} 条`:"",Ae=D>0?`，已抓取标题 ${D} 条`:"",pe=F>0?`，缺少标题 ${F} 条`:"",Ie=B>0?`，信息完整 ${B} 条`:"",Ne=X>0?`，信息不完整 ${X} 条`:"",je=oe>0?`，已轮询但信息不完整 ${oe} 条`:"",He=K>0?`，已有评论视频 ${K} 条`:"",be=L>0?`，无评论视频 ${L} 条`:"",Oe=j>0?`，已轮询但无评论 ${j} 条`:"",ve=T>0?`，已有评论游标 ${T} 条`:"",Re=G>0?`，有评论但无游标 ${G} 条`:"",fe=Y>0?`，无评论但有游标 ${Y} 条`:"",De=Z>0?`，无评论游标 ${Z} 条`:"",Ue=Q>0?`，已轮询但无游标 ${Q} 条`:"",Ve=de>0?`，关联评论 ${de} 条`:"";return`筛选: ${n}，共 ${e} 条，当前展示 ${t} 条，第 ${p}/${o} 页${$e}${xe}${me}${_e}${we}${Se}${Ee}${Ce}${qe}${ke}${ee}${re}${Le}${Te}${Be}${Me}${ce}${Pe}${ue}${Ae}${pe}${Ie}${Ne}${je}${He}${be}${Oe}${ve}${Re}${fe}${De}${Ue}${Ve}`}function Xe(e,t={}){const l=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),a=Number((e==null?void 0:e.events_injected)??r),i=t.subject||(l===1?"视频":"轮询");return r>0||a>0?`${i}完成，处理 ${l} 个视频，新增 ${r} 条评论，注入 ${a} 个事件。`:l>0?`${i}完成，处理 ${l} 个视频，暂无新增评论。`:`${i}完成，暂无可处理视频。`}function x(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const l=new Date(e);if(Number.isNaN(l.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const r=l.getTime()-t;return r<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:P(e)}:r<=Pt?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:P(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:P(e)}}function xi(e){const t=x(e),l=t.detail?`<div class="form-hint" style="margin-top:4px;">${d(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${d(t.label)}</span>${l}`}function et(e,t="-"){const l=[];return e!=null&&e.updated_at&&l.push(`更新: ${P(e.updated_at)}`),e!=null&&e.created_at&&l.push(`创建: ${P(e.created_at)}`),`${d((e==null?void 0:e.name)||t)}${l.map(r=>`<div class="form-hint" style="margin-top:4px;">${d(r)}</div>`).join("")}`}function _i(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function _(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function wi(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function Si(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function Ei(e){var n,p,o,b,c,h;const t=!!((p=(n=e==null?void 0:e.checks)==null?void 0:n.auth)!=null&&p.ready),l=!!((b=(o=e==null?void 0:e.checks)==null?void 0:o.worker_or_publish)!=null&&b.ready),r=!!((c=e==null?void 0:e.signals)!=null&&c.polling_worker_enabled),a=!!((h=e==null?void 0:e.signals)!=null&&h.native_publish_enabled);return r||a?`${t?"鉴权已就绪":"鉴权未就绪"}，${l?"执行链路可用":"执行链路阻塞"}`:"当前无需鉴权"}function Ci(e){var a,i,n;const t=!!((a=e==null?void 0:e.signals)!=null&&a.publish_mode_config_ready),l=!!((i=e==null?void 0:e.signals)!=null&&i.native_publish_enabled),r=!!((n=e==null?void 0:e.signals)!=null&&n.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",l?"原生发布启用":"原生发布停用",r?"轮询链路启用":"轮询链路停用"].join("，")}function qi(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",l=_(e)?"字段完整":`缺少 ${wi(e).join(" / ")}`;return`${d(t)}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function st(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function ki(e,t="",l="",r=e.length){const a=e.length,i=at(e,t,l),n=e.filter(s=>s.is_active||s.active),p=e.filter(s=>!(s.is_active||s.active)),o=n.length,b=p.length,c=e.filter(s=>_(s)).length,h=e.filter(s=>(s.is_active||s.active)&&_(s)).length,m=Math.max(0,c-h),w=Math.max(0,o-h),y=Math.max(0,b-m),f=n.filter(s=>s.last_used_at).length,C=Math.max(0,o-f),E=p.filter(s=>s.last_used_at).length,V=Math.max(0,b-E),O=e.filter(s=>_(s)&&s.last_used_at).length,W=Math.max(0,c-O),R=Math.max(0,a-c),u=e.filter(s=>!_(s)&&s.last_used_at).length,I=Math.max(0,R-u),N=e.filter(s=>!s.last_used_at).length,z=Math.max(0,a-N),$=Date.now(),J=e.filter(s=>_(s)&&x(s.expires_at,$).hasExpiry&&!x(s.expires_at,$).expired).length,D=e.filter(s=>_(s)&&x(s.expires_at,$).expired).length,F=e.filter(s=>_(s)&&x(s.expires_at,$).expiringSoon).length,K=e.filter(s=>_(s)&&!x(s.expires_at,$).hasExpiry).length,L=e.map(s=>x(s.expires_at,$)),j=n.map(s=>x(s.expires_at,$)),T=p.map(s=>x(s.expires_at,$)),G=L.filter(s=>s.hasExpiry).length,Y=L.filter(s=>s.hasExpiry&&!s.expired).length,Z=L.filter(s=>s.expired).length,Q=L.filter(s=>s.expiringSoon).length,B=j.filter(s=>s.hasExpiry&&!s.expired).length,X=j.filter(s=>s.expired).length,oe=j.filter(s=>s.expiringSoon).length,de=j.filter(s=>!s.hasExpiry).length,me=T.filter(s=>s.hasExpiry&&!s.expired).length,$e=T.filter(s=>s.expired).length,xe=T.filter(s=>s.expiringSoon).length,_e=T.filter(s=>!s.hasExpiry).length,we=e.filter(s=>!_(s)&&x(s.expires_at,$).hasExpiry&&!x(s.expires_at,$).expired).length,Se=e.filter(s=>!_(s)&&x(s.expires_at,$).expired).length,Ee=e.filter(s=>!_(s)&&x(s.expires_at,$).expiringSoon).length,Ce=e.filter(s=>!_(s)&&!x(s.expires_at,$).hasExpiry).length,qe=L.filter(s=>!s.hasExpiry).length,ke=st(t,l),ee=i.filter(s=>_(s)).length,re=Math.max(0,i.length-ee),Le=i.filter(s=>{if(!_(s))return!1;const se=x(s.expires_at,$);return se.hasExpiry&&!se.expired}).length,Te=i.filter(s=>_(s)?x(s.expires_at,$).expired:!1).length,Be=i.filter(s=>_(s)?x(s.expires_at,$).expiringSoon:!1).length,Me=i.filter(s=>_(s)?!x(s.expires_at,$).hasExpiry:!1).length,ce=i.filter(s=>_(s)&&(s.is_active||s.active)).length,Pe=Math.max(0,ee-ce),ue=i.filter(s=>_(s)&&s.last_used_at).length,Ae=Math.max(0,ee-ue),pe=i.filter(s=>!_(s)&&s.last_used_at).length,Ie=Math.max(0,re-pe),Ne=i.filter(s=>_(s)?!1:x(s.expires_at,$).expired).length,je=i.filter(s=>_(s)?!1:x(s.expires_at,$).expiringSoon).length,He=i.filter(s=>_(s)?!1:!x(s.expires_at,$).hasExpiry).length,be=i.filter(s=>!_(s)&&(s.is_active||s.active)).length,Oe=Math.max(0,re-be),ve=i.filter(s=>s.is_active||s.active).length,Re=Math.max(0,i.length-ve),fe=i.filter(s=>s.last_used_at).length,De=Math.max(0,i.length-fe),Ue=i.filter(s=>{const se=x(s.expires_at,$);return se.hasExpiry&&!se.expired}).length,Ve=i.filter(s=>x(s.expires_at,$).expired).length,ct=i.filter(s=>x(s.expires_at,$).expiringSoon).length,ut=i.filter(s=>!x(s.expires_at,$).hasExpiry).length,pt=t?"":`，激活 ${ve} 个，未激活 ${Re} 个`,bt=t?"":`，完整且激活 ${ce} 个，完整但未激活 ${Pe} 个`,vt=t?"":`，缺字段且激活 ${be} 个，缺字段且未激活 ${Oe} 个`,ft=t||l?`，筛选结果完整 ${ee} 个${bt}，完整且有效 ${Le} 个，完整且已过期 ${Te} 个，完整且即将过期 ${Be} 个，完整且未设置过期 ${Me} 个，完整且已使用 ${ue} 个，完整但未使用 ${Ae} 个，缺字段 ${re} 个${vt}，缺字段但已使用 ${pe} 个，缺字段且从未使用 ${Ie} 个，缺字段且已过期 ${Ne} 个，缺字段且即将过期 ${je} 个，缺字段且未设置过期 ${He} 个${pt}，已使用 ${fe} 个，从未使用 ${De} 个，有效 ${Ue} 个，已过期 ${Ve} 个，即将过期 ${ct} 个，未设置过期 ${ut} 个`:"";return`共 ${a} 个凭证，激活中 ${o} 个，未激活 ${b} 个，激活且完整 ${h} 个，未激活但完整 ${m} 个，激活但缺字段 ${w} 个，未激活且缺字段 ${y} 个，激活且已使用 ${f} 个，激活但从未使用 ${C} 个，未激活且已使用 ${E} 个，未激活但从未使用 ${V} 个，激活且有效 ${B} 个，未激活且有效 ${me} 个，激活已过期 ${X} 个，未激活已过期 ${$e} 个，激活即将过期 ${oe} 个，未激活即将过期 ${xe} 个，激活未设置过期 ${de} 个，未激活未设置过期 ${_e} 个，字段完整 ${c} 个，完整且有效 ${J} 个，完整且已过期 ${D} 个，完整即将过期 ${F} 个，完整未设置过期 ${K} 个，完整且已使用 ${O} 个，完整但未使用 ${W} 个，字段缺失 ${R} 个，缺字段但已使用 ${u} 个，缺字段且未使用 ${I} 个，缺字段但有效 ${we} 个，缺字段且已过期 ${Se} 个，缺字段即将过期 ${Ee} 个，缺字段未设置过期 ${Ce} 个，已使用 ${z} 个，从未使用 ${N} 个，设置过期时间 ${G} 个，有效 ${Y} 个，已过期 ${Z} 个，即将过期 ${Q} 个，未设置 ${qe} 个；筛选: ${ke}，当前展示 ${r} 个${ft}`}function at(e,t="",l=""){const r=Date.now();return e.filter(a=>{const i=a.is_active||a.active;if(t==="active"&&!i||t==="inactive"&&i)return!1;const n=x(a.expires_at,r);return!(l==="expired"&&!n.expired||l==="expiring"&&!n.expiringSoon||l==="valid"&&(!n.hasExpiry||n.expired)||l==="unset"&&n.hasExpiry)})}function Li(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${st(e,t)}）`:"暂无凭证"}function tt(e,t,l){const r=e.querySelector(l);t.forEach(a=>{const i=e.querySelector(a);i==null||i.addEventListener("keydown",n=>{n.key==="Enter"&&(n.preventDefault(),r.disabled||r.click())})})}async function Ti(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function l(){var n,p,o,b,c,h,m,w,y,f,C,E,V,O,W,R;const i=e.querySelector("#bili-status-cards");i.innerHTML='<div class="page-loading">加载中...</div>';try{const u=await k.getBilibiliStatus(),I=Number((u==null?void 0:u.video_count)??0),N=Number(((n=u==null?void 0:u.videos)==null?void 0:n.poll_enabled_count)??0),z=Math.max(0,I-N),$=Dt(N,I),J=!!((p=u==null?void 0:u.diagnostics)!=null&&p.ready),D=jt((o=u==null?void 0:u.diagnostics)==null?void 0:o.blocking_reasons),F=et(u==null?void 0:u.credential,"未配置"),K=!!(((c=(b=u==null?void 0:u.diagnostics)==null?void 0:b.signals)==null?void 0:c.credential_present)??((m=(h=u==null?void 0:u.diagnostics)==null?void 0:h.release_gates)==null?void 0:m.credential_present)),L=!!(((y=(w=u==null?void 0:u.diagnostics)==null?void 0:w.signals)==null?void 0:y.credential_complete)??((C=(f=u==null?void 0:u.diagnostics)==null?void 0:f.release_gates)==null?void 0:C.credential_complete)),j=Si(K,L),T=Ei(u==null?void 0:u.diagnostics),G=Ht((E=u==null?void 0:u.diagnostics)==null?void 0:E.effective_publish_mode),Y=Ci(u==null?void 0:u.diagnostics),Z=Ot((V=u==null?void 0:u.config)==null?void 0:V.poll_interval_seconds),Q=Rt((O=u==null?void 0:u.config)==null?void 0:O.rate_limit_per_minute),B=x((W=u==null?void 0:u.credential)==null?void 0:W.expires_at),X=Vt((R=u==null?void 0:u.credential)==null?void 0:R.last_used_at);i.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${_i(B)}">${d(B.label)}</div>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${w.map(f=>`<tr data-id="${d(f.id||f.video_id)}">
              ...
              <td class="cell-truncate">${hi(f)}</td>
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),l=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}l.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await it.getComment(t);l.innerHTML=`
      ...
      `;const a=l.querySelector("#query-goto-comment");a&&a.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=a.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){l.innerHTML=`<div class="page-error">查询失败: ${d(r.message)}</div>`}})}const ze={dashboard:{render:rt,title:"仪表盘"},jobs:{render:mt,title:"任务管理"},"daily-metrics":{render:xt,title:"每日指标"},knowledge:{render:_t,title:"知识库"},"role-cards":{render:wt,title:"角色卡"},profiles:{render:St,title:"风格配置"},gateway:{render:Ct,title:"网关"},audit:{render:qt,title:"审计日志"},bilibili:{render:Ti,title:"B站集成"},query:{render:Bi,title:"查询"}};let nt=null;function Mi(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function ot(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function dt(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Pi(e){e.preventDefault();const t=document.getElementById("login-api-key"),l=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await g("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),dt(),Ye("dashboard")}catch{l.textContent="API Key 无效或服务不可用",l.style.display="block",window.__ADMIN_API_KEY__=""}}}function Ai(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",ot()}function Ye(e){if(!ze[e])return;nt=e,document.querySelectorAll("#nav-list .nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===e)}),document.getElementById("page-title").textContent=ze[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',ze[e].render(t).catch(l=>{t.innerHTML=`<div class="page-error">加载失败: ${l.message}</div>`})}function Ii(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==nt&&Ye(t)})})}function Ni(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),l=document.getElementById("expand-left-btn");t&&l&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),l.style.display="block"}),l.addEventListener("click",()=>{e.classList.remove("collapsed"),l.style.display="none"}))}function ji(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let l=0;e.addEventListener("click",()=>{l=(l+1)%t.length,t[l]?document.body.setAttribute("data-theme",t[l]):document.body.removeAttribute("data-theme")})}function Hi(){Ni(),ji(),Ii(),document.getElementById("login-form").addEventListener("submit",Pi),document.getElementById("logout-btn").addEventListener("click",Ai),Mi()?(dt(),Ye("dashboard")):ot()}Hi();
