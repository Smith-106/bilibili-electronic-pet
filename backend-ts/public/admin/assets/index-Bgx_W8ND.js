(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const l of i)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function s(i){const l={};return i.integrity&&(l.integrity=i.integrity),i.referrerPolicy&&(l.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?l.credentials="include":i.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(i){if(i.ep)return;i.ep=!0;const l=s(i);fetch(i.href,l)}})();function te(e,t,s){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof s=="string"&&s.trim()?s.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function U(){return(window.__ADMIN_API_KEY__||"").trim()}async function m(e,t={}){const s=U(),r=new Headers(t.headers||{});s&&r.set("x-api-key",s);const i=await fetch(e,{...t,headers:r}),l=await i.json().catch(()=>({}));if(!i.ok){const d=(l==null?void 0:l.detail)||(l==null?void 0:l.error);throw new Error(te(d,i.status,i.statusText))}return l}async function R(e,t){const s=U(),r=new Headers;s&&r.set("x-api-key",s);const i=await fetch(e,{headers:r});if(!i.ok)throw new Error("download_failed");const l=await i.blob(),d=URL.createObjectURL(l),n=document.createElement("a");n.href=d,n.download=t,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(d)}function w(e){const t=new URLSearchParams;for(const[r,i]of Object.entries(e))i!=null&&i!==""&&t.set(r,String(i));const s=t.toString();return s?`?${s}`:""}function $(){return{getOverview(){return m("/api/admin/overview")},getJobs({status:e,limit:t}={}){return m(`/api/admin/jobs${w({status:e,limit:t})}`)},getJob(e){return m(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return m(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return m(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return m("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return m("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return R(`/export/jobs.csv${w({status:e,limit:t})}`,"jobs.csv")},getComment(e){return m(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return m(`/api/admin/gateway/logs${w({limit:e,comment_id:t})}`)},publishGatewayReply(e){return m("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:s}={}){return m(`/api/admin/audit/summary${w({days:e,action:t,ok:s})}`)},getAuditLogs({limit:e,action:t,ok:s}={}){return m(`/api/audit-log${w({limit:e,action:t,ok:s})}`)},exportAuditCsv({limit:e,action:t,ok:s}={}){return R(`/export/audit-logs.csv${w({limit:e,action:t,ok:s})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return m(`/api/metrics/daily${w({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return m(`/api/admin/knowledge${w({limit:e,offset:t})}`)},createKnowledgeEntry(e){return m("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return m(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return m(`/api/admin/role-cards${w({limit:e,offset:t})}`)},createRoleCard(e){return m("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return m(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return m(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return m(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return m("/api/admin/style-profile")},setStyleProfile(e){return m("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return m("/api/admin/role-profile")},setRoleProfile(e){return m("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return m("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:s}={}){return m(`/api/admin/bilibili/videos${w({poll_enabled:e,limit:t,offset:s})}`)},addBilibiliVideo(e){return m("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return m("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return m("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return m("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return m(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return m(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function o(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function A(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function ie(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const s=Date.now()-t.getTime(),r=Math.floor(s/1e3);if(r<60)return"刚刚";const i=Math.floor(r/60);if(i<60)return`${i}分钟前`;const l=Math.floor(i/60);if(l<24)return`${l}小时前`;const d=Math.floor(l/24);if(d<30)return`${d}天前`;const n=Math.floor(d/30);return n<12?`${n}个月前`:`${Math.floor(n/12)}年前`}catch{return""}}function q(e){const t=ie(e),s=A(e);return t?`<span title="${o(s)}">${o(t)}</span>`:`<span title="${o(s)}">${o(s)}</span>`}function S(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const se={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function H(e){if(!e)return"";const t=se[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${o(t.label)}</span>`}function P(e,t="是",s="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${o(e?t:s)}</span>`}let j=null;function c(e,t="info"){const s=document.getElementById("app-toast");s&&s.remove(),j&&clearTimeout(j);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},i=document.createElement("div");i.id="app-toast",i.className="toast-notification",i.style.setProperty("--toast-color",r[t]||r.info),i.innerHTML=`
  ...
  `,document.body.appendChild(i),requestAnimationFrame(()=>i.classList.add("show"));const l=()=>{i.classList.remove("show"),setTimeout(()=>i.remove(),300)};i.querySelector(".toast-close").onclick=l,j=setTimeout(l,4e3)}const T=$();async function z(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,s,r,i]=await Promise.all([T.getOverview().catch(()=>null),T.getJobs({limit:5}).catch(()=>null),T.getGatewayLogs({limit:5}).catch(()=>null),T.getAuditSummary({days:7}).catch(()=>null)]),l=t||{},d=Array.isArray(s==null?void 0:s.items)?s.items:[],n=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{c("正在刷新...","info"),z(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${o(t.message)}</div>`}}const _=$();async function le(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;const s=e.querySelector("#jobs-status"),r=e.querySelector("#jobs-limit");async function i(){var n;t.clear(),l();const d=e.querySelector("#jobs-table-wrapper");d.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await _.getJobs({status:s.value,limit:r.value}),p=Array.isArray(a==null?void 0:a.items)?a.items:[];if(p.length===0){d.innerHTML='<div class="table-empty">暂无任务</div>';return}d.innerHTML=`
      ...
      `,(n=d.querySelector("#jobs-select-all"))==null||n.addEventListener("change",u=>{const v=u.target.checked;d.querySelectorAll(".job-checkbox").forEach(f=>{f.checked=v,v?t.add(f.dataset.id):t.delete(f.dataset.id)}),l()}),d.querySelectorAll(".job-checkbox").forEach(u=>{u.addEventListener("change",()=>{u.checked?t.add(u.dataset.id):t.delete(u.dataset.id),l()})}),d.querySelectorAll(".job-approve").forEach(u=>{u.addEventListener("click",async()=>{u.disabled=!0,u.textContent="审批中...";try{await _.approveJob(u.dataset.id),c("审批成功","success"),i()}catch(v){c(`审批失败: ${v.message}`,"error"),u.disabled=!1,u.textContent="审批"}})}),d.querySelectorAll(".job-retry").forEach(u=>{u.addEventListener("click",async()=>{u.disabled=!0,u.textContent="重试中...";try{await _.retryJob(u.dataset.id),c("重试已提交","success"),i()}catch(v){c(`重试失败: ${v.message}`,"error"),u.disabled=!1,u.textContent="重试"}})})}catch(a){d.innerHTML=`<div class="page-error">加载失败: ${o(a.message)}</div>`}}function l(){const d=e.querySelector("#jobs-batch-bar"),n=e.querySelector("#jobs-selected-count");t.size>0?(d.style.display="flex",n.textContent=`已选 ${t.size} 项`):d.style.display="none"}e.querySelector("#jobs-filter-btn").addEventListener("click",i),e.querySelector("#jobs-refresh").addEventListener("click",i),e.querySelector("#jobs-export").addEventListener("click",async()=>{try{await _.exportJobsCsv({status:s.value,limit:r.value}),c("导出成功","success")}catch(d){c(`导出失败: ${d.message}`,"error")}}),e.querySelector("#jobs-batch-approve").addEventListener("click",async()=>{if(t.size!==0)try{await _.batchApprove([...t]),c(`批量审批 ${t.size} 项成功`,"success"),i()}catch(d){c(`批量审批失败: ${d.message}`,"error")}}),e.querySelector("#jobs-batch-retry").addEventListener("click",async()=>{if(t.size!==0)try{await _.batchRetry([...t]),c(`批量重试 ${t.size} 项成功`,"success"),i()}catch(d){c(`批量重试失败: ${d.message}`,"error")}}),await i()}const re=$();async function ae(e){e.innerHTML=`
    <div class="page-header">
      <h2>每日指标</h2>
      <div class="page-actions">
  ...
  `;async function t(){const s=e.querySelector("#metrics-days").value,r=e.querySelector("#metrics-table-wrapper");r.innerHTML='<div class="page-loading">加载中...</div>';try{const i=await re.getDailyMetrics({days:s}),l=Array.isArray(i==null?void 0:i.items)?i.items:Array.isArray(i)?i:[];if(l.length===0){r.innerHTML='<div class="table-empty">暂无指标数据</div>';return}r.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `}catch(i){r.innerHTML=`<div class="page-error">加载失败: ${o(i.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const M=$();async function de(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const s=e.querySelector("#knowledge-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await M.getKnowledgeEntries({limit:50}),i=Array.isArray(r==null?void 0:r.items)?r.items:[];if(i.length===0){s.innerHTML='<div class="table-empty">暂无知识条目</div>';return}s.innerHTML=`
      ...
      `,s.querySelectorAll(".knowledge-disable").forEach(l=>{l.addEventListener("click",async()=>{try{await M.disableKnowledgeEntry(l.dataset.id),c("已禁用","success"),t()}catch(d){c(`操作失败: ${d.message}`,"error")}})})}catch(r){s.innerHTML=`<div class="page-error">加载失败: ${o(r.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const s=e.querySelector("#knowledge-category").value.trim(),r=e.querySelector("#knowledge-title").value.trim(),i=e.querySelector("#knowledge-content").value.trim();if(!r||!i){c("标题和内容不能为空","warning");return}try{await M.createKnowledgeEntry({category:s,title:r,content:i}),c("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(l){c(`创建失败: ${l.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const k=$();let L=!1,y=null;async function oe(e){L=!1,y=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `}const J=$();async function ue(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
  ...
  `;const t=e.querySelector("#gw-reply"),s=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{s.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const i=e.querySelector("#gw-publish-btn"),l=e.querySelector("#gw-comment-id").value.trim(),d=e.querySelector("#gw-reply").value.trim(),n=e.querySelector("#gw-source").value.trim(),a=e.querySelector("#gw-force").checked;if(!l||!d){c("Comment ID 和回复内容不能为空","warning");return}i.disabled=!0,i.textContent="发布中...";try{await J.publishGatewayReply({comment_id:l,reply_text:d,source:n,force_publish:a}),c("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",s.textContent="0/0",r()}catch(p){c(`发布失败: ${p.message}`,"error")}finally{i.disabled=!1,i.textContent="发布"}});async function r(){const i=e.querySelector("#gw-table-wrapper"),l=e.querySelector("#gw-limit").value;i.innerHTML='<div class="page-loading">加载中...</div>';try{const d=await J.getGatewayLogs({limit:l}),n=Array.isArray(d==null?void 0:d.items)?d.items:[];if(n.length===0){i.innerHTML='<div class="table-empty">暂无网关日志</div>';return}i.innerHTML=ce({columns:[{key:"id",label:"ID",class:"cell-id",render:a=>{var p;return o((p=a.id)==null?void 0:p.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:a=>{var p;return o((p=a.comment_id)==null?void 0:p.substring(0,12))}},{key:"status",label:"状态",render:a=>H(a.status)},{key:"platform",label:"平台",render:a=>o(a.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:a=>{var p;return o((p=a.reply_text)==null?void 0:p.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:a=>q(a.created_at)}],rows:n})}catch(d){i.innerHTML=`<div class="page-error">加载失败: ${o(d.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",r),e.querySelector("#gw-filter-btn").addEventListener("click",r),await r()}const B=$();async function ve(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const r=await B.getAuditSummary({days:7}),i=e.querySelector("#audit-summary-cards");i.innerHTML=`
      ...
      `}catch(n){r.innerHTML=`<div class="page-error">加载失败: ${o(n.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),s()}),e.querySelector("#audit-filter-btn").addEventListener("click",s),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await B.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),c("导出成功","success")}catch(r){c(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),s()])}const h=$(),be=/^BV[a-zA-Z0-9]{10}$/,pe={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},me={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},ye={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},fe={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},ge={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"};function g(e){const t=e instanceof Error?e.message:String(e??"request_failed");return pe[t]||t}function he(e){return e?be.test(e)?null:"invalid_bvid_format":"bvid_required"}function we(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function $e(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Se(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(s=>me[s]||s).join("；")}function _e(e){const t=String(e??"").trim().toLowerCase();return ye[t]||t||"-"}function qe(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function ke(e,t){const s=String(e??"").trim().toLowerCase();if(!s)return"-";const r=fe[s]||{label:s,cls:"badge-muted"},i=s==="error"&&t?ge[String(t).trim().toLowerCase()]||String(t):"",l=i?` title="${o(i)}"`:"";return`<span class="status-badge ${r.cls}"${l}>${o(r.label)}</span>${i?`<div class="form-hint" style="margin-top:4px;">${o(i)}</div>`:""}`}function D(e){return e?A(e):"-"}function Le(e){if(e==="true")return!0;if(e==="false")return!1}function xe(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function Ee(e,t,s){return`筛选: ${s==="true"?"轮询中":s==="false"?"已停用":"全部"}，共 ${e} 条，当前展示 ${t} 条`}function V(e,t={}){const s=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),i=Number((e==null?void 0:e.events_injected)??r),l=t.subject||(s===1?"视频":"轮询");return r>0||i>0?`${l}完成，处理 ${s} 个视频，新增 ${r} 条评论，注入 ${i} 个事件。`:s>0?`${l}完成，处理 ${s} 个视频，暂无新增评论。`:`${l}完成，暂无可处理视频。`}async function Te(e){e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function t(){var l,d,n,a,p,u,v,f;const i=e.querySelector("#bili-status-cards");try{const b=await h.getBilibiliStatus(),x=Number(((l=b==null?void 0:b.videos)==null?void 0:l.poll_enabled_count)??0),E=!!((d=b==null?void 0:b.diagnostics)!=null&&d.ready),N=Se((n=b==null?void 0:b.diagnostics)==null?void 0:n.blocking_reasons),W=(a=b==null?void 0:b.credential)!=null&&a.name?o(b.credential.name):"未配置",Z=_e((p=b==null?void 0:b.diagnostics)==null?void 0:p.effective_publish_mode),Q=qe((u=b==null?void 0:b.config)==null?void 0:u.poll_interval_seconds),X=D((v=b==null?void 0:b.credential)==null?void 0:v.expires_at),ee=D((f=b==null?void 0:b.credential)==null?void 0:f.last_used_at);i.innerHTML=`
        <div class="stat-card mini">
      ...
      `}catch(b){i.innerHTML=`<div class="page-error">状态加载失败: ${o(g(b))}</div>`}}async function s(){const i=e.querySelector("#bili-videos-wrapper"),l=e.querySelector("#bili-video-summary"),d=e.querySelector("#bili-video-filter-btn"),n=e.querySelector("#bili-video-poll-filter").value;l.textContent="加载中...",d.disabled=!0;try{const a=await h.getBilibiliVideos({limit:50,poll_enabled:Le(n)}),p=Array.isArray(a==null?void 0:a.items)?a.items:Array.isArray(a)?a:[],u=Number((a==null?void 0:a.total)??p.length);if(l.textContent=Ee(u,p.length,n),p.length===0){i.innerHTML=`<div class="table-empty">${o(xe(n))}</div>`;return}i.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${p.map(v=>`<tr data-id="${o(v.id||v.video_id)}">
              ...
              <td>${ke(v.last_poll_status,v.last_poll_error)}</td>
              <td class="cell-actions">
      ...
      `,i.querySelectorAll(".cred-activate").forEach(n=>{n.addEventListener("click",async()=>{n.disabled=!0;try{await h.activateBilibiliCredential(n.dataset.id),c("已激活","success"),await Promise.all([t(),r()])}catch(a){c(`激活失败: ${g(a)}`,"error")}finally{n.disabled=!1}})}),i.querySelectorAll(".cred-delete").forEach(n=>{n.addEventListener("click",async()=>{if(confirm("确定删除此凭证？")){n.disabled=!0;try{await h.deleteBilibiliCredential(n.dataset.id),c("已删除","success"),await Promise.all([t(),r()])}catch(a){c(`删除失败: ${g(a)}`,"error")}finally{n.disabled=!1}}})})}catch(l){i.innerHTML=`<div class="page-error">加载失败: ${o(g(l))}</div>`}}e.querySelector("#bili-video-add").addEventListener("click",async()=>{const i=e.querySelector("#bili-video-add"),l=e.querySelector("#bili-video-bvid").value.trim(),d=he(l);if(d){c(g(d),"warning");return}i.disabled=!0,i.textContent="添加中...";try{await h.addBilibiliVideo(l),c("添加成功","success"),e.querySelector("#bili-video-bvid").value="",await Promise.all([t(),s()])}catch(n){c(`添加失败: ${g(n)}`,"error")}finally{i.disabled=!1,i.textContent="添加"}}),e.querySelector("#cred-add").addEventListener("click",async()=>{const i=e.querySelector("#cred-add"),l=$e(e.querySelector("#cred-expires").value),d={name:e.querySelector("#cred-name").value.trim(),sessdata:e.querySelector("#cred-sessdata").value.trim(),bili_jct:e.querySelector("#cred-bili-jct").value.trim(),buvid3:e.querySelector("#cred-buvid3").value.trim(),buvid4:e.querySelector("#cred-buvid4").value.trim(),expires_at:l},n=we(d);if(n){c(g(n),"warning");return}i.disabled=!0,i.textContent="添加中...";try{await h.addBilibiliCredential(d),c("凭证添加成功","success"),e.querySelector("#cred-name").value="",e.querySelector("#cred-sessdata").value="",e.querySelector("#cred-bili-jct").value="",e.querySelector("#cred-buvid3").value="",e.querySelector("#cred-buvid4").value="",e.querySelector("#cred-expires").value="",await Promise.all([t(),r()])}catch(a){c(`添加失败: ${g(a)}`,"error")}finally{i.disabled=!1,i.textContent="添加凭证"}}),e.querySelector("#bili-poll-btn").addEventListener("click",async()=>{const i=e.querySelector("#bili-poll-btn");i.disabled=!0,i.textContent="轮询中...";try{const l=await h.triggerBilibiliPoll();c(V(l==null?void 0:l.result),"success"),await Promise.all([t(),s()])}catch(l){c(`轮询失败: ${g(l)}`,"error")}finally{i.disabled=!1,i.textContent="触发轮询"}}),e.querySelector("#bili-refresh").addEventListener("click",()=>{t(),s(),r()}),e.querySelector("#bili-video-filter-btn").addEventListener("click",s),e.querySelector("#bili-video-poll-filter").addEventListener("change",s),await Promise.all([t(),s(),r()])}const K=$();async function Ce(e){e.innerHTML=`
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),s=e.querySelector("#query-comment-result");if(!t){c("请输入 Comment ID","warning");return}s.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await K.getComment(t);s.innerHTML=`
      ...
      `}catch(r){s.innerHTML=`<div class="page-error">查询失败: ${o(r.message)}</div>`}}),e.querySelector("#query-job-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-job-id").value.trim(),s=e.querySelector("#query-job-result");if(!t){c("请输入 Job ID","warning");return}s.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await K.getJob(t);s.innerHTML=`
        <div class="detail-card">
      ...
      `;const i=s.querySelector("#query-goto-comment");i&&i.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=i.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){s.innerHTML=`<div class="page-error">查询失败: ${o(r.message)}</div>`}})}const I={dashboard:{render:z,title:"仪表盘"},jobs:{render:le,title:"任务管理"},"daily-metrics":{render:ae,title:"每日指标"},knowledge:{render:de,title:"知识库"},"role-cards":{render:oe,title:"角色卡"},profiles:{render:ne,title:"风格配置"},gateway:{render:ue,title:"网关"},audit:{render:ve,title:"审计日志"},bilibili:{render:Te,title:"B站集成"},query:{render:Ce,title:"查询"}};let G=null;function Ae(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function F(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function Y(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function je(e){e.preventDefault();const t=document.getElementById("login-api-key"),s=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await m("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),Y(),O("dashboard")}catch{s.textContent="API Key 无效或服务不可用",s.style.display="block",window.__ADMIN_API_KEY__=""}}}function Me(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",F()}function O(e){if(!I[e])return;G=e,document.querySelectorAll("#nav-list .nav-item").forEach(s=>{s.classList.toggle("active",s.dataset.page===e)}),document.getElementById("page-title").textContent=I[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',I[e].render(t).catch(s=>{t.innerHTML=`<div class="page-error">加载失败: ${s.message}</div>`})}function Be(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==G&&O(t)})})}function Ie(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),s=document.getElementById("expand-left-btn");t&&s&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),s.style.display="block"}),s.addEventListener("click",()=>{e.classList.remove("collapsed"),s.style.display="none"}))}function Pe(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let s=0;e.addEventListener("click",()=>{s=(s+1)%t.length,t[s]?document.body.setAttribute("data-theme",t[s]):document.body.removeAttribute("data-theme")})}function He(){Ie(),Pe(),Be(),document.getElementById("login-form").addEventListener("submit",je),document.getElementById("logout-btn").addEventListener("click",Me),Ae()?(Y(),O("dashboard")):F()}He();
