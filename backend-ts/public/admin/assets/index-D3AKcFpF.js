(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))s(l);new MutationObserver(l=>{for(const r of l)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(l){const r={};return l.integrity&&(r.integrity=l.integrity),l.referrerPolicy&&(r.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?r.credentials="include":l.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(l){if(l.ep)return;l.ep=!0;const r=i(l);fetch(l.href,r)}})();function de(e,t,i){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof i=="string"&&i.trim()?i.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function Q(){return(window.__ADMIN_API_KEY__||"").trim()}async function y(e,t={}){const i=Q(),s=new Headers(t.headers||{});i&&s.set("x-api-key",i);const l=await fetch(e,{...t,headers:s}),r=await l.json().catch(()=>({}));if(!l.ok){const a=(r==null?void 0:r.detail)||(r==null?void 0:r.error);throw new Error(de(a,l.status,l.statusText))}return r}async function z(e,t){const i=Q(),s=new Headers;i&&s.set("x-api-key",i);const l=await fetch(e,{headers:s});if(!l.ok)throw new Error("download_failed");const r=await l.blob(),a=URL.createObjectURL(r),u=document.createElement("a");u.href=a,u.download=t,document.body.appendChild(u),u.click(),document.body.removeChild(u),URL.revokeObjectURL(a)}function w(e){const t=new URLSearchParams;for(const[s,l]of Object.entries(e))l!=null&&l!==""&&t.set(s,String(l));const i=t.toString();return i?`?${i}`:""}function S(){return{getOverview(){return y("/api/admin/overview")},getJobs({status:e,limit:t}={}){return y(`/api/admin/jobs${w({status:e,limit:t})}`)},getJob(e){return y(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return y(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return y(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return y("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return y("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return z(`/export/jobs.csv${w({status:e,limit:t})}`,"jobs.csv")},getComment(e){return y(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return y(`/api/admin/gateway/logs${w({limit:e,comment_id:t})}`)},publishGatewayReply(e){return y("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:i}={}){return y(`/api/admin/audit/summary${w({days:e,action:t,ok:i})}`)},getAuditLogs({limit:e,action:t,ok:i}={}){return y(`/api/audit-log${w({limit:e,action:t,ok:i})}`)},exportAuditCsv({limit:e,action:t,ok:i}={}){return z(`/export/audit-logs.csv${w({limit:e,action:t,ok:i})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return y(`/api/metrics/daily${w({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return y(`/api/admin/knowledge${w({limit:e,offset:t})}`)},createKnowledgeEntry(e){return y("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return y(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return y(`/api/admin/role-cards${w({limit:e,offset:t})}`)},createRoleCard(e){return y("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return y(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return y(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return y(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return y("/api/admin/style-profile")},setStyleProfile(e){return y("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return y("/api/admin/role-profile")},setRoleProfile(e){return y("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return y("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:i}={}){return y(`/api/admin/bilibili/videos${w({poll_enabled:e,limit:t,offset:i})}`)},addBilibiliVideo(e){return y("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return y(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return y("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return y("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return y("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return y(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return y(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function n(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function E(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function ne(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const i=Date.now()-t.getTime(),s=Math.floor(i/1e3);if(s<60)return"刚刚";const l=Math.floor(s/60);if(l<60)return`${l}分钟前`;const r=Math.floor(l/60);if(r<24)return`${r}小时前`;const a=Math.floor(r/24);if(a<30)return`${a}天前`;const u=Math.floor(a/30);return u<12?`${u}个月前`:`${Math.floor(u/12)}年前`}catch{return""}}function C(e){const t=ne(e),i=E(e);return t?`<span title="${n(i)}">${n(t)}</span>`:`<span title="${n(i)}">${n(i)}</span>`}function q(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const oe={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function J(e){if(!e)return"";const t=oe[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${n(t.label)}</span>`}function D(e,t="是",i="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${n(e?t:i)}</span>`}let H=null;function b(e,t="info"){const i=document.getElementById("app-toast");i&&i.remove(),H&&clearTimeout(H);const s={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},l=document.createElement("div");l.id="app-toast",l.className="toast-notification",l.style.setProperty("--toast-color",s[t]||s.info),l.innerHTML=`
        ...
        <div class="section-card">
          ...
          <div class="audit-summary-grid">
            <div class="stat-card mini">
              ...
              <div class="stat-value">${q(l==null?void 0:l.total)}</div>
            </div>
            <div class="stat-card mini">
              <div class="stat-label">成功</div>
              <div class="stat-value" style="color:var(--success-color)">${q(l==null?void 0:l.ok_count)}</div>
            </div>
            <div class="stat-card mini">
              <div class="stat-label">失败</div>
              <div class="stat-value" style="color:var(--danger-color)">${q(l==null?void 0:l.failed_count)}</div>
            </div>
          </div>
        </div>
      </div>
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{b("正在刷新...","info"),X(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${n(t.message)}</div>`}}const k=S();async function ce(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
          ...
          <tbody>
            ${v.map(c=>{var m,p,g,o;return`
              <tr data-id="${n(c.id)}">
                ...
                <td>${(o=c.risk_flags)!=null&&o.length?c.risk_flags.map(_=>`<span class="risk-flag">${n(_)}</span>`).join(" "):"-"}</td>
  ...
  `;async function t(){const i=e.querySelector("#metrics-days").value,s=e.querySelector("#metrics-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';try{const l=await ue.getDailyMetrics({days:i}),r=Array.isArray(l==null?void 0:l.items)?l.items:Array.isArray(l)?l:[];if(r.length===0){s.innerHTML='<div class="table-empty">暂无指标数据</div>';return}s.innerHTML=`
      ...
      `}catch(l){s.innerHTML=`<div class="page-error">加载失败: ${n(l.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const O=S();async function be(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const i=e.querySelector("#knowledge-table-wrapper");i.innerHTML='<div class="page-loading">加载中...</div>';try{const s=await O.getKnowledgeEntries({limit:50}),l=Array.isArray(s==null?void 0:s.items)?s.items:[];if(l.length===0){i.innerHTML='<div class="table-empty">暂无知识条目</div>';return}i.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `,i.querySelectorAll(".knowledge-disable").forEach(r=>{r.addEventListener("click",async()=>{try{await O.disableKnowledgeEntry(r.dataset.id),b("已禁用","success"),t()}catch(a){b(`操作失败: ${a.message}`,"error")}})})}catch(s){i.innerHTML=`<div class="page-error">加载失败: ${n(s.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const i=e.querySelector("#knowledge-category").value.trim(),s=e.querySelector("#knowledge-title").value.trim(),l=e.querySelector("#knowledge-content").value.trim();if(!s||!l){b("标题和内容不能为空","warning");return}try{await O.createKnowledgeEntry({category:i,title:s,content:l}),b("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(r){b(`创建失败: ${r.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const T=S();let A=!1,f=null;async function pe(e){A=!1,f=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `;const t=e.querySelector("#gw-reply"),i=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{i.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const l=e.querySelector("#gw-publish-btn"),r=e.querySelector("#gw-comment-id").value.trim(),a=e.querySelector("#gw-reply").value.trim(),u=e.querySelector("#gw-source").value.trim(),d=e.querySelector("#gw-force").checked;if(!r||!a){b("Comment ID 和回复内容不能为空","warning");return}l.disabled=!0,l.textContent="发布中...";try{await G.publishGatewayReply({comment_id:r,reply_text:a,source:u,force_publish:d}),b("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",i.textContent="0/0",s()}catch(v){b(`发布失败: ${v.message}`,"error")}finally{l.disabled=!1,l.textContent="发布"}});async function s(){const l=e.querySelector("#gw-table-wrapper"),r=e.querySelector("#gw-limit").value;l.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await G.getGatewayLogs({limit:r}),u=Array.isArray(a==null?void 0:a.items)?a.items:[];if(u.length===0){l.innerHTML='<div class="table-empty">暂无网关日志</div>';return}l.innerHTML=ye({columns:[{key:"id",label:"ID",class:"cell-id",render:d=>{var v;return n((v=d.id)==null?void 0:v.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:d=>{var v;return n((v=d.comment_id)==null?void 0:v.substring(0,12))}},{key:"status",label:"状态",render:d=>J(d.status)},{key:"platform",label:"平台",render:d=>n(d.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:d=>{var v;return n((v=d.reply_text)==null?void 0:v.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:d=>C(d.created_at)}],rows:u})}catch(a){l.innerHTML=`<div class="page-error">加载失败: ${n(a.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",s),e.querySelector("#gw-filter-btn").addEventListener("click",s),await s()}const N=S();async function ge(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const s=await N.getAuditSummary({days:7}),l=e.querySelector("#audit-summary-cards");l.innerHTML=`
        <div class="stat-card mini">
          <div class="stat-label">总操作</div>
      ...
      `}catch{e.querySelector("#audit-summary-cards").innerHTML='<div class="page-error">摘要加载失败</div>'}}async function i(){const s=e.querySelector("#audit-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';const l=e.querySelector("#audit-action").value.trim(),r=e.querySelector("#audit-ok").value,a=e.querySelector("#audit-limit").value;try{const u=await N.getAuditLogs({action:l,ok:r,limit:a}),d=Array.isArray(u==null?void 0:u.items)?u.items:[];if(d.length===0){s.innerHTML='<div class="table-empty">暂无审计日志</div>';return}s.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `}catch(u){s.innerHTML=`<div class="page-error">加载失败: ${n(u.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),i()}),e.querySelector("#audit-filter-btn").addEventListener("click",i),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await N.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),b("导出成功","success")}catch(s){b(`导出失败: ${s.message}`,"error")}}),await Promise.all([t(),i()])}const $=S(),he=/^BV[a-zA-Z0-9]{10}$/,$e={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},we={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},Se={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},_e={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},I={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},L=50,qe=7*24*60*60*1e3;function h(e){const t=e instanceof Error?e.message:String(e??"request_failed");return $e[t]||t}function xe(e){return e?he.test(e)?null:"invalid_bvid_format":"bvid_required"}function ke(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Le(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Ee(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(i=>we[i]||i).join("；")}function Ce(e){const t=String(e??"").trim().toLowerCase();return Se[t]||t||"-"}function Te(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Ae(e,t){const i=String(e??"").trim().toLowerCase();if(!i)return"-";const s=_e[i]||{label:i,cls:"badge-muted"},l=i==="error"&&t?I[String(t).trim().toLowerCase()]||String(t):"",r=l?` title="${n(l)}"`:"";return`<span class="status-badge ${s.cls}"${r}>${n(s.label)}</span>${l?`<div class="form-hint" style="margin-top:4px;">${n(l)}</div>`:""}`}function Me(e){return e?E(e):"-"}function Be(e){if(e==="true")return!0;if(e==="false")return!1}function je(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function K(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Ie(e){return e.filter(t=>!K(t)).length}function Pe(e){const i=K(e)?`aid: ${e.aid}`:I.no_aid;return`${n((e==null?void 0:e.bvid)||"-")}${i?`<div class="form-hint" style="margin-top:4px;">${n(i)}</div>`:""}`}function He(e){const t=K(e),i=t?"":" disabled",s=t?"":` title="${n(I.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${n(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${i}${s}>同步</button>`}function Oe(e,t,i,s=0,l=L,r=[]){const a=i==="true"?"轮询中":i==="false"?"已停用":"全部",u=Math.floor(s/l)+1,d=Math.max(1,Math.ceil(e/l)),v=Ie(r),c=v>0?`，当前页缺少 aid ${v} 条`:"";return`筛选: ${a}，共 ${e} 条，当前展示 ${t} 条，第 ${u}/${d} 页${c}`}function Y(e,t={}){const i=Number((e==null?void 0:e.videos)??0),s=Number((e==null?void 0:e.comments)??0),l=Number((e==null?void 0:e.events_injected)??s),r=t.subject||(i===1?"视频":"轮询");return s>0||l>0?`${r}完成，处理 ${i} 个视频，新增 ${s} 条评论，注入 ${l} 个事件。`:i>0?`${r}完成，处理 ${i} 个视频，暂无新增评论。`:`${r}完成，暂无可处理视频。`}function P(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const i=new Date(e);if(Number.isNaN(i.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const s=i.getTime()-t;return s<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:E(e)}:s<=qe?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:E(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:E(e)}}function Ne(e){const t=P(e),i=t.detail?`<div class="form-hint" style="margin-top:4px;">${n(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${n(t.label)}</span>${i}`}function Re(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function F(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function De(e,t="",i="",s=e.length){const l=e.length,r=e.filter(m=>m.is_active||m.active).length,a=Date.now(),u=e.map(m=>P(m.expires_at,a)),d=u.filter(m=>m.hasExpiry).length,v=u.filter(m=>m.expired).length,c=F(t,i);return`共 ${l} 个凭证，激活中 ${r} 个，设置过期时间 ${d} 个，已过期 ${v} 个；筛选: ${c}，当前展示 ${s} 个`}function Je(e,t="",i=""){const s=Date.now();return e.filter(l=>{const r=l.is_active||l.active;if(t==="active"&&!r||t==="inactive"&&r)return!1;const a=P(l.expires_at,s);return!(i==="expired"&&!a.expired||i==="expiring"&&!a.expiringSoon||i==="valid"&&(!a.hasExpiry||a.expired)||i==="unset"&&a.hasExpiry)})}function Ke(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${F(e,t)}）`:"暂无凭证"}function W(e,t,i){const s=e.querySelector(i);t.forEach(l=>{const r=e.querySelector(l);r==null||r.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),s.disabled||s.click())})})}async function Ue(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function i(){var a,u,d,v,c,m,p,g;const r=e.querySelector("#bili-status-cards");try{const o=await $.getBilibiliStatus(),_=Number(((a=o==null?void 0:o.videos)==null?void 0:a.poll_enabled_count)??0),x=!!((u=o==null?void 0:o.diagnostics)!=null&&u.ready),V=Ee((d=o==null?void 0:o.diagnostics)==null?void 0:d.blocking_reasons),se=(v=o==null?void 0:o.credential)!=null&&v.name?n(o.credential.name):"未配置",le=Ce((c=o==null?void 0:o.diagnostics)==null?void 0:c.effective_publish_mode),re=Te((m=o==null?void 0:o.config)==null?void 0:m.poll_interval_seconds),M=P((p=o==null?void 0:o.credential)==null?void 0:p.expires_at),ae=Me((g=o==null?void 0:o.credential)==null?void 0:g.last_used_at);r.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${Re(M)}">${n(M.label)}</div>
        ...
        ${V?`<div class="page-error" style="grid-column: 1 / -1; margin: 0;">阻塞原因: ${n(V)}</div>`:""}
      `}catch(o){r.innerHTML=`<div class="page-error">状态加载失败: ${n(h(o))}</div>`}}async function s(){const r=e.querySelector("#bili-videos-wrapper"),a=e.querySelector("#bili-video-summary"),u=e.querySelector("#bili-video-filter-btn"),d=e.querySelector("#bili-video-prev"),v=e.querySelector("#bili-video-next"),c=e.querySelector("#bili-video-poll-filter").value;a.textContent="加载中...",u.disabled=!0,d.disabled=!0,v.disabled=!0;try{const m=await $.getBilibiliVideos({limit:L,offset:t,poll_enabled:Be(c)}),p=Array.isArray(m==null?void 0:m.items)?m.items:Array.isArray(m)?m:[],g=Number((m==null?void 0:m.total)??p.length);if(p.length===0&&g>0&&t>0){t=Math.max(0,t-L),await s();return}if(a.textContent=Oe(g,p.length,c,t,L,p),d.disabled=t<=0,v.disabled=t+p.length>=g,p.length===0){r.innerHTML=`<div class="table-empty">${n(je(c))}</div>`;return}r.innerHTML=`
        <table class="data-table">
      ...
      `,r.querySelectorAll(".bili-toggle-poll").forEach(o=>{o.addEventListener("click",async()=>{o.disabled=!0;try{await $.toggleBilibiliVideoPoll(o.dataset.id),b("操作成功","success"),await Promise.all([i(),s()])}catch(_){b(`失败: ${h(_)}`,"error")}finally{o.disabled=!1}})}),r.querySelectorAll(".bili-sync").forEach(o=>{o.addEventListener("click",async()=>{if(o.dataset.hasAid==="false"){b(I.no_aid,"warning");return}const _=o.textContent;o.disabled=!0,o.textContent="同步中...";try{const x=await $.syncBilibiliVideo(o.dataset.id);b(Y(x==null?void 0:x.result,{subject:"同步"}),"success"),await Promise.all([i(),s()])}catch(x){b(`同步失败: ${h(x)}`,"error")}finally{o.disabled=!1,o.textContent=_}})}),r.querySelectorAll(".bili-delete").forEach(o=>{o.addEventListener("click",async()=>{if(confirm("确定删除此视频？")){o.disabled=!0;try{await $.deleteBilibiliVideo(o.dataset.id),b("已删除","success"),await Promise.all([i(),s()])}catch(_){b(`删除失败: ${h(_)}`,"error")}finally{o.disabled=!1}}})})}catch(m){a.textContent="视频加载失败",r.innerHTML=`<div class="page-error">加载失败: ${n(h(m))}</div>`}finally{u.disabled=!1}}async function l(){const r=e.querySelector("#bili-creds-wrapper"),a=e.querySelector("#bili-cred-summary"),u=e.querySelector("#bili-cred-active-filter").value,d=e.querySelector("#bili-cred-expiry-filter").value;try{const v=await $.getBilibiliCredentials(),c=Array.isArray(v==null?void 0:v.items)?v.items:Array.isArray(v)?v:[],m=Je(c,u,d);if(a.textContent=De(c,u,d,m.length),m.length===0){r.innerHTML=`<div class="table-empty">${n(Ke(u,d))}</div>`;return}r.innerHTML=`
        <table class="data-table">
