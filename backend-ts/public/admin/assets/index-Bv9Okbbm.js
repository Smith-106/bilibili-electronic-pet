(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const l of r)if(l.type==="childList")for(const a of l.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(r){const l={};return r.integrity&&(l.integrity=r.integrity),r.referrerPolicy&&(l.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?l.credentials="include":r.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(r){if(r.ep)return;r.ep=!0;const l=i(r);fetch(r.href,l)}})();function Ze(e,t,i){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof i=="string"&&i.trim()?i.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function Me(){return(window.__ADMIN_API_KEY__||"").trim()}async function g(e,t={}){const i=Me(),s=new Headers(t.headers||{});i&&s.set("x-api-key",i);const r=await fetch(e,{...t,headers:s}),l=await r.json().catch(()=>({}));if(!r.ok){const a=(l==null?void 0:l.detail)||(l==null?void 0:l.error);throw new Error(Ze(a,r.status,r.statusText))}return l}async function qe(e,t){const i=Me(),s=new Headers;i&&s.set("x-api-key",i);const r=await fetch(e,{headers:s});if(!r.ok)throw new Error("download_failed");const l=await r.blob(),a=URL.createObjectURL(l),p=document.createElement("a");p.href=a,p.download=t,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(a)}function T(e){const t=new URLSearchParams;for(const[s,r]of Object.entries(e))r!=null&&r!==""&&t.set(s,String(r));const i=t.toString();return i?`?${i}`:""}function M(){return{getOverview(){return g("/api/admin/overview")},getJobs({status:e,limit:t}={}){return g(`/api/admin/jobs${T({status:e,limit:t})}`)},getJob(e){return g(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return g(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return g(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return g("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return g("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return qe(`/export/jobs.csv${T({status:e,limit:t})}`,"jobs.csv")},getComment(e){return g(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return g(`/api/admin/gateway/logs${T({limit:e,comment_id:t})}`)},publishGatewayReply(e){return g("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:i}={}){return g(`/api/admin/audit/summary${T({days:e,action:t,ok:i})}`)},getAuditLogs({limit:e,action:t,ok:i}={}){return g(`/api/audit-log${T({limit:e,action:t,ok:i})}`)},exportAuditCsv({limit:e,action:t,ok:i}={}){return qe(`/export/audit-logs.csv${T({limit:e,action:t,ok:i})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return g(`/api/metrics/daily${T({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return g(`/api/admin/knowledge${T({limit:e,offset:t})}`)},createKnowledgeEntry(e){return g("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return g(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return g(`/api/admin/role-cards${T({limit:e,offset:t})}`)},createRoleCard(e){return g("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return g(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return g(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return g("/api/admin/style-profile")},setStyleProfile(e){return g("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return g("/api/admin/role-profile")},setRoleProfile(e){return g("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return g("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:i}={}){return g(`/api/admin/bilibili/videos${T({poll_enabled:e,limit:t,offset:i})}`)},addBilibiliVideo(e){return g("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return g(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return g("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return g("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return g("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return g(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function o(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function B(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function Qe(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const i=Date.now()-t.getTime(),s=Math.floor(i/1e3);if(s<60)return"刚刚";const r=Math.floor(s/60);if(r<60)return`${r}分钟前`;const l=Math.floor(r/60);if(l<24)return`${l}小时前`;const a=Math.floor(l/24);if(a<30)return`${a}天前`;const p=Math.floor(a/30);return p<12?`${p}个月前`:`${Math.floor(p/12)}年前`}catch{return""}}function ee(e){const t=Qe(e),i=B(e);return t?`<span title="${o(i)}">${o(t)}</span>`:`<span title="${o(i)}">${o(i)}</span>`}function I(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const Xe={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function Se(e){if(!e)return"";const t=Xe[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${o(t.label)}</span>`}function we(e,t="是",i="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${o(e?t:i)}</span>`}let me=null;function v(e,t="info"){const i=document.getElementById("app-toast");i&&i.remove(),me&&clearTimeout(me);const s={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},r=document.createElement("div");r.id="app-toast",r.className="toast-notification",r.style.setProperty("--toast-color",s[t]||s.info),r.innerHTML=`
  ...
  `,document.body.appendChild(r),requestAnimationFrame(()=>r.classList.add("show"));const l=()=>{r.classList.remove("show"),setTimeout(()=>r.remove(),300)};r.querySelector(".toast-close").onclick=l,me=setTimeout(l,4e3)}const re=M();async function Ae(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,i,s,r]=await Promise.all([re.getOverview().catch(()=>null),re.getJobs({limit:5}).catch(()=>null),re.getGatewayLogs({limit:5}).catch(()=>null),re.getAuditSummary({days:7}).catch(()=>null)]),l=t||{},a=Array.isArray(i==null?void 0:i.items)?i.items:[],p=Array.isArray(s==null?void 0:s.items)?s.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{v("正在刷新...","info"),Ae(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${o(t.message)}</div>`}}const Q=M();async function et(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;const i=e.querySelector("#jobs-status"),s=e.querySelector("#jobs-limit");async function r(){var p;t.clear(),l();const a=e.querySelector("#jobs-table-wrapper");a.innerHTML='<div class="page-loading">加载中...</div>';try{const n=await Q.getJobs({status:i.value,limit:s.value}),b=Array.isArray(n==null?void 0:n.items)?n.items:[];if(b.length===0){a.innerHTML='<div class="table-empty">暂无任务</div>';return}a.innerHTML=`
        <table class="data-table">
          <thead><tr>
          ...
          <tbody>
            ${b.map(c=>{var h,m,$,y;return`
              <tr data-id="${o(c.id)}">
                ...
                <td class="cell-time">${ee(c.created_at)}</td>
      ...
      `,(p=a.querySelector("#jobs-select-all"))==null||p.addEventListener("change",c=>{const h=c.target.checked;a.querySelectorAll(".job-checkbox").forEach(m=>{m.checked=h,h?t.add(m.dataset.id):t.delete(m.dataset.id)}),l()}),a.querySelectorAll(".job-checkbox").forEach(c=>{c.addEventListener("change",()=>{c.checked?t.add(c.dataset.id):t.delete(c.dataset.id),l()})}),a.querySelectorAll(".job-approve").forEach(c=>{c.addEventListener("click",async()=>{c.disabled=!0,c.textContent="审批中...";try{await Q.approveJob(c.dataset.id),v("审批成功","success"),r()}catch(h){v(`审批失败: ${h.message}`,"error"),c.disabled=!1,c.textContent="审批"}})}),a.querySelectorAll(".job-retry").forEach(c=>{c.addEventListener("click",async()=>{c.disabled=!0,c.textContent="重试中...";try{await Q.retryJob(c.dataset.id),v("重试已提交","success"),r()}catch(h){v(`重试失败: ${h.message}`,"error"),c.disabled=!1,c.textContent="重试"}})})}catch(n){a.innerHTML=`<div class="page-error">加载失败: ${o(n.message)}</div>`}}function l(){const a=e.querySelector("#jobs-batch-bar"),p=e.querySelector("#jobs-selected-count");t.size>0?(a.style.display="flex",p.textContent=`已选 ${t.size} 项`):a.style.display="none"}e.querySelector("#jobs-filter-btn").addEventListener("click",r),e.querySelector("#jobs-refresh").addEventListener("click",r),e.querySelector("#jobs-export").addEventListener("click",async()=>{try{await Q.exportJobsCsv({status:i.value,limit:s.value}),v("导出成功","success")}catch(a){v(`导出失败: ${a.message}`,"error")}}),e.querySelector("#jobs-batch-approve").addEventListener("click",async()=>{if(t.size!==0)try{await Q.batchApprove([...t]),v(`批量审批 ${t.size} 项成功`,"success"),r()}catch(a){v(`批量审批失败: ${a.message}`,"error")}}),e.querySelector("#jobs-batch-retry").addEventListener("click",async()=>{if(t.size!==0)try{await Q.batchRetry([...t]),v(`批量重试 ${t.size} 项成功`,"success"),r()}catch(a){v(`批量重试失败: ${a.message}`,"error")}}),await r()}const tt=M();async function it(e){e.innerHTML=`
    <div class="page-header">
      <h2>每日指标</h2>
      <div class="page-actions">
  ...
  `;async function t(){const i=e.querySelector("#metrics-days").value,s=e.querySelector("#metrics-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await tt.getDailyMetrics({days:i}),l=Array.isArray(r==null?void 0:r.items)?r.items:Array.isArray(r)?r:[];if(l.length===0){s.innerHTML='<div class="table-empty">暂无指标数据</div>';return}s.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `}catch(r){s.innerHTML=`<div class="page-error">加载失败: ${o(r.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const $e=M();async function lt(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${r.map(l=>{var a,p;return`<tr>
              ...
              <td class="cell-time">${ee(l.created_at)}</td>
              <td class="cell-actions">
  ...
  `}const Ce=M();async function nt(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
  ...
  `;const t=e.querySelector("#gw-reply"),i=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{i.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const r=e.querySelector("#gw-publish-btn"),l=e.querySelector("#gw-comment-id").value.trim(),a=e.querySelector("#gw-reply").value.trim(),p=e.querySelector("#gw-source").value.trim(),n=e.querySelector("#gw-force").checked;if(!l||!a){v("Comment ID 和回复内容不能为空","warning");return}r.disabled=!0,r.textContent="发布中...";try{await Ce.publishGatewayReply({comment_id:l,reply_text:a,source:p,force_publish:n}),v("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",i.textContent="0/0",s()}catch(b){v(`发布失败: ${b.message}`,"error")}finally{r.disabled=!1,r.textContent="发布"}});async function s(){const r=e.querySelector("#gw-table-wrapper"),l=e.querySelector("#gw-limit").value;r.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await Ce.getGatewayLogs({limit:l}),p=Array.isArray(a==null?void 0:a.items)?a.items:[];if(p.length===0){r.innerHTML='<div class="table-empty">暂无网关日志</div>';return}r.innerHTML=at({columns:[{key:"id",label:"ID",class:"cell-id",render:n=>{var b;return o((b=n.id)==null?void 0:b.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:n=>{var b;return o((b=n.comment_id)==null?void 0:b.substring(0,12))}},{key:"status",label:"状态",render:n=>Se(n.status)},{key:"platform",label:"平台",render:n=>o(n.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:n=>{var b;return o((b=n.reply_text)==null?void 0:b.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:n=>ee(n.created_at)}],rows:p})}catch(a){r.innerHTML=`<div class="page-error">加载失败: ${o(a.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",s),e.querySelector("#gw-filter-btn").addEventListener("click",s),await s()}const _e=M();async function ot(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
        ...
        <table class="data-table">
          ...
          <tbody>
            ${n.map(b=>{var c;return`<tr>
              ...
              <td class="cell-time">${ee(b.created_at)}</td>
            </tr>`}).join("")}
          </tbody>
        </table>
      `}catch(p){s.innerHTML=`<div class="page-error">加载失败: ${o(p.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),i()}),e.querySelector("#audit-filter-btn").addEventListener("click",i),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await _e.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(s){v(`导出失败: ${s.message}`,"error")}}),await Promise.all([t(),i()])}const k=M(),dt=/^BV[a-zA-Z0-9]{10}$/,ct={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},ut={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},pt={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},bt={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},ne={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},X=50,vt=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return ct[t]||t}function ft(e){return e?dt.test(e)?null:"invalid_bvid_format":"bvid_required"}function yt(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function gt(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function ht(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(i=>ut[i]||i).join("；")}function mt(e){const t=String(e??"").trim().toLowerCase();return pt[t]||t||"-"}function $t(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function _t(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function xt(e,t){const i=Number(t??0);if(!Number.isFinite(i)||i<=0)return"暂无视频";const s=Number(e??0);return`覆盖率 ${((Number.isFinite(s)?Math.min(i,Math.max(0,s)):0)/i*100).toFixed(1).replace(/\.0$/,"")}%`}function wt(e,t,i){const s=String(e??"").trim().toLowerCase();if(!s)return"-";const r=bt[s]||{label:s,cls:"badge-muted"},l=s==="error"&&t?ne[String(t).trim().toLowerCase()]||String(t):"",a=l?` title="${o(l)}"`:"",p=typeof i=="number"&&Number.isFinite(i)?`评论游标: ${i}`:"",n=[l,p].filter(Boolean).map(b=>`<div class="form-hint" style="margin-top:4px;">${o(b)}</div>`).join("");return`<span class="status-badge ${r.cls}"${a}>${o(r.label)}</span>${n}`}function St(e){return e?B(e):"-"}function Et(e){if(e==="true")return!0;if(e==="false")return!1}function qt(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function J(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Ct(e){return e.filter(t=>!J(t)).length}function kt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function Lt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!J(t)).length}function Tt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&J(t)).length}function Bt(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function Mt(e){return e.filter(t=>{const i=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return i==="ok"||i==="no_new"}).length}function At(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function Pt(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function jt(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function Nt(e){return e.filter(t=>J(t)&&!(t!=null&&t.last_polled_at)).length}function It(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function Ht(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function Ot(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function Rt(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function Vt(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function Dt(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function Ut(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function Jt(e){return e.filter(t=>J(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function Wt(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(J(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function Kt(e){return e.reduce((t,i)=>{const s=Number((i==null?void 0:i.comment_count)??0);return t+(Number.isFinite(s)&&s>0?s:0)},0)}function zt(e){const i=J(e)?`aid: ${e.aid}`:ne.no_aid;return`${o((e==null?void 0:e.bvid)||"-")}${i?`<div class="form-hint" style="margin-top:4px;">${o(i)}</div>`:""}`}function Ft(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(`更新: ${B(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${B(e.created_at)}`),`${o((e==null?void 0:e.title)||"-")}${t.map(i=>`<div class="form-hint" style="margin-top:4px;">${o(i)}</div>`).join("")}`}function Gt(e){const t=J(e),i=t?"":" disabled",s=t?"":` title="${o(ne.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${o(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${i}${s}>同步</button>`}function Yt(e,t,i,s=0,r=X,l=[]){const a=i==="true"?"轮询中":i==="false"?"已停用":"全部",p=Math.floor(s/r)+1,n=Math.max(1,Math.ceil(e/r)),b=kt(l),c=Math.max(0,l.length-b),h=Lt(l),m=Tt(l),$=Ct(l),y=Math.max(0,l.length-$),f=Bt(l),S=Mt(l),E=At(l),H=Pt(l),O=jt(l),R=Nt(l),V=Math.max(0,l.length-O),u=Ht(l),A=Math.max(0,l.length-u),P=Ot(l),_=Math.max(0,l.length-P),W=Rt(l),K=Math.max(0,l.length-W),D=Vt(l),F=Dt(l),L=Ut(l),j=Math.max(0,l.length-D),N=It(l),z=Jt(l),G=Math.max(0,l.length-z),Y=Wt(l),Z=Kt(l),te=$>0?`，当前页缺少 aid ${$} 条`:"",U=i===""&&b>0?`，当前页轮询开启 ${b} 条`:"",ie=i===""&&c>0?`，当前页轮询停用 ${c} 条`:"",oe=i===""&&h>0?`，轮询开启但缺少 aid ${h} 条`:"",de=i===""&&m>0?`，轮询停用但可同步 ${m} 条`:"",ce=y>0?`，可同步 ${y} 条`:"",ue=S>0?`，正常轮询 ${S} 条`:"",pe=E>0?`，成功轮询 ${E} 条`:"",be=H>0?`，无新增 ${H} 条`:"",ve=f>0?`，轮询失败 ${f} 条`:"",fe=V>0?`，已有轮询记录 ${V} 条`:"",ye=O>0?`，尚未轮询 ${O} 条`:"",ge=R>0?`，可同步但尚未轮询 ${R} 条`:"",he=u>0?`，已识别 UP 主 ${u} 条`:"",d=A>0?`，缺少 UP 主 ${A} 条`:"",He=P>0?`，已抓取标题 ${P} 条`:"",Oe=_>0?`，缺少标题 ${_} 条`:"",Re=z>0?`，信息完整 ${z} 条`:"",Ve=G>0?`，信息不完整 ${G} 条`:"",De=Y>0?`，已轮询但信息不完整 ${Y} 条`:"",Ue=W>0?`，已有评论视频 ${W} 条`:"",Je=K>0?`，无评论视频 ${K} 条`:"",We=D>0?`，已有评论游标 ${D} 条`:"",Ke=F>0?`，有评论但无游标 ${F} 条`:"",ze=L>0?`，无评论但有游标 ${L} 条`:"",Fe=j>0?`，无评论游标 ${j} 条`:"",Ge=N>0?`，已轮询但无游标 ${N} 条`:"",Ye=Z>0?`，关联评论 ${Z} 条`:"";return`筛选: ${a}，共 ${e} 条，当前展示 ${t} 条，第 ${p}/${n} 页${U}${ie}${te}${oe}${de}${ce}${ue}${pe}${be}${ve}${fe}${ye}${ge}${he}${d}${He}${Oe}${Re}${Ve}${De}${Ue}${Je}${We}${Ke}${ze}${Fe}${Ge}${Ye}`}function ke(e,t={}){const i=Number((e==null?void 0:e.videos)??0),s=Number((e==null?void 0:e.comments)??0),r=Number((e==null?void 0:e.events_injected)??s),l=t.subject||(i===1?"视频":"轮询");return s>0||r>0?`${l}完成，处理 ${i} 个视频，新增 ${s} 条评论，注入 ${r} 个事件。`:i>0?`${l}完成，处理 ${i} 个视频，暂无新增评论。`:`${l}完成，暂无可处理视频。`}function w(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const i=new Date(e);if(Number.isNaN(i.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const s=i.getTime()-t;return s<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:B(e)}:s<=vt?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:B(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:B(e)}}function Zt(e){const t=w(e),i=t.detail?`<div class="form-hint" style="margin-top:4px;">${o(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${o(t.label)}</span>${i}`}function Le(e,t="-"){const i=[];return e!=null&&e.updated_at&&i.push(`更新: ${B(e.updated_at)}`),e!=null&&e.created_at&&i.push(`创建: ${B(e.created_at)}`),`${o((e==null?void 0:e.name)||t)}${i.map(s=>`<div class="form-hint" style="margin-top:4px;">${o(s)}</div>`).join("")}`}function Qt(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function C(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function Xt(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function ei(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function ti(e){var a,p,n,b,c,h;const t=!!((p=(a=e==null?void 0:e.checks)==null?void 0:a.auth)!=null&&p.ready),i=!!((b=(n=e==null?void 0:e.checks)==null?void 0:n.worker_or_publish)!=null&&b.ready),s=!!((c=e==null?void 0:e.signals)!=null&&c.polling_worker_enabled),r=!!((h=e==null?void 0:e.signals)!=null&&h.native_publish_enabled);return s||r?`${t?"鉴权已就绪":"鉴权未就绪"}，${i?"执行链路可用":"执行链路阻塞"}`:"当前无需鉴权"}function ii(e){var r,l,a;const t=!!((r=e==null?void 0:e.signals)!=null&&r.publish_mode_config_ready),i=!!((l=e==null?void 0:e.signals)!=null&&l.native_publish_enabled),s=!!((a=e==null?void 0:e.signals)!=null&&a.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",i?"原生发布启用":"原生发布停用",s?"轮询链路启用":"轮询链路停用"].join("，")}function li(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",i=C(e)?"字段完整":`缺少 ${Xt(e).join(" / ")}`;return`${o(t)}${i?`<div class="form-hint" style="margin-top:4px;">${o(i)}</div>`:""}`}function Pe(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function si(e,t="",i="",s=e.length){const r=e.length,l=e.filter(d=>d.is_active||d.active),a=e.filter(d=>!(d.is_active||d.active)),p=l.length,n=a.length,b=e.filter(d=>C(d)).length,c=e.filter(d=>(d.is_active||d.active)&&C(d)).length,h=Math.max(0,b-c),m=Math.max(0,p-c),$=Math.max(0,n-h),y=l.filter(d=>d.last_used_at).length,f=Math.max(0,p-y),S=a.filter(d=>d.last_used_at).length,E=Math.max(0,n-S),H=e.filter(d=>C(d)&&d.last_used_at).length,O=Math.max(0,b-H),R=Math.max(0,r-b),V=e.filter(d=>!C(d)&&d.last_used_at).length,u=Math.max(0,R-V),A=e.filter(d=>!d.last_used_at).length,P=Math.max(0,r-A),_=Date.now(),W=e.filter(d=>C(d)&&w(d.expires_at,_).hasExpiry&&!w(d.expires_at,_).expired).length,K=e.filter(d=>C(d)&&w(d.expires_at,_).expired).length,D=e.filter(d=>C(d)&&w(d.expires_at,_).expiringSoon).length,F=e.filter(d=>C(d)&&!w(d.expires_at,_).hasExpiry).length,L=e.map(d=>w(d.expires_at,_)),j=l.map(d=>w(d.expires_at,_)),N=a.map(d=>w(d.expires_at,_)),z=L.filter(d=>d.hasExpiry).length,G=L.filter(d=>d.hasExpiry&&!d.expired).length,Y=L.filter(d=>d.expired).length,Z=L.filter(d=>d.expiringSoon).length,te=j.filter(d=>d.hasExpiry&&!d.expired).length,U=j.filter(d=>d.expired).length,ie=j.filter(d=>d.expiringSoon).length,oe=j.filter(d=>!d.hasExpiry).length,de=N.filter(d=>d.hasExpiry&&!d.expired).length,ce=N.filter(d=>d.expired).length,ue=N.filter(d=>d.expiringSoon).length,pe=N.filter(d=>!d.hasExpiry).length,be=e.filter(d=>!C(d)&&w(d.expires_at,_).hasExpiry&&!w(d.expires_at,_).expired).length,ve=e.filter(d=>!C(d)&&w(d.expires_at,_).expired).length,fe=e.filter(d=>!C(d)&&w(d.expires_at,_).expiringSoon).length,ye=e.filter(d=>!C(d)&&!w(d.expires_at,_).hasExpiry).length,ge=L.filter(d=>!d.hasExpiry).length,he=Pe(t,i);return`共 ${r} 个凭证，激活中 ${p} 个，未激活 ${n} 个，激活且完整 ${c} 个，未激活但完整 ${h} 个，激活但缺字段 ${m} 个，未激活且缺字段 ${$} 个，激活且已使用 ${y} 个，激活但从未使用 ${f} 个，未激活且已使用 ${S} 个，未激活但从未使用 ${E} 个，激活且有效 ${te} 个，未激活且有效 ${de} 个，激活已过期 ${U} 个，未激活已过期 ${ce} 个，激活即将过期 ${ie} 个，未激活即将过期 ${ue} 个，激活未设置过期 ${oe} 个，未激活未设置过期 ${pe} 个，字段完整 ${b} 个，完整且有效 ${W} 个，完整且已过期 ${K} 个，完整即将过期 ${D} 个，完整未设置过期 ${F} 个，完整且已使用 ${H} 个，完整但未使用 ${O} 个，字段缺失 ${R} 个，缺字段但已使用 ${V} 个，缺字段且未使用 ${u} 个，缺字段但有效 ${be} 个，缺字段且已过期 ${ve} 个，缺字段即将过期 ${fe} 个，缺字段未设置过期 ${ye} 个，已使用 ${P} 个，从未使用 ${A} 个，设置过期时间 ${z} 个，有效 ${G} 个，已过期 ${Y} 个，即将过期 ${Z} 个，未设置 ${ge} 个；筛选: ${he}，当前展示 ${s} 个`}function ri(e,t="",i=""){const s=Date.now();return e.filter(r=>{const l=r.is_active||r.active;if(t==="active"&&!l||t==="inactive"&&l)return!1;const a=w(r.expires_at,s);return!(i==="expired"&&!a.expired||i==="expiring"&&!a.expiringSoon||i==="valid"&&(!a.hasExpiry||a.expired)||i==="unset"&&a.hasExpiry)})}function ai(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${Pe(e,t)}）`:"暂无凭证"}function Te(e,t,i){const s=e.querySelector(i);t.forEach(r=>{const l=e.querySelector(r);l==null||l.addEventListener("keydown",a=>{a.key==="Enter"&&(a.preventDefault(),s.disabled||s.click())})})}async function ni(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function i(){var a,p,n,b,c,h,m,$,y,f,S,E,H,O,R,V;const l=e.querySelector("#bili-status-cards");l.innerHTML='<div class="page-loading">加载中...</div>';try{const u=await k.getBilibiliStatus(),A=Number((u==null?void 0:u.video_count)??0),P=Number(((a=u==null?void 0:u.videos)==null?void 0:a.poll_enabled_count)??0),_=Math.max(0,A-P),W=xt(P,A),K=!!((p=u==null?void 0:u.diagnostics)!=null&&p.ready),D=ht((n=u==null?void 0:u.diagnostics)==null?void 0:n.blocking_reasons),F=Le(u==null?void 0:u.credential,"未配置"),L=!!(((c=(b=u==null?void 0:u.diagnostics)==null?void 0:b.signals)==null?void 0:c.credential_present)??((m=(h=u==null?void 0:u.diagnostics)==null?void 0:h.release_gates)==null?void 0:m.credential_present)),j=!!(((y=($=u==null?void 0:u.diagnostics)==null?void 0:$.signals)==null?void 0:y.credential_complete)??((S=(f=u==null?void 0:u.diagnostics)==null?void 0:f.release_gates)==null?void 0:S.credential_complete)),N=ei(L,j),z=ti(u==null?void 0:u.diagnostics),G=mt((E=u==null?void 0:u.diagnostics)==null?void 0:E.effective_publish_mode),Y=ii(u==null?void 0:u.diagnostics),Z=$t((H=u==null?void 0:u.config)==null?void 0:H.poll_interval_seconds),te=_t((O=u==null?void 0:u.config)==null?void 0:O.rate_limit_per_minute),U=w((R=u==null?void 0:u.credential)==null?void 0:R.expires_at),ie=St((V=u==null?void 0:u.credential)==null?void 0:V.last_used_at);l.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          <div class="stat-value" style="font-size:14px; color:${Qt(U)}">${o(U.label)}</div>
      ...
      `}catch(u){l.innerHTML=`<div class="page-error">状态加载失败: ${o(q(u))}</div>`}}async function s(){const l=e.querySelector("#bili-videos-wrapper"),a=e.querySelector("#bili-video-summary"),p=e.querySelector("#bili-video-filter-btn"),n=e.querySelector("#bili-video-poll-filter"),b=e.querySelector("#bili-video-prev"),c=e.querySelector("#bili-video-next"),h=n.value;a.textContent="加载中...",l.innerHTML='<div class="page-loading">加载中...</div>',n.disabled=!0,p.disabled=!0,b.disabled=!0,c.disabled=!0;try{const m=await k.getBilibiliVideos({limit:X,offset:t,poll_enabled:Et(h)}),$=Array.isArray(m==null?void 0:m.items)?m.items:Array.isArray(m)?m:[],y=Number((m==null?void 0:m.total)??$.length);if($.length===0&&y>0&&t>0){t=Math.max(0,t-X),await s();return}if(a.textContent=Yt(y,$.length,h,t,X,$),b.disabled=t<=0,c.disabled=t+$.length>=y,$.length===0){l.innerHTML=`<div class="table-empty">${o(qt(h))}</div>`;return}l.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${$.map(f=>`<tr data-id="${o(f.id||f.video_id)}">
              <td class="cell-id">${zt(f)}</td>
              <td class="cell-truncate">${Ft(f)}</td>
              <td>${we(f.poll_enabled)}</td>
              <td>${f.comment_count??"-"}</td>
              <td class="cell-time">${f.last_polled_at?ee(f.last_polled_at):"-"}</td>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${$.map(y=>`<tr data-id="${o(y.id||y.credential_id)}">
              ...
              <td>${Zt(y.expires_at)}</td>
              <td class="cell-time">${y.last_used_at?ee(y.last_used_at):"-"}</td>
              <td class="cell-actions">
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),i=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}i.innerHTML='<div class="page-loading">查询中...</div>';try{const s=await Be.getComment(t);i.innerHTML=`
      ...
      `;const r=i.querySelector("#query-goto-comment");r&&r.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=r.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(s){i.innerHTML=`<div class="page-error">查询失败: ${o(s.message)}</div>`}})}const xe={dashboard:{render:Ae,title:"仪表盘"},jobs:{render:et,title:"任务管理"},"daily-metrics":{render:it,title:"每日指标"},knowledge:{render:lt,title:"知识库"},"role-cards":{render:st,title:"角色卡"},profiles:{render:rt,title:"风格配置"},gateway:{render:nt,title:"网关"},audit:{render:ot,title:"审计日志"},bilibili:{render:ni,title:"B站集成"},query:{render:oi,title:"查询"}};let je=null;function di(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function Ne(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function Ie(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function ci(e){e.preventDefault();const t=document.getElementById("login-api-key"),i=document.getElementById("login-error"),s=t.value.trim();if(s){window.__ADMIN_API_KEY__=s;try{await g("/api/admin/overview"),sessionStorage.setItem("admin_api_key",s),Ie(),Ee("dashboard")}catch{i.textContent="API Key 无效或服务不可用",i.style.display="block",window.__ADMIN_API_KEY__=""}}}function ui(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",Ne()}function Ee(e){if(!xe[e])return;je=e,document.querySelectorAll("#nav-list .nav-item").forEach(i=>{i.classList.toggle("active",i.dataset.page===e)}),document.getElementById("page-title").textContent=xe[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',xe[e].render(t).catch(i=>{t.innerHTML=`<div class="page-error">加载失败: ${i.message}</div>`})}function pi(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==je&&Ee(t)})})}function bi(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),i=document.getElementById("expand-left-btn");t&&i&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),i.style.display="block"}),i.addEventListener("click",()=>{e.classList.remove("collapsed"),i.style.display="none"}))}function vi(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let i=0;e.addEventListener("click",()=>{i=(i+1)%t.length,t[i]?document.body.setAttribute("data-theme",t[i]):document.body.removeAttribute("data-theme")})}function fi(){bi(),vi(),pi(),document.getElementById("login-form").addEventListener("submit",ci),document.getElementById("logout-btn").addEventListener("click",ui),di()?(Ie(),Ee("dashboard")):Ne()}fi();
