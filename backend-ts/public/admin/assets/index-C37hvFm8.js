(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))a(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}})();function G(e,t,s){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof s=="string"&&s.trim()?s.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function J(){return(window.__ADMIN_API_KEY__||"").trim()}async function p(e,t={}){const s=J(),a=new Headers(t.headers||{});s&&a.set("x-api-key",s);const i=await fetch(e,{...t,headers:a}),r=await i.json().catch(()=>({}));if(!i.ok){const d=(r==null?void 0:r.detail)||(r==null?void 0:r.error);throw new Error(G(d,i.status,i.statusText))}return r}async function O(e,t){const s=J(),a=new Headers;s&&a.set("x-api-key",s);const i=await fetch(e,{headers:a});if(!i.ok)throw new Error("download_failed");const r=await i.blob(),d=URL.createObjectURL(r),o=document.createElement("a");o.href=d,o.download=t,document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(d)}function f(e){const t=new URLSearchParams;for(const[a,i]of Object.entries(e))i!=null&&i!==""&&t.set(a,String(i));const s=t.toString();return s?`?${s}`:""}function h(){return{getOverview(){return p("/api/admin/overview")},getJobs({status:e,limit:t}={}){return p(`/api/admin/jobs${f({status:e,limit:t})}`)},getJob(e){return p(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return p(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return p(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return p("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return p("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return O(`/export/jobs.csv${f({status:e,limit:t})}`,"jobs.csv")},getComment(e){return p(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return p(`/api/admin/gateway/logs${f({limit:e,comment_id:t})}`)},publishGatewayReply(e){return p("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:s}={}){return p(`/api/admin/audit/summary${f({days:e,action:t,ok:s})}`)},getAuditLogs({limit:e,action:t,ok:s}={}){return p(`/api/audit-log${f({limit:e,action:t,ok:s})}`)},exportAuditCsv({limit:e,action:t,ok:s}={}){return O(`/export/audit-logs.csv${f({limit:e,action:t,ok:s})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return p(`/api/metrics/daily${f({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return p(`/api/admin/knowledge${f({limit:e,offset:t})}`)},createKnowledgeEntry(e){return p("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return p(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return p(`/api/admin/role-cards${f({limit:e,offset:t})}`)},createRoleCard(e){return p("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return p(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return p(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return p(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return p("/api/admin/style-profile")},setStyleProfile(e){return p("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return p("/api/admin/role-profile")},setRoleProfile(e){return p("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return p("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:s}={}){return p(`/api/admin/bilibili/videos${f({poll_enabled:e,limit:t,offset:s})}`)},addBilibiliVideo(e){return p("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return p(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return p(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return p(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return p("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return p("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return p("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return p(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return p(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function n(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function I(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function Y(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const s=Date.now()-t.getTime(),a=Math.floor(s/1e3);if(a<60)return"刚刚";const i=Math.floor(a/60);if(i<60)return`${i}分钟前`;const r=Math.floor(i/60);if(r<24)return`${r}小时前`;const d=Math.floor(r/24);if(d<30)return`${d}天前`;const o=Math.floor(d/30);return o<12?`${o}个月前`:`${Math.floor(o/12)}年前`}catch{return""}}function x(e){const t=Y(e),s=I(e);return t?`<span title="${n(s)}">${n(t)}</span>`:`<span title="${n(s)}">${n(s)}</span>`}function $(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const F={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function B(e){if(!e)return"";const t=F[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${n(t.label)}</span>`}function M(e,t="是",s="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${n(e?t:s)}</span>`}let T=null;function u(e,t="info"){const s=document.getElementById("app-toast");s&&s.remove(),T&&clearTimeout(T);const a={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},i=document.createElement("div");i.id="app-toast",i.className="toast-notification",i.style.setProperty("--toast-color",a[t]||a.info),i.innerHTML=`
        ...
        <div class="section-card">
          ...
          <div class="table-wrapper">
            <table class="data-table">
              ...
              <tbody>
                ${d.length===0?'<tr><td colspan="4" class="table-empty-cell">暂无任务</td></tr>':d.map(l=>{var c,v;return`<tr>
  ...
  `;const s=e.querySelector("#jobs-status"),a=e.querySelector("#jobs-limit");async function i(){var o;t.clear(),r();const d=e.querySelector("#jobs-table-wrapper");d.innerHTML='<div class="page-loading">加载中...</div>';try{const l=await S.getJobs({status:s.value,limit:a.value}),c=Array.isArray(l==null?void 0:l.items)?l.items:[];if(c.length===0){d.innerHTML='<div class="table-empty">暂无任务</div>';return}d.innerHTML=`
        <table class="data-table">
          <thead><tr>
      ...
      `,(o=d.querySelector("#jobs-select-all"))==null||o.addEventListener("change",v=>{const y=v.target.checked;d.querySelectorAll(".job-checkbox").forEach(w=>{w.checked=y,y?t.add(w.dataset.id):t.delete(w.dataset.id)}),r()}),d.querySelectorAll(".job-checkbox").forEach(v=>{v.addEventListener("change",()=>{v.checked?t.add(v.dataset.id):t.delete(v.dataset.id),r()})}),d.querySelectorAll(".job-approve").forEach(v=>{v.addEventListener("click",async()=>{v.disabled=!0,v.textContent="审批中...";try{await S.approveJob(v.dataset.id),u("审批成功","success"),i()}catch(y){u(`审批失败: ${y.message}`,"error"),v.disabled=!1,v.textContent="审批"}})}),d.querySelectorAll(".job-retry").forEach(v=>{v.addEventListener("click",async()=>{v.disabled=!0,v.textContent="重试中...";try{await S.retryJob(v.dataset.id),u("重试已提交","success"),i()}catch(y){u(`重试失败: ${y.message}`,"error"),v.disabled=!1,v.textContent="重试"}})})}catch(l){d.innerHTML=`<div class="page-error">加载失败: ${n(l.message)}</div>`}}function r(){const d=e.querySelector("#jobs-batch-bar"),o=e.querySelector("#jobs-selected-count");t.size>0?(d.style.display="flex",o.textContent=`已选 ${t.size} 项`):d.style.display="none"}e.querySelector("#jobs-filter-btn").addEventListener("click",i),e.querySelector("#jobs-refresh").addEventListener("click",i),e.querySelector("#jobs-export").addEventListener("click",async()=>{try{await S.exportJobsCsv({status:s.value,limit:a.value}),u("导出成功","success")}catch(d){u(`导出失败: ${d.message}`,"error")}}),e.querySelector("#jobs-batch-approve").addEventListener("click",async()=>{if(t.size!==0)try{await S.batchApprove([...t]),u(`批量审批 ${t.size} 项成功`,"success"),i()}catch(d){u(`批量审批失败: ${d.message}`,"error")}}),e.querySelector("#jobs-batch-retry").addEventListener("click",async()=>{if(t.size!==0)try{await S.batchRetry([...t]),u(`批量重试 ${t.size} 项成功`,"success"),i()}catch(d){u(`批量重试失败: ${d.message}`,"error")}}),await i()}const Q=h();async function W(e){e.innerHTML=`
    <div class="page-header">
      <h2>每日指标</h2>
      <div class="page-actions">
  ...
  `;async function t(){const s=e.querySelector("#knowledge-table-wrapper");s.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await C.getKnowledgeEntries({limit:50}),i=Array.isArray(a==null?void 0:a.items)?a.items:[];if(i.length===0){s.innerHTML='<div class="table-empty">暂无知识条目</div>';return}s.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${i.map(r=>{var d,o;return`<tr>
              <td class="cell-id">${n((d=r.id)==null?void 0:d.toString().substring(0,8))}</td>
              <td>${n(r.category)}</td>
              <td>${n(r.title)}</td>
              <td class="cell-truncate">${n((o=r.content)==null?void 0:o.substring(0,80))}</td>
              <td>${M(r.enabled!==!1)}</td>
      ...
      `,s.querySelectorAll(".knowledge-disable").forEach(r=>{r.addEventListener("click",async()=>{try{await C.disableKnowledgeEntry(r.dataset.id),u("已禁用","success"),t()}catch(d){u(`操作失败: ${d.message}`,"error")}})})}catch(a){s.innerHTML=`<div class="page-error">加载失败: ${n(a.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const s=e.querySelector("#knowledge-category").value.trim(),a=e.querySelector("#knowledge-title").value.trim(),i=e.querySelector("#knowledge-content").value.trim();if(!a||!i){u("标题和内容不能为空","warning");return}try{await C.createKnowledgeEntry({category:s,title:a,content:i}),u("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(r){u(`创建失败: ${r.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const q=h();let _=!1,b=null;async function ee(e){_=!1,b=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `;const t=e.querySelector("#rc-select"),s=e.querySelector("#rc-editor");let a=[];function i(){_=!0}function r(){return _?confirm("当前角色卡有未保存的修改，确定要切换吗？"):!0}function d(l){b=l,e.querySelector("#rc-key").value=(l==null?void 0:l.key)||"",e.querySelector("#rc-key").disabled=!!l,e.querySelector("#rc-name").value=(l==null?void 0:l.name)||"",e.querySelector("#rc-desc").value=(l==null?void 0:l.description)||"",e.querySelector("#rc-system-prompt").value=(l==null?void 0:l.system_prompt)||"",e.querySelector("#rc-tone").value=(l==null?void 0:l.tone)||"",e.querySelector("#rc-constraints").value=typeof(l==null?void 0:l.constraints)=="string"?l.constraints:JSON.stringify((l==null?void 0:l.constraints)||"",null,2),e.querySelector("#rc-editor-title").textContent=l?`编辑: ${l.name||l.key}`:"新建角色卡",e.querySelector("#rc-activate").style.display=l&&l.enabled!==!1?"inline-flex":"none",e.querySelector("#rc-disable").style.display=l&&l.enabled!==!1?"inline-flex":"none",s.style.display="block",_=!1}s.querySelectorAll(".form-input").forEach(l=>l.addEventListener("input",i));async function o(){try{const l=await q.getRoleCards({limit:100});a=Array.isArray(l==null?void 0:l.items)?l.items:Array.isArray(l)?l:[],t.innerHTML='<option value="">-- 新建 --</option>'+a.map(c=>`<option value="${n(c.key)}">${n(c.name||c.key)}${c.enabled===!1?" (禁用)":""}</option>`).join("")}catch(l){u(`加载失败: ${l.message}`,"error")}}t.addEventListener("change",()=>{if(!r()){t.value=(b==null?void 0:b.key)||"";return}const l=t.value,c=a.find(v=>v.key===l);d(c||null)}),e.querySelector("#rc-new").addEventListener("click",()=>{r()&&(t.value="",d(null))}),e.querySelector("#rc-save").addEventListener("click",async()=>{const l={key:e.querySelector("#rc-key").value.trim(),name:e.querySelector("#rc-name").value.trim(),description:e.querySelector("#rc-desc").value.trim(),system_prompt:e.querySelector("#rc-system-prompt").value.trim(),tone:e.querySelector("#rc-tone").value.trim()},c=e.querySelector("#rc-constraints").value.trim();try{l.constraints=c?JSON.parse(c):""}catch{l.constraints=c}if(!l.key){u("Key 不能为空","warning");return}try{b!=null&&b.key?(await q.updateRoleCard(b.key,l),u("保存成功","success")):(await q.createRoleCard(l),u("创建成功","success")),_=!1,await o(),t.value=l.key}catch(v){u(`操作失败: ${v.message}`,"error")}}),e.querySelector("#rc-activate").addEventListener("click",async()=>{if(b!=null&&b.key)try{await q.activateRoleCard(b.key),u("已激活","success"),await o()}catch(l){u(`激活失败: ${l.message}`,"error")}}),e.querySelector("#rc-disable").addEventListener("click",async()=>{if(b!=null&&b.key)try{await q.disableRoleCard(b.key),u("已禁用","success"),await o()}catch(l){u(`禁用失败: ${l.message}`,"error")}}),e.querySelector("#rc-refresh").addEventListener("click",()=>{o()}),await o()}const E=h();async function te(e){e.innerHTML=`
  ...
  `;const t=e.querySelector("#gw-reply"),s=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{s.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const i=e.querySelector("#gw-publish-btn"),r=e.querySelector("#gw-comment-id").value.trim(),d=e.querySelector("#gw-reply").value.trim(),o=e.querySelector("#gw-source").value.trim(),l=e.querySelector("#gw-force").checked;if(!r||!d){u("Comment ID 和回复内容不能为空","warning");return}i.disabled=!0,i.textContent="发布中...";try{await R.publishGatewayReply({comment_id:r,reply_text:d,source:o,force_publish:l}),u("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",s.textContent="0/0",a()}catch(c){u(`发布失败: ${c.message}`,"error")}finally{i.disabled=!1,i.textContent="发布"}});async function a(){const i=e.querySelector("#gw-table-wrapper"),r=e.querySelector("#gw-limit").value;i.innerHTML='<div class="page-loading">加载中...</div>';try{const d=await R.getGatewayLogs({limit:r}),o=Array.isArray(d==null?void 0:d.items)?d.items:[];if(o.length===0){i.innerHTML='<div class="table-empty">暂无网关日志</div>';return}i.innerHTML=ie({columns:[{key:"id",label:"ID",class:"cell-id",render:l=>{var c;return n((c=l.id)==null?void 0:c.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:l=>{var c;return n((c=l.comment_id)==null?void 0:c.substring(0,12))}},{key:"status",label:"状态",render:l=>B(l.status)},{key:"platform",label:"平台",render:l=>n(l.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:l=>{var c;return n((c=l.reply_text)==null?void 0:c.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:l=>x(l.created_at)}],rows:o})}catch(d){i.innerHTML=`<div class="page-error">加载失败: ${n(d.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",a),e.querySelector("#gw-filter-btn").addEventListener("click",a),await a()}const A=h();async function re(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const a=await A.getAuditSummary({days:7}),i=e.querySelector("#audit-summary-cards");i.innerHTML=`
      ...
      `}catch{e.querySelector("#audit-summary-cards").innerHTML='<div class="page-error">摘要加载失败</div>'}}async function s(){const a=e.querySelector("#audit-table-wrapper");a.innerHTML='<div class="page-loading">加载中...</div>';const i=e.querySelector("#audit-action").value.trim(),r=e.querySelector("#audit-ok").value,d=e.querySelector("#audit-limit").value;try{const o=await A.getAuditLogs({action:i,ok:r,limit:d}),l=Array.isArray(o==null?void 0:o.items)?o.items:[];if(l.length===0){a.innerHTML='<div class="table-empty">暂无审计日志</div>';return}a.innerHTML=`
        <table class="data-table">
          <thead><tr>
  ...
  `;async function t(){var r,d,o,l;const i=e.querySelector("#bili-status-cards");try{const c=await g.getBilibiliStatus(),v=Number(((r=c==null?void 0:c.videos)==null?void 0:r.poll_enabled_count)??0),y=!!((d=c==null?void 0:c.diagnostics)!=null&&d.ready),w=ce((o=c==null?void 0:c.diagnostics)==null?void 0:o.blocking_reasons),k=(l=c==null?void 0:c.credential)!=null&&l.name?n(c.credential.name):"未配置";i.innerHTML=`
        <div class="stat-card mini">
      ...
      `}catch(c){i.innerHTML=`<div class="page-error">状态加载失败: ${n(m(c))}</div>`}}async function s(){const i=e.querySelector("#bili-videos-wrapper");try{const r=await g.getBilibiliVideos({limit:50}),d=Array.isArray(r==null?void 0:r.items)?r.items:Array.isArray(r)?r:[];if(d.length===0){i.innerHTML='<div class="table-empty">暂无视频</div>';return}i.innerHTML=`
        <table class="data-table">
      ...
      `,i.querySelectorAll(".bili-toggle-poll").forEach(o=>{o.addEventListener("click",async()=>{try{await g.toggleBilibiliVideoPoll(o.dataset.id),u("操作成功","success"),await Promise.all([t(),s()])}catch(l){u(`失败: ${m(l)}`,"error")}})}),i.querySelectorAll(".bili-sync").forEach(o=>{o.addEventListener("click",async()=>{o.disabled=!0;try{await g.syncBilibiliVideo(o.dataset.id),u("同步完成","success"),s()}catch(l){u(`同步失败: ${m(l)}`,"error"),o.disabled=!1}})}),i.querySelectorAll(".bili-delete").forEach(o=>{o.addEventListener("click",async()=>{if(confirm("确定删除此视频？"))try{await g.deleteBilibiliVideo(o.dataset.id),u("已删除","success"),await Promise.all([t(),s()])}catch(l){u(`删除失败: ${m(l)}`,"error")}})})}catch(r){i.innerHTML=`<div class="page-error">加载失败: ${n(m(r))}</div>`}}async function a(){const i=e.querySelector("#bili-creds-wrapper");try{const r=await g.getBilibiliCredentials(),d=Array.isArray(r==null?void 0:r.items)?r.items:Array.isArray(r)?r:[];if(d.length===0){i.innerHTML='<div class="table-empty">暂无凭证</div>';return}i.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${d.map(o=>`<tr data-id="${n(o.id||o.credential_id)}">
              ...
              <td>${M(o.is_active||o.active)}</td>
              <td class="cell-time">${n(o.expires_at?I(o.expires_at):"-")}</td>
              <td class="cell-actions">
      ...
      `,i.querySelectorAll(".cred-activate").forEach(o=>{o.addEventListener("click",async()=>{try{await g.activateBilibiliCredential(o.dataset.id),u("已激活","success"),await Promise.all([t(),a()])}catch(l){u(`激活失败: ${m(l)}`,"error")}})}),i.querySelectorAll(".cred-delete").forEach(o=>{o.addEventListener("click",async()=>{if(confirm("确定删除此凭证？"))try{await g.deleteBilibiliCredential(o.dataset.id),u("已删除","success"),await Promise.all([t(),a()])}catch(l){u(`删除失败: ${m(l)}`,"error")}})})}catch(r){i.innerHTML=`<div class="page-error">加载失败: ${n(m(r))}</div>`}}e.querySelector("#bili-video-add").addEventListener("click",async()=>{const i=e.querySelector("#bili-video-bvid").value.trim(),r=oe(i);if(r){u(m(r),"warning");return}try{await g.addBilibiliVideo(i),u("添加成功","success"),e.querySelector("#bili-video-bvid").value="",await Promise.all([t(),s()])}catch(d){u(`添加失败: ${m(d)}`,"error")}}),e.querySelector("#cred-add").addEventListener("click",async()=>{const i={name:e.querySelector("#cred-name").value.trim(),sessdata:e.querySelector("#cred-sessdata").value.trim(),bili_jct:e.querySelector("#cred-bili-jct").value.trim(),buvid3:e.querySelector("#cred-buvid3").value.trim(),buvid4:e.querySelector("#cred-buvid4").value.trim(),expires_at:e.querySelector("#cred-expires").value||void 0},r=ne(i);if(r){u(m(r),"warning");return}try{await g.addBilibiliCredential(i),u("凭证添加成功","success"),e.querySelector("#cred-name").value="",e.querySelector("#cred-sessdata").value="",e.querySelector("#cred-bili-jct").value="",e.querySelector("#cred-buvid3").value="",e.querySelector("#cred-buvid4").value="",e.querySelector("#cred-expires").value="",await Promise.all([t(),a()])}catch(d){u(`添加失败: ${m(d)}`,"error")}}),e.querySelector("#bili-poll-btn").addEventListener("click",async()=>{const i=e.querySelector("#bili-poll-btn");i.disabled=!0,i.textContent="轮询中...";try{await g.triggerBilibiliPoll(),u("轮询完成","success"),s()}catch(r){u(`轮询失败: ${m(r)}`,"error")}finally{i.disabled=!1,i.textContent="触发轮询"}}),e.querySelector("#bili-refresh").addEventListener("click",()=>{t(),s(),a()}),await Promise.all([t(),s(),a()])}const N=h();async function ve(e){e.innerHTML=`
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),s=e.querySelector("#query-comment-result");if(!t){u("请输入 Comment ID","warning");return}s.innerHTML='<div class="page-loading">查询中...</div>';try{const a=await N.getComment(t);s.innerHTML=`
      ...
      `;const i=s.querySelector("#query-goto-comment");i&&i.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=i.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(a){s.innerHTML=`<div class="page-error">查询失败: ${n(a.message)}</div>`}})}const j={dashboard:{render:D,title:"仪表盘"},jobs:{render:Z,title:"任务管理"},"daily-metrics":{render:W,title:"每日指标"},knowledge:{render:X,title:"知识库"},"role-cards":{render:ee,title:"角色卡"},profiles:{render:te,title:"风格配置"},gateway:{render:se,title:"网关"},audit:{render:re,title:"审计日志"},bilibili:{render:ue,title:"B站集成"},query:{render:ve,title:"查询"}};let K=null;function pe(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function V(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function U(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function be(e){e.preventDefault();const t=document.getElementById("login-api-key"),s=document.getElementById("login-error"),a=t.value.trim();if(a){window.__ADMIN_API_KEY__=a;try{await p("/api/admin/overview"),sessionStorage.setItem("admin_api_key",a),U(),P("dashboard")}catch{s.textContent="API Key 无效或服务不可用",s.style.display="block",window.__ADMIN_API_KEY__=""}}}function me(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",V()}function P(e){if(!j[e])return;K=e,document.querySelectorAll("#nav-list .nav-item").forEach(s=>{s.classList.toggle("active",s.dataset.page===e)}),document.getElementById("page-title").textContent=j[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',j[e].render(t).catch(s=>{t.innerHTML=`<div class="page-error">加载失败: ${s.message}</div>`})}function ye(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==K&&P(t)})})}function ge(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),s=document.getElementById("expand-left-btn");t&&s&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),s.style.display="block"}),s.addEventListener("click",()=>{e.classList.remove("collapsed"),s.style.display="none"}))}function fe(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let s=0;e.addEventListener("click",()=>{s=(s+1)%t.length,t[s]?document.body.setAttribute("data-theme",t[s]):document.body.removeAttribute("data-theme")})}function he(){ge(),fe(),ye(),document.getElementById("login-form").addEventListener("submit",be),document.getElementById("logout-btn").addEventListener("click",me),pe()?(U(),P("dashboard")):V()}he();
