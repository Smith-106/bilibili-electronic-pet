(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))l(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&l(a)}).observe(document,{childList:!0,subtree:!0});function i(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(r){if(r.ep)return;r.ep=!0;const s=i(r);fetch(r.href,s)}})();function de(e,t,i){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof i=="string"&&i.trim()?i.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function Z(){return(window.__ADMIN_API_KEY__||"").trim()}async function m(e,t={}){const i=Z(),l=new Headers(t.headers||{});i&&l.set("x-api-key",i);const r=await fetch(e,{...t,headers:l}),s=await r.json().catch(()=>({}));if(!r.ok){const a=(s==null?void 0:s.detail)||(s==null?void 0:s.error);throw new Error(de(a,r.status,r.statusText))}return s}async function z(e,t){const i=Z(),l=new Headers;i&&l.set("x-api-key",i);const r=await fetch(e,{headers:l});if(!r.ok)throw new Error("download_failed");const s=await r.blob(),a=URL.createObjectURL(s),u=document.createElement("a");u.href=a,u.download=t,document.body.appendChild(u),u.click(),document.body.removeChild(u),URL.revokeObjectURL(a)}function S(e){const t=new URLSearchParams;for(const[l,r]of Object.entries(e))r!=null&&r!==""&&t.set(l,String(r));const i=t.toString();return i?`?${i}`:""}function _(){return{getOverview(){return m("/api/admin/overview")},getJobs({status:e,limit:t}={}){return m(`/api/admin/jobs${S({status:e,limit:t})}`)},getJob(e){return m(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return m(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return m(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return m("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return m("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return z(`/export/jobs.csv${S({status:e,limit:t})}`,"jobs.csv")},getComment(e){return m(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return m(`/api/admin/gateway/logs${S({limit:e,comment_id:t})}`)},publishGatewayReply(e){return m("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:i}={}){return m(`/api/admin/audit/summary${S({days:e,action:t,ok:i})}`)},getAuditLogs({limit:e,action:t,ok:i}={}){return m(`/api/audit-log${S({limit:e,action:t,ok:i})}`)},exportAuditCsv({limit:e,action:t,ok:i}={}){return z(`/export/audit-logs.csv${S({limit:e,action:t,ok:i})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return m(`/api/metrics/daily${S({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return m(`/api/admin/knowledge${S({limit:e,offset:t})}`)},createKnowledgeEntry(e){return m("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return m(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return m(`/api/admin/role-cards${S({limit:e,offset:t})}`)},createRoleCard(e){return m("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return m(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return m(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return m(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return m("/api/admin/style-profile")},setStyleProfile(e){return m("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return m("/api/admin/role-profile")},setRoleProfile(e){return m("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return m("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:i}={}){return m(`/api/admin/bilibili/videos${S({poll_enabled:e,limit:t,offset:i})}`)},addBilibiliVideo(e){return m("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return m(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return m("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return m("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return m("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return m(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return m(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function n(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function T(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function ne(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const i=Date.now()-t.getTime(),l=Math.floor(i/1e3);if(l<60)return"刚刚";const r=Math.floor(l/60);if(r<60)return`${r}分钟前`;const s=Math.floor(r/60);if(s<24)return`${s}小时前`;const a=Math.floor(s/24);if(a<30)return`${a}天前`;const u=Math.floor(a/30);return u<12?`${u}个月前`:`${Math.floor(u/12)}年前`}catch{return""}}function C(e){const t=ne(e),i=T(e);return t?`<span title="${n(i)}">${n(t)}</span>`:`<span title="${n(i)}">${n(i)}</span>`}function q(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const oe={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function K(e){if(!e)return"";const t=oe[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${n(t.label)}</span>`}function J(e,t="是",i="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${n(e?t:i)}</span>`}let O=null;function v(e,t="info"){const i=document.getElementById("app-toast");i&&i.remove(),O&&clearTimeout(O);const l={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},r=document.createElement("div");r.id="app-toast",r.className="toast-notification",r.style.setProperty("--toast-color",l[t]||l.info),r.innerHTML=`
  ...
  `;async function t(){const i=e.querySelector("#metrics-days").value,l=e.querySelector("#metrics-table-wrapper");l.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await ue.getDailyMetrics({days:i}),s=Array.isArray(r==null?void 0:r.items)?r.items:Array.isArray(r)?r:[];if(s.length===0){l.innerHTML='<div class="table-empty">暂无指标数据</div>';return}l.innerHTML=`
      ...
      `}catch(r){l.innerHTML=`<div class="page-error">加载失败: ${n(r.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const N=_();async function be(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const i=e.querySelector("#knowledge-table-wrapper");i.innerHTML='<div class="page-loading">加载中...</div>';try{const l=await N.getKnowledgeEntries({limit:50}),r=Array.isArray(l==null?void 0:l.items)?l.items:[];if(r.length===0){i.innerHTML='<div class="table-empty">暂无知识条目</div>';return}i.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${r.map(s=>{var a,u;return`<tr>
              <td class="cell-id">${n((a=s.id)==null?void 0:a.toString().substring(0,8))}</td>
              <td>${n(s.category)}</td>
              <td>${n(s.title)}</td>
              <td class="cell-truncate">${n((u=s.content)==null?void 0:u.substring(0,80))}</td>
              <td>${J(s.enabled!==!1)}</td>
      ...
      `,i.querySelectorAll(".knowledge-disable").forEach(s=>{s.addEventListener("click",async()=>{try{await N.disableKnowledgeEntry(s.dataset.id),v("已禁用","success"),t()}catch(a){v(`操作失败: ${a.message}`,"error")}})})}catch(l){i.innerHTML=`<div class="page-error">加载失败: ${n(l.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const i=e.querySelector("#knowledge-category").value.trim(),l=e.querySelector("#knowledge-title").value.trim(),r=e.querySelector("#knowledge-content").value.trim();if(!l||!r){v("标题和内容不能为空","warning");return}try{await N.createKnowledgeEntry({category:i,title:l,content:r}),v("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(s){v(`创建失败: ${s.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const A=_();let M=!1,h=null;async function pe(e){M=!1,h=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `;const t=e.querySelector("#rc-select"),i=e.querySelector("#rc-editor");let l=[];function r(){M=!0}function s(){return M?confirm("当前角色卡有未保存的修改，确定要切换吗？"):!0}function a(d){h=d,e.querySelector("#rc-key").value=(d==null?void 0:d.key)||"",e.querySelector("#rc-key").disabled=!!d,e.querySelector("#rc-name").value=(d==null?void 0:d.name)||"",e.querySelector("#rc-desc").value=(d==null?void 0:d.description)||"",e.querySelector("#rc-system-prompt").value=(d==null?void 0:d.system_prompt)||"",e.querySelector("#rc-tone").value=(d==null?void 0:d.tone)||"",e.querySelector("#rc-constraints").value=typeof(d==null?void 0:d.constraints)=="string"?d.constraints:JSON.stringify((d==null?void 0:d.constraints)||"",null,2),e.querySelector("#rc-editor-title").textContent=d?`编辑: ${d.name||d.key}`:"新建角色卡",e.querySelector("#rc-activate").style.display=d&&d.enabled!==!1?"inline-flex":"none",e.querySelector("#rc-disable").style.display=d&&d.enabled!==!1?"inline-flex":"none",i.style.display="block",M=!1}i.querySelectorAll(".form-input").forEach(d=>d.addEventListener("input",r));async function u(){try{const d=await A.getRoleCards({limit:100});l=Array.isArray(d==null?void 0:d.items)?d.items:Array.isArray(d)?d:[],t.innerHTML='<option value="">-- 新建 --</option>'+l.map(b=>`<option value="${n(b.key)}">${n(b.name||b.key)}${b.enabled===!1?" (禁用)":""}</option>`).join("")}catch(d){v(`加载失败: ${d.message}`,"error")}}t.addEventListener("change",()=>{if(!s()){t.value=(h==null?void 0:h.key)||"";return}const d=t.value,b=l.find(c=>c.key===d);a(b||null)}),e.querySelector("#rc-new").addEventListener("click",()=>{s()&&(t.value="",a(null))}),e.querySelector("#rc-save").addEventListener("click",async()=>{const d={key:e.querySelector("#rc-key").value.trim(),name:e.querySelector("#rc-name").value.trim(),description:e.querySelector("#rc-desc").value.trim(),system_prompt:e.querySelector("#rc-system-prompt").value.trim(),tone:e.querySelector("#rc-tone").value.trim()},b=e.querySelector("#rc-constraints").value.trim();try{d.constraints=b?JSON.parse(b):""}catch{d.constraints=b}if(!d.key){v("Key 不能为空","warning");return}try{h!=null&&h.key?(await A.updateRoleCard(h.key,d),v("保存成功","success")):(await A.createRoleCard(d),v("创建成功","success")),M=!1,await u(),t.value=d.key}catch(c){v(`操作失败: ${c.message}`,"error")}}),e.querySelector("#rc-activate").addEventListener("click",async()=>{if(h!=null&&h.key)try{await A.activateRoleCard(h.key),v("已激活","success"),await u()}catch(d){v(`激活失败: ${d.message}`,"error")}}),e.querySelector("#rc-disable").addEventListener("click",async()=>{if(h!=null&&h.key)try{await A.disableRoleCard(h.key),v("已禁用","success"),await u()}catch(d){v(`禁用失败: ${d.message}`,"error")}}),e.querySelector("#rc-refresh").addEventListener("click",()=>{u()}),await u()}const I=_();async function me(e){e.innerHTML=`
  ...
  `;async function t(){try{const[i,l]=await Promise.all([I.getStyleProfile().catch(()=>null),I.getRoleProfile().catch(()=>null)]);i!=null&&i.style&&(e.querySelector("#profile-style").value=i.style,e.querySelector("#profile-style-current").textContent=`当前: ${i.style}`),l!=null&&l.role&&(e.querySelector("#profile-role").value=l.role,e.querySelector("#profile-role-current").textContent=`当前: ${l.role}`)}catch(i){v(`加载配置失败: ${i.message}`,"error")}}e.querySelector("#profile-style-apply").addEventListener("click",async()=>{const i=e.querySelector("#profile-style").value;try{await I.setStyleProfile(i),e.querySelector("#profile-style-current").textContent=`当前: ${i}`,v("风格已更新","success")}catch(l){v(`更新失败: ${l.message}`,"error")}}),e.querySelector("#profile-role-apply").addEventListener("click",async()=>{const i=e.querySelector("#profile-role").value;try{await I.setRoleProfile(i),e.querySelector("#profile-role-current").textContent=`当前: ${i}`,v("角色配置已更新","success")}catch(l){v(`更新失败: ${l.message}`,"error")}}),await t()}function ye({columns:e,rows:t,empty:i="暂无数据"}){if(!t||t.length===0)return`<div class="table-empty">${n(i)}</div>`;const l=e.map(s=>`<th class="${s.class||""}">${n(s.label)}</th>`).join(""),r=t.map(s=>`<tr>${e.map(a=>`<td class="${a.class||""}">${a.render?a.render(s):n(s[a.key])}</td>`).join("")}</tr>`).join("");return`
    <div class="table-wrapper">
      <table class="data-table">
        <thead><tr>${l}</tr></thead>
        <tbody>${r}</tbody>
  ...
  `;const t=e.querySelector("#gw-reply"),i=e.querySelector("#gw-char-count");t.addEventListener("input",()=>{i.textContent=`${t.value.length} 字`}),e.querySelector("#gw-publish-btn").addEventListener("click",async()=>{const r=e.querySelector("#gw-publish-btn"),s=e.querySelector("#gw-comment-id").value.trim(),a=e.querySelector("#gw-reply").value.trim(),u=e.querySelector("#gw-source").value.trim(),d=e.querySelector("#gw-force").checked;if(!s||!a){v("Comment ID 和回复内容不能为空","warning");return}r.disabled=!0,r.textContent="发布中...";try{await G.publishGatewayReply({comment_id:s,reply_text:a,source:u,force_publish:d}),v("发布成功","success"),e.querySelector("#gw-comment-id").value="",e.querySelector("#gw-reply").value="",i.textContent="0/0",l()}catch(b){v(`发布失败: ${b.message}`,"error")}finally{r.disabled=!1,r.textContent="发布"}});async function l(){const r=e.querySelector("#gw-table-wrapper"),s=e.querySelector("#gw-limit").value;r.innerHTML='<div class="page-loading">加载中...</div>';try{const a=await G.getGatewayLogs({limit:s}),u=Array.isArray(a==null?void 0:a.items)?a.items:[];if(u.length===0){r.innerHTML='<div class="table-empty">暂无网关日志</div>';return}r.innerHTML=ye({columns:[{key:"id",label:"ID",class:"cell-id",render:d=>{var b;return n((b=d.id)==null?void 0:b.toString().substring(0,8))}},{key:"comment_id",label:"Comment ID",class:"cell-id",render:d=>{var b;return n((b=d.comment_id)==null?void 0:b.substring(0,12))}},{key:"status",label:"状态",render:d=>K(d.status)},{key:"platform",label:"平台",render:d=>n(d.platform||"-")},{key:"reply_text",label:"回复摘要",class:"cell-truncate",render:d=>{var b;return n((b=d.reply_text)==null?void 0:b.substring(0,60))}},{key:"created_at",label:"时间",class:"cell-time",render:d=>C(d.created_at)}],rows:u})}catch(a){r.innerHTML=`<div class="page-error">加载失败: ${n(a.message)}</div>`}}e.querySelector("#gw-refresh").addEventListener("click",l),e.querySelector("#gw-filter-btn").addEventListener("click",l),await l()}const R=_();async function ge(e){e.innerHTML=`
    <div class="page-header">
      <h2>审计日志</h2>
      <div class="page-actions">
  ...
  `;async function t(){try{const l=await R.getAuditSummary({days:7}),r=e.querySelector("#audit-summary-cards");r.innerHTML=`
      ...
      `}catch{e.querySelector("#audit-summary-cards").innerHTML='<div class="page-error">摘要加载失败</div>'}}async function i(){const l=e.querySelector("#audit-table-wrapper");l.innerHTML='<div class="page-loading">加载中...</div>';const r=e.querySelector("#audit-action").value.trim(),s=e.querySelector("#audit-ok").value,a=e.querySelector("#audit-limit").value;try{const u=await R.getAuditLogs({action:r,ok:s,limit:a}),d=Array.isArray(u==null?void 0:u.items)?u.items:[];if(d.length===0){l.innerHTML='<div class="table-empty">暂无审计日志</div>';return}l.innerHTML=`
        <table class="data-table">
          <thead><tr>
  ...
  `;async function i(){var a,u,d,b,c,y,f,g;const s=e.querySelector("#bili-status-cards");try{const o=await w.getBilibiliStatus(),p=Number(((a=o==null?void 0:o.videos)==null?void 0:a.poll_enabled_count)??0),x=!!((u=o==null?void 0:o.diagnostics)!=null&&u.ready),L=Ee((d=o==null?void 0:o.diagnostics)==null?void 0:d.blocking_reasons),se=(b=o==null?void 0:o.credential)!=null&&b.name?n(o.credential.name):"未配置",le=Te((c=o==null?void 0:o.diagnostics)==null?void 0:c.effective_publish_mode),re=Ce((y=o==null?void 0:o.config)==null?void 0:y.poll_interval_seconds),B=H((f=o==null?void 0:o.credential)==null?void 0:f.expires_at),ae=Me((g=o==null?void 0:o.credential)==null?void 0:g.last_used_at);s.innerHTML=`
      ...
      `,s.querySelectorAll(".cred-activate").forEach(o=>{o.addEventListener("click",async()=>{o.disabled=!0;try{await w.activateBilibiliCredential(o.dataset.id),v("已激活","success"),await Promise.all([i(),r()])}catch(p){v(`激活失败: ${$(p)}`,"error")}finally{o.disabled=!1}})}),s.querySelectorAll(".cred-delete").forEach(o=>{o.addEventListener("click",async()=>{if(confirm("确定删除此凭证？")){o.disabled=!0;try{await w.deleteBilibiliCredential(o.dataset.id),v("已删除","success"),await Promise.all([i(),r()])}catch(p){v(`删除失败: ${$(p)}`,"error")}finally{o.disabled=!1}}})})}catch(y){a.textContent="凭证加载失败",s.innerHTML=`<div class="page-error">加载失败: ${n($(y))}</div>`}finally{u.disabled=!1,d.disabled=!1}}e.querySelector("#bili-video-add").addEventListener("click",async()=>{const s=e.querySelector("#bili-video-add"),a=e.querySelector("#bili-video-bvid").value.trim(),u=xe(a);if(u){v($(u),"warning");return}s.disabled=!0,s.textContent="添加中...";try{await w.addBilibiliVideo(a),v("添加成功","success"),e.querySelector("#bili-video-bvid").value="",await Promise.all([i(),l()])}catch(d){v(`添加失败: ${$(d)}`,"error")}finally{s.disabled=!1,s.textContent="添加"}}),e.querySelector("#cred-add").addEventListener("click",async()=>{var b;const s=e.querySelector("#cred-add"),a=ke(e.querySelector("#cred-expires").value),u={name:e.querySelector("#cred-name").value.trim(),sessdata:e.querySelector("#cred-sessdata").value.trim(),bili_jct:e.querySelector("#cred-bili-jct").value.trim(),buvid3:e.querySelector("#cred-buvid3").value.trim(),buvid4:e.querySelector("#cred-buvid4").value.trim(),expires_at:a},d=Le(u);if(d){v($(d),"warning");return}s.disabled=!0,s.textContent="添加中...";try{const c=await w.addBilibiliCredential(u);v((b=c==null?void 0:c.item)!=null&&b.is_active?"凭证添加成功，已自动激活":"凭证添加成功","success"),e.querySelector("#cred-name").value="",e.querySelector("#cred-sessdata").value="",e.querySelector("#cred-bili-jct").value="",e.querySelector("#cred-buvid3").value="",e.querySelector("#cred-buvid4").value="",e.querySelector("#cred-expires").value="",await Promise.all([i(),r()])}catch(c){v(`添加失败: ${$(c)}`,"error")}finally{s.disabled=!1,s.textContent="添加凭证"}}),e.querySelector("#bili-poll-btn").addEventListener("click",async()=>{const s=e.querySelector("#bili-poll-btn");s.disabled=!0,s.textContent="轮询中...";try{const a=await w.triggerBilibiliPoll();v(Y(a==null?void 0:a.result),"success"),await Promise.all([i(),l()])}catch(a){v(`轮询失败: ${$(a)}`,"error")}finally{s.disabled=!1,s.textContent="触发轮询"}}),e.querySelector("#bili-refresh").addEventListener("click",async()=>{const s=e.querySelector("#bili-refresh");s.disabled=!0,s.textContent="刷新中...";try{await Promise.all([i(),l(),r()])}finally{s.disabled=!1,s.innerHTML='<svg width="14" height="14"><use href="#icon-refresh"></use></svg> 刷新'}}),e.querySelector("#bili-video-filter-btn").addEventListener("click",()=>{t=0,l()}),e.querySelector("#bili-video-poll-filter").addEventListener("change",()=>{t=0,l()}),e.querySelector("#bili-video-prev").addEventListener("click",()=>{t<=0||(t=Math.max(0,t-E),l())}),e.querySelector("#bili-video-next").addEventListener("click",()=>{t+=E,l()}),e.querySelector("#bili-cred-active-filter").addEventListener("change",r),e.querySelector("#bili-cred-expiry-filter").addEventListener("change",r),F(e,["#bili-video-bvid"],"#bili-video-add"),F(e,["#cred-name","#cred-sessdata","#cred-bili-jct","#cred-buvid3","#cred-buvid4","#cred-expires"],"#cred-add"),await Promise.all([i(),l(),r()])}const W=_();async function Ve(e){e.innerHTML=`
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),i=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}i.innerHTML='<div class="page-loading">查询中...</div>';try{const l=await W.getComment(t);i.innerHTML=`
      ...
      `}catch(l){i.innerHTML=`<div class="page-error">查询失败: ${n(l.message)}</div>`}}),e.querySelector("#query-job-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-job-id").value.trim(),i=e.querySelector("#query-job-result");if(!t){v("请输入 Job ID","warning");return}i.innerHTML='<div class="page-loading">查询中...</div>';try{const l=await W.getJob(t);i.innerHTML=`
        <div class="detail-card">
