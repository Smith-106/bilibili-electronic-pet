(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function l(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=l(s);fetch(s.href,i)}})();function gt(e,t,l){return typeof e=="string"&&/^[a-z0-9_:-]+$/i.test(e)?e:t>=500?"request_failed":typeof l=="string"&&l.trim()?l.trim().toLowerCase().replace(/\s+/g,"_"):"request_failed"}function rt(){return(window.__ADMIN_API_KEY__||"").trim()}async function h(e,t={}){const l=rt(),r=new Headers(t.headers||{});l&&r.set("x-api-key",l);const s=await fetch(e,{...t,headers:r}),i=await s.json().catch(()=>({}));if(!s.ok){const n=(i==null?void 0:i.detail)||(i==null?void 0:i.error);throw new Error(gt(n,s.status,s.statusText))}return i}async function Ze(e,t){const l=rt(),r=new Headers;l&&r.set("x-api-key",l);const s=await fetch(e,{headers:r});if(!s.ok)throw new Error("download_failed");const i=await s.blob(),n=URL.createObjectURL(i),p=document.createElement("a");p.href=n,p.download=t,document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(n)}function A(e){const t=new URLSearchParams;for(const[r,s]of Object.entries(e))s!=null&&s!==""&&t.set(r,String(s));const l=t.toString();return l?`?${l}`:""}function N(){return{getOverview(){return h("/api/admin/overview")},getJobs({status:e,limit:t}={}){return h(`/api/admin/jobs${A({status:e,limit:t})}`)},getJob(e){return h(`/api/jobs/${encodeURIComponent(e)}`)},approveJob(e){return h(`/api/jobs/${encodeURIComponent(e)}/approve`,{method:"POST"})},retryJob(e,t={}){return h(`/api/jobs/${encodeURIComponent(e)}/retry`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},batchApprove(e){return h("/api/jobs/approve-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},batchRetry(e){return h("/api/jobs/retry-batch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({job_ids:e})})},exportJobsCsv({status:e,limit:t}={}){return Ze(`/export/jobs.csv${A({status:e,limit:t})}`,"jobs.csv")},getComment(e){return h(`/api/comments/${encodeURIComponent(e)}`)},getGatewayLogs({limit:e,comment_id:t}={}){return h(`/api/admin/gateway/logs${A({limit:e,comment_id:t})}`)},publishGatewayReply(e){return h("/gateway/publish",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},getAuditSummary({days:e,action:t,ok:l}={}){return h(`/api/admin/audit/summary${A({days:e,action:t,ok:l})}`)},getAuditLogs({limit:e,action:t,ok:l}={}){return h(`/api/audit-log${A({limit:e,action:t,ok:l})}`)},exportAuditCsv({limit:e,action:t,ok:l}={}){return Ze(`/export/audit-logs.csv${A({limit:e,action:t,ok:l})}`,"audit-logs.csv")},getDailyMetrics({days:e}={}){return h(`/api/metrics/daily${A({days:e})}`)},getKnowledgeEntries({limit:e,offset:t}={}){return h(`/api/admin/knowledge${A({limit:e,offset:t})}`)},createKnowledgeEntry(e){return h("/api/admin/knowledge",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},disableKnowledgeEntry(e){return h(`/api/admin/knowledge/${encodeURIComponent(e)}/disable`,{method:"POST"})},getRoleCards({limit:e,offset:t}={}){return h(`/api/admin/role-cards${A({limit:e,offset:t})}`)},createRoleCard(e){return h("/api/admin/role-cards",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},updateRoleCard(e,t){return h(`/api/admin/role-cards/${encodeURIComponent(e)}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})},disableRoleCard(e){return h(`/api/admin/role-cards/${encodeURIComponent(e)}/disable`,{method:"POST"})},activateRoleCard(e){return h(`/api/admin/role-cards/${encodeURIComponent(e)}/activate`,{method:"POST"})},getStyleProfile(){return h("/api/admin/style-profile")},setStyleProfile(e){return h("/api/admin/style-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({style:e})})},getRoleProfile(){return h("/api/admin/role-profile")},setRoleProfile(e){return h("/api/admin/role-profile",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({role:e})})},getBilibiliStatus(){return h("/api/admin/bilibili/status")},getBilibiliVideos({poll_enabled:e,limit:t,offset:l}={}){return h(`/api/admin/bilibili/videos${A({poll_enabled:e,limit:t,offset:l})}`)},addBilibiliVideo(e){return h("/api/admin/bilibili/videos",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({bvid:e})})},toggleBilibiliVideoPoll(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/toggle-poll`,{method:"POST"})},syncBilibiliVideo(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}/sync`,{method:"POST"})},deleteBilibiliVideo(e){return h(`/api/admin/bilibili/videos/${encodeURIComponent(e)}`,{method:"DELETE"})},triggerBilibiliPoll(){return h("/api/admin/bilibili/poll",{method:"POST"})},getBilibiliCredentials(){return h("/api/admin/bilibili/credentials")},addBilibiliCredential(e){return h("/api/admin/bilibili/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})},activateBilibiliCredential(e){return h(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}/activate`,{method:"POST"})},deleteBilibiliCredential(e){return h(`/api/admin/bilibili/credentials/${encodeURIComponent(e)}`,{method:"DELETE"})}}}function d(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function L(e){if(!e)return"-";try{const t=new Date(e);return isNaN(t.getTime())?String(e):t.toLocaleString("zh-CN",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1})}catch{return String(e)}}function mt(e){if(!e)return"";try{const t=new Date(e);if(isNaN(t.getTime()))return"";const l=Date.now()-t.getTime(),r=Math.floor(l/1e3);if(r<60)return"刚刚";const s=Math.floor(r/60);if(s<60)return`${s}分钟前`;const i=Math.floor(s/60);if(i<24)return`${i}小时前`;const n=Math.floor(i/24);if(n<30)return`${n}天前`;const p=Math.floor(n/30);return p<12?`${p}个月前`:`${Math.floor(p/12)}年前`}catch{return""}}function ne(e){const t=mt(e),l=L(e);return t?`<span title="${d(l)}">${d(t)}</span>`:`<span title="${d(l)}">${d(l)}</span>`}function H(e){if(e==null)return"0";const t=Number(e);return isNaN(t)?"0":String(t)}const $t={published:{label:"已发布",cls:"badge-success"},failed:{label:"失败",cls:"badge-danger"},queued:{label:"排队中",cls:"badge-warning"},pending_review:{label:"待审核",cls:"badge-warning"},approved:{label:"已审批",cls:"badge-success"},retrying:{label:"重试中",cls:"badge-info"},skipped:{label:"已跳过",cls:"badge-muted"},processing:{label:"处理中",cls:"badge-info"}};function Ge(e){if(!e)return"";const t=$t[e]||{label:e,cls:"badge-muted"};return`<span class="status-badge ${t.cls}">${d(t.label)}</span>`}function Fe(e,t="是",l="否"){return`<span class="status-badge ${e?"badge-success":"badge-muted"}">${d(e?t:l)}</span>`}let We=null;function v(e,t="info"){const l=document.getElementById("app-toast");l&&l.remove(),We&&clearTimeout(We);const r={info:"var(--primary-cta)",success:"var(--success-color)",error:"var(--danger-color)",warning:"var(--warning-color)"},s=document.createElement("div");s.id="app-toast",s.className="toast-notification",s.style.setProperty("--toast-color",r[t]||r.info),s.innerHTML=`
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>s.classList.add("show"));const i=()=>{s.classList.remove("show"),setTimeout(()=>s.remove(),300)};s.querySelector(".toast-close").onclick=i,We=setTimeout(i,4e3)}const he=N();async function st(e){e.innerHTML='<div class="page-loading">加载中...</div>';try{const[t,l,r,s]=await Promise.all([he.getOverview().catch(()=>null),he.getJobs({limit:5}).catch(()=>null),he.getGatewayLogs({limit:5}).catch(()=>null),he.getAuditSummary({days:7}).catch(()=>null)]),i=t||{},n=Array.isArray(l==null?void 0:l.items)?l.items:[],p=Array.isArray(r==null?void 0:r.items)?r.items:[];e.innerHTML=`
    ...
    `,e.querySelector("#dashboard-refresh").addEventListener("click",()=>{v("正在刷新...","info"),st(e)})}catch(t){e.innerHTML=`<div class="page-error">加载失败: ${d(t.message)}</div>`}}const se=N();async function xt(e){let t=new Set;e.innerHTML=`
    <div class="page-header">
      <h2>任务管理</h2>
  ...
  `;const l=e.querySelector("#jobs-status"),r=e.querySelector("#jobs-limit");async function s(){var p;t.clear(),i();const n=e.querySelector("#jobs-table-wrapper");n.innerHTML='<div class="page-loading">加载中...</div>';try{const o=await se.getJobs({status:l.value,limit:r.value}),b=Array.isArray(o==null?void 0:o.items)?o.items:[];if(b.length===0){n.innerHTML='<div class="table-empty">暂无任务</div>';return}n.innerHTML=`
        <table class="data-table">
          <thead><tr>
          ...
          <tbody>
            ${b.map(c=>{var g,$,w,y;return`
              <tr data-id="${d(c.id)}">
                ...
                <td class="cell-time">${ne(c.created_at)}</td>
      ...
      `,(p=n.querySelector("#jobs-select-all"))==null||p.addEventListener("change",c=>{const g=c.target.checked;n.querySelectorAll(".job-checkbox").forEach($=>{$.checked=g,g?t.add($.dataset.id):t.delete($.dataset.id)}),i()}),n.querySelectorAll(".job-checkbox").forEach(c=>{c.addEventListener("change",()=>{c.checked?t.add(c.dataset.id):t.delete(c.dataset.id),i()})}),n.querySelectorAll(".job-approve").forEach(c=>{c.addEventListener("click",async()=>{c.disabled=!0,c.textContent="审批中...";try{await se.approveJob(c.dataset.id),v("审批成功","success"),s()}catch(g){v(`审批失败: ${g.message}`,"error"),c.disabled=!1,c.textContent="审批"}})}),n.querySelectorAll(".job-retry").forEach(c=>{c.addEventListener("click",async()=>{c.disabled=!0,c.textContent="重试中...";try{await se.retryJob(c.dataset.id),v("重试已提交","success"),s()}catch(g){v(`重试失败: ${g.message}`,"error"),c.disabled=!1,c.textContent="重试"}})})}catch(o){n.innerHTML=`<div class="page-error">加载失败: ${d(o.message)}</div>`}}function i(){const n=e.querySelector("#jobs-batch-bar"),p=e.querySelector("#jobs-selected-count");t.size>0?(n.style.display="flex",p.textContent=`已选 ${t.size} 项`):n.style.display="none"}e.querySelector("#jobs-filter-btn").addEventListener("click",s),e.querySelector("#jobs-refresh").addEventListener("click",s),e.querySelector("#jobs-export").addEventListener("click",async()=>{try{await se.exportJobsCsv({status:l.value,limit:r.value}),v("导出成功","success")}catch(n){v(`导出失败: ${n.message}`,"error")}}),e.querySelector("#jobs-batch-approve").addEventListener("click",async()=>{if(t.size!==0)try{await se.batchApprove([...t]),v(`批量审批 ${t.size} 项成功`,"success"),s()}catch(n){v(`批量审批失败: ${n.message}`,"error")}}),e.querySelector("#jobs-batch-retry").addEventListener("click",async()=>{if(t.size!==0)try{await se.batchRetry([...t]),v(`批量重试 ${t.size} 项成功`,"success"),s()}catch(n){v(`批量重试失败: ${n.message}`,"error")}}),await s()}const _t=N();async function wt(e){e.innerHTML=`
    <div class="page-header">
      <h2>每日指标</h2>
      <div class="page-actions">
  ...
  `;async function t(){const l=e.querySelector("#metrics-days").value,r=e.querySelector("#metrics-table-wrapper");r.innerHTML='<div class="page-loading">加载中...</div>';try{const s=await _t.getDailyMetrics({days:l}),i=Array.isArray(s==null?void 0:s.items)?s.items:Array.isArray(s)?s:[];if(i.length===0){r.innerHTML='<div class="table-empty">暂无指标数据</div>';return}r.innerHTML=`
      ...
      `}catch(s){r.innerHTML=`<div class="page-error">加载失败: ${d(s.message)}</div>`}}e.querySelector("#metrics-load").addEventListener("click",t),await t()}const Je=N();async function St(e){e.innerHTML=`
    <div class="page-header">
      <h2>知识库</h2>
  ...
  `;async function t(){const l=e.querySelector("#knowledge-table-wrapper");l.innerHTML='<div class="page-loading">加载中...</div>';try{const r=await Je.getKnowledgeEntries({limit:50}),s=Array.isArray(r==null?void 0:r.items)?r.items:[];if(s.length===0){l.innerHTML='<div class="table-empty">暂无知识条目</div>';return}l.innerHTML=`
        <table class="data-table">
          ...
          <tbody>
            ${s.map(i=>{var n,p;return`<tr>
              ...
              <td class="cell-time">${ne(i.created_at)}</td>
              <td class="cell-actions">
      ...
      `,l.querySelectorAll(".knowledge-disable").forEach(i=>{i.addEventListener("click",async()=>{try{await Je.disableKnowledgeEntry(i.dataset.id),v("已禁用","success"),t()}catch(n){v(`操作失败: ${n.message}`,"error")}})})}catch(r){l.innerHTML=`<div class="page-error">加载失败: ${d(r.message)}</div>`}}e.querySelector("#knowledge-create").addEventListener("click",async()=>{const l=e.querySelector("#knowledge-category").value.trim(),r=e.querySelector("#knowledge-title").value.trim(),s=e.querySelector("#knowledge-content").value.trim();if(!r||!s){v("标题和内容不能为空","warning");return}try{await Je.createKnowledgeEntry({category:l,title:r,content:s}),v("创建成功","success"),e.querySelector("#knowledge-category").value="",e.querySelector("#knowledge-title").value="",e.querySelector("#knowledge-content").value="",t()}catch(i){v(`创建失败: ${i.message}`,"error")}}),e.querySelector("#knowledge-refresh").addEventListener("click",t),await t()}const de=N();let ce=!1,S=null;async function Et(e){ce=!1,S=null,e.innerHTML=`
    <div class="page-header">
      <h2>角色卡管理</h2>
      <div class="page-actions">
  ...
  `;const t=e.querySelector("#rc-select"),l=e.querySelector("#rc-editor");let r=[];function s(){ce=!0}function i(){return ce?confirm("当前角色卡有未保存的修改，确定要切换吗？"):!0}function n(o){S=o,e.querySelector("#rc-key").value=(o==null?void 0:o.key)||"",e.querySelector("#rc-key").disabled=!!o,e.querySelector("#rc-name").value=(o==null?void 0:o.name)||"",e.querySelector("#rc-desc").value=(o==null?void 0:o.description)||"",e.querySelector("#rc-system-prompt").value=(o==null?void 0:o.system_prompt)||"",e.querySelector("#rc-tone").value=(o==null?void 0:o.tone)||"",e.querySelector("#rc-constraints").value=typeof(o==null?void 0:o.constraints)=="string"?o.constraints:JSON.stringify((o==null?void 0:o.constraints)||"",null,2),e.querySelector("#rc-editor-title").textContent=o?`编辑: ${o.name||o.key}`:"新建角色卡",e.querySelector("#rc-activate").style.display=o&&o.enabled!==!1?"inline-flex":"none",e.querySelector("#rc-disable").style.display=o&&o.enabled!==!1?"inline-flex":"none",l.style.display="block",ce=!1}l.querySelectorAll(".form-input").forEach(o=>o.addEventListener("input",s));async function p(){try{const o=await de.getRoleCards({limit:100});r=Array.isArray(o==null?void 0:o.items)?o.items:Array.isArray(o)?o:[],t.innerHTML='<option value="">-- 新建 --</option>'+r.map(b=>`<option value="${d(b.key)}">${d(b.name||b.key)}${b.enabled===!1?" (禁用)":""}</option>`).join("")}catch(o){v(`加载失败: ${o.message}`,"error")}}t.addEventListener("change",()=>{if(!i()){t.value=(S==null?void 0:S.key)||"";return}const o=t.value,b=r.find(c=>c.key===o);n(b||null)}),e.querySelector("#rc-new").addEventListener("click",()=>{i()&&(t.value="",n(null))}),e.querySelector("#rc-save").addEventListener("click",async()=>{const o={key:e.querySelector("#rc-key").value.trim(),name:e.querySelector("#rc-name").value.trim(),description:e.querySelector("#rc-desc").value.trim(),system_prompt:e.querySelector("#rc-system-prompt").value.trim(),tone:e.querySelector("#rc-tone").value.trim()},b=e.querySelector("#rc-constraints").value.trim();try{o.constraints=b?JSON.parse(b):""}catch{o.constraints=b}if(!o.key){v("Key 不能为空","warning");return}try{S!=null&&S.key?(await de.updateRoleCard(S.key,o),v("保存成功","success")):(await de.createRoleCard(o),v("创建成功","success")),ce=!1,await p(),t.value=o.key}catch(c){v(`操作失败: ${c.message}`,"error")}}),e.querySelector("#rc-activate").addEventListener("click",async()=>{if(S!=null&&S.key)try{await de.activateRoleCard(S.key),v("已激活","success"),await p()}catch(o){v(`激活失败: ${o.message}`,"error")}}),e.querySelector("#rc-disable").addEventListener("click",async()=>{if(S!=null&&S.key)try{await de.disableRoleCard(S.key),v("已禁用","success"),await p()}catch(o){v(`禁用失败: ${o.message}`,"error")}}),e.querySelector("#rc-refresh").addEventListener("click",()=>{p()}),await p()}const ge=N();async function Ct(e){e.innerHTML=`
  ...
  `}const Qe=N();async function Lt(e){e.innerHTML=`
    <div class="page-header">
      <h2>网关</h2>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${o.map(b=>{var c;return`<tr>
              ...
              <td class="cell-time">${ne(b.created_at)}</td>
            </tr>`}).join("")}
          </tbody>
        </table>
      `}catch(p){r.innerHTML=`<div class="page-error">加载失败: ${d(p.message)}</div>`}}e.querySelector("#audit-refresh").addEventListener("click",()=>{t(),l()}),e.querySelector("#audit-filter-btn").addEventListener("click",l),e.querySelector("#audit-export").addEventListener("click",async()=>{try{await Ke.exportAuditCsv({action:e.querySelector("#audit-action").value.trim(),ok:e.querySelector("#audit-ok").value,limit:e.querySelector("#audit-limit").value}),v("导出成功","success")}catch(r){v(`导出失败: ${r.message}`,"error")}}),await Promise.all([t(),l()])}const T=N(),Tt=/^BV[a-zA-Z0-9]{10}$/,Bt={unauthorized:"未授权，请检查管理 API Key。",bilibili_not_configured:"请先添加并激活可用的 B 站凭证。",bilibili_sync_failed:"同步失败，请稍后重试。",invalid_poll_enabled:"轮询开关参数无效。",invalid_video_id:"视频标识无效。",invalid_credential_id:"凭证标识无效。",video_not_found:"视频不存在或已删除。",credential_not_found:"凭证不存在或已删除。",invalid_bvid_format:"BVID 格式不正确。",bvid_required:"BVID 不能为空。",name_required:"名称不能为空。",sessdata_required:"SESSDATA 不能为空。",bili_jct_required:"bili_jct 不能为空。",buvid3_required:"buvid3 不能为空。",invalid_expires_at:"过期时间格式无效。",request_failed:"请求失败，请稍后重试。"},Mt={"auth:no active credential":"缺少可用的激活凭证。","dependency:diagnostics_unavailable":"诊断信息暂时不可用。"},Pt={manual_queue:"人工队列",simulated:"模拟发布",webhook:"Webhook",real_publish:"真实发布",native_bilibili:"原生 B 站发布"},At={ok:{label:"成功",cls:"badge-success"},no_new:{label:"无新增",cls:"badge-muted"},error:{label:"失败",cls:"badge-danger"}},me={no_aid:"缺少视频 aid，暂时无法轮询。",retry_exhausted:"评论抓取重试耗尽。"},ae=50,Nt=7*24*60*60*1e3;function q(e){const t=e instanceof Error?e.message:String(e??"request_failed");return Bt[t]||t}function It(e){return e?Tt.test(e)?null:"invalid_bvid_format":"bvid_required"}function jt(e){return e.name?e.sessdata?e.bili_jct?e.buvid3?e.expires_at===null?"invalid_expires_at":null:"buvid3_required":"bili_jct_required":"sessdata_required":"name_required"}function Ht(e){if(!e)return;const t=new Date(e);return Number.isNaN(t.getTime())?null:t.toISOString()}function Rt(e){return(Array.isArray(e)?e.filter(Boolean):[]).map(l=>Mt[l]||l).join("；")}function Ot(e){const t=String(e??"").trim().toLowerCase();return Pt[t]||t||"-"}function Dt(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":t%60===0?`${t/60} 分钟`:`${t} 秒`}function Ut(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"-":`${t} 次/分钟`}function Vt(e){const t=Number(e);if(!Number.isFinite(t)||t<=0)return"";const l=t/60;if(l>=1)return`约每秒 ${l.toFixed(l>=10?0:1).replace(/\.0$/,"")} 次`;const r=60/t;return`约每 ${r.toFixed(r>=10?0:1).replace(/\.0$/,"")} 秒 1 次`}function Xe(e,t,l="覆盖率"){const r=Number(t??0);if(!Number.isFinite(r)||r<=0)return"暂无视频";const s=Number(e??0),n=((Number.isFinite(s)?Math.min(r,Math.max(0,s)):0)/r*100).toFixed(1).replace(/\.0$/,"");return`${l} ${n}%`}function Wt(e,t){const l=Number(e??0);if(!Number.isFinite(l)||l<=0)return"暂无视频";const r=Number(t??0),s=Number.isFinite(r)?Math.min(l,Math.max(0,r)):0,i=Math.max(0,l-s);return`轮询中 ${s}，停用 ${i}`}function Jt(e,t,l){const r=String(e??"").trim().toLowerCase();if(!r)return"-";const s=At[r]||{label:r,cls:"badge-muted"},i=r==="error"&&t?me[String(t).trim().toLowerCase()]||String(t):"",n=i?` title="${d(i)}"`:"",p=typeof l=="number"&&Number.isFinite(l)?`评论游标: ${l}`:"",o=[i,p].filter(Boolean).map(b=>`<div class="form-hint" style="margin-top:4px;">${d(b)}</div>`).join("");return`<span class="status-badge ${s.cls}"${n}>${d(s.label)}</span>${o}`}function Kt(e){if(e==="true")return!0;if(e==="false")return!1}function zt(e){return e==="true"?"暂无轮询中视频":e==="false"?"暂无已停用视频":"暂无视频"}function V(e){return typeof(e==null?void 0:e.aid)=="number"&&Number.isFinite(e.aid)}function Ft(e){return e.filter(t=>!V(t)).length}function Gt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)).length}function Yt(e){return e.filter(t=>!!(t!=null&&t.poll_enabled)&&!V(t)).length}function Zt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&V(t)).length}function Qt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function Xt(e){return e.filter(t=>!(t!=null&&t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ei(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&!(t!=null&&t.last_polled_at)).length}function ti(e){return e.filter(t=>(t==null?void 0:t.poll_enabled)&&(t==null?void 0:t.last_polled_at)).length}function ii(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="error").length}function li(e){return e.filter(t=>{const l=String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase();return l==="ok"||l==="no_new"}).length}function ri(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="ok").length}function si(e){return e.filter(t=>String((t==null?void 0:t.last_poll_status)??"").trim().toLowerCase()==="no_new").length}function ai(e){return e.filter(t=>!(t!=null&&t.last_polled_at)).length}function ni(e){return e.filter(t=>V(t)&&!(t!=null&&t.last_polled_at)).length}function oi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function di(e){return e.filter(t=>typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function ci(e){return e.filter(t=>String((t==null?void 0:t.title)??"").trim().length>0).length}function ui(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0).length}function pi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&Number((t==null?void 0:t.comment_count)??0)<=0).length}function bi(e){return e.filter(t=>typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function vi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)>0&&!(typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid))).length}function fi(e){return e.filter(t=>Number((t==null?void 0:t.comment_count)??0)<=0&&typeof(t==null?void 0:t.last_rpid)=="number"&&Number.isFinite(t.last_rpid)).length}function yi(e){return e.filter(t=>V(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid)).length}function hi(e){return e.filter(t=>(t==null?void 0:t.last_polled_at)&&!(V(t)&&String((t==null?void 0:t.title)??"").trim().length>0&&typeof(t==null?void 0:t.owner_mid)=="number"&&Number.isFinite(t.owner_mid))).length}function gi(e){return e.reduce((t,l)=>{const r=Number((l==null?void 0:l.comment_count)??0);return t+(Number.isFinite(r)&&r>0?r:0)},0)}function mi(e){const l=V(e)?`aid: ${e.aid}`:me.no_aid;return`${d((e==null?void 0:e.bvid)||"-")}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function $i(e){const t=[];return typeof(e==null?void 0:e.owner_mid)=="number"&&Number.isFinite(e.owner_mid)&&t.push(`UP主 MID: ${e.owner_mid}`),e!=null&&e.updated_at&&t.push(`更新: ${L(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${L(e.created_at)}`),`${d((e==null?void 0:e.title)||"-")}${t.map(l=>`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`).join("")}`}function xi(e){const t=V(e),l=t?"":" disabled",r=t?"":` title="${d(me.no_aid)}"`;return`<button class="btn btn-sm bili-sync" data-id="${d(e.id||e.video_id)}" data-has-aid="${t?"true":"false"}"${l}${r}>同步</button>`}function _i(e,t,l,r=0,s=ae,i=[]){const n=l==="true"?"轮询中":l==="false"?"已停用":"全部",p=Math.floor(r/s)+1,o=Math.max(1,Math.ceil(e/s)),b=Gt(i),c=Math.max(0,i.length-b),g=Yt(i),$=Zt(i),w=Qt(i),y=Xt(i),f=ei(i),C=ti(i),E=Ft(i),W=Math.max(0,i.length-E),R=ii(i),J=li(i),O=ri(i),u=si(i),k=ai(i),B=ni(i),K=Math.max(0,i.length-k),m=di(i),Q=Math.max(0,i.length-m),z=ci(i),F=Math.max(0,i.length-z),D=ui(i),M=Math.max(0,i.length-D),I=pi(i),P=bi(i),X=vi(i),ee=fi(i),te=Math.max(0,i.length-P),ie=oi(i),G=yi(i),le=Math.max(0,i.length-G),Y=hi(i),j=gi(i),Z=E>0?`，当前页缺少 aid ${E} 条`:"",$e=l===""&&b>0?`，当前页轮询开启 ${b} 条`:"",xe=l===""&&c>0?`，当前页轮询停用 ${c} 条`:"",_e=l===""&&g>0?`，轮询开启但缺少 aid ${g} 条`:"",we=l===""&&$>0?`，轮询停用但可同步 ${$} 条`:"",Se=l===""&&w>0?`，轮询停用且从未轮询 ${w} 条`:"",Ee=l===""&&y>0?`，轮询停用且已有轮询记录 ${y} 条`:"",Ce=l===""&&f>0?`，轮询开启但尚未轮询 ${f} 条`:"",qe=l===""&&C>0?`，轮询开启且已有轮询记录 ${C} 条`:"",Le=W>0?`，可同步 ${W} 条`:"",re=J>0?`，正常轮询 ${J} 条`:"",oe=O>0?`，成功轮询 ${O} 条`:"",ke=u>0?`，无新增 ${u} 条`:"",Te=R>0?`，轮询失败 ${R} 条`:"",Be=K>0?`，已有轮询记录 ${K} 条`:"",Me=k>0?`，尚未轮询 ${k} 条`:"",ue=B>0?`，可同步但尚未轮询 ${B} 条`:"",Pe=m>0?`，已识别 UP 主 ${m} 条`:"",pe=Q>0?`，缺少 UP 主 ${Q} 条`:"",Ae=z>0?`，已抓取标题 ${z} 条`:"",be=F>0?`，缺少标题 ${F} 条`:"",Ne=G>0?`，信息完整 ${G} 条`:"",Ie=le>0?`，信息不完整 ${le} 条`:"",je=Y>0?`，已轮询但信息不完整 ${Y} 条`:"",He=D>0?`，已有评论视频 ${D} 条`:"",Re=M>0?`，无评论视频 ${M} 条`:"",ve=I>0?`，已轮询但无评论 ${I} 条`:"",Oe=P>0?`，已有评论游标 ${P} 条`:"",fe=X>0?`，有评论但无游标 ${X} 条`:"",De=ee>0?`，无评论但有游标 ${ee} 条`:"",ye=te>0?`，无评论游标 ${te} 条`:"",Ue=ie>0?`，已轮询但无游标 ${ie} 条`:"",Ve=j>0?`，关联评论 ${j} 条`:"";return`筛选: ${n}，共 ${e} 条，当前展示 ${t} 条，第 ${p}/${o} 页${$e}${xe}${Z}${_e}${we}${Se}${Ee}${Ce}${qe}${Le}${re}${oe}${ke}${Te}${Be}${Me}${ue}${Pe}${pe}${Ae}${be}${Ne}${Ie}${je}${He}${Re}${ve}${Oe}${fe}${De}${ye}${Ue}${Ve}`}function et(e,t={}){const l=Number((e==null?void 0:e.videos)??0),r=Number((e==null?void 0:e.comments)??0),s=Number((e==null?void 0:e.events_injected)??r),i=t.subject||(l===1?"视频":"轮询");return r>0||s>0?`${i}完成，处理 ${l} 个视频，新增 ${r} 条评论，注入 ${s} 个事件。`:l>0?`${i}完成，处理 ${l} 个视频，暂无新增评论。`:`${i}完成，暂无可处理视频。`}function x(e,t=Date.now()){if(!e)return{hasExpiry:!1,expired:!1,expiringSoon:!1,label:"未设置",cls:"badge-muted",detail:""};const l=new Date(e);if(Number.isNaN(l.getTime()))return{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"时间异常",cls:"badge-danger",detail:String(e)};const r=l.getTime()-t;return r<=0?{hasExpiry:!0,expired:!0,expiringSoon:!1,label:"已过期",cls:"badge-danger",detail:L(e)}:r<=Nt?{hasExpiry:!0,expired:!1,expiringSoon:!0,label:"即将过期",cls:"badge-warning",detail:L(e)}:{hasExpiry:!0,expired:!1,expiringSoon:!1,label:"有效",cls:"badge-success",detail:L(e)}}function wi(e){const t=x(e),l=t.detail?`<div class="form-hint" style="margin-top:4px;">${d(t.detail)}</div>`:"";return`<span class="status-badge ${t.cls}">${d(t.label)}</span>${l}`}function tt(e,t="-"){const l=[];return e!=null&&e.updated_at&&l.push(`更新: ${L(e.updated_at)}`),e!=null&&e.created_at&&l.push(`创建: ${L(e.created_at)}`),`${d((e==null?void 0:e.name)||t)}${l.map(r=>`<div class="form-hint" style="margin-top:4px;">${d(r)}</div>`).join("")}`}function Si(e){return(e==null?void 0:e.cls)==="badge-danger"?"var(--danger-color)":(e==null?void 0:e.cls)==="badge-warning"?"var(--warning-color)":(e==null?void 0:e.cls)==="badge-success"?"var(--success-color)":"var(--grey-2)"}function Ei(e){if(!e)return{label:"未配置",detail:""};if(e!=null&&e.last_used_at)return{label:L(e.last_used_at),detail:""};const t=[];return e!=null&&e.updated_at&&t.push(`更新: ${L(e.updated_at)}`),e!=null&&e.created_at&&t.push(`创建: ${L(e.created_at)}`),{label:"从未使用",detail:t.join("，")}}function _(e){return!!(e!=null&&e.has_sessdata&&(e!=null&&e.has_bili_jct)&&(e!=null&&e.buvid3))}function Ci(e){const t=[];return e!=null&&e.has_sessdata||t.push("SESSDATA"),e!=null&&e.has_bili_jct||t.push("bili_jct"),e!=null&&e.buvid3||t.push("buvid3"),t}function qi(e,t){return e?t?"凭证字段完整":"凭证字段缺失":"未配置凭证"}function Li(e){var n,p,o,b,c,g;const t=!!((p=(n=e==null?void 0:e.checks)==null?void 0:n.auth)!=null&&p.ready),l=!!((b=(o=e==null?void 0:e.checks)==null?void 0:o.worker_or_publish)!=null&&b.ready),r=!!((c=e==null?void 0:e.signals)!=null&&c.polling_worker_enabled),s=!!((g=e==null?void 0:e.signals)!=null&&g.native_publish_enabled);return r||s?`${t?"鉴权已就绪":"鉴权未就绪"}，${l?"执行链路可用":"执行链路阻塞"}`:"当前无需鉴权"}function ki(e){var s,i,n;const t=!!((s=e==null?void 0:e.signals)!=null&&s.publish_mode_config_ready),l=!!((i=e==null?void 0:e.signals)!=null&&i.native_publish_enabled),r=!!((n=e==null?void 0:e.signals)!=null&&n.polling_worker_enabled);return[t?"模式配置就绪":"模式配置缺失",l?"原生发布启用":"原生发布停用",r?"轮询链路启用":"轮询链路停用"].join("，")}function Ti(e){const t=[e!=null&&e.has_sessdata?"SESSDATA":"",e!=null&&e.has_bili_jct?"bili_jct":"",e!=null&&e.buvid3?`buvid3:${e.buvid3}`:""].filter(Boolean).join(" / ")||"-",l=_(e)?"字段完整":`缺少 ${Ci(e).join(" / ")}`;return`${d(t)}${l?`<div class="form-hint" style="margin-top:4px;">${d(l)}</div>`:""}`}function at(e="",t=""){return`激活: ${e==="active"?"仅激活":e==="inactive"?"仅未激活":"全部"}，过期: ${t==="expired"?"已过期":t==="expiring"?"即将过期":t==="valid"?"有效":t==="unset"?"未设置过期时间":"全部"}`}function Bi(e,t="",l="",r=e.length){const s=e.length,i=nt(e,t,l),n=e.filter(a=>a.is_active||a.active),p=e.filter(a=>!(a.is_active||a.active)),o=n.length,b=p.length,c=e.filter(a=>_(a)).length,g=e.filter(a=>(a.is_active||a.active)&&_(a)).length,$=Math.max(0,c-g),w=Math.max(0,o-g),y=Math.max(0,b-$),f=n.filter(a=>a.last_used_at).length,C=Math.max(0,o-f),E=p.filter(a=>a.last_used_at).length,W=Math.max(0,b-E),R=e.filter(a=>_(a)&&a.last_used_at).length,J=Math.max(0,c-R),O=Math.max(0,s-c),u=e.filter(a=>!_(a)&&a.last_used_at).length,k=Math.max(0,O-u),B=e.filter(a=>!a.last_used_at).length,K=Math.max(0,s-B),m=Date.now(),Q=e.filter(a=>_(a)&&x(a.expires_at,m).hasExpiry&&!x(a.expires_at,m).expired).length,z=e.filter(a=>_(a)&&x(a.expires_at,m).expired).length,F=e.filter(a=>_(a)&&x(a.expires_at,m).expiringSoon).length,D=e.filter(a=>_(a)&&!x(a.expires_at,m).hasExpiry).length,M=e.map(a=>x(a.expires_at,m)),I=n.map(a=>x(a.expires_at,m)),P=p.map(a=>x(a.expires_at,m)),X=M.filter(a=>a.hasExpiry).length,ee=M.filter(a=>a.hasExpiry&&!a.expired).length,te=M.filter(a=>a.expired).length,ie=M.filter(a=>a.expiringSoon).length,G=I.filter(a=>a.hasExpiry&&!a.expired).length,le=I.filter(a=>a.expired).length,Y=I.filter(a=>a.expiringSoon).length,j=I.filter(a=>!a.hasExpiry).length,Z=P.filter(a=>a.hasExpiry&&!a.expired).length,$e=P.filter(a=>a.expired).length,xe=P.filter(a=>a.expiringSoon).length,_e=P.filter(a=>!a.hasExpiry).length,we=e.filter(a=>!_(a)&&x(a.expires_at,m).hasExpiry&&!x(a.expires_at,m).expired).length,Se=e.filter(a=>!_(a)&&x(a.expires_at,m).expired).length,Ee=e.filter(a=>!_(a)&&x(a.expires_at,m).expiringSoon).length,Ce=e.filter(a=>!_(a)&&!x(a.expires_at,m).hasExpiry).length,qe=M.filter(a=>!a.hasExpiry).length,Le=at(t,l),re=i.filter(a=>_(a)).length,oe=Math.max(0,i.length-re),ke=i.filter(a=>{if(!_(a))return!1;const U=x(a.expires_at,m);return U.hasExpiry&&!U.expired}).length,Te=i.filter(a=>_(a)?x(a.expires_at,m).expired:!1).length,Be=i.filter(a=>_(a)?x(a.expires_at,m).expiringSoon:!1).length,Me=i.filter(a=>_(a)?!x(a.expires_at,m).hasExpiry:!1).length,ue=i.filter(a=>_(a)&&(a.is_active||a.active)).length,Pe=Math.max(0,re-ue),pe=i.filter(a=>_(a)&&a.last_used_at).length,Ae=Math.max(0,re-pe),be=i.filter(a=>!_(a)&&a.last_used_at).length,Ne=Math.max(0,oe-be),Ie=i.filter(a=>{if(_(a))return!1;const U=x(a.expires_at,m);return U.hasExpiry&&!U.expired}).length,je=i.filter(a=>_(a)?!1:x(a.expires_at,m).expired).length,He=i.filter(a=>_(a)?!1:x(a.expires_at,m).expiringSoon).length,Re=i.filter(a=>_(a)?!1:!x(a.expires_at,m).hasExpiry).length,ve=i.filter(a=>!_(a)&&(a.is_active||a.active)).length,Oe=Math.max(0,oe-ve),fe=i.filter(a=>a.is_active||a.active).length,De=Math.max(0,i.length-fe),ye=i.filter(a=>a.last_used_at).length,Ue=Math.max(0,i.length-ye),Ve=i.filter(a=>{const U=x(a.expires_at,m);return U.hasExpiry&&!U.expired}).length,ut=i.filter(a=>x(a.expires_at,m).expired).length,pt=i.filter(a=>x(a.expires_at,m).expiringSoon).length,bt=i.filter(a=>!x(a.expires_at,m).hasExpiry).length,vt=t?"":`，激活 ${fe} 个，未激活 ${De} 个`,ft=t?"":`，完整且激活 ${ue} 个，完整但未激活 ${Pe} 个`,yt=t?"":`，缺字段且激活 ${ve} 个，缺字段且未激活 ${Oe} 个`,ht=t||l?`，筛选结果完整 ${re} 个${ft}，完整且有效 ${ke} 个，完整且已过期 ${Te} 个，完整且即将过期 ${Be} 个，完整且未设置过期 ${Me} 个，完整且已使用 ${pe} 个，完整但未使用 ${Ae} 个，缺字段 ${oe} 个${yt}，缺字段但已使用 ${be} 个，缺字段且从未使用 ${Ne} 个，缺字段但有效 ${Ie} 个，缺字段且已过期 ${je} 个，缺字段且即将过期 ${He} 个，缺字段且未设置过期 ${Re} 个${vt}，已使用 ${ye} 个，从未使用 ${Ue} 个，有效 ${Ve} 个，已过期 ${ut} 个，即将过期 ${pt} 个，未设置过期 ${bt} 个`:"";return`共 ${s} 个凭证，激活中 ${o} 个，未激活 ${b} 个，激活且完整 ${g} 个，未激活但完整 ${$} 个，激活但缺字段 ${w} 个，未激活且缺字段 ${y} 个，激活且已使用 ${f} 个，激活但从未使用 ${C} 个，未激活且已使用 ${E} 个，未激活但从未使用 ${W} 个，激活且有效 ${G} 个，未激活且有效 ${Z} 个，激活已过期 ${le} 个，未激活已过期 ${$e} 个，激活即将过期 ${Y} 个，未激活即将过期 ${xe} 个，激活未设置过期 ${j} 个，未激活未设置过期 ${_e} 个，字段完整 ${c} 个，完整且有效 ${Q} 个，完整且已过期 ${z} 个，完整即将过期 ${F} 个，完整未设置过期 ${D} 个，完整且已使用 ${R} 个，完整但未使用 ${J} 个，字段缺失 ${O} 个，缺字段但已使用 ${u} 个，缺字段且未使用 ${k} 个，缺字段但有效 ${we} 个，缺字段且已过期 ${Se} 个，缺字段即将过期 ${Ee} 个，缺字段未设置过期 ${Ce} 个，已使用 ${K} 个，从未使用 ${B} 个，设置过期时间 ${X} 个，有效 ${ee} 个，已过期 ${te} 个，即将过期 ${ie} 个，未设置 ${qe} 个；筛选: ${Le}，当前展示 ${r} 个${ht}`}function nt(e,t="",l=""){const r=Date.now();return e.filter(s=>{const i=s.is_active||s.active;if(t==="active"&&!i||t==="inactive"&&i)return!1;const n=x(s.expires_at,r);return!(l==="expired"&&!n.expired||l==="expiring"&&!n.expiringSoon||l==="valid"&&(!n.hasExpiry||n.expired)||l==="unset"&&n.hasExpiry)})}function Mi(e="",t=""){return e||t?`暂无匹配筛选条件的凭证（${at(e,t)}）`:"暂无凭证"}function it(e,t,l){const r=e.querySelector(l);t.forEach(s=>{const i=e.querySelector(s);i==null||i.addEventListener("keydown",n=>{n.key==="Enter"&&(n.preventDefault(),r.disabled||r.click())})})}async function Pi(e){let t=0;e.innerHTML=`
    <div class="page-header">
      <h2>B站集成</h2>
  ...
  `;async function l(){var n,p,o,b,c,g,$,w,y,f,C,E,W,R,J,O;const i=e.querySelector("#bili-status-cards");i.innerHTML='<div class="page-loading">加载中...</div>';try{const u=await T.getBilibiliStatus(),k=Number((u==null?void 0:u.video_count)??0),B=Number(((n=u==null?void 0:u.videos)==null?void 0:n.poll_enabled_count)??0),K=Math.max(0,k-B),m=Wt(k,B),Q=Xe(B,k),z=Xe(K,k,"占比"),F=!!((p=u==null?void 0:u.diagnostics)!=null&&p.ready),D=Rt((o=u==null?void 0:u.diagnostics)==null?void 0:o.blocking_reasons),M=tt(u==null?void 0:u.credential,"未配置"),I=!!(((c=(b=u==null?void 0:u.diagnostics)==null?void 0:b.signals)==null?void 0:c.credential_present)??(($=(g=u==null?void 0:u.diagnostics)==null?void 0:g.release_gates)==null?void 0:$.credential_present)),P=!!(((y=(w=u==null?void 0:u.diagnostics)==null?void 0:w.signals)==null?void 0:y.credential_complete)??((C=(f=u==null?void 0:u.diagnostics)==null?void 0:f.release_gates)==null?void 0:C.credential_complete)),X=qi(I,P),ee=Li(u==null?void 0:u.diagnostics),te=Ot((E=u==null?void 0:u.diagnostics)==null?void 0:E.effective_publish_mode),ie=ki(u==null?void 0:u.diagnostics),G=Dt((W=u==null?void 0:u.config)==null?void 0:W.poll_interval_seconds),le=Ut((R=u==null?void 0:u.config)==null?void 0:R.rate_limit_per_minute),Y=Vt((J=u==null?void 0:u.config)==null?void 0:J.rate_limit_per_minute),j=x((O=u==null?void 0:u.credential)==null?void 0:O.expires_at),Z=Ei(u==null?void 0:u.credential);i.innerHTML=`
        <div class="stat-card mini">
        ...
        <div class="stat-card mini">
          ...
          ${Y?`<div class="form-hint" style="margin-top:6px;">${d(Y)}</div>`:""}
        </div>
        <div class="stat-card mini">
          <div class="stat-label">凭证过期</div>
          <div class="stat-value" style="font-size:14px; color:${Si(j)}">${d(j.label)}</div>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${w.map(f=>`<tr data-id="${d(f.id||f.video_id)}">
              <td class="cell-id">${mi(f)}</td>
              <td class="cell-truncate">${$i(f)}</td>
              <td>${Fe(f.poll_enabled)}</td>
              <td>${f.comment_count??"-"}</td>
              <td class="cell-time">${f.last_polled_at?ne(f.last_polled_at):"-"}</td>
              <td>${Jt(f.last_poll_status,f.last_poll_error,f.last_rpid)}</td>
              <td class="cell-actions">
      ...
      `,i.querySelectorAll(".bili-toggle-poll").forEach(f=>{f.addEventListener("click",async()=>{f.disabled=!0;try{await T.toggleBilibiliVideoPoll(f.dataset.id),v("操作成功","success"),await Promise.all([l(),r()])}catch(C){v(`失败: ${q(C)}`,"error")}finally{f.disabled=!1}})}),i.querySelectorAll(".bili-sync").forEach(f=>{f.addEventListener("click",async()=>{if(f.dataset.hasAid==="false"){v(me.no_aid,"warning");return}const C=f.textContent;f.disabled=!0,f.textContent="同步中...";try{const E=await T.syncBilibiliVideo(f.dataset.id);v(et(E==null?void 0:E.result,{subject:"同步"}),"success"),await Promise.all([l(),r()])}catch(E){v(`同步失败: ${q(E)}`,"error")}finally{f.disabled=!1,f.textContent=C}})}),i.querySelectorAll(".bili-delete").forEach(f=>{f.addEventListener("click",async()=>{if(confirm("确定删除此视频？")){f.disabled=!0;try{await T.deleteBilibiliVideo(f.dataset.id),v("已删除","success"),await Promise.all([l(),r()])}catch(C){v(`删除失败: ${q(C)}`,"error")}finally{f.disabled=!1}}})})}catch($){n.textContent="视频加载失败",i.innerHTML=`<div class="page-error">加载失败: ${d(q($))}</div>`}finally{o.disabled=!1,p.disabled=!1}}async function s(){const i=e.querySelector("#bili-creds-wrapper"),n=e.querySelector("#bili-cred-summary"),p=e.querySelector("#bili-cred-active-filter"),o=e.querySelector("#bili-cred-expiry-filter"),b=p.value,c=o.value;n.textContent="加载中...",i.innerHTML='<div class="page-loading">加载中...</div>',p.disabled=!0,o.disabled=!0;try{const g=await T.getBilibiliCredentials(),$=Array.isArray(g==null?void 0:g.items)?g.items:Array.isArray(g)?g:[],w=nt($,b,c);if(n.textContent=Bi($,b,c,w.length),w.length===0){i.innerHTML=`<div class="table-empty">${d(Mi(b,c))}</div>`;return}i.innerHTML=`
        <table class="data-table">
          <thead><tr><th>名称</th><th>凭证摘要</th><th>激活</th><th>过期状态</th><th>最近使用</th><th>操作</th></tr></thead>
          <tbody>
            ${w.map(y=>`<tr data-id="${d(y.id||y.credential_id)}">
              <td>${tt(y)}</td>
              <td class="cell-id">${Ti(y)}</td>
              <td>${Fe(y.is_active||y.active)}</td>
              <td>${wi(y.expires_at)}</td>
              <td class="cell-time">${y.last_used_at?ne(y.last_used_at):"-"}</td>
              <td class="cell-actions">
  ...
  `,e.querySelector("#query-comment-btn").addEventListener("click",async()=>{const t=e.querySelector("#query-comment-id").value.trim(),l=e.querySelector("#query-comment-result");if(!t){v("请输入 Comment ID","warning");return}l.innerHTML='<div class="page-loading">查询中...</div>';try{const r=await lt.getComment(t);l.innerHTML=`
      ...
      `;const s=l.querySelector("#query-goto-comment");s&&s.addEventListener("click",()=>{e.querySelector("#query-comment-id").value=s.dataset.id,e.querySelector("#query-comment-btn").click()})}catch(r){l.innerHTML=`<div class="page-error">查询失败: ${d(r.message)}</div>`}})}const ze={dashboard:{render:st,title:"仪表盘"},jobs:{render:xt,title:"任务管理"},"daily-metrics":{render:wt,title:"每日指标"},knowledge:{render:St,title:"知识库"},"role-cards":{render:Et,title:"角色卡"},profiles:{render:Ct,title:"风格配置"},gateway:{render:Lt,title:"网关"},audit:{render:kt,title:"审计日志"},bilibili:{render:Pi,title:"B站集成"},query:{render:Ai,title:"查询"}};let ot=null;function Ni(){const e=sessionStorage.getItem("admin_api_key");return e?(window.__ADMIN_API_KEY__=e,!0):!1}function dt(){document.getElementById("login-overlay").style.display="flex",document.getElementById("logout-btn").style.display="none"}function ct(){document.getElementById("login-overlay").style.display="none",document.getElementById("logout-btn").style.display=""}async function Ii(e){e.preventDefault();const t=document.getElementById("login-api-key"),l=document.getElementById("login-error"),r=t.value.trim();if(r){window.__ADMIN_API_KEY__=r;try{await h("/api/admin/overview"),sessionStorage.setItem("admin_api_key",r),ct(),Ye("dashboard")}catch{l.textContent="API Key 无效或服务不可用",l.style.display="block",window.__ADMIN_API_KEY__=""}}}function ji(){sessionStorage.removeItem("admin_api_key"),window.__ADMIN_API_KEY__="",document.getElementById("page-container").innerHTML="",dt()}function Ye(e){if(!ze[e])return;ot=e,document.querySelectorAll("#nav-list .nav-item").forEach(l=>{l.classList.toggle("active",l.dataset.page===e)}),document.getElementById("page-title").textContent=ze[e].title;const t=document.getElementById("page-container");t.innerHTML='<div class="page-loading">加载中...</div>',ze[e].render(t).catch(l=>{t.innerHTML=`<div class="page-error">加载失败: ${l.message}</div>`})}function Hi(){document.querySelectorAll("#nav-list .nav-item").forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.page;t&&t!==ot&&Ye(t)})})}function Ri(){const e=document.getElementById("left-sidebar"),t=document.getElementById("toggle-left-btn"),l=document.getElementById("expand-left-btn");t&&l&&e&&(t.addEventListener("click",()=>{e.classList.add("collapsed"),l.style.display="block"}),l.addEventListener("click",()=>{e.classList.remove("collapsed"),l.style.display="none"}))}function Oi(){const e=document.getElementById("theme-toggle-btn");if(!e)return;const t=["","dark","sepia"];let l=0;e.addEventListener("click",()=>{l=(l+1)%t.length,t[l]?document.body.setAttribute("data-theme",t[l]):document.body.removeAttribute("data-theme")})}function Di(){Ri(),Oi(),Hi(),document.getElementById("login-form").addEventListener("submit",Ii),document.getElementById("logout-btn").addEventListener("click",ji),Ni()?(ct(),Ye("dashboard")):dt()}Di();
