(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const d of o)if(d.type==="childList")for(const i of d.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const d={};return o.integrity&&(d.integrity=o.integrity),o.referrerPolicy&&(d.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?d.credentials="include":o.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function s(o){if(o.ep)return;o.ep=!0;const d=n(o);fetch(o.href,d)}})();const he=Object.freeze({petName:"Mochi",statusLine:"Idle on the browser ledge, listening for the next check-in.",loopMode:"Local placeholder loop",lastCheckIn:"2026-04-10 03:30",adapterLabel:"Local stub",loopHint:"Swap this adapter with a real pet core endpoint when the contract is ready.",mood:{label:"Curious",note:"Ready to nudge the next companion interaction with a light status ping."},memoryTitle:"Short-term memory",memorySummary:"Remembers that the current milestone is a pet-first prototype, so it prefers short updates and visible state changes.",vitals:[{label:"Energy",value:"76%"},{label:"Hunger",value:"Snack soon"},{label:"Bond",value:"Growing"},{label:"Focus",value:"Watching queue"}],recentSignals:["Last pat received 2 minutes ago.","Quiet window open for another 18 minutes.","Next nudge stays local until the real API is wired in."],recentInteractions:[{kind:"pat",title:"Pat interaction",detail:"A calm pat kept Mochi settled on the browser ledge.",timestamp:"2026-04-10T03:28:00.000Z",source:"Local Stub"},{kind:"signal",title:"Status pulse",detail:"The local adapter emitted a lightweight keep-alive signal.",timestamp:"2026-04-10T03:30:00.000Z",source:"Local Stub"}]});function be(e){return JSON.parse(JSON.stringify(e))}function re(e=he){return{async getCompanionState(){return await Promise.resolve(),be(e)}}}function ge({endpoint:e="/companion/state",actionEndpoint:t="/companion/actions",fetchImpl:n=(o=>(o=globalThis.fetch)==null?void 0:o.bind(globalThis))(),fallback:s=re()}={}){return{async getCompanionState(){if(typeof n!="function")return s.getCompanionState();try{const d=await n(e,{headers:{Accept:"application/json"}});if(!d.ok)throw new Error(`companion_state_${d.status}`);const i=await d.json();if(!i||typeof i!="object")throw new Error("companion_state_invalid");return i}catch{return s.getCompanionState()}},async performAction(d,i){if(typeof n!="function")return{ok:!1,fallback:!0};const k=await n(t,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({action:d,note:i})});if(!k.ok)throw new Error(`companion_action_${k.status}`);return k.json()}}}const ye=[{label:"Energy",value:"Unknown"},{label:"Hunger",value:"Unknown"},{label:"Bond",value:"Unknown"}],Se=["Local companion loop has not reported any recent signals yet."],ve=[{kind:"signal",title:"Companion signal pending",detail:"No structured interaction timeline is available yet.",timestamp:"Pending",source:"Local stub"}],O=["all","pat","feed","wake","signal","fallback"],K=["pat","feed","wake"],M=Symbol("petCompanionCleanup");function se(e){return{key:String(e+1),label:`Alt+${e+1}`}}function ke(e){const t=String(e??"").trim().toLowerCase();return t==="pat"||t==="feed"||t==="wake"||t==="signal"?t:t==="fallback"?"fallback":"signal"}function we(e){const t=String((e==null?void 0:e.source)??"").trim().toLowerCase(),n=String((e==null?void 0:e.title)??"").trim().toLowerCase();return t.includes("fallback")||n.includes("fallback")?"fallback":n.includes("pat")?"pat":n.includes("feed")?"feed":n.includes("wake")?"wake":"signal"}function m(e){return e==="all"?"All":e==="pat"?"Pat":e==="feed"?"Feed":e==="wake"?"Wake":e==="fallback"?"Fallback":"Signal"}function b(e){const t=String(e??"").trim().toLowerCase();return O.includes(t)?t:"all"}function B(e){return K.includes(b(e))}function Le(e){const t=b(e);return t==="pat"?{label:"Pat note",placeholder:"Optional note for the next pat.",hint:"Describe the comfort, bond, or calming signal you want the timeline to capture. Press Ctrl+Enter to send."}:t==="feed"?{label:"Feed note",placeholder:"Optional note for the next feed.",hint:"Add snack, refill, or appetite context so the feed entry reads clearly later. Press Ctrl+Enter to send."}:t==="wake"?{label:"Wake note",placeholder:"Optional note for the next wake.",hint:"Explain the nudge or prompt that should bring the companion back into motion. Press Ctrl+Enter to send."}:{label:"Interaction note",placeholder:"Optional note for the next pat, feed, or wake.",hint:"Optional context travels into the companion timeline."}}function Ce(e){const t=b(e);return B(t)?null:t==="signal"?{message:"Signal entries are read-only snapshots. Pick Pat, Feed, or Wake to focus the composer on a writable action.",shortcuts:K}:t==="fallback"?{message:"Fallback entries describe degraded state only. Switch to Pat, Feed, or Wake before drafting the next note.",shortcuts:K}:{message:"Notes publish through Pat, Feed, or Wake actions. Pick one to focus the composer before writing.",shortcuts:K}}function $e(e){const t=b(e);return t==="signal"?"Signal entries are read-only. Pick Pat, Feed, or Wake before sending.":t==="fallback"?"Fallback entries are read-only. Pick Pat, Feed, or Wake before sending.":"Pick Pat, Feed, or Wake before sending a note."}function Ae(e){const t=b(e);return t==="pat"?{label:"Suggested pat notes",templates:["Soft pat settled Mochi into a calmer loop.","Bond signal ticked upward after a gentle tap.","Comfort pass landed right on time for the next check-in."]}:t==="feed"?{label:"Suggested feed notes",templates:["Refilled snack tray and appetite stabilized.","Quick bite restored energy before the next loop window.","Treat drop landed cleanly and hunger signal eased."]}:t==="wake"?{label:"Suggested wake notes",templates:["Bright nudge reopened the interaction window.","Wake pulse brought Mochi back into active mode.","Gentle prompt resumed the browser buddy loop."]}:null}function Te(e,t,n){const s=b(e),o=String(t??"").trim();return n?{label:"Template waiting",detail:"Choose Replace, Append, or Cancel to resolve the current draft.",tone:"pending"}:o?B(s)?{label:`${m(s)} draft ready`,detail:`Will publish with the next ${m(s).toLowerCase()} action.`,tone:"ready"}:{label:"Draft waiting",detail:"Pick Pat, Feed, or Wake to send this note.",tone:"pending"}:B(s)?{label:`${m(s)} draft empty`,detail:"Type a note or pick a template to stage the next action.",tone:"idle"}:{label:"Composer idle",detail:"Select Pat, Feed, or Wake to focus the draft composer.",tone:"idle"}}function Ee(){return`
  ...
  `}function c(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function E(e){return`${e.toISOString().slice(0,16).replace("T"," ")} UTC`}function U(e,t,n,s){const o=Math.max(1,Math.round(Math.abs(e)/t)),d=o===1?n:s;return e>=0?`${o} ${d} ago`:`in ${o} ${d}`}function xe(e){const t=String(e??"").trim();if(!t||t.toLowerCase()==="pending")return{label:t||"Pending",exact:"",machine:""};const n=new Date(t);if(Number.isNaN(n.getTime()))return{label:t,exact:"",machine:""};const s=Math.round((Date.now()-n.getTime())/1e3),o=Math.abs(s);return o<45?{label:s>=0?"just now":"in moments",exact:E(n),machine:n.toISOString()}:o<60*60?{label:U(s,60,"min","mins"),exact:E(n),machine:n.toISOString()}:o<60*60*24?{label:U(s,60*60,"hour","hours"),exact:E(n),machine:n.toISOString()}:o<60*60*24*7?{label:U(s,60*60*24,"day","days"),exact:E(n),machine:n.toISOString()}:{label:E(n),exact:E(n),machine:n.toISOString()}}function ce(e){const t=e&&typeof e=="object"?e:{},n=t.mood&&typeof t.mood=="object"?t.mood:{},s=Array.isArray(t.vitals)&&t.vitals.length?t.vitals:ye,o=Array.isArray(t.recentSignals)&&t.recentSignals.length?t.recentSignals:Se,d=Array.isArray(t.recentInteractions)&&t.recentInteractions.length?t.recentInteractions.map(i=>({kind:ke((i==null?void 0:i.kind)||we(i)),title:(i==null?void 0:i.title)||"Companion signal",detail:(i==null?void 0:i.detail)||"No detail published yet.",timestamp:(i==null?void 0:i.timestamp)||"Pending",source:(i==null?void 0:i.source)||"Memory"})):ve;return{petName:t.petName||"Companion",statusLine:t.statusLine||"Waiting for the first local update.",loopMode:t.loopMode||"Local placeholder loop",lastCheckIn:t.lastCheckIn||"Pending",adapterLabel:t.adapterLabel||"Local stub",loopHint:t.loopHint||"Wire a real endpoint later without changing the browser shell.",mood:{label:n.label||"Settling",note:n.note||"No mood note has been published yet."},memoryTitle:t.memoryTitle||"Memory summary",memorySummary:t.memorySummary||"No memory summary is available yet. The prototype stays useful even before backend contracts exist.",vitals:s,recentSignals:o,recentInteractions:d}}function Ie(e){return e.map(t=>`
      ...
      `}).join("")}function Oe(e,t){const n=b(t),s=n==="all"?e:e.filter(o=>o.kind===n);return s.length===0?`
      <div class="timeline-empty" data-role="timeline-empty">
        No ${c(m(n).toLowerCase())} interactions yet.
      </div>
    `:s.map(o=>{const d=xe(o.timestamp),i=m(o.kind);return`
      ...
      `}).join("")}function Be(e,t="all"){const n=ce(e),s=b(t);return`
  ...
  `}async function Ne(e,{adapter:t=re()}={}){if(!e)throw new Error("A target element is required to render the pet companion surface.");typeof e[M]=="function"&&e[M](),e.innerHTML=De();const n=e.ownerDocument,s=e.querySelector('[data-role="content"]'),o=e.querySelector('[data-action="refresh"]'),d=e.querySelector('[data-role="adapter-status"]'),i=e.querySelector('[data-role="shortcut-help-toggle"]'),k=e.querySelector('[data-role="shortcut-help"]'),x=e.querySelector('[data-role="shortcut-help-title"]'),I=e.querySelector('[data-role="shortcut-help-close"]'),j=e.querySelector('[data-role="live-region"]'),r=e.querySelector('[data-role="action-note"]'),V=e.querySelector('[data-role="action-note-label"]'),J=e.querySelector('[data-role="action-note-hint"]'),Q=e.querySelector('[data-role="action-note-status"]'),Z=e.querySelector('[data-role="action-note-status-label"]'),X=e.querySelector('[data-role="action-note-status-detail"]'),P=e.querySelector('[data-role="action-note-clear"]'),C=e.querySelector('[data-role="composer-templates"]'),$=e.querySelector('[data-role="composer-template-actions"]'),A=e.querySelector('[data-role="composer-guide"]'),W=[...e.querySelectorAll('[data-role="action-buttons"] [data-action]')];let f="all",D=null,g=null,S=!1,Y="";function de(a){return!!(a&&typeof a=="object"&&"tagName"in a&&["INPUT","TEXTAREA","SELECT"].includes(String(a.tagName).toUpperCase()))}function H(){W.forEach(a=>{const p=a.getAttribute("data-action")===f;a.classList.toggle("is-linked",p),a.setAttribute("data-filter-linked",p?"true":"false")})}function h(a){const l=String(a??"").trim();!j||!l||(Y===l&&(j.textContent=""),Y=l,j.textContent=l)}function ee(){i&&(i.setAttribute("aria-expanded",S?"true":"false"),i.classList.toggle("is-active",S)),k&&(k.hidden=!S)}function pe(a=!1){const l=[x,I].filter(Boolean);if(!l.length)return;const p=a?l[l.length-1]:l[0];p==null||p.focus()}function F(a,l,{moveFocus:p=!1}={}){S=a,ee(),p&&(a?x==null||x.focus():i==null||i.focus()),l&&h(l)}function ue(a){return!!(a&&(k!=null&&k.contains(a)||i!=null&&i.contains(a)))}function z(a,{announcement:l}={}){const p=b(a);p!==f&&(w(),f=p,oe(),l&&h(l))}function w(){g=null}function me(){r&&(r.value="",r.focus()),w(),v(),h("Draft cleared.")}function fe(a){if(!r||!g)return;const l=r.value.trim();a==="append"&&l?r.value=`${l}
${g}`:r.value=g,r.focus(),w(),v(),h(`${m(f)} template ${a==="append"?"appended to":"replaced"} draft.`)}function v(){const a=Le(f),l=Te(f,r==null?void 0:r.value,g),p=Ae(f),T=Ce(f),L=!!(r!=null&&r.value.trim())||!!g;V&&(V.textContent=a.label),r&&(r.placeholder=a.placeholder,r.setAttribute("data-composer-kind",b(f))),J&&(J.textContent=a.hint),Q&&Q.setAttribute("data-status-tone",l.tone),Z&&(Z.textContent=l.label),X&&(X.textContent=l.detail),P&&(P.disabled=!L),C&&(p?(C.hidden=!1,C.innerHTML=`
        ...
        `,[...C.querySelectorAll('[data-role="composer-template"]')].forEach(u=>{u.addEventListener("click",()=>{if(r){const y=u.getAttribute("data-template-value")??"",ie=r.value.trim();if(ie&&ie!==y){g=y,v(),h("Template selected. Choose Replace, Append, or Cancel.");return}r.value=y,r.focus(),w(),v(),h(`${m(f)} template inserted into draft.`)}})})):(C.innerHTML="",C.hidden=!0)),$&&(!g||!p?($.innerHTML="",$.hidden=!0):($.hidden=!1,$.innerHTML=`
          <p class="composer-template-actions-copy">
            Keep the current draft, append the suggestion, or replace it with:
            <span class="composer-template-preview">${c(g)}</span>
          </p>
        ...
        `,[...$.querySelectorAll('[data-role="template-merge-action"]')].forEach(u=>{u.addEventListener("click",()=>{const y=u.getAttribute("data-merge-mode");if(y==="replace"||y==="append"){fe(y);return}w(),v(),h("Template merge cancelled.")})}))),A&&(T?(A.hidden=!1,A.innerHTML=`
        ...
        `,[...A.querySelectorAll('[data-role="composer-shortcut"]')].forEach(u=>{u.addEventListener("click",()=>{const y=b(u.getAttribute("data-shortcut-kind"));z(y,{announcement:`Timeline filter set to ${m(y)}.`}),r==null||r.focus()})})):(A.innerHTML="",A.hidden=!0))}function N(a){o.disabled=a,W.forEach(l=>{l.disabled=a}),r&&(r.disabled=a)}r==null||r.addEventListener("input",()=>{g&&w(),v()}),P==null||P.addEventListener("click",()=>{me()}),i==null||i.addEventListener("click",()=>{F(!S,`Shortcut help ${S?"closed":"opened"}.`,{moveFocus:!0})}),I==null||I.addEventListener("click",()=>{F(!1,"Shortcut help closed.",{moveFocus:!0})});function te(a){!S||ue(a.target)||F(!1,"Shortcut help closed.")}function ae(a){var T;if(a.key==="Escape"&&g){a.preventDefault(),w(),v(),h("Template merge cancelled.");return}if(a.key==="Escape"&&S){a.preventDefault(),F(!1,"Shortcut help closed.",{moveFocus:!0});return}if(a.key==="Tab"&&S){const L=[x,I].filter(Boolean);if(!L.length)return;const R=e.ownerDocument.activeElement,u=L.indexOf(R);if(u===-1){a.preventDefault(),pe(a.shiftKey);return}const y=a.shiftKey?(u-1+L.length)%L.length:(u+1)%L.length;a.preventDefault(),(T=L[y])==null||T.focus();return}if(a.key==="?"&&!de(a.target)){a.preventDefault(),F(!S,`Shortcut help ${S?"closed":"opened"}.`,{moveFocus:!0});return}if(!a.altKey||a.ctrlKey||a.metaKey||a.shiftKey)return;const l=Number.parseInt(a.key,10)-1;if(Number.isNaN(l)||l<0||l>=O.length)return;a.preventDefault();const p=O[l];z(p,{announcement:`Timeline filter set to ${m(p)}.`})}n.addEventListener("click",te),n.addEventListener("keydown",ae);async function ne(a){if(!a)return;if(typeof t.performAction!="function"){d.textContent="Adapter: action unavailable",h(`${m(a)} action is unavailable in this preview.`);return}const l=typeof(r==null?void 0:r.value)=="string"?r.value.trim():"";N(!0),d.textContent=`Adapter: sending ${a}`,h(`Sending ${m(a)} action.`);try{await t.performAction(a,l||void 0),w(),f=b(a),r&&(r.value=""),await q(),h(`${m(a)} action sent.`)}catch(p){s.innerHTML=le(p),d.textContent="Adapter: action failed",N(!1),h(`${m(a)} action failed.`)}}r==null||r.addEventListener("keydown",a=>{if(a.key==="Escape"&&g){a.preventDefault(),w(),v(),h("Template merge cancelled.");return}if(a.key==="Enter"&&(a.ctrlKey||a.metaKey)&&!B(f)){a.preventDefault(),h($e(f));return}a.key==="Enter"&&(a.ctrlKey||a.metaKey)&&B(f)&&(a.preventDefault(),ne(f))});function oe(){if(!D){H(),v();return}s.innerHTML=Be(D,f),H(),v(),[...s.querySelectorAll('[data-role="timeline-filter"]')].forEach(l=>{l.addEventListener("click",()=>{const p=b(l.getAttribute("data-filter-kind"));z(p,{announcement:`Timeline filter set to ${m(p)}.`})})})}async function q(){N(!0),o.textContent="Refreshing...",d.textContent="Adapter: syncing local loop";try{const a=await t.getCompanionState(),l=ce(a);D=l,oe(),d.textContent=`Adapter: ${l.adapterLabel}`}catch(a){D=null,s.innerHTML=le(a),d.textContent="Adapter: degraded"}finally{N(!1),o.textContent="Refresh mood"}}for(const a of W)a.addEventListener("click",async()=>{const l=a.getAttribute("data-action");await ne(l)});o.addEventListener("click",()=>{q()});function _(){n.removeEventListener("click",te),n.removeEventListener("keydown",ae),e[M]===_&&delete e[M]}return e[M]=_,H(),ee(),v(),await q(),{destroy:_,reload:q}}const G=document.getElementById("app");G&&Ne(G,{adapter:ge()}).catch(e=>{G.innerHTML=`
      <main class="companion-shell" data-surface="pet-companion">
