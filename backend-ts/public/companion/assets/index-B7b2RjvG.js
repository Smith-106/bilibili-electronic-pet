(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const S=Object.freeze({petName:"Mochi",statusLine:"Idle on the browser ledge, listening for the next check-in.",loopMode:"Local placeholder loop",lastCheckIn:"2026-04-10 03:30",adapterLabel:"Local stub",loopHint:"Swap this adapter with a real pet core endpoint when the contract is ready.",mood:{label:"Curious",note:"Ready to nudge the next companion interaction with a light status ping."},memoryTitle:"Short-term memory",memorySummary:"Remembers that the current milestone is a pet-first prototype, so it prefers short updates and visible state changes.",vitals:[{label:"Energy",value:"76%"},{label:"Hunger",value:"Snack soon"},{label:"Bond",value:"Growing"},{label:"Focus",value:"Watching queue"}],recentSignals:["Last pat received 2 minutes ago.","Quiet window open for another 18 minutes.","Next nudge stays local until the real API is wired in."],recentInteractions:[{title:"Pat interaction",detail:"A calm pat kept Mochi settled on the browser ledge.",timestamp:"2026-04-10T03:28:00.000Z",source:"Local Stub"},{title:"Status pulse",detail:"The local adapter emitted a lightweight keep-alive signal.",timestamp:"2026-04-10T03:30:00.000Z",source:"Local Stub"}]});function w(t){return JSON.parse(JSON.stringify(t))}function b(t=S){return{async getCompanionState(){return await Promise.resolve(),w(t)}}}function L({endpoint:t="/companion/state",actionEndpoint:e="/companion/actions",fetchImpl:a=(n=>(n=globalThis.fetch)==null?void 0:n.bind(globalThis))(),fallback:s=b()}={}){return{async getCompanionState(){if(typeof a!="function")return s.getCompanionState();try{const o=await a(t,{headers:{Accept:"application/json"}});if(!o.ok)throw new Error(`companion_state_${o.status}`);const i=await o.json();if(!i||typeof i!="object")throw new Error("companion_state_invalid");return i}catch{return s.getCompanionState()}},async performAction(o,i){if(typeof a!="function")return{ok:!1,fallback:!0};const c=await a(e,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({action:o,note:i})});if(!c.ok)throw new Error(`companion_action_${c.status}`);return c.json()}}}const A=[{label:"Energy",value:"Unknown"},{label:"Hunger",value:"Unknown"},{label:"Bond",value:"Unknown"}],$=["Local companion loop has not reported any recent signals yet."],C=[{title:"Companion signal pending",detail:"No structured interaction timeline is available yet.",timestamp:"Pending",source:"Local stub"}];function r(t){return String(t).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function d(t){return`${t.toISOString().slice(0,16).replace("T"," ")} UTC`}function m(t,e,a,s){const n=Math.max(1,Math.round(Math.abs(t)/e)),o=n===1?a:s;return t>=0?`${n} ${o} ago`:`in ${n} ${o}`}function T(t){const e=String(t??"").trim();if(!e||e.toLowerCase()==="pending")return{label:e||"Pending",exact:"",machine:""};const a=new Date(e);if(Number.isNaN(a.getTime()))return{label:e,exact:"",machine:""};const s=Math.round((Date.now()-a.getTime())/1e3),n=Math.abs(s);return n<45?{label:s>=0?"just now":"in moments",exact:d(a),machine:a.toISOString()}:n<60*60?{label:m(s,60,"min","mins"),exact:d(a),machine:a.toISOString()}:n<60*60*24?{label:m(s,60*60,"hour","hours"),exact:d(a),machine:a.toISOString()}:n<60*60*24*7?{label:m(s,60*60*24,"day","days"),exact:d(a),machine:a.toISOString()}:{label:d(a),exact:d(a),machine:a.toISOString()}}function g(t){const e=t&&typeof t=="object"?t:{},a=e.mood&&typeof e.mood=="object"?e.mood:{},s=Array.isArray(e.vitals)&&e.vitals.length?e.vitals:A,n=Array.isArray(e.recentSignals)&&e.recentSignals.length?e.recentSignals:$,o=Array.isArray(e.recentInteractions)&&e.recentInteractions.length?e.recentInteractions.map(i=>({title:(i==null?void 0:i.title)||"Companion signal",detail:(i==null?void 0:i.detail)||"No detail published yet.",timestamp:(i==null?void 0:i.timestamp)||"Pending",source:(i==null?void 0:i.source)||"Memory"})):C;return{petName:e.petName||"Companion",statusLine:e.statusLine||"Waiting for the first local update.",loopMode:e.loopMode||"Local placeholder loop",lastCheckIn:e.lastCheckIn||"Pending",adapterLabel:e.adapterLabel||"Local stub",loopHint:e.loopHint||"Wire a real endpoint later without changing the browser shell.",mood:{label:a.label||"Settling",note:a.note||"No mood note has been published yet."},memoryTitle:e.memoryTitle||"Memory summary",memorySummary:e.memorySummary||"No memory summary is available yet. The prototype stays useful even before backend contracts exist.",vitals:s,recentSignals:n,recentInteractions:o}}function x(t){return t.map(e=>`
        <article class="metric-card">
          <span class="metric-label">${r(e.label||"State")}</span>
          <strong class="metric-value">${r(e.value||"Unknown")}</strong>
        </article>
      `).join("")}function k(t){return t.map(e=>`<li class="signal-item">${r(e)}</li>`).join("")}function M(t){return t.map(e=>{const a=T(e.timestamp);return`
      ...
      `}).join("")}function I(t){const e=g(t);return`
  ...
  `}async function O(t,{adapter:e=b()}={}){if(!t)throw new Error("A target element is required to render the pet companion surface.");t.innerHTML=N();const a=t.querySelector('[data-role="content"]'),s=t.querySelector('[data-action="refresh"]'),n=t.querySelector('[data-role="adapter-status"]'),o=t.querySelector('[data-role="action-note"]'),i=[...t.querySelectorAll('[data-role="action-buttons"] [data-action]')];function c(l){s.disabled=l,i.forEach(p=>{p.disabled=l}),o&&(o.disabled=l)}async function u(){c(!0),s.textContent="Refreshing...",n.textContent="Adapter: syncing local loop";try{const l=await e.getCompanionState(),p=g(l);a.innerHTML=I(p),n.textContent=`Adapter: ${p.adapterLabel}`}catch(l){a.innerHTML=f(l),n.textContent="Adapter: degraded"}finally{c(!1),s.textContent="Refresh mood"}}for(const l of i)l.addEventListener("click",async()=>{const p=l.getAttribute("data-action");if(!p||typeof e.performAction!="function")return;const y=typeof(o==null?void 0:o.value)=="string"?o.value.trim():"";c(!0),n.textContent=`Adapter: sending ${p}`;try{await e.performAction(p,y||void 0),o&&(o.value=""),await u()}catch(v){a.innerHTML=f(v),n.textContent="Adapter: action failed",c(!1)}});return s.addEventListener("click",()=>{u()}),await u(),{reload:u}}const h=document.getElementById("app");h&&O(h,{adapter:L()}).catch(t=>{h.innerHTML=`
      <main class="companion-shell" data-surface="pet-companion">
