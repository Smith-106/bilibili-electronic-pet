...
const releaseUrl = 'https://github.com/Smith-106/bilibili-electronic-pet/releases/tag/v1.4.0';
...
const baseline = [
  ['Shipped baseline', 'v1.4.0', 'Current Bilibili-first release baseline with the TypeScript backend and operator control plane.'],
  ['Docs release', 'v1.4.0', 'GitHub Pages documentation layer and docs deployment workflow.'],
  ...
  return `
    ...
    <main id="top">
      <section class="hero" id="overview">
        <div class="hero-copy">
          <p class="eyebrow">Documentation · v1.4.0 docs release</p>
    ...
    <footer>
      <p>Bilibili Electronic Pet documentation site · Repository baseline v1.4.0 · Docs release v1.4.0</p>
    </footer>
  `;
}
